...
class BcfApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.full_update_viewpoint_endpoint = _Endpoint(
            settings={
                'response_type': (Viewpoint,),
                'auth': [
                    'ApiKey',
                ...
                'endpoint_path': '/bcf/2.1/projects/{projects_pk}/topics/{topics_guid}/viewpoints/{guid}',
                'operation_id': 'full_update_viewpoint',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def full_update_viewpoint(
        ...
        **kwargs
        ...
        >>> thread = api.full_update_viewpoint(guid, projects_pk, topics_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['topics_guid'] = \
            topics_guid
        return self.full_update_viewpoint_endpoint.call_with_http_info(**kwargs)
