...
from wrightyrion.page_interactor.modules.common_handler import CommonHandler
from wrightyrion.page_interactor.modules.scroll_handler import ScrollHandler
...
class PageInteractor:
    ...
    async def scroll_load(self,
        ...
        :return:
        """
        return await self._scroll_handler.scroll_load(scroll_step=scroll_step, load_wait=load_wait, same_th=same_th, scroll_step_callbacks=scroll_step_callbacks, elem=elem)
    ...
    async def scroll_load_selector(self,
        ...
        """
        return await self._scroll_handler.scroll_load_selector(selector=selector, threshold=threshold, scroll_step=scroll_step, load_wait=load_wait, same_th=same_th, scroll_step_callbacks=scroll_step_callbacks, log_interval=log_interval, count_check_interval=count_check_interval, elem=elem)
