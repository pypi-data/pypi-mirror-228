...
VERSION = "4.7.0a1693466269"
PLUGIN_VERSION = "4.7.0-alpha.1693466269+e7b047d8"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the vsphere resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource vsphere {PLUGIN_VERSION}`
                """)
            else:
                raise
