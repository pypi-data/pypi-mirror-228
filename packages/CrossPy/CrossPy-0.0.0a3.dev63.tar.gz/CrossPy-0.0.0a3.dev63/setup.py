...
VERSION = '0.0.0a3.dev63'  # release # SKIP 64?
...
setup(
    ...
    url='https://users.oden.utexas.edu/~byou/crosspy',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Bozhi YOU, University of Texas at Austin',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='youbozhi@cs.utexas.edu',  # Optional
