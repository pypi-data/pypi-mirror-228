/*! For license information please see 79546-hRFTZ5z1sWI.js.LICENSE.txt */
export const id=79546;export const ids=[79546];export const modules={29530:(e,t,i)=>{i.d(t,{t:()=>l});var s=i(57835),o=i(68144),r=i(76187);const n=Symbol("valueNotInitialized");class a extends r.sR{constructor(e){if(super(e),e.type!==s.pX.ELEMENT)throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);this.previousValue=n}render(e,t){return o.Ld}update(e,[t,i]){if(!this.hasChanged(i))return o.Ld;this.host=e.options&&e.options.host,this.element=e.element,this.renderer=t;return this.previousValue===n?this.addRenderer():this.runRenderer(),this.previousValue=Array.isArray(i)?[...i]:i,o.Ld}reconnected(){this.addRenderer()}disconnected(){this.removeRenderer()}addRenderer(){throw new Error("The `addRenderer` method must be implemented.")}runRenderer(){throw new Error("The `runRenderer` method must be implemented.")}removeRenderer(){throw new Error("The `removeRenderer` method must be implemented.")}renderRenderer(e,...t){const i=this.renderer.call(this.host,...t);(0,o.sY)(i,e,{host:this.host})}hasChanged(e){return Array.isArray(e)?!Array.isArray(this.previousValue)||(this.previousValue.length!==e.length||e.some(((e,t)=>e!==this.previousValue[t]))):this.previousValue!==e}}const l=(0,s.XM)(class extends a{addRenderer(){this.element.renderer=(e,t,i)=>{this.renderRenderer(e,i.item,i,t)}}runRenderer(){this.element.requestContentUpdate()}removeRenderer(){this.element.renderer=null}})},92459:(e,t,i)=>{class s extends HTMLElement{static get version(){return"24.1.4"}}customElements.define("vaadin-material-styles",s);var o=i(68144);const r=[];function n(e){return e&&Object.prototype.hasOwnProperty.call(e,"__themes")}function a(e,t,i={}){var s;e&&(s=e,n(customElements.get(s))&&console.warn(`The custom element definition for "${e}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`)),t=function(e=[]){return[e].flat(1/0).filter((e=>e instanceof o.c3||(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1)))}(t),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(e,t,i):r.push({themeFor:e,styles:t,include:i.include,moduleId:i.moduleId})}const l=(e,...t)=>{((e,...t)=>{const i=document.createElement("style");i.id=e,i.textContent=t.map((e=>e.toString())).join("\n").replace(":host","html"),document.head.insertAdjacentElement("afterbegin",i)})(`material-${e}`,t)};a("",o.iv`
  :host {
    /* Text colors */
...
`,{moduleId:"material-color-light"});a("",o.iv`
  :host {
    /* Text colors */
    --material-body-text-color: var(--dark-theme-text-color, rgba(255, 255, 255, 1));
    --material-secondary-text-color: var(--dark-theme-secondary-color, rgba(255, 255, 255, 0.7));
...
`,{moduleId:"material-color-dark"});l("color-base",o.iv`
  :host {
    /* Text colors */
    --material-body-text-color: var(--light-theme-text-color, rgba(0, 0, 0, 0.87));
    --material-secondary-text-color: var(--light-theme-secondary-color, rgba(0, 0, 0, 0.54));
...
`);const h=[];function d(e){return e&&Object.prototype.hasOwnProperty.call(e,"__themes")}const c=o.iv`
  :host {
    display: flex;
    align-items: center;
...
`;!function(e,t,i={}){var s;e&&(s=e,d(customElements.get(s))&&console.warn(`The custom element definition for "${e}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`)),t=function(e=[]){return[e].flat(1/0).filter((e=>e instanceof o.c3||(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1)))}(t),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(e,t,i):h.push({themeFor:e,styles:t,include:i.include,moduleId:i.moduleId})}("vaadin-item",c,{moduleId:"material-item"});var u=i(86295);const _=u.iv`
  :host {
    cursor: pointer;
...
`;(0,u.hC)("vaadin-combo-box-item",[c,_],{moduleId:"material-combo-box-item"});l("shadow",o.iv`
  /* prettier-ignore */
  :host {
...
`;a("",p,{moduleId:"material-overlay"});const m=e=>class extends e{static get properties(){return{_theme:{type:String,readOnly:!0}}}static get observedAttributes(){return[...super.observedAttributes,"theme"]}attributeChangedCallback(e,t,i){super.attributeChangedCallback(e,t,i),"theme"===e&&this._set_theme(i)}},g=[];function v(e){return e&&Object.prototype.hasOwnProperty.call(e,"__themes")}function f(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():g}function b(e=""){let t=0;return e.startsWith("lumo-")||e.startsWith("material-")?t=1:e.startsWith("vaadin-")&&(t=2),t}function y(e){const t=[];return e.include&&[].concat(e.include).forEach((e=>{const i=f().find((t=>t.moduleId===e));i?t.push(...y(i),...i.styles):console.warn(`Included moduleId ${e} not found in style registry`)}),e.styles),t}function x(e){const t=`${e}-default-theme`,i=f().filter((i=>i.moduleId!==t&&function(e,t){return(e||"").split(" ").some((e=>new RegExp(`^${e.split("*").join(".*")}$`,"u").test(t)))}(i.themeFor,e))).map((e=>({...e,styles:[...y(e),...e.styles],includePriority:b(e.moduleId)}))).sort(((e,t)=>t.includePriority-e.includePriority));return i.length>0?i:f().filter((e=>e.moduleId===t))}const I=e=>class extends(m(e)){static finalize(){if(super.finalize(),this.elementStyles)return;const e=this.prototype._template;e&&!v(this)&&function(e,t){const i=document.createElement("style");i.innerHTML=e.map((e=>e.cssText)).join("\n"),t.content.appendChild(i)}(this.getStylesForThis(),e)}static finalizeStyles(e){const t=this.getStylesForThis();return e?[...super.finalizeStyles(e),...t]:t}static getStylesForThis(){const e=Object.getPrototypeOf(this.prototype),t=(e?e.constructor.__themes:[])||[];this.__themes=[...t,...x(this.is)];const i=this.__themes.flatMap((e=>e.styles));return i.filter(((e,t)=>t===i.lastIndexOf(e)))}};!function(e,t,i={}){var s;e&&(s=e,v(customElements.get(s))&&console.warn(`The custom element definition for "${e}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`)),t=function(e=[]){return[e].flat(1/0).filter((e=>e instanceof o.c3||(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1)))}(t),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(e,t,i):g.push({themeFor:e,styles:t,include:i.include,moduleId:i.moduleId})}("vaadin-overlay",p,{moduleId:"material-vaadin-overlay"});var C=i(87529),w=i(28426);const E=e=>e.test(navigator.userAgent),S=e=>e.test(navigator.platform);E(/Android/u),E(/Chrome/u)&&/Google Inc/u.test(navigator.vendor);E(/Firefox/u);const T=S(/^iPad/u)||S(/^Mac/u)&&navigator.maxTouchPoints>1,V=S(/^iPhone/u)||T,k=E(/^((?!chrome|android).)*safari/iu),P=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})(),A=[];function O(e,t,i=e.getAttribute("dir")){t?e.setAttribute("dir",t):null!=i&&e.removeAttribute("dir")}function L(){return document.documentElement.getAttribute("dir")}new MutationObserver((function(){const e=L();A.forEach((t=>{O(t,e)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const z=e=>class extends e{static get properties(){return{dir:{type:String,value:"",reflectToAttribute:!0,converter:{fromAttribute:e=>e||"",toAttribute:e=>""===e?null:e}}}}get __isRTL(){return"rtl"===this.getAttribute("dir")}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")&&!this.__restoreSubscription||(this.__subscribe(),O(this,L(),null))}attributeChangedCallback(e,t,i){if(super.attributeChangedCallback(e,t,i),"dir"!==e)return;const s=L(),o=i===s&&-1===A.indexOf(this),r=!i&&t&&-1===A.indexOf(this),n=i!==s&&t===s;o||r?(this.__subscribe(),O(this,s,i)):n&&this.__unsubscribe()}disconnectedCallback(){super.disconnectedCallback(),this.__restoreSubscription=A.includes(this),this.__unsubscribe()}_valueToNodeAttribute(e,t,i){("dir"!==i||""!==t||e.hasAttribute("dir"))&&super._valueToNodeAttribute(e,t,i)}_attributeToProperty(e,t,i){"dir"!==e||t?super._attributeToProperty(e,t,i):this.dir=""}__subscribe(){A.includes(this)||A.push(this)}__unsubscribe(){A.includes(this)&&A.splice(A.indexOf(this),1)}};function M(e){window.Vaadin&&window.Vaadin.templateRendererCallback?window.Vaadin.templateRendererCallback(e):e.querySelector("template")&&console.warn(`WARNING: <template> inside <${e.localName}> is no longer supported. Import @vaadin/polymer-legacy-adapter/template-renderer.js to enable compatibility.`)}let R=new WeakMap,N=new WeakMap,D={},F=0;const B=e=>e?e.host||B(e.parentNode):null,H=e=>e&&e.nodeType===Node.ELEMENT_NODE,q=(...e)=>{console.error(`Error: ${e.join(" ")}. Skip setting aria-hidden.`)},$=(e,t,i,s)=>{const o=((e,t)=>H(e)?t.map((t=>{if(!H(t))return q(t,"is not a valid element"),null;if(e.contains(t))return t;const i=B(t);return i&&e.contains(i)?i:(q(t,"is not contained inside",e),null)})).filter((e=>Boolean(e))):(q(e,"is not a valid element"),[]))(t,Array.isArray(e)?e:[e]);D[i]||(D[i]=new WeakMap);const r=D[i],n=[],a=new Set,l=new Set(o),h=e=>{e&&!a.has(e)&&(a.add(e),h(e.parentNode))};o.forEach(h);const d=e=>{e&&!l.has(e)&&[...e.children].forEach((e=>{if(!["template","script","style"].includes(e.localName))if(a.has(e))d(e);else{const t=e.getAttribute(s),o=null!==t&&"false"!==t,a=(R.get(e)||0)+1,l=(r.get(e)||0)+1;R.set(e,a),r.set(e,l),n.push(e),1===a&&o&&N.set(e,!0),1===l&&e.setAttribute(i,"true"),o||e.setAttribute(s,"true")}}))};return d(t),a.clear(),F+=1,()=>{n.forEach((e=>{const t=R.get(e)-1,o=r.get(e)-1;R.set(e,t),r.set(e,o),t||(N.has(e)?N.delete(e):e.removeAttribute(s)),o||e.removeAttribute(i)})),F-=1,F||(R=new WeakMap,R=new WeakMap,N=new WeakMap,D={})}},U=(e,t=document.body,i="data-aria-hidden")=>{const s=Array.from(Array.isArray(e)?e:[e]);return t&&s.push(...Array.from(t.querySelectorAll("[aria-live]"))),$(s,t,i,"aria-hidden")};HTMLElement.prototype;class W{constructor(e,t){this.host=e,this.callback="function"==typeof t?t:()=>e}showModal(){const e=this.callback();this.__showOthers=U(e)}close(){this.__showOthers&&(this.__showOthers(),this.__showOthers=null)}}let j=!1;function K(){let e=document.activeElement||document.body;for(;e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}function G(e){const t=e.style;if("hidden"===t.visibility||"none"===t.display)return!0;const i=window.getComputedStyle(e);return"hidden"===i.visibility||"none"===i.display}function Y(e,t){const i=Math.max(e.tabIndex,0),s=Math.max(t.tabIndex,0);return 0===i||0===s?s>i:i>s}function X(e){const t=e.length;if(t<2)return e;const i=Math.ceil(t/2);return function(e,t){const i=[];for(;e.length>0&&t.length>0;)Y(e[0],t[0])?i.push(t.shift()):i.push(e.shift());return i.concat(e,t)}(X(e.slice(0,i)),X(e.slice(i)))}function Q(e){return e.getRootNode().activeElement===e}function Z(e,t){if(e.nodeType!==Node.ELEMENT_NODE||G(e))return!1;const i=e,s=function(e){if(!function(e){return!e.matches('[tabindex="-1"]')&&(e.matches("input, select, textarea, button, object")?e.matches(":not([disabled])"):e.matches("a[href], area[href], iframe, [tabindex], [contentEditable]"))}(e))return-1;const t=e.getAttribute("tabindex")||0;return Number(t)}(i);let o=s>0;s>=0&&t.push(i);let r=[];return r="slot"===i.localName?i.assignedNodes({flatten:!0}):(i.shadowRoot||i).children,[...r].forEach((e=>{o=Z(e,t)||o})),o}window.addEventListener("keydown",(()=>{j=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{j=!1}),{capture:!0});class J{saveFocus(e){this.focusNode=e||K()}restoreFocus(){const e=this.focusNode;e&&(K()===document.body?setTimeout((()=>e.focus())):e.focus(),this.focusNode=null)}}const ee=[];class te{constructor(e){this.host=e,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}get __focusableElements(){return function(e){const t=[];return Z(e,t)?X(t):t}(this.__trapNode)}get __focusedElementIndex(){const e=this.__focusableElements;return e.indexOf(e.filter(Q).pop())}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(e){if(this.__trapNode=e,0===this.__focusableElements.length)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");ee.push(this),-1===this.__focusedElementIndex&&this.__focusableElements[0].focus()}releaseFocus(){this.__trapNode=null,ee.pop()}__onKeyDown(e){if(this.__trapNode&&this===Array.from(ee).pop()&&"Tab"===e.key){e.preventDefault();const t=e.shiftKey;this.__focusNextElement(t)}}__focusNextElement(e=!1){const t=this.__focusableElements,i=e?-1:1,s=this.__focusedElementIndex,o=t[(t.length+s+i)%t.length];o.focus(),"input"===o.localName&&o.select()}}var ie=i(76389);const se=(0,ie.o)((e=>class extends e{constructor(){super(),this.__controllers=new Set}connectedCallback(){super.connectedCallback(),this.__controllers.forEach((e=>{e.hostConnected&&e.hostConnected()}))}disconnectedCallback(){super.disconnectedCallback(),this.__controllers.forEach((e=>{e.hostDisconnected&&e.hostDisconnected()}))}addController(e){this.__controllers.add(e),void 0!==this.$&&this.isConnected&&e.hostConnected&&e.hostConnected()}removeController(e){this.__controllers.delete(e)}})),oe=e=>class extends(se(e)){static get properties(){return{focusTrap:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!1},restoreFocusNode:{type:HTMLElement}}}constructor(){super(),this.__ariaModalController=new W(this),this.__focusTrapController=new te(this),this.__focusRestorationController=new J}ready(){super.ready(),this.addController(this.__ariaModalController),this.addController(this.__focusTrapController),this.addController(this.__focusRestorationController)}_resetFocus(){this.focusTrap&&(this.__ariaModalController.close(),this.__focusTrapController.releaseFocus()),this.restoreFocusOnClose&&this._shouldRestoreFocus()&&this.__focusRestorationController.restoreFocus()}_saveFocus(){this.restoreFocusOnClose&&this.__focusRestorationController.saveFocus(this.restoreFocusNode)}_trapFocus(){this.focusTrap&&(this.__ariaModalController.showModal(),this.__focusTrapController.trapFocus(this.$.overlay))}_shouldRestoreFocus(){const e=K();return e===document.body||this._deepContains(e)}_deepContains(e){if(this.contains(e))return!0;let t=e;const i=e.ownerDocument;for(;t&&t!==i&&t!==this;)t=t.parentNode||t.host;return t===this}};class re extends(oe(I(z(w.H3)))){static get template(){return w.dy`
      <style>
        :host {
          z-index: 200;
          position: fixed;
...
`,ae=p;a("",ae,{moduleId:"material-menu-overlay"});const le=u.iv`
  [part='overlay'] {
    position: relative;
    overflow: visible;
...
`;(0,u.hC)("vaadin-combo-box-overlay",[ae,le,ne,he,u.iv`
      :host {
        --_vaadin-combo-box-items-container-border-width: 8px 0;
        --_vaadin-combo-box-items-container-border-style: solid;
      }
    `],{moduleId:"material-combo-box-overlay"});const de=e=>class extends e{static get properties(){return{index:{type:Number},item:{type:Object},label:{type:String},selected:{type:Boolean,value:!1,reflectToAttribute:!0},focused:{type:Boolean,value:!1,reflectToAttribute:!0},renderer:{type:Function}}}static get observers(){return["__rendererOrItemChanged(renderer, index, item.*, selected, focused)","__updateLabel(label, renderer)"]}connectedCallback(){super.connectedCallback(),this._owner=this.parentNode.owner;const e=this._owner.getAttribute("dir");e&&this.setAttribute("dir",e)}requestContentUpdate(){if(!this.renderer)return;const e={index:this.index,item:this.item,focused:this.focused,selected:this.selected};this.renderer(this,this._owner,e)}__rendererOrItemChanged(e,t,i){void 0!==i&&void 0!==t&&(this._oldRenderer!==e&&(this.innerHTML="",delete this._$litPart$),e&&(this._oldRenderer=e,this.requestContentUpdate()))}__updateLabel(e,t){t||(this.textContent=e)}};class ce extends(de((0,u.Tb)(z(w.H3)))){static get template(){return w.dy`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get is(){return"vaadin-combo-box-item"}}customElements.define(ce.is,ce);const ue={start:"top",end:"bottom"},_e={start:"left",end:"right"},pe=new ResizeObserver((e=>{setTimeout((()=>{e.forEach((e=>{e.target.__overlay&&e.target.__overlay._updatePosition()}))}))})),me=e=>class extends e{static get properties(){return{positionTarget:{type:Object,value:null},horizontalAlign:{type:String,value:"start"},verticalAlign:{type:String,value:"top"},noHorizontalOverlap:{type:Boolean,value:!1},noVerticalOverlap:{type:Boolean,value:!1},requiredVerticalSpace:{type:Number,value:0}}}static get observers(){return["__positionSettingsChanged(horizontalAlign, verticalAlign, noHorizontalOverlap, noVerticalOverlap, requiredVerticalSpace)","__overlayOpenedChanged(opened, positionTarget)"]}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}__addUpdatePositionEventListeners(){window.addEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes=function(e){const t=[];for(;e;){if(e.nodeType===Node.DOCUMENT_NODE){t.push(e);break}e.nodeType!==Node.DOCUMENT_FRAGMENT_NODE?e=e.assignedSlot?e.assignedSlot:e.parentNode:(t.push(e),e=e.host)}return t}(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach((e=>{e.addEventListener("scroll",this.__onScroll,!0)}))}__removeUpdatePositionEventListeners(){window.removeEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach((e=>{e.removeEventListener("scroll",this.__onScroll,!0)})),this.__positionTargetAncestorRootNodes=null)}__overlayOpenedChanged(e,t){if(this.__removeUpdatePositionEventListeners(),t&&(t.__overlay=null,pe.unobserve(t),e&&(this.__addUpdatePositionEventListeners(),t.__overlay=this,pe.observe(t))),e){const e=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach((t=>{this.__margins[t]=parseInt(e[t],10)}))),this.setAttribute("dir",e.direction),this._updatePosition(),requestAnimationFrame((()=>this._updatePosition()))}}__positionSettingsChanged(){this._updatePosition()}__onScroll(e){this.contains(e.target)||this._updatePosition()}_updatePosition(){if(!this.positionTarget||!this.opened)return;const e=this.positionTarget.getBoundingClientRect(),t=this.__shouldAlignStartVertically(e);this.style.justifyContent=t?"flex-start":"flex-end";const i=this.__isRTL,s=this.__shouldAlignStartHorizontally(e,i),o=!i&&s||i&&!s;this.style.alignItems=o?"flex-start":"flex-end";const r=this.getBoundingClientRect(),n=this.__calculatePositionInOneDimension(e,r,this.noVerticalOverlap,ue,this,t),a=this.__calculatePositionInOneDimension(e,r,this.noHorizontalOverlap,_e,this,s);Object.assign(this.style,n,a),this.toggleAttribute("bottom-aligned",!t),this.toggleAttribute("top-aligned",t),this.toggleAttribute("end-aligned",!o),this.toggleAttribute("start-aligned",o)}__shouldAlignStartHorizontally(e,t){const i=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const s=Math.min(window.innerWidth,document.documentElement.clientWidth),o=!t&&"start"===this.horizontalAlign||t&&"end"===this.horizontalAlign;return this.__shouldAlignStart(e,i,s,this.__margins,o,this.noHorizontalOverlap,_e)}__shouldAlignStartVertically(e){const t=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const i=Math.min(window.innerHeight,document.documentElement.clientHeight),s="top"===this.verticalAlign;return this.__shouldAlignStart(e,t,i,this.__margins,s,this.noVerticalOverlap,ue)}__shouldAlignStart(e,t,i,s,o,r,n){const a=i-e[r?n.end:n.start]-s[n.end],l=e[r?n.start:n.end]-s[n.start],h=o?a:l;return o===(h>(o?l:a)||h>t)}__adjustBottomProperty(e,t,i){let s;if(e===t.end){if(t.end===ue.end){const e=Math.min(window.innerHeight,document.documentElement.clientHeight);if(i>e&&this.__oldViewportHeight){s=i-(this.__oldViewportHeight-e)}this.__oldViewportHeight=e}if(t.end===_e.end){const e=Math.min(window.innerWidth,document.documentElement.clientWidth);if(i>e&&this.__oldViewportWidth){s=i-(this.__oldViewportWidth-e)}this.__oldViewportWidth=e}}return s}__calculatePositionInOneDimension(e,t,i,s,o,r){const n=r?s.start:s.end,a=r?s.end:s.start,l=parseFloat(o.style[n]||getComputedStyle(o)[n]),h=this.__adjustBottomProperty(n,s,l),d=t[r?s.start:s.end]-e[i===r?s.end:s.start];return{[n]:h?`${h}px`:`${l+d*(r?-1:1)}px`,[a]:""}}},ge=e=>class extends(me(e)){static get observers(){return["_setOverlayWidth(positionTarget, opened)"]}constructor(){super(),this.requiredVerticalSpace=200}connectedCallback(){super.connectedCallback();const e=this._comboBox,t=e&&e.getAttribute("dir");t&&this.setAttribute("dir",t)}_shouldCloseOnOutsideClick(e){const t=e.composedPath();return!t.includes(this.positionTarget)&&!t.includes(this)}_setOverlayWidth(e,t){if(e&&t){const t=this.localName;this.style.setProperty(`--_${t}-default-width`,`${e.clientWidth}px`);const i=getComputedStyle(this._comboBox).getPropertyValue(`--${t}-width`);""===i?this.style.removeProperty(`--${t}-width`):this.style.setProperty(`--${t}-width`,i),this._updatePosition()}}};let ve;(0,u.hC)("vaadin-combo-box-overlay",u.iv`
    #overlay {
