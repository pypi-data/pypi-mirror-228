...
</custom-style>`;i.setAttribute("style","display: none;"),document.head.appendChild(i.content)},82160:(t,e,o)=>{function i(t){return new Promise(((e,o)=>{t.oncomplete=t.onsuccess=()=>e(t.result),t.onabort=t.onerror=()=>o(t.error)}))}function r(t,e){const o=indexedDB.open(t);o.onupgradeneeded=()=>o.result.createObjectStore(e);const r=i(o);return(t,o)=>r.then((i=>o(i.transaction(e,t).objectStore(e))))}let a;function n(){return a||(a=r("keyval-store","keyval")),a}function d(t,e=n()){return e("readonly",(e=>i(e.get(t))))}function l(t,e,o=n()){return o("readwrite",(o=>(o.put(e,t),i(o.transaction))))}function s(t=n()){return t("readwrite",(t=>(t.clear(),i(t.transaction))))}o.d(e,{MT:()=>r,RV:()=>i,U2:()=>d,ZH:()=>s,t8:()=>l})}};
//# sourceMappingURL=88700-tejuoQs5s6U.js.map