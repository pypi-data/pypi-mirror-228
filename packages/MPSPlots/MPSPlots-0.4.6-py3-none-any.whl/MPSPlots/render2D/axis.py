...
from MPSPlots.render2D.artist import Line, FillLine, STDLine, Mesh, Scatter, Contour
...
class Axis:
    ...
    def __add__(self, other):
        self._artist_list += other.Artist
        return self
    ...
    def add_fill_line(self, **kwargs: dict) -> None:
        """
    ...
    def add_std_line(self, **kwargs: dict) -> None:
        """
    ...
    def add_scatter(self, **kwargs: dict) -> None:
        """
    ...
    def add_mesh(self, **kwargs: dict) -> None:
        """
    ...
    def add_contour(self, **kwargs: dict) -> None:
        """
    ...
    def add_line(self, **kwargs: dict) -> None:
        """
