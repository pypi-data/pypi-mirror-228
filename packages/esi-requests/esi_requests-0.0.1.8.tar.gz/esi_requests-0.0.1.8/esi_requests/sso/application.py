...
class Application:
    ...
    def save(self) -> None:
        ...
        """
        if os.path.exists("application.json") and os.stat("application.json").st_size:
            with open("application.json", "r") as all_apps_fp:
        ...
        with open("application.json", "w") as all_apps_fp:
...
class ESIApplications(object):
    ...
    def __load_apps(self) -> None:
        if not os.path.exists("application.json") or not os.stat("application.json").st_size:
            return
