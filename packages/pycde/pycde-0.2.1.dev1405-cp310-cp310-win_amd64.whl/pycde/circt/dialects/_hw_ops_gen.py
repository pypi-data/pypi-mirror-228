...
class AggregateConstantOp(_ods_ir.OpView):
  ...
  def __init__(self, result, fields, *, loc=None, ip=None):
    ...
    issubclass(type(fields), _ods_ir.Attribute) or
...
class GlobalRefOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, namepath, *, loc=None, ip=None):
    ...
    issubclass(type(namepath), _ods_ir.Attribute) or
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class HWTestModuleOp(_ods_ir.OpView):
  OPERATION_NAME = "hw.testmodule"

  _ODS_REGIONS = (1, True)

  def __init__(self, sym_name, module_type, parameters, *, port_attrs=None, port_locs=None, comment=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    issubclass(type(module_type), _ods_ir.Attribute) or
    ...
    if port_attrs is not None: attributes["port_attrs"] = (port_attrs if (
        issubclass(type(port_attrs), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('DictArrayAttr')) else
          _ods_ir.AttrBuilder.get('DictArrayAttr')(port_attrs, context=_ods_context))
    if port_locs is not None: attributes["port_locs"] = (port_locs if (
        issubclass(type(port_locs), _ods_ir.Attribute) or
    ...
    if comment is not None: attributes["comment"] = (comment if (
        issubclass(type(comment), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
  ...
  @builtins.property
  def port_attrs(self):
    if "port_attrs" not in self.operation.attributes:
      return None
    return self.operation.attributes["port_attrs"]

  @port_attrs.setter
  def port_attrs(self, value):
    if value is not None:
      self.operation.attributes["port_attrs"] = value
    elif "port_attrs" in self.operation.attributes:
      del self.operation.attributes["port_attrs"]
...
class InstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, instanceName, moduleName, inputs, argNames, resultNames, parameters, *, inner_sym=None, loc=None, ip=None):
    ...
    issubclass(type(instanceName), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
class StructInjectOp(_ods_ir.OpView):
  ...
  def __init__(self, input, field, newValue, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
