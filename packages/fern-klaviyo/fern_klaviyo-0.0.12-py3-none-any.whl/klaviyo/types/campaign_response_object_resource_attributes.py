...
class CampaignResponseObjectResourceAttributes(pydantic.BaseModel):
    ...
    send_options: CampaignResponseObjectResourceAttributesSendOptions = pydantic.Field(
        description="Options to use when sending a campaign"
    )
    tracking_options: CampaignResponseObjectResourceAttributesTrackingOptions = pydantic.Field(
