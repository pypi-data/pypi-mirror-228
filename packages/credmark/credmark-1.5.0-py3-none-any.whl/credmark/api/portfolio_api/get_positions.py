...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/portfolio/{chainId}/{accounts}/positions".format(
...
def _parse_response(*, client: "Credmark", response: httpx.Response) -> PositionsResponse:
    if response.status_code == HTTPStatus.OK:
        response_200 = PositionsResponse.from_dict(response.json())
...
def _build_response(*, client: "Credmark", response: httpx.Response) -> Response[PositionsResponse]:
    return Response(
