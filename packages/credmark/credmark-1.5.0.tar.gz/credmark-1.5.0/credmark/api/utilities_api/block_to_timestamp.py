...
def _get_kwargs(chain_id: int, *, block_number: float, client: "Credmark") -> Dict[str, Any]:
    url = "{}/v1/utilities/chains/{chainId}/block/to-timestamp".format(client.base_url, chainId=chain_id)
...
def sync_detailed(chain_id: int, *, block_number: float, client: "Credmark") -> Response[BlockResponse]:
...
def sync(chain_id: int, *, block_number: float, client: "Credmark") -> BlockResponse:
    """Convert block number to timestamp.
...
async def asyncio_detailed(chain_id: int, *, block_number: float, client: "Credmark") -> Response[BlockResponse]:
    """Convert block number to timestamp.
...
async def asyncio(chain_id: int, *, block_number: float, client: "Credmark") -> BlockResponse:
    """Convert block number to timestamp.
