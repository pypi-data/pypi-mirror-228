...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/portfolio/{chainId}/{accounts}/positions/historical".format(
...
def _parse_response(*, client: "Credmark", response: httpx.Response) -> PositionsHistoricalResponse:
    if response.status_code == HTTPStatus.OK:
        response_200 = PositionsHistoricalResponse.from_dict(response.json())
...
def _build_response(*, client: "Credmark", response: httpx.Response) -> Response[PositionsHistoricalResponse]:
    return Response(
