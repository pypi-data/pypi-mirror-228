...
class Settings:
    ...
    - `HTC_DOCKER_MOUNTS`: Additional mount locations for our Docker container. This is for example useful if part of the data lies on a separate disk and you link to this location in your dataset. With this environment variable, you can make the symbolic link also work in the Docker container. However, please note that if the symbolic link is located in the first level of the dataset folder (e.g. intermediates directory), then the docker mounts are created automatically. The syntax is `path_local1:path_docker1;path_local2:path_docker2`. Example: `HTC_DOCKER_MOUNTS="/mnt/nvme_4tb/2021_02_05_Tivita_multiorgan_masks/intermediates/preprocessing:/mnt/nvme_4tb/2021_02_05_Tivita_multiorgan_masks/intermediates/preprocessing"`
