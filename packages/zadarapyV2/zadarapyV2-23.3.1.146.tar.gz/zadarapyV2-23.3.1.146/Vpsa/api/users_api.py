...
class UsersApi(object):
    ...
    def change_user_pass_by_temp_code(self, username, change_user_pass_by_temp_code, **kwargs):  # noqa: E501
        """change_user_pass_by_temp_code  # noqa: E501

        Change a user's password using a temporary password code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_user_pass_by_temp_code(username, change_user_pass_by_temp_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.change_user_pass_by_temp_code_with_http_info(username, change_user_pass_by_temp_code, **kwargs)  # noqa: E501
        else:
            (data) = self.change_user_pass_by_temp_code_with_http_info(username, change_user_pass_by_temp_code, **kwargs)  # noqa: E501
            return data

    def change_user_pass_by_temp_code_with_http_info(self, username, change_user_pass_by_temp_code, **kwargs):  # noqa: E501
        """change_user_pass_by_temp_code  # noqa: E501

        Change a user's password using a temporary password code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_user_pass_by_temp_code_with_http_info(username, change_user_pass_by_temp_code, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['username', 'change_user_pass_by_temp_code']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
