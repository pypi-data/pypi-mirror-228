...
class MirroringAndCloningApi(object):
    ...
    def show_remote_snapshots_on_cg(self, id, show_remote_snapshots_on_cg, **kwargs):  # noqa: E501
        """show_remote_snapshots_on_cg  # noqa: E501

        List the snapshots in a Remote VPSA volume.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show_remote_snapshots_on_cg(id, show_remote_snapshots_on_cg, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: (required)
        :param ShowRemoteSnapshotsOnCg show_remote_snapshots_on_cg: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.show_remote_snapshots_on_cg_with_http_info(id, show_remote_snapshots_on_cg, **kwargs)  # noqa: E501
        else:
            (data) = self.show_remote_snapshots_on_cg_with_http_info(id, show_remote_snapshots_on_cg, **kwargs)  # noqa: E501
            return data

    def show_remote_snapshots_on_cg_with_http_info(self, id, show_remote_snapshots_on_cg, **kwargs):  # noqa: E501
        """show_remote_snapshots_on_cg  # noqa: E501

        List the snapshots in a Remote VPSA volume.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show_remote_snapshots_on_cg_with_http_info(id, show_remote_snapshots_on_cg, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'show_remote_snapshots_on_cg']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'show_remote_snapshots_on_cg' is set
        if self.api_client.client_side_validation and ('show_remote_snapshots_on_cg' not in params or
                                                       params['show_remote_snapshots_on_cg'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `show_remote_snapshots_on_cg` when calling `show_remote_snapshots_on_cg`")  # noqa: E501
        ...
        body_params = None
        if 'show_remote_snapshots_on_cg' in params:
            body_params = params['show_remote_snapshots_on_cg']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
