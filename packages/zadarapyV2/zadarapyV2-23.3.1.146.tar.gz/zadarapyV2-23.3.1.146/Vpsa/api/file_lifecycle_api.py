...
class FileLifecycleApi(object):
    ...
    def get_flc_data(self, get_flc_data, **kwargs):  # noqa: E501
        """get_flc_data  # noqa: E501

        get flc data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flc_data(get_flc_data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GetFlcData get_flc_data: The resources_str is json string in the format:{chart_name:{name:<name>,type:<type>}} (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_flc_data_with_http_info(get_flc_data, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flc_data_with_http_info(get_flc_data, **kwargs)  # noqa: E501
            return data

    def get_flc_data_with_http_info(self, get_flc_data, **kwargs):  # noqa: E501
        """get_flc_data  # noqa: E501

        get flc data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flc_data_with_http_info(get_flc_data, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['get_flc_data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'get_flc_data' is set
        if self.api_client.client_side_validation and ('get_flc_data' not in params or
                                                       params['get_flc_data'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `get_flc_data` when calling `get_flc_data`")  # noqa: E501
        ...
        body_params = None
        if 'get_flc_data' in params:
            body_params = params['get_flc_data']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/xml'])  # noqa: E501
