...
class InlineResponse20043Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20043ResponseUser'
    }
    ...
    def __init__(self, message=None, status=None, user=None, _configuration=None):  # noqa: E501
        """InlineResponse20043Response - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this InlineResponse20043Response.  # noqa: E501


        :return: The message of this InlineResponse20043Response.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this InlineResponse20043Response.


        :param message: The message of this InlineResponse20043Response.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this InlineResponse20043Response.  # noqa: E501


        :return: The status of this InlineResponse20043Response.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this InlineResponse20043Response.


        :param status: The status of this InlineResponse20043Response.  # noqa: E501
        :type: int
        """
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20043Response.  # noqa: E501


        :return: The user of this InlineResponse20043Response.  # noqa: E501
        :rtype: InlineResponse20043ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20043Response.


        :param user: The user of this InlineResponse20043Response.  # noqa: E501
        :type: InlineResponse20043ResponseUser
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse20043Response, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20043Response):
            return False
