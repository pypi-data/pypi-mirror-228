...
class UsageReportsApi(object):
    ...
    def generate_usage_reports(self, generate_usage_reports, **kwargs):  # noqa: E501
        ...
        >>> thread = api.generate_usage_reports(generate_usage_reports, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GenerateUsageReports generate_usage_reports: (required)
        ...
        if kwargs.get('async_req'):
            return self.generate_usage_reports_with_http_info(generate_usage_reports, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_usage_reports_with_http_info(generate_usage_reports, **kwargs)  # noqa: E501
            return data

    def generate_usage_reports_with_http_info(self, generate_usage_reports, **kwargs):  # noqa: E501
        """generate_usage_reports  # noqa: E501

        Generate a usage report. Each account lists the following for each policy: capacity, number of objects, number of containers, data transfer in, data transfer out  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_usage_reports_with_http_info(generate_usage_reports, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['generate_usage_reports']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'generate_usage_reports' is set
        if self.api_client.client_side_validation and ('generate_usage_reports' not in params or
                                                       params['generate_usage_reports'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `generate_usage_reports` when calling `generate_usage_reports`")  # noqa: E501
        ...
        body_params = None
        if 'generate_usage_reports' in params:
            body_params = params['generate_usage_reports']
        # HTTP header `Accept`
