...
from .dlearn.strategy import cvtColor
import pyzjr.zmath as zmath
import pyzjr.Z as Z
from pyzjr.utils import Boundingbox
        ...
        if self.results.multi_hand_landmarks:
            for handType,handLms in zip(self.results.multi_handedness,self.results.multi_hand_landmarks):
                ...
                if draw:
                    ...
                    #               Z.purple, 2)
                    img=Bbox.cornerRect(img,bbox=[bbox[0] - 20, bbox[1] - 20, bbox[0] + bbox[2] + 20, bbox[1] + bbox[3] + 20])
