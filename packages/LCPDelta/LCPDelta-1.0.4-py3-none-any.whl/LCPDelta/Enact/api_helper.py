...
class APIHelper:
    ...
    # Series:
    def get_series_data(self, series_id, date_from = date.today(), date_to = date.today(), option_id = None, country_id = "Gb", half_hourly_average = False):
    ...
    def get_plants_by_fuel_and_country(self, fuel_id, country_id = "Gb"):
    ...
    def get_history_of_forecast_for_given_date(self, series_id, date, country_id = "Gb", option_id = None):
    ...
    def get_history_of_forecast_for_date_range(self, series_id, date_from, date_to, country_id = "Gb", option_id = None):
        """Gets the history of a forecast for a given date
    ...
    #BOA:
    def get_bm_data_by_period(self, date, period, includeAcceptedTimes = False):
        ...
        Args:
            ...
            includeAcceptedTimes (bool): Choose whether object include BOA accepted times or not
        ...
        if includeAcceptedTimes is not False:
