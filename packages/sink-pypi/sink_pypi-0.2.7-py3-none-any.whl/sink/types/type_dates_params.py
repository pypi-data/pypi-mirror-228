...
class TypeDatesParams(TypedDict, total=False):
    ...
    required_nullable_date: Required[Annotated[Optional[Union[str, date]], PropertyInfo(format="iso8601")]]

    list_date: Annotated[List[Union[str, date]], PropertyInfo(format="iso8601")]
