...
class Types(SyncAPIResource):
    ...
    def dates(
        ...
        *,
        ...
        oneof_date: Union[str, date] | int | NotGiven = NOT_GIVEN,
    ...
    def datetimes(
        ...
        *,
        ...
        required_nullable_datetime: Optional[Union[str, datetime]],
        list_datetime: List[Union[str, datetime]] | NotGiven = NOT_GIVEN,
        oneof_datetime: Union[str, datetime] | int | NotGiven = NOT_GIVEN,
    ...
    def enums(
        self,
        *,
        input_currency: shared_params.Currency | NotGiven = NOT_GIVEN,
