...
__all__ = ["Streaming", "AsyncStreaming"]


class Streaming(SyncAPIResource):
    @overload
    def basic(
        self,
        *,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                streaming_basic_params.StreamingBasicParams,
            ),
    ...
    def nested_params(
        ...
        *,
        model: str,
        prompt: str,
        parent_object: streaming_nested_params_params.NestedStreamingRequestNonStreamingParentObject
        | NotGiven = NOT_GIVEN,
        stream: Literal[False] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
    ...
    def nested_params(
        ...
        *,
        ...
        prompt: str,
        stream: Literal[True],
        parent_object: streaming_nested_params_params.NestedStreamingRequestStreamingParentObject
        | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                streaming_nested_params_params.StreamingNestedParamsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def query_param_discriminator(
        ...
        *,
        prompt: str,
        should_stream: Literal[False] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def query_param_discriminator(
        ...
        *,
        prompt: str,
        should_stream: Literal[False] | Literal[True] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
...
class AsyncStreaming(AsyncAPIResource):
    @overload
    async def basic(
        self,
        *,
