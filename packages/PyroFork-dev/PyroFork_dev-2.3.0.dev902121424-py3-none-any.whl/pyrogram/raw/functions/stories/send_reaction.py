...
class SendReaction(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["user_id", "story_id", "reaction", "add_to_recent"]

    ID = 0x49aaa9b3
    QUALNAME = "functions.stories.SendReaction"

    def __init__(self, *, user_id: "raw.base.InputUser", story_id: int, reaction: "raw.base.Reaction", add_to_recent: Optional[bool] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SendReaction":
        ...
        return SendReaction(user_id=user_id, story_id=story_id, reaction=reaction, add_to_recent=add_to_recent)
