...
class WebPageAttributeStory(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["user_id", "id", "story"]

    ID = 0x939a4671
    QUALNAME = "types.WebPageAttributeStory"

    def __init__(self, *, user_id: int, id: int, story: "raw.base.StoryItem" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "WebPageAttributeStory":
        ...
        return WebPageAttributeStory(user_id=user_id, id=id, story=story)
