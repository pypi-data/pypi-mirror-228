...
class GetStoryViewsList(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "offset", "limit", "just_contacts", "reactions_first", "q"]

    ID = 0xf95f61a4
    QUALNAME = "functions.stories.GetStoryViewsList"

    def __init__(self, *, id: int, offset: str, limit: int, just_contacts: Optional[bool] = None, reactions_first: Optional[bool] = None, q: Optional[str] = None) -> None:
        self.id = id  # int
    ...
    def read(b: BytesIO, *args: Any) -> "GetStoryViewsList":
        ...
        return GetStoryViewsList(id=id, offset=offset, limit=limit, just_contacts=just_contacts, reactions_first=reactions_first, q=q)
