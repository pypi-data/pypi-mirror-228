...
class SendStory(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["media", "privacy_rules", "random_id", "pinned", "noforwards", "media_areas", "caption", "entities", "period"]

    ID = 0xd455fcec
    QUALNAME = "functions.stories.SendStory"

    def __init__(self, *, media: "raw.base.InputMedia", privacy_rules: List["raw.base.InputPrivacyRule"], random_id: int, pinned: Optional[bool] = None, noforwards: Optional[bool] = None, media_areas: Optional[List["raw.base.MediaArea"]] = None, caption: Optional[str] = None, entities: Optional[List["raw.base.MessageEntity"]] = None, period: Optional[int] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SendStory":
        ...
        return SendStory(media=media, privacy_rules=privacy_rules, random_id=random_id, pinned=pinned, noforwards=noforwards, media_areas=media_areas, caption=caption, entities=entities, period=period)
