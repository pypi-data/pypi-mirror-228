...
from logi import getLogger as getSysLogger
from logi import *
from logi import getLoggerClass, addLevelName, setLoggerClass
...
class KaiOSLogger(_LoggerClass):
...
class KaiOSFormatter(Formatter):
    """
    KaiOSFormatter class used to standardize formatting
    ...
    def __init__(self, include_timestamp=False):
        ...
        any affect on a KaiOSFormatter instance.
...
def getLogger(name, handler=None):
    ...
    if handler is None:
        ...
        handler.setFormatter(KaiOSFormatter())
