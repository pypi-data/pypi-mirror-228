...
class DescribeTaiJiHYTasksResponse(AbstractModel):
    """DescribeTaiJiHYTasksResponse返回参数结构体

    """

    def __init__(self, training_task_set=None, total_count=None, request_id=None):
        r"""
        :param training_task_set: 训练任务集
        :type training_task_set: list of TrainingTaskSetItem
        :param total_count: 数量
        :type total_count: int
        :param request_id: 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
        :type request_id: str
        """
        self.TrainingTaskSet = training_task_set
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :param Status: 任务状态
        :type Status: str
        :param TAIJIInstanceId: 任务信息
注意：此字段可能返回 null，表示取不到有效值。
        :type TAIJIInstanceId: str
        :param TAIJIInstanceName: 任务信息
注意：此字段可能返回 null，表示取不到有效值。
        :type TAIJIInstanceName: str
        :param TAIJITemplateId: 任务信息
注意：此字段可能返回 null，表示取不到有效值。
        :type TAIJITemplateId: str
        """
        self.Id = None
        ...
        self.Message = None
        self.Status = None
        self.TAIJIInstanceId = None
        self.TAIJIInstanceName = None
        self.TAIJITemplateId = None
    ...
    def _deserialize(self, params):
        ...
        self.Message = params.get("Message")
        self.Status = params.get("Status")
        self.TAIJIInstanceId = params.get("TAIJIInstanceId")
        self.TAIJIInstanceName = params.get("TAIJIInstanceName")
        self.TAIJITemplateId = params.get("TAIJITemplateId")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            if name in memeber_set:
