...
def check_is_dir(dir_local_path: str):
    if not is_dir(dir_local_path):
        raise FileNotFoundError(f"No such file: '{dir_local_path}'")
...
def check_is_file(file_local_path: str):
...
if __name__ == "__main__":  # pragma: no cover
    ...
    write_file(test_file_dir + "unicode_chars.txt", "tut0156êµîƒﬁÌπÏ“{ëôøÇ¡¶{µœ≤é≤")
