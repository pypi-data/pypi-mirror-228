...
# %% auto 0
__all__ = ['SearchGroups_Error', 'search_groups_by_name', 'get_all_groups', 'get_group_by_id', 'GroupType_Enum',
           'generate_body_create_group', 'CreateGroup_Error', 'create_group', 'update_group', 'get_group_owners',
