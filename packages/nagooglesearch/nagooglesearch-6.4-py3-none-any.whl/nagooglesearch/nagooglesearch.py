		...
		with open(file, "r", encoding = "UTF-8") as stream:
			for line in stream:
				...
				if line:
					array.append(line)
		stream.close()
	return array[random.randint(0, len(array) - 1)] if array else "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.82 Safari/537.36"
