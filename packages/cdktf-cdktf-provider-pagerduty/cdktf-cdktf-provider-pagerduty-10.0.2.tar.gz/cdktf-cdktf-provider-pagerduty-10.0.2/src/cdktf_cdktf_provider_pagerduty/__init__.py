...
__all__ = [
    ...
    "custom_field_option",
    "custom_field_schema",
    "custom_field_schema_assignment",
    "custom_field_schema_field_configuration",
...
from . import custom_field_option
from . import custom_field_schema
from . import custom_field_schema_assignment
from . import custom_field_schema_field_configuration
