    ...
    """
{
    ...
    "packages": [
        ...
        "cdktf_cdktf_provider_pagerduty.custom_field",
        "cdktf_cdktf_provider_pagerduty.custom_field_option",
        "cdktf_cdktf_provider_pagerduty.custom_field_schema",
        "cdktf_cdktf_provider_pagerduty.custom_field_schema_assignment",
        "cdktf_cdktf_provider_pagerduty.custom_field_schema_field_configuration",
    ...
    "package_data": {
        "cdktf_cdktf_provider_pagerduty._jsii": [
            "provider-pagerduty@10.0.2.jsii.tgz"
        ],
        "cdktf_cdktf_provider_pagerduty": [
            "py.typed"
        ]
