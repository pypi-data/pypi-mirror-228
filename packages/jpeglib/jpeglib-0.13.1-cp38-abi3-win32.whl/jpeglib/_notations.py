...
def Jab_to_factors(Jab) -> List:
    ...
    Read more about the notations in
    `Tuomas Siipola's article <https://zpl.fi/chroma-subsampling-and-jpeg-sampling-factors/>`_
    or `glossary <https://jpeglib.readthedocs.io/en/latest/glossary.html#jpeg-sampling-factor>`_.

    :param Jab:
    List of three numbers, J:a:b notation of subsampling.
    :type dstfile: list
    :return:
    Subsampling factors, as list of three lists, each containing 2 numbers.
    :rtype: list
