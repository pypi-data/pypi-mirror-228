...
class Metasploit:
    def __init__(self, username: str = config.MSF_RPC_USERNAME, password: str = config.MSF_RPC_PASSWORD,
                 server: str = config.MSF_RPC_HOST, port: int = config.MSF_RPC_PORT, ssl: bool = config.MSF_RPC_SSL,
                 **kwargs):
        """
