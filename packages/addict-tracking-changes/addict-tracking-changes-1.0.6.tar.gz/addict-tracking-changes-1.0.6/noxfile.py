...
# @nox.session(python="3.11")
# def badges(session):
# o\    # Install pytest, pytest-cov, flake8 and genbadge
...
#     session.run(
#         "flake8", "src/addict_tracking_changes", 
#         "--exit-zero",
#         "--format=pylint",
#         #"--htmldir=./reports/flake8",
#         "--statistics", "--output-file=reports/flake8/flake8stats.txt"
#     )

#     # Generate a badge for tests
#     session.run("genbadge", "tests", "-i", "reports/junit/junit.xml", "-o", "badge_tests.svg")

#     # Generate a badge for coverage
#     session.run("genbadge", "coverage", "-i", "reports/coverage/coverage.xml", "-o", "badge_coverage.svg")

#     # Generate a badge for flake8 based on the statistics text report
#     session.run("genbadge", "flake8", "-i", "reports/flake8/flake8stats.txt", "-o", "badge_flake8.svg")
