...
class Z3solver:
    ...
    def label_circuit(self, constant_value: bool = False):
    ...
    def import_labels(self) -> Dict:
        ...
        relevant_dir = None
        for dir in all_dirs:
            if re.search(self.approximate_benchmark, dir) and os.path.isdir(f'{folder}/{dir}'):
    ...
    def express_approximate_circuit(self):
        ...
        print(f'{approximate_circuit_function = }')
