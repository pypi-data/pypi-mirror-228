...
class UserAction(BaseModel):
    ...
    id: str
    slash_command: str
    resource: MessageResource | SettingsResource | None
    value: str | None = None
...
class SwitResponse(BaseModel):
    callback_type: ViewCallbackType | AttachmentCallbackTypes | SettingsCallbackTypes | BotCallbackTypes
    new_view: View | None
    attachments: list[AttachmentView] | None
