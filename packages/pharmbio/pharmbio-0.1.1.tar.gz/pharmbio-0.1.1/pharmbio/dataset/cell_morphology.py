...
from pharmbio.data_processing import feature_aggregation as fa
...
def get_cell_morphology_data(
    ...
    for index, plate_metadata in enumerate(
        ...
        output_filename = (
            f"{saving_dir}/{plate_metadata[plate_acq_id]}_{plate_metadata[plate_acq_name]}.parquet"
        )
        ...
        aggregated_data = fa.aggregate_morphology_data(
            df=df_combined,
