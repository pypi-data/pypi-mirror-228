...
async def follow_app_logs_until_ready(sdk: SlingshotSDK, spec_id: str) -> schemas.AppInstanceStatus:
...
async def _wait_for_app_ready(sdk: SlingshotSDK, spec_id: str) -> schemas.AppInstanceStatus:
