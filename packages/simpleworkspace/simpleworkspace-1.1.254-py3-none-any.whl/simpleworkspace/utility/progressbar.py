...
class ProgressBar:
    ...
    def AddCallback_OnIncrementSteps(self, increments: int, callback: Callable[[], any]):
        """
    ...
    def AddCallback_OnReachedTarget(self, targetIncrements: int, callback: Callable[[], any]):
        """
