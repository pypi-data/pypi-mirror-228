...
def get_access_token(api_host, username, password, logger=None) -> str:
    """
    .. py:method:: request an access token
    :param api_host: str: api host, example: https://www.example.com/api
