...
class StatusesController(BaseController):
    ...
    def get_statuses(self,
        ...
        Args:
            device_ids (list of int): Which devices to get statuses for.
            ...
            category (list of StatusCategoryEnum, optional): Which status
                categories to get statuses for.
            lost_production_signal_id (int, optional): Which data signal to
                use for calculating lost production. Defaults to the
                configured default lost production signal.
            fields (list of string, optional): Which fields to include in the
                response. Valid fields are those defined in the `StatusItem`
        ...
        Returns:
            list of StatusItem: Response from the API. A list of statuses with
                related data.
        ...
        return APIHelper.json_deserialize(_context.response.raw_body, StatusItem.from_dictionary)
    ...
    def get_active_statuses(self,
                            ...
                            use_utc=False,
                            contract_type='service'):
        """Does a GET request to /activestatus.
        ...
        Returns:
            list of StatusItem: Response from the API. A list of active
                statuses with related data.
