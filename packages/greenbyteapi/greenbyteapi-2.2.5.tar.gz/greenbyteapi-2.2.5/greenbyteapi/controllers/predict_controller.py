...
class PredictController(BaseController):
    ...
    def get_predict_alerts(self,
        ...
        Args:
            ...
            timestamp_end (datetime): The end of the time interval to get data
                ...
                **date-time** format:  * Timestamps ending with 'Z' are
                ...
                to "2020-04-01T00:00:00".  Timestamps selected in the portal
                will by default be in UTC.
            site_ids (list of int, optional): What sites to get alerts for.
            component_ids (list of int, optional): What components to get
                alerts for.
        ...
        Returns:
            list of PredictAlertsResponse: Response from the API. A list of
                Predict alerts.
        ...
        return APIHelper.json_deserialize(_context.response.raw_body, PredictAlertsResponse.from_dictionary)
