...
class AntiAffinityGroupArgs:
    ...
    @property
    @pulumi.getter
    def spread(self) -> pulumi.Input[int]:
        return pulumi.get(self, "spread")

    @spread.setter
    def spread(self, value: pulumi.Input[int]):
...
class AntiAffinityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spread: Optional[pulumi.Input[int]] = None,
                 token: Optional[pulumi.Input[str]] = None,
                 url: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a AntiAffinityGroup resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spread is None and not opts.urn:
                raise TypeError("Missing required property 'spread'")
            __props__.__dict__["spread"] = spread
        ...
        super(AntiAffinityGroup, __self__).__init__(
            'vco:cloudspace:AntiAffinityGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AntiAffinityGroup':
        """
        ...
        __props__.__dict__["spread"] = None
        __props__.__dict__["status"] = None
    ...
    @property
    @pulumi.getter
    def spread(self) -> pulumi.Output[int]:
        return pulumi.get(self, "spread")
