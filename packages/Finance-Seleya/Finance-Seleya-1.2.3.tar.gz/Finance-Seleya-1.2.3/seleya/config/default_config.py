...
SERVER_URL = 'app.portageb.com' if 'PB_SERVER_URL' not in os.environ else os.environ[
    'PB_SERVER_URL']
SERVER_PORT = 'app.portageb.com' if 'PB_SERVER_URL' not in os.environ else os.environ[
    'PB_SERVER_URL']
