...
class ContentManager:
    ...
    def get_section_content(self, _section: str | None = ...) -> dict[str, dict[str, Any]]: ...
    def set_section_content(self, _data: dict[str, dict[str, Any]], _section: str | None = ...) -> None: ...
    def get_dialog(self, _section: str | None = ..., _id: str | None = ...) -> dict[str, Any]: ...
