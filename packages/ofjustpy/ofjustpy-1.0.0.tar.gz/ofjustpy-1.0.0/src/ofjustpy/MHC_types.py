...
Label = gen_HC_type(HCType.mutable, "Label", TR.LabelMixin, stytags=sty.label)

Span = gen_HC_type(HCType.mutable, "Span", TR.SpanMixin, stytags=sty.span)

TextInput = gen_HC_type(
    HCType.mutable, "TextInput", TR.TextInputMixin, stytags=sty.input
)
...
class HCCMutable:
    ...
    StackV = gen_Div_type(
        HCType.hcc_mutable_div, "Div", TR.DivMixin, stytags=sty.stackv
    )
    StackH = gen_Div_type(
        HCType.hcc_mutable_div, "Div", TR.DivMixin, stytags=sty.stackh
    )
    StackW = gen_Div_type(
        HCType.hcc_mutable_div, "Div", TR.DivMixin, stytags=sty.stackw
    )
    Container = gen_Div_type(
        HCType.hcc_mutable_div, "Div", TR.DivMixin, stytags=sty.container
    )
...
class HCCStatic:
    ...
    StackV = gen_Div_type(
        HCType.hcc_static_div, "HCCStaticDiv", TR.DivMixin, stytags=sty.stackv
    )


# div's css and child both are mutable
Div = gen_Div_type(HCType.mutable, "Div", TR.DivMixin)
StackH = gen_Div_type(HCType.mutable, "Div", TR.DivMixin, stytags=sty.stackh)
StackV = gen_Div_type(HCType.mutable, "StackV", TR.DivMixin, stytags=sty.stackv)
...
StackD = gen_Div_type(
    ...
    stytags=[db.f, flx.one, ppos.relative],
)
