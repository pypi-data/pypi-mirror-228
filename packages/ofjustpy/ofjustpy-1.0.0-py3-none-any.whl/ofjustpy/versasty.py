...
h2 = [xl, lh.normal, lh.normal, mr / st / 0, mr / sb / 1]  # "prose", "prose-2xl"

h3 = [fz.lg, lh.normal, lh.normal, mr / st / 0, mr / sb / 2]  # "prose", "prose-2xl"
...
ul = [mr / 2, pd / 2, li.disc, li.inside]
ol = [mr / 2, pd / 2, W / "1/2", li.disc, li.inside]
li = []
img = [mr / 2, pd / 2]
# ?? para.mr.sb = 5
# type = "button"
button = [
    ...
    bdr.md,
    bold,
    "uppercase ease-linear transition-all duration-150",
    *hover(noop / shadow.md, bg / gray / 2),
]
...
icon_button = [bg / gray / 1, ta.center, pd / 1, shadow.md, *hover(bg / gray / 2)]
...
prose = [fc / gray / 6, prose.lg]  # TODO:use some other name than prose
...
right_cell = [*cell, W / "1/8", ta.start]
...
nav = [container, top / 0]
footer = [mr / st / 4, shadow, container]
div = []
