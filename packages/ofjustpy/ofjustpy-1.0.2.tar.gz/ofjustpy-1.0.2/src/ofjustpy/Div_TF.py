...
from .TF_impl import Stub_HCCMutable


def gen_Div_type(div_type=HCType.passive,
                 hc_tag="PassiveDiv",
    ...
    match div_type:
        case HCType.passive:
            ...
            class WithStub(hc_type):
                ...
                def stub(self):
                    return Stub_DivPassive(target=self)
        ...
        case HCType.hcc_mutable_div:
            ...
            class WithStub(core_hc_type):
                ...
                def stub(self):
                    ...
                    return Stub_HCCMutable(
                        mutable_shell_type, staticCore=self, **self.kwargs
                    )
                    pass
