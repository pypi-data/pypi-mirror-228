...
def main() -> None:  # noqa: D401 D202 D205
    ...
    with dpg.theme() as grn_btn_theme:
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (0, 255, 0, 255)
            )  # GREEN
    ...
    with dpg.theme() as blue_btn_theme:
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (0, 0, 255, 255)
            )  # BLUE
    ...
    with dpg.theme() as grey_btn_theme:
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (105, 105, 105, 255)
            )  # GREY
    ...
    with dpg.theme() as grey_column_theme:
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_color(
                dpg.mvThemeCol_Button, (185, 185, 185, 255)
            )  # WHITE
    ...
    with dpg.window(
        ...
        with dpg.child_window(
            ...
            dpg.add_text(default_value="FREQ: 50 MHz to 6400 MHz",
        ...
        with dpg.child_window(
            ...
            dpg.add_text(
                ...
                pos=(dpg.get_item_width(item="col_pwr") / 7,
                     39 - ADJUSTMENT + 5),
            )
        ...
        for i in range(8):
            ...
            with dpg.child_window(
                tag=f"row_{i+1}",
                pos=(0, ROW_HEIGHT * (i + MAIN_TABLE_HEIGHT) -
                     ADJUSTMENT),  # (x, y)
                width=50,
                height=ROW_HEIGHT,
            ):
            ...
            with dpg.child_window(
                label=f"CHANNEL {i+1}",
                tag=f"freq_win_{i+1}",
                pos=(50, ROW_HEIGHT * (i + MAIN_TABLE_HEIGHT) -
                     ADJUSTMENT),  # (x, y)
                width=250,
                height=ROW_HEIGHT,
            ):
            ...
            with dpg.child_window(
                ...
                pos=(300, ROW_HEIGHT * (i + MAIN_TABLE_HEIGHT) -
                     ADJUSTMENT),  # (x, y)
                width=180,
                height=ROW_HEIGHT,
            ):
            ...
            with dpg.child_window(
                ...
                pos=(480, ROW_HEIGHT * (i + MAIN_TABLE_HEIGHT) -
                     ADJUSTMENT),  # (x, y)
                width=180,
                height=ROW_HEIGHT,
            ):
            ...
            with dpg.child_window(
                pos=(
                    660, ROW_HEIGHT * (i + MAIN_TABLE_HEIGHT) - ADJUSTMENT
                ),
                width=(200),
                height=ROW_HEIGHT,
            ):
        ...
        with dpg.child_window(
            ...
            reset_all = dpg.add_button(
                ...
                pos=(
                    (
                        dpg.get_item_width(item="big_buttons") - 50) /
                    DIVISOR,
                    (
                        dpg.get_item_height(
                            item="big_buttons"
            ...
            custom_load_button = dpg.add_button(
                ...
                pos=(
                    (
                        dpg.get_item_width(item="big_buttons") - 250) /
            ...
            dpg.add_button(
                ...
                pos=(
                    (
                        dpg.get_item_width(item="big_buttons") - 230) /
                    DIVISOR,
                    (
                        dpg.get_item_height(
                            item="big_buttons"
            ...
            dpg.add_text(
                ...
                pos=(
                    (
                        dpg.get_item_width(item="big_buttons") - 120) /
                    DIVISOR,
                    (
                        dpg.get_item_height(
                            item="big_buttons"
            ...
            with dpg.child_window(
                ...
                pos=(
                    (
                        dpg.get_item_width(item="big_buttons") - 255) /
                    DIVISOR,
                    (
                        dpg.get_item_height(
                            item="big_buttons"
                ...
                mission_bravo_button = dpg.add_button(
                    ...
                    pos=(
                        (
                            dpg.get_item_width(item="big_buttons") - 85) /
                        DIVISOR,
                        (
                            dpg.get_item_height(
                                item="big_buttons"
        ...
        with dpg.child_window(
            ...
            _ = [
                ...
                for card, exists in
                enumerate(populate_right_side_buttons(), start=1)
            ]
                ...
                case True:
                    try:
                        ...
                        dpg.bind_item_theme(
                            ...
                            serial_num=str(
                                return_teensy(device_names()).popitem()[0]
    ...
    try:  # Stop gap in case the font files cannot be found
        ...
        _ = [
            (
                ...
                dpg.bind_item_font(
                    item=f"channel_{i}", font=default_font_added
                ),
            )
            for i in range(1, 9)
        ]
