...
setup(
    ...
    install_requires=["django", "python-dotenv", "django-elasticsearch-dsl", 'django-environ',
                      "onesignal-sdk", 'daphne', 'psycopg2-binary',
                      "uvicorn", "django-storages", "boto3", 'pymysql'],
    # add any
