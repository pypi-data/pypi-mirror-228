...
def get_global_uniq_leads_analytics(from_date: datetime = None, to_date: datetime = None):
    ...
    for item in uniq_leads:
        uniq_leads_dic[item["_id"]] = item["uniq_leads"]
...
def get_date_aggregated_analytics(source_id=None, started_at: datetime.datetime = None, ended_at: datetime.datetime = None,
                                  bots_ids: [str] = None, configs: [str] = None):
    pipeline: list = _build_date_aggregated_analytics_pipeline(source_id, started_at, ended_at, bots_ids)
