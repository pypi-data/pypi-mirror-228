...
class DocumentRetriever(AbstractApiClass):
    ...
    def get_matching_documents(self, query: str, deployment_token: str, filters: dict = None, limit: int = None, result_columns: list = None, max_words: int = None, num_retrieval_margin_words: int = None, max_words_per_chunk: int = None):
        """
        ...
        Returns:
            list[DocumentRetrieverLookupResult]: The relevant documentation results found from the document retriever.
        """
        return self.client.get_matching_documents(self.document_retriever_id, query, deployment_token, filters, limit, result_columns, max_words, num_retrieval_margin_words, max_words_per_chunk)
