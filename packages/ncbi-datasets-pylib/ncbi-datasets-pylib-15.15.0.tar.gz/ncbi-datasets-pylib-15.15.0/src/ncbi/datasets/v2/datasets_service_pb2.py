...
_TAXONOMYDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetTaxonomyLinks',
    full_name='ncbi.datasets.v2.TaxonomyDataset.GetTaxonomyLinks',
    index=3,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._TAXONOMYLINKSREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._TAXONOMYLINKSRESPONSE,
    serialized_options=b'\302\360\031\363\001\n\360\001\010\001\022%/v2alpha/taxonomy/taxon/{taxon}/links*?Retrieve external links associated with a taxonomic identifier.2XUsing an NCBI Taxonomy ID at any rank, get the external links associated with the taxon.:\016taxonomy_linksB\010Taxonomyr\020application/json',
    create_key=_descriptor._internal_create_key,
  ),
])
