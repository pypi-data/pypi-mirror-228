...
from swbuilder import step, builds, staging, errors, utils
...
class ImageDefs(object):
    ...
    def parse_yaml(self, filename):
        # locate and verify the swbuilder.yml file
        ...
        with open(fname, "r", encoding = "utf-8") as yaml_file:
    ...
    def generate_build(
        ...
        **kwargs,
        ...
        Args:
            image (str): name of the image as defined in the swbuilder.py file
