...
from swbuilder import cli, utils, staging
from swbuilder.imagedefs import ImageDefs
import swbuilder.errors as errors
...
def run(args):
    ...
    if args.version:
        ...
        print("swbuilder version %s" % __version__)
        return
    ...
    if not os.path.exists(args.makefile):
        ...
        if args.makefile == "swbuilder.yml":
            msg += "\nType `swbuilder --help` to see usage."
