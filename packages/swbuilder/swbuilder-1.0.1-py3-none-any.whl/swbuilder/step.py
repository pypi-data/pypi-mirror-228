...
from swbuilder import utils
from swbuilder import staging
from swbuilder import errors
...
class BuildStep(object):
    ...
    def build(self, client, pull=False, usecache=True):
        ...
        if self.build_first and not self.build_first.built:
            self.build_external_dockerfile(client, self.build_first, self.buildargs)
    ...
    @staticmethod
    def build_external_dockerfile(client, image, buildargs):
