...
from langchain_xfyun.chains.openai_functions.utils import (
    _convert_schema,
    _resolve_schema_references,
    get_llm_kwargs,
)
from langchain_xfyun.output_parsers.openai_functions import (
...
def create_extraction_chain(
    ...
    Args:
        ...
        verbose: Whether to run in verbose mode. In verbose mode, some intermediate
            logs will be printed to the console. Defaults to `langchain_xfyun.verbose` value.
