...
class MlflowLogger:
    ...
    def langchain_artifact(self, chain: Any) -> None:
        with self.mlflow.start_run(
            ...
            self.mlflow.langchain.log_model(chain, "langchain_xfyun-model")
...
class MlflowCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(
        ...
        experiment: Optional[str] = "langchain_xfyun",
        tags: Optional[Dict] = {},
    ...
    def _create_session_analysis_df(self) -> Any:
        ...
        if "name" in on_llm_start_records_df.columns:
            ...
            # ["langchain_xfyun", "llms", "openai", "AzureOpenAI"]
    ...
    def flush_tracker(self, langchain_asset: Any = None, finish: bool = False) -> None:
        ...
        if langchain_asset:
            ...
            if "langchain_xfyun.chains.llm.LLMChain" in str(type(langchain_asset)):
