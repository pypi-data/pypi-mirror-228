...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    Examples:
        ...
        >>> from langchain_xfyun.callbacks import ArgillaCallbackHandler
    ...
    def __init__(
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                " on how to create a `langchain_xfyun`-compatible `FeedbackDataset` in"
        ...
        if supported_fields != [field.name for field in self.dataset.fields]:
            raise ValueError(
                ...
                f"`langchain_xfyun` integration. Supported fields are: {supported_fields},"
                f" and the current `FeedbackDataset` fields are {[field.name for field in self.dataset.fields]}."  # noqa: E501
                " For more information on how to create a `langchain_xfyun`-compatible"
        ...
        warnings.warn(
            (
                ...
                " change based on updates to `langchain_xfyun`. Please report any issues to"
