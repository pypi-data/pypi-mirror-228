"""Base callback handler that can be used to handle callbacks in langchain_xfyun."""
...
if TYPE_CHECKING:
    from langchain_xfyun.schema.agent import AgentAction, AgentFinish
    from langchain_xfyun.schema.document import Document
    from langchain_xfyun.schema.messages import BaseMessage
    from langchain_xfyun.schema.output import ChatGenerationChunk, GenerationChunk, LLMResult
...
class BaseCallbackHandler(
    ...
    """Base callback handler that can be used to handle callbacks from langchain_xfyun."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler that can be used to handle callbacks from langchain_xfyun."""
