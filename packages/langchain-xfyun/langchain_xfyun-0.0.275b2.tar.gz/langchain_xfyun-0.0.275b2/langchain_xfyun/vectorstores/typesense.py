...
class Typesense(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.embedding.openai import OpenAIEmbeddings
            from langchain_xfyun.vectorstores import Typesense
            import typesense
            ...
            typesense_collection_name = "langchain_xfyun-memory"
    ...
    def __init__(
        ...
        *,
        ...
        self._typesense_collection_name = (
            typesense_collection_name or f"langchain_xfyun-{str(uuid.uuid4())}"
        )
