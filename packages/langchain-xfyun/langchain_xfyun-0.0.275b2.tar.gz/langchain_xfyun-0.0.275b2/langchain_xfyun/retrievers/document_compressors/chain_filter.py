...
from langchain_xfyun import LLMChain, PromptTemplate
...
from langchain_xfyun.retrievers.document_compressors.base import BaseDocumentCompressor
from langchain_xfyun.retrievers.document_compressors.chain_filter_prompt import (
    prompt_template,
)
from langchain_xfyun.schema import BasePromptTemplate, Document
