...
from langchain_xfyun.llms import OpenAI, OpenAIChat
...
class PromptLayerOpenAI(OpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.llms import PromptLayerOpenAI
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = promptlayer_api_request(
                "langchain_xfyun.PromptLayerOpenAI",
                "langchain_xfyun",
                [prompt],
                params,
                self.pl_tags,
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            pl_request_id = await promptlayer_api_request_async(
                "langchain_xfyun.PromptLayerOpenAI.async",
                "langchain_xfyun",
                [prompt],
                params,
                self.pl_tags,
...
class PromptLayerOpenAIChat(OpenAIChat):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.llms import PromptLayerOpenAIChat
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = promptlayer_api_request(
                "langchain_xfyun.PromptLayerOpenAIChat",
                "langchain_xfyun",
                [prompt],
                params,
                self.pl_tags,
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        for i in range(len(prompts)):
            ...
            params = {**self._identifying_params, **kwargs}
            pl_request_id = await promptlayer_api_request_async(
                "langchain_xfyun.PromptLayerOpenAIChat.async",
                "langchain_xfyun",
                [prompt],
                params,
                self.pl_tags,
