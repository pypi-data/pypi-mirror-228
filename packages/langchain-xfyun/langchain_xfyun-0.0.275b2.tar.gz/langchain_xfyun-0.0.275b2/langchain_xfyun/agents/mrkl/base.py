...
from langchain_xfyun.agents.agent import Agent, AgentExecutor, AgentOutputParser
from langchain_xfyun.agents.agent_types import AgentType
from langchain_xfyun.agents.mrkl.output_parser import MRKLOutputParser
from langchain_xfyun.agents.mrkl.prompt import FORMAT_INSTRUCTIONS, PREFIX, SUFFIX
from langchain_xfyun.agents.tools import Tool
from langchain_xfyun.agents.utils import validate_tools_single_input
...
class MRKLChain(AgentExecutor):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import OpenAI, MRKLChain
            from langchain_xfyun.chains.mrkl.base import ChainConfig
    ...
    def from_chains(
        ...
        Example:
            .. code-block:: python
                ...
                from langchain_xfyun import LLMMathChain, OpenAI, SerpAPIWrapper, MRKLChain
                from langchain_xfyun.chains.mrkl.base import ChainConfig
                llm = OpenAI(temperature=0)
