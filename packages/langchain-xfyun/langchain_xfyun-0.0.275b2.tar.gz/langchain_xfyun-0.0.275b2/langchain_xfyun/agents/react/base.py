...
from langchain_xfyun.agents.react.output_parser import ReActOutputParser
from langchain_xfyun.agents.react.textworld_prompt import TEXTWORLD_PROMPT
from langchain_xfyun.agents.react.wiki_prompt import WIKI_PROMPT
...
class ReActChain(AgentExecutor):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import ReActChain, OpenAI
