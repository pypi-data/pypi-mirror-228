...
if TYPE_CHECKING:
    from langchain_xfyun.vectorstores._pgvector_data_models import CollectionStore
...
_LANGCHAIN_DEFAULT_COLLECTION_NAME = "langchain_xfyun"
...
class PGVector(VectorStore):
    ...
    Args:
        ...
        embedding_function: Any embedding function implementing
            `langchain_xfyun.embeddings.base.Embeddings` interface.
        collection_name: The name of the collection to use. (default: langchain_xfyun)
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.vectorstores import PGVector
    ...
    def __post_init__(
        ...
        from langchain_xfyun.vectorstores._pgvector_data_models import (
            CollectionStore,
            EmbeddingStore,
        )
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchain_xfyun import PGVector
