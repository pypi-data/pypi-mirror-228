...
from langchain_xfyun._api import deprecated
...
from langchain_xfyun.utilities.redis import (
    _array_to_buffer,
    check_redis_module_exist,
    get_client,
)
from langchain_xfyun.utils import get_from_dict_or_env
from langchain_xfyun.vectorstores.base import VectorStore, VectorStoreRetriever
from langchain_xfyun.vectorstores.redis.constants import (
...
if TYPE_CHECKING:
    ...
    from langchain_xfyun.vectorstores.redis.schema import RedisModel
...
class Redis(VectorStore):
    ...
    .. code-block:: python
        ...
        from langchain_xfyun.vectorstores import Redis
    ...
    schema according to the following rules:
        ...
        - All lists of strings are indexed as tag fields (joined by
            langchain_xfyun.vectorstores.redis.constants.REDIS_TAG_SEPARATOR)
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        always present in the langchain_xfyun schema.
        ...
        try:
            ...
            from langchain_xfyun.vectorstores.redis.schema import read_schema
    ...
    def _get_schema_with_defaults(
        ...
        from langchain_xfyun.vectorstores.redis.schema import RedisModel, read_schema
