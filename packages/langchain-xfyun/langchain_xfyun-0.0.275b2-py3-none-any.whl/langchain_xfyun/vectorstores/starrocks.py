...
from langchain_xfyun.pydantic_v1 import BaseSettings
...
class StarRocksSettings(BaseSettings):
    ...
    Attribute:
        ...
        column_map (Dict) : Column type map to project column name onto langchain_xfyun
