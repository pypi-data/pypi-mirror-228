...
from langchain_xfyun.vectorstores.utils import DistanceStrategy
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            .. code-block:: python
                ...
                from langchain_xfyun.vectorstores import SingleStoreDB
        ...
        self.connection_kwargs["conn_attrs"]["_connector_name"] = "langchain_xfyun python sdk"
