...
from langchain_xfyun.docstore.base import AddableMixin, Docstore
...
class ScaNN(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.embeddings import HuggingFaceEmbeddings
            from langchain_xfyun.vectorstores import ScaNN
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchain_xfyun import ScaNN
