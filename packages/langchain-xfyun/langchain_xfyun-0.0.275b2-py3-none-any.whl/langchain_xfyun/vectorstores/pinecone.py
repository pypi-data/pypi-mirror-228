...
from langchain_xfyun.vectorstores.utils import DistanceStrategy, maximal_marginal_relevance
...
class Pinecone(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.vectorstores import Pinecone
            ...
            index = pinecone.Index("langchain_xfyun-demo")
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from langchain_xfyun import Pinecone
                ...
                pinecone = Pinecone.from_texts(
                    texts,
                    embeddings,
                    index_name="langchain_xfyun-demo"
                )
        """
        try:
            import pinecone
