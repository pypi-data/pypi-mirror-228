...
from langchain_xfyun.agents.agent import AgentOutputParser, BaseSingleActionAgent
from langchain_xfyun.agents.xml.prompt import agent_instructions
from langchain_xfyun.callbacks.base import Callbacks
from langchain_xfyun.chains.llm import LLMChain
from langchain_xfyun.prompts.chat import AIMessagePromptTemplate, ChatPromptTemplate
from langchain_xfyun.schema import AgentAction, AgentFinish
...
class XMLAgent(BaseSingleActionAgent):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from langchain_xfyun.agents import XMLAgent
            from langchain_xfyun
