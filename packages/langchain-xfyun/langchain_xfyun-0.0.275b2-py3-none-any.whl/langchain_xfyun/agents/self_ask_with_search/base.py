...
from langchain_xfyun.agents.self_ask_with_search.output_parser import SelfAskOutputParser
from langchain_xfyun.agents.self_ask_with_search.prompt import PROMPT
...
class SelfAskWithSearchChain(AgentExecutor):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import SelfAskWithSearchChain, OpenAI, GoogleSerperAPIWrapper
