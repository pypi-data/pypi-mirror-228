...
from langchain_xfyun.utils import get_from_env
...
from langchain_xfyun.load.load import loads
from langchain_xfyun.schema import ChatGeneration, Generation
from langchain_xfyun.vectorstores.redis import Redis as RedisVectorstore
...
class SQLiteCache(SQLAlchemyCache):
    ...
    def __init__(self, database_path: str = ".langchain_xfyun.db"):
...
class RedisSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            langchain_xfyun.llm_cache = RedisSemanticCache(
...
class GPTCache(BaseCache):
    ...
    def __init__(
        ...
        .. code-block:: python
            ...
            langchain_xfyun.llm_cache = GPTCache(init_gptcache)
