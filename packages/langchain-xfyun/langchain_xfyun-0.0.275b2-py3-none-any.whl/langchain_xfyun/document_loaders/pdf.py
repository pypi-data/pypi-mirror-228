...
from langchain_xfyun.document_loaders.unstructured import UnstructuredFileLoader
...
class UnstructuredPDFLoader(UnstructuredFileLoader):
    ...
    langchain_xfyun Document object. If you use "elements" mode, the unstructured
    ...
    Examples
    --------
    from langchain_xfyun.document_loaders import UnstructuredPDFLoader
...
class AmazonTextractPDFLoader(BasePDFLoader):
    ...
    Example:
        .. code-block:: python
            from langchain_xfyun.document_loaders import AmazonTextractPDFLoader
