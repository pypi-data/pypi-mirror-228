...
from langchain_xfyun.schema.output import ChatGenerationChunk
    ...
    def _generate_with_cache(
        ...
        **kwargs: Any,
        ...
        if langchain_xfyun.llm_cache is None or disregard_cache:
            # This happens when langchain_xfyun.cache is None, but self.cache is True
            ...
            if isinstance(cache_val, list):
                ...
                langchain_xfyun.llm_cache.update(prompt, llm_string, result.generations)
                return result
