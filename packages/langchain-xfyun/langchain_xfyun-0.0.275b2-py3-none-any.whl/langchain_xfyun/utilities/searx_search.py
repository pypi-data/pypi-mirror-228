...
Then create a searx search instance like this:
    ...
    .. code-block:: python
        ...
        from langchain_xfyun.utilities import SearxSearchWrapper
...
For example the following query:
    ...
    .. code-block:: python
        ...
        s = SearxSearchWrapper("langchain_xfyun library", engines=['github'])

        # can also be written as:
        s = SearxSearchWrapper("langchain_xfyun library !github")
        # or even:
        s = SearxSearchWrapper("langchain_xfyun library !gh")
...
engines.
    ...
    .. code-block:: python
        ...
        s = SearchWrapper("langchain_xfyun library", query_suffix="!gh")


        s = SearchWrapper("langchain_xfyun library")
...
from langchain_xfyun.pydantic_v1 import (
    BaseModel,
    Extra,
    Field,
    PrivateAttr,
