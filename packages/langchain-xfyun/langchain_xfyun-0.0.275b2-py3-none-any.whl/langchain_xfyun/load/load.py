...
class Reviver:
    ...
    def __init__(
        ...
        # By default only support langchain_xfyun, but user can pass in additional namespaces
        self.valid_namespaces = (
            ["langchain_xfyun", *valid_namespaces] if valid_namespaces else ["langchain_xfyun"]
        )
    ...
    def __call__(self, value: Dict[str, Any]) -> Any:
        ...
        if (
            ...
            # The root namespace "langchain_xfyun" is not a valid identifier.
            if len(namespace) == 1 and namespace[0] == "langchain_xfyun":
                raise ValueError(f"Invalid namespace: {value}")
