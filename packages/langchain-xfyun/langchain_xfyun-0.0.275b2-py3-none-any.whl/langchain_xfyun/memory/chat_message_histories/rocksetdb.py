...
from langchain_xfyun.schema import BaseChatMessageHistory
from langchain_xfyun.schema.messages import BaseMessage, _message_to_dict, messages_from_dict
...
class RocksetChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(
        ...
        try:
            self.client.set_application("langchain_xfyun")
