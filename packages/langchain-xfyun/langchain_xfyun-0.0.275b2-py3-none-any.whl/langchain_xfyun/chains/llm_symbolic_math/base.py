...
from langchain_xfyun.base_language import BaseLanguageModel
...
from langchain_xfyun.chains.llm_symbolic_math.prompt import PROMPT
from langchain_xfyun.prompts.base import BasePromptTemplate
...
class LLMSymbolicMathChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import LLMSymbolicMathChain, OpenAI
