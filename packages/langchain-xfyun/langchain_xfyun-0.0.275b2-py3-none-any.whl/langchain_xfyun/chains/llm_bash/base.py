...
from langchain_xfyun.chains.llm_bash.prompt import PROMPT
from langchain_xfyun.pydantic_v1 import Extra, Field, root_validator
from langchain_xfyun.schema import BasePromptTemplate, OutputParserException
...
class LLMBashChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import LLMBashChain, OpenAI
