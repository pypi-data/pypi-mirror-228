...
from langchain_xfyun.chains.elasticsearch_database.prompts import ANSWER_PROMPT, DSL_PROMPT
from langchain_xfyun.chains.llm import LLMChain
from langchain_xfyun.output_parsers.json import SimpleJsonOutputParser
from langchain_xfyun.pydantic_v1 import Extra, root_validator
from langchain_xfyun.schema import BaseLLMOutputParser, BasePromptTemplate
...
class ElasticsearchDatabaseChain(Chain):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun import ElasticsearchDatabaseChain, OpenAI
            from elasticsearch import Elasticsearch
