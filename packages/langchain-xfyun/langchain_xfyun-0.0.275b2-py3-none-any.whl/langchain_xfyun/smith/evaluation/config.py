...
from langchain_xfyun.evaluation.criteria.eval_chain import CRITERIA_TYPE
from langchain_xfyun.evaluation.embedding_distance.base import (
    EmbeddingDistance as EmbeddingDistanceEnum,
)
from langchain_xfyun.evaluation.schema import EvaluatorType, StringEvaluator
from langchain_xfyun.evaluation.string_distance.base import (
...
class RunEvalConfig(BaseModel):
    ...
    evaluators : List[Union[EvaluatorType, EvalConfig]]
        ...
        Each can be the string of an :class:`EvaluatorType <langchain_xfyun.evaluation.schema.EvaluatorType>`, such
        as EvaluatorType.QA, the evaluator type string ("qa"), or a configuration for a
        given evaluator (e.g., :class:`RunEvalConfig.QA <langchain_xfyun.smith.evaluation.config.RunEvalConfig.QA>`).
    ...
    :class:`EvaluatorType <langchain_xfyun.evaluation.schema.EvaluatorType>`, such
    as `EvaluatorType.QA`, the evaluator type string ("qa"), or a configuration for a
    given evaluator
    (e.g., 
    :class:`RunEvalConfig.QA <langchain_xfyun.smith.evaluation.config.RunEvalConfig.QA>`)."""  # noqa: E501
