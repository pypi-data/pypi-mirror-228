...
from langchain_xfyun.pydantic_v1 import PrivateAttr
...
class OpenLLM(LLM):
    ...
    Example running an LLM model locally managed by OpenLLM:
        .. code-block:: python
            ...
            from langchain_xfyun.llms import OpenLLM
            llm = OpenLLM(
                model_name='flan-t5',
    ...
    def runner(self) -> openllm.LLMRunner:
        ...
        .. code-block:: python
            ...
            svc = bentoml.Service("langchain_xfyun-openllm", runners=[llm.runner])
