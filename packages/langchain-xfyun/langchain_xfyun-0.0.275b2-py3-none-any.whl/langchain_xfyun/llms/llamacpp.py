...
from langchain_xfyun.utils import get_pydantic_field_names
from langchain_xfyun.utils.utils import build_extra_kwargs
...
class LlamaCpp(LLM):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.llms import LlamaCpp
