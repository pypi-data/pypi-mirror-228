...
class SDKManager(Base):
    ...
    def dataspec_repr(
        ...
        PRIVACY_COLORS = {
            "PEP": ("#428e92", "#428e92", "white"),
            "DP": ("#006064", "#006064", "white"),
            "NOT_PEP": ("white", "#428e92", "#428e92"),
        }
        if info == "status":
            TASK = (
                ARROW_TASK
        ...
        # Privacy type
        pep_type = f" (PEP)" if dataspec.is_pep() else ""
        ...
        # Assemble
        label = f"{policy_msg}{name}{classname}{pep_type}"
        return (
