...
class search_results_best_dict(objects.baseObject):
    def __init__(self, data:Dict={}):
        self.score:float = 0
        self.tests:int = 0
        self.input:List[str] = []
        self.by_length:float = 0
        self.result:bool = False
        self.phrases:tuple = ()
        self.update(data)


class search_results_sorted_list(objects.baseObject):
    def __init__(self, data:Dict={}):
        self.score:float = 0
        self.tests:int = 0
        self.input:List[str] = []
...
class search_results(objects.baseObject):
    def __init__(self, data:Dict={}):
        self.input:List[str] = []
        self.update(data)
        self.best:search_results_best_dict = search_results_best_dict(data.get('best', {}))
        self.sorted:List[search_results_sorted_list] = [search_results_sorted_list(x) for x in data.get('sorted', [])]