...
class system:
    def __init__(self, year: str, level: str, unit: str, gas: str,household=True,exact_estimation=True):
        self.Y = year
        self.L = level
        self.u = unit
        self.gas = gas
    ...
    def import_data_tru(self):
      ...
      try:
        tru_CI = tru.read_var(self.Y,self.L,'CI_matrix',self.u).T
      except Exception as e:
        tru_CI = tru.read_var('2020',self.L,'CI_matrix',self.u).T
