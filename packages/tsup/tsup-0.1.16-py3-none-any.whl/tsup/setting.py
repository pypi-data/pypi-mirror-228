...
ITEM_PIPELINES = [
    "tsup.pipelines.mysql_pipeline.MysqlPipeline",
    # "tsup.pipelines.mongo_pipeline.MongoPipeline",
    # "tsup.pipelines.console_pipeline.ConsolePipeline",
]
...
# SPIDER
SPIDER_THREAD_COUNT = 1  # 视频管理并发数，追求速度推荐32
...
REDIS_KEY = ""
# 视频管理启动时删除的key，类型: 元组/bool/string。 支持正则; 常用于清空任务队列，否则重启时会断点续爬
DELETE_KEYS = []
...
# 下载
DOWNLOADER = "tsup.network.downloader.RequestsDownloader"
SESSION_DOWNLOADER = "tsup.network.downloader.RequestsSessionDownloader"
RENDER_DOWNLOADER = "tsup.network.downloader.SeleniumDownloader"
# RENDER_DOWNLOADER="tsup.network.downloader.PlaywrightDownloader"
...
# 监控数据存储的表名，视频管理管理系统上会以task_id命名
