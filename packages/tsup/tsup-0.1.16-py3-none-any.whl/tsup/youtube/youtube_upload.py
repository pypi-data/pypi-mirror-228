...
class YoutubeUpload:
    ...
    async def upload(
        ...
        if release_date_hour is None:
            ...
            release_date_hour = "10:15"
        self.log.debug(f"wait_policy:{self.wait_policy}")
        ...
        self.log.debug(f"publish_policy:{publish_policy}--{PublishpolicyOptions[publish_policy]}")
        ...
        self.log.debug(f"captions_certification:{captions_certification}--{CaptionsCertificationOptions[captions_certification]}")
        ...
        self.log.debug(f"license_type:{license_type}--{LicenceTypeOptions[license_type]}")
        ...
        self.log.debug(f"shorts_remixing_type:{shorts_remixing_type}--{ShortsremixingTypeOptions[shorts_remixing_type]}")
        ...
        if categories is not None:
            self.log.debug(f"categories:{categories}--{CategoryOptions[categories]}")
        ...
        self.log.debug(f"comments_ratings_policy:{comments_ratings_policy}--{CommentsRatingsPolicyOptions[comments_ratings_policy]}")
