...
YoutubeUploadURL = (
    "https://www.youtube.com/upload?persist_gl=1&gl=US&persist_hl=1&hl=en"
)
...
DOUYIN_INPUT_FILE_THUMBNAIL_OPTION_UPLOAD = (
    ".header--3-YMH > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)"
)
...
DOUYIN_LOCATION_RESULT = (
    "div.semi-select-option:nth-child(1) > div:nth-child(2) > div:nth-child(1)"
)
DOUYIN_MINI_SELECT = ".select--2uNK1"
DOUYIN_MINI_SELECT_OPTION = (
    ".select--2uNK1 > div:nth-child(1) > div:nth-child(1) > span:nth-child(1)"
)
...
DOUYIN_HOT_TOPIC_RESULT = (
    "//html/body/div[7]/div/div/div/div/div/div/div[1]/div[2]/div[1]/div"
)

DOUYIN_HEJI_SELECT_OPTION = (
    ".sel-area--2hBSM > div:nth-child(2) > div:nth-child(1) > div:nth-child(1)"
)
...
DONE_BUTTON_XPATH = "//*[@id='done-button']"
DONE_BUTTON_CSS_SELECTOR = "#done-button"
