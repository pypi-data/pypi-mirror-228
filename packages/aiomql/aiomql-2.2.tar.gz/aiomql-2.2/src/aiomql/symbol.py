...
class Symbol(SymbolInfo):
    ...
    async def compute_volume(self, *, amount: float, pips: float) -> float:
    ...
    async def copy_rates_from(self, *, timeframe: TimeFrame, date_from: datetime | int, count: int) -> Candles:
        """
