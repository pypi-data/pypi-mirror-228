...
class ClusterDefinition(CamelCaseBase):
    ...
    auto_resume: Optional[bool] = Field(None, alias="autoResume")
    auto_az: Optional[bool] = Field(False, alias="autoAZ")
    ...
    def __init__(self, **data: Any):
        ...
        if self.use_spot_instance:
            ...
            self.auto_resume = False if self.auto_resume is None else self.auto_resume
            ...
            self.auto_resume = True if self.auto_resume is None else self.auto_resume
...
class ClusterResponse(CamelCaseBase):
    ...
    auto_resume: Optional[bool] = Field(True, alias="autoResume")
