...
def wait_for_content_start(
        keypress=None, spinner_fn=None, mask=Region.ALL,
        black_threshold=None, motion_threshold=None, consecutive_frames=None,
        timeout_secs=30):
    ...
    :param stbt.Keypress keypress: The return value from `stbt.press` that
