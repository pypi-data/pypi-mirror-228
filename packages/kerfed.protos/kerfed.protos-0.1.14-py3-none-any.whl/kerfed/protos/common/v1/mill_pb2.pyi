...
class MillMachine(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["extents", b"extents", "max_z_travel", b"max_z_travel", "spindle_length", b"spindle_length", "spindle_pad", b"spindle_pad", "spindle_radius", b"spindle_radius", "tool_pad", b"tool_pad"]) -> None: ...
...
class MillPreprocess(google.protobuf.message.Message):
    ...
    def diameters(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]:
        """What diameter of tools are available?"""
    @property
    def directions(self) -> kerfed.protos.common.v1.ndarray_pb2.NDArray:
        """an (N, 3) double array of unit vectors of possible directions."""
    @property
    ...
    @property
    def drills(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CutDrill]:
        """The preprocessor may have extracted drill cuts."""
    def __init__(
        self,
        *,
        ...
        drills: collections.abc.Iterable[global___CutDrill] | None = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["diameters", b"diameters", "directions", b"directions", "drills", b"drills", "mesh", b"mesh", "stock", b"stock", "stock_geometry", b"stock_geometry"]) -> None: ...
...
@typing_extensions.final
class CutMill(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    tool: kerfed.protos.common.v1.path_pb2.ToolKind.ValueType
    """Square or ball."""
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["radius", b"radius", "tool", b"tool", "volume", b"volume"]) -> None: ...

global___CutMill = CutMill

@typing_extensions.final
class CutDrill(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["depth", b"depth", "labels", b"labels", "normal", b"normal", "origins", b"origins", "radius", b"radius", "thru", b"thru"]) -> None: ...

global___CutDrill = CutDrill

@typing_extensions.final
class CutFace(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["area", b"area", "depth", b"depth", "radius", b"radius"]) -> None: ...

global___CutFace = CutFace
...
class MillFabrication(google.protobuf.message.Message):
    ...
    class Cut(google.protobuf.message.Message):
        ...
        FIXTURE_INDEX_FIELD_NUMBER: builtins.int
        LABEL_FIELD_NUMBER: builtins.int
        @property
        def mill(self) -> global___CutMill: ...
        @property
        def drill(self) -> global___CutDrill: ...
        @property
        def face(self) -> global___CutFace: ...
        fixture_index: builtins.int
        ...
        def __init__(
            self,
            *,
            mill: global___CutMill | None = ...,
            drill: global___CutDrill | None = ...,
            face: global___CutFace | None = ...,
            fixture_index: builtins.int = ...,
            label: builtins.str = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["drill", b"drill", "face", b"face", "mill", b"mill", "op", b"op"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["drill", b"drill", "face", b"face", "fixture_index", b"fixture_index", "label", b"label", "mill", b"mill", "op", b"op"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["op", b"op"]) -> typing_extensions.Literal["mill", "drill", "face"] | None: ...
    ...
    @property
    def cuts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MillFabrication.Cut]:
    ...
    @property
    def gcode(self) -> kerfed.protos.common.v1.fileblob_pb2.FileBlob:
        """The "G-code" for the milled part in a ZIP archive."""
    @property
    ...
    def __init__(
        ...
        *,
        ...
        cuts: collections.abc.Iterable[global___MillFabrication.Cut] | None = ...,
        volume: kerfed.protos.common.v1.fileblob_pb2.FileBlob | None = ...,
        gcode: kerfed.protos.common.v1.fileblob_pb2.FileBlob | None = ...,
        pre: global___MillPreprocess | None = ...,
        machine: global___MillMachine | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["gcode", b"gcode", "machine", b"machine", "pre", b"pre", "stock", b"stock", "volume", b"volume"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cuts", b"cuts", "fixtures", b"fixtures", "gcode", b"gcode", "machine", b"machine", "pre", b"pre", "stock", b"stock", "volume", b"volume"]) -> None: ...
