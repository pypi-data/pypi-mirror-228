...
class _SegmentTagEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SegmentTag.ValueType], builtins.type):
    ...
    sees this tag.
    """
    SEGMENT_TAG_DRILL: _SegmentTag.ValueType  # 6
...
of the segment are touching the finished part.
"""
SEGMENT_TAG_MOVE: SegmentTag.ValueType  # 3
"""The segment is a reposition move and is not cutting
material away: this generall corresponds `G0`
"""
SEGMENT_TAG_MOVE_SHORTCUT: SegmentTag.ValueType  # 4
"""This is a shortcut between cutting segments and
is not cutting material away.
"""
SEGMENT_TAG_MOVE_LINK: SegmentTag.ValueType  # 5
"""This is a move where the intermediate region
has NOT been checked for collision and is relying on
a postprocesser to connect or "link" the path.
A move with this tag MUST be checked before execution
...
sees this tag.
"""
SEGMENT_TAG_DRILL: SegmentTag.ValueType  # 6
"""This segment represents a drilling operation."""
...
class _ToolKindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ToolKind.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    TOOL_KIND_UNSPECIFIED: _ToolKind.ValueType  # 0
    TOOL_KIND_SQUARE_MILL: _ToolKind.ValueType  # 1
    """A cylinder."""
    TOOL_KIND_BALL_MILL: _ToolKind.ValueType  # 2
    """A cylinder with a hemispherical end."""
    TOOL_KIND_DRILL: _ToolKind.ValueType  # 3
    """A drill bit."""

class ToolKind(_ToolKind, metaclass=_ToolKindEnumTypeWrapper): ...

TOOL_KIND_UNSPECIFIED: ToolKind.ValueType  # 0
TOOL_KIND_SQUARE_MILL: ToolKind.ValueType  # 1
"""A cylinder."""
TOOL_KIND_BALL_MILL: ToolKind.ValueType  # 2
"""A cylinder with a hemispherical end."""
TOOL_KIND_DRILL: ToolKind.ValueType  # 3
"""A drill bit."""
global___ToolKind = ToolKind
...
class Tool(google.protobuf.message.Message):
    ...
    kind: global___ToolKind.ValueType
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kind", b"kind", "length_cut", b"length_cut", "length_total", b"length_total", "radius", b"radius"]) -> None: ...
...
class Segment(google.protobuf.message.Message):
    ...
    """Segment velocity in meters/second, constant over segment"""
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["angle", b"angle", "final", b"final", "start", b"start", "tag", b"tag", "tool_index", b"tool_index", "velocity", b"velocity"]) -> None: ...
...
class SegmentPath(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["plane", b"plane", "segments", b"segments", "tools", b"tools"]) -> None: ...
