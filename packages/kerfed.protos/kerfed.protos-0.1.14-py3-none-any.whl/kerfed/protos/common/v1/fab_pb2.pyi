...
class TitleBlock(google.protobuf.message.Message):
    ...
    @property
    def footer(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """A list of markdown items that will be rendered in the drawing."""
    def __init__(
        self,
        *,
        logo: kerfed.protos.common.v1.fileblob_pb2.FileBlob | None = ...,
        name: builtins.str = ...,
        footer: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
...
global___TitleBlock = TitleBlock
...
class FlatFabrication(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["flattened", b"flattened", "to_flattened", b"to_flattened"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["area", b"area", "extents", b"extents", "flattened", b"flattened", "holes", b"holes", "perimeter", b"perimeter", "rapids", b"rapids", "thickness", b"thickness", "to_flattened", b"to_flattened"]) -> None: ...
...
class CotsFabrication(google.protobuf.message.Message):
    ...
    @property
    def matches(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CotsFabrication.CotsMatch]:
    ...
    def __init__(
        self,
        *,
        matches: collections.abc.Iterable[global___CotsFabrication.CotsMatch] | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["annular", b"annular", "cylinder", b"cylinder", "primitive", b"primitive"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["annular", b"annular", "cylinder", b"cylinder", "matches", b"matches", "primitive", b"primitive"]) -> None: ...
...
class BentFabrication(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["flat", b"flat", "regions", b"regions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bend_angle", b"bend_angle", "bend_count", b"bend_count", "bend_k", b"bend_k", "bend_radii", b"bend_radii", "bend_setups", b"bend_setups", "flat", b"flat", "regions", b"regions"]) -> None: ...
...
class RollFabrication(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["flat", b"flat"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["diameter", b"diameter", "flat", b"flat", "height", b"height"]) -> None: ...
...
class TurnFabrication(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["diameter", b"diameter", "height", b"height", "inner_diameter", b"inner_diameter", "profile", b"profile", "volume", b"volume"]) -> None: ...
...
class PartFabrication(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["add", b"add", "bent", b"bent", "cots", b"cots", "defaults", b"defaults", "details", b"details", "drawing", b"drawing", "flat", b"flat", "manual", b"manual", "mill", b"mill", "outcome", b"outcome", "roll", b"roll", "turn", b"turn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add", b"add", "bent", b"bent", "cots", b"cots", "defaults", b"defaults", "details", b"details", "drawing", b"drawing", "extents", b"extents", "flat", b"flat", "geom_id", b"geom_id", "geom_name", b"geom_name", "manual", b"manual", "method_id", b"method_id", "mill", b"mill", "outcome", b"outcome", "posts", b"posts", "roll", b"roll", "turn", b"turn"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["details", b"details"]) -> typing_extensions.Literal["flat", "bent", "roll", "mill", "cots", "add", "turn", "manual"] | None: ...
