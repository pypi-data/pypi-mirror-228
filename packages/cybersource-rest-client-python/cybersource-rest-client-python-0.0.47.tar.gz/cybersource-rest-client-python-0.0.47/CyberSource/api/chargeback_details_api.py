...
class ChargebackDetailsApi(object):
    ...
    def get_chargeback_details(self, start_time, end_time, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_chargeback_details(start_time, end_time, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_chargeback_details_with_http_info(start_time, end_time, **kwargs)
        else:
            (data) = self.get_chargeback_details_with_http_info(start_time, end_time, **kwargs)
            return data

    def get_chargeback_details_with_http_info(self, start_time, end_time, **kwargs):
        """
        Get Chargeback Details
        Chargeback Detail Report Description
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_chargeback_details_with_http_info(start_time, end_time, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_chargeback_details" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(f'/reporting/v3/chargeback-details', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ReportingV3ChargebackDetailsGet200Response',
