...
class InlineResponse202(object):
    ...
    def id(self):
        """
        Gets the id of this InlineResponse202.
        An unique identification number generated by Cybersource to identify the submitted request. Returned by all services. It is also appended to the endpoint of the resource. On incremental authorizations, this value with be the same as the identification number returned in the original authorization response. 

        :return: The id of this InlineResponse202.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this InlineResponse202.
        :type: str
        """
    ...
    def submit_time_utc(self):
        """
        Gets the submit_time_utc of this InlineResponse202.
        Time of request in UTC. Format: `YYYY-MM-DDThh:mm:ssZ` **Example** `2016-08-11T22:47:57Z` equals August 11, 2016, at 22:47:57 (10:47:57 p.m.). The `T` separates the date and the time. The `Z` indicates UTC.  Returned by Cybersource for all services. 

        :return: The submit_time_utc of this InlineResponse202.
        :rtype: str
        """
    ...
    def submit_time_utc(self, submit_time_utc):
        """
        Sets the submit_time_utc of this InlineResponse202.
        Time of request in UTC. Format: `YYYY-MM-DDThh:mm:ssZ` **Example** `2016-08-11T22:47:57Z` equals August 11, 2016, at 22:47:57 (10:47:57 p.m.). The `T` separates the date and the time. The `Z` indicates UTC.  Returned by Cybersource for all services. 

        :param submit_time_utc: The submit_time_utc of this InlineResponse202.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this InlineResponse202.
        The status of the submitted transaction.  Possible values:  - ACCEPTED 

        :return: The status of this InlineResponse202.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this InlineResponse202.
        :type: str
        """
    ...
    def subscription_information(self):
        """
        Gets the subscription_information of this InlineResponse202.

        :return: The subscription_information of this InlineResponse202.
        :rtype: InlineResponse202SubscriptionInformation
        """
    ...
    def subscription_information(self, subscription_information):
        """
        Sets the subscription_information of this InlineResponse202.

        :param subscription_information: The subscription_information of this InlineResponse202.
        :type: InlineResponse202SubscriptionInformation
        """
