...
class PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION(object):
    """
    ...
    def __init__(self, status=None, reason=None, message=None):
        """
        PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION - a model defined in Swagger
        """
    ...
    def reason(self):
        """
        Gets the reason of this PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION.
    ...
    def reason(self, reason):
        """
        Sets the reason of this PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION.
        The reason of the status. Possible values are: - `INVALID_MERCHANT_CONFIGURATION` - `CONSUMER_AUTHENTICATION_REQUIRED` - `CONSUMER_AUTHENTICATION_FAILED` - `AUTHENTICATION_FAILED` 
    ...
    def message(self):
        ...
        :return: The message of this PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION.
        The message describing the reason of the status. Value is: - Encountered a Payer Authentication problem. Payer could not be authenticated. 

        :param message: The message of this PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PtsV2PaymentsPost201ResponseEmbeddedActionsCONSUMERAUTHENTICATION):
            return False
