...
class InlineResponse403Errors(object):
    """
    ...
    def __init__(self, type=None, message=None):
        """
        InlineResponse403Errors - a model defined in Swagger
        """
    ...
    def message(self):
        """
        Gets the message of this InlineResponse403Errors.
        The detailed message related to the type.

        :return: The message of this InlineResponse403Errors.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this InlineResponse403Errors.
        The detailed message related to the type.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse403Errors):
            return False
