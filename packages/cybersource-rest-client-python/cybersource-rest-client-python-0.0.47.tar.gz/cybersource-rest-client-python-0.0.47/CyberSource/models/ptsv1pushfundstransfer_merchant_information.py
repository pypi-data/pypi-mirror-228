...
class Ptsv1pushfundstransferMerchantInformation(object):
    ...
    def submit_local_date_time(self):
        """
        Gets the submit_local_date_time of this Ptsv1pushfundstransferMerchantInformation.
        Time that the transaction was submitted in local time. The time is in hhmmss format. 

        :return: The submit_local_date_time of this Ptsv1pushfundstransferMerchantInformation.
        :rtype: str
        """
    ...
    def submit_local_date_time(self, submit_local_date_time):
        """
        Sets the submit_local_date_time of this Ptsv1pushfundstransferMerchantInformation.
        Time that the transaction was submitted in local time. The time is in hhmmss format. 
    ...
    def vat_registration_number(self):
        """
        Gets the vat_registration_number of this Ptsv1pushfundstransferMerchantInformation.
        Your government-assigned tax identification number.  Visa Platform Connect: max length is 20 

        :return: The vat_registration_number of this Ptsv1pushfundstransferMerchantInformation.
        :rtype: str
        """
    ...
    def vat_registration_number(self, vat_registration_number):
        """
        Sets the vat_registration_number of this Ptsv1pushfundstransferMerchantInformation.
        Your government-assigned tax identification number.  Visa Platform Connect: max length is 20 

        :param vat_registration_number: The vat_registration_number of this Ptsv1pushfundstransferMerchantInformation.
        :type: str
        """
