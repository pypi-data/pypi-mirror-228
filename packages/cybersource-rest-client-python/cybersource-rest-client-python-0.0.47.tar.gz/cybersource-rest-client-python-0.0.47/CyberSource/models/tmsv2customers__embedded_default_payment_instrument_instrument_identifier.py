...
class Tmsv2customersEmbeddedDefaultPaymentInstrumentInstrumentIdentifier(object):
    """
    ...
    def __init__(self, id=None):
        """
        Tmsv2customersEmbeddedDefaultPaymentInstrumentInstrumentIdentifier - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersEmbeddedDefaultPaymentInstrumentInstrumentIdentifier):
            return False
