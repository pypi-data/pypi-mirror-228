...
class Ptsv2refreshpaymentstatusidProcessingInformation(object):
    """
    ...
    def __init__(self, action_list=None):
        """
        Ptsv2refreshpaymentstatusidProcessingInformation - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2refreshpaymentstatusidProcessingInformation):
            return False
