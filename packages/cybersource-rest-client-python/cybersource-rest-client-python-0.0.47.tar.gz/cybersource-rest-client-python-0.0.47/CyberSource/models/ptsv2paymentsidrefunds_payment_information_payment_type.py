...
class Ptsv2paymentsidrefundsPaymentInformationPaymentType(object):
    """
    ...
    def __init__(self, name=None, sub_type_name=None, method=None):
        """
        Ptsv2paymentsidrefundsPaymentInformationPaymentType - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        ...
        :return: The name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        A Payment Type is an agreed means for a payee to receive legal tender from a payer. The way one pays for a commercial financial transaction. Examples: Card, Bank Transfer, Digital, Direct Debit. Possible values: - `CARD` (use this for a PIN debit transaction) - `CHECK` (use this for all eCheck payment transactions - ECP Debit, ECP Follow-on Credit, ECP StandAlone Credit) - `bankTransfer` (use for Online Bank Transafer for methods such as P24, iDeal, Estonia Bank, KCP) - `localCard` (KCP Local card via Altpay) - `carrierBilling` (KCP Carrier Billing via Altpay) 

        :param name: The name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        :type: str
        """
    ...
    def sub_type_name(self):
        """
        Gets the sub_type_name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        ...
        :return: The sub_type_name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        :rtype: str
        """
    ...
    def sub_type_name(self, sub_type_name):
        """
        Sets the sub_type_name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        Detailed information about the Payment Type. Possible values: - `DEBIT`: Use this value to indicate a PIN debit transaction.  Examples: For Card, if Credit or Debit or PrePaid. For Bank Transfer, if Online Bank Transfer or Wire Transfers. 

        :param sub_type_name: The sub_type_name of this Ptsv2paymentsidrefundsPaymentInformationPaymentType.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2paymentsidrefundsPaymentInformationPaymentType):
            return False
