...
class Tmsv2customersDefaultPaymentInstrument(object):
    """
    ...
    def __init__(self, id=None):
        """
        Tmsv2customersDefaultPaymentInstrument - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersDefaultPaymentInstrument):
            return False
