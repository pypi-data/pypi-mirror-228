...
class Ptsv2paymentsClientReferenceInformation(object):
    ...
    def __init__(self, code=None, reconciliation_id=None, paused_request_id=None, transaction_id=None, comments=None, partner=None, application_name=None, application_version=None, application_user=None):
        """
    ...
    def reconciliation_id(self):
        """
        Gets the reconciliation_id of this Ptsv2paymentsClientReferenceInformation.
        Reference number for the transaction. Depending on how your Cybersource account is configured, this value could either be provided in the API request or generated by CyberSource. The actual value used in the request to the processor is provided back to you by Cybersource in the response. 

        :return: The reconciliation_id of this Ptsv2paymentsClientReferenceInformation.
        :rtype: str
        """
    ...
    def reconciliation_id(self, reconciliation_id):
        """
        Sets the reconciliation_id of this Ptsv2paymentsClientReferenceInformation.
        Reference number for the transaction. Depending on how your Cybersource account is configured, this value could either be provided in the API request or generated by CyberSource. The actual value used in the request to the processor is provided back to you by Cybersource in the response. 
