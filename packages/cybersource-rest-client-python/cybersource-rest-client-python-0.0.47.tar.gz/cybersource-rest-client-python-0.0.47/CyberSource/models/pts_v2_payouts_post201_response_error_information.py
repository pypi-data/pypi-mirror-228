...
class PtsV2PayoutsPost201ResponseErrorInformation(object):
    """
    ...
    def __init__(self, reason=None, message=None, details=None):
        """
        PtsV2PayoutsPost201ResponseErrorInformation - a model defined in Swagger
        """
    ...
    def message(self):
        """
        Gets the message of this PtsV2PayoutsPost201ResponseErrorInformation.
        The detail message related to the status and reason listed above.

        :return: The message of this PtsV2PayoutsPost201ResponseErrorInformation.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this PtsV2PayoutsPost201ResponseErrorInformation.
        The detail message related to the status and reason listed above.

        :param message: The message of this PtsV2PayoutsPost201ResponseErrorInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PtsV2PayoutsPost201ResponseErrorInformation):
            return False
