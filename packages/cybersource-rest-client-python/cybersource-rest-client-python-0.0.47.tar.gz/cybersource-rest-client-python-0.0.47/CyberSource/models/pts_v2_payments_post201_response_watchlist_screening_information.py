...
class PtsV2PaymentsPost201ResponseWatchlistScreeningInformation(object):
    """
    ...
    def __init__(self, ip_country_confidence=None, info_codes=None, watch_list=None):
        """
        PtsV2PaymentsPost201ResponseWatchlistScreeningInformation - a model defined in Swagger
        """
    ...
    def info_codes(self):
        """
        Gets the info_codes of this PtsV2PaymentsPost201ResponseWatchlistScreeningInformation.
        ...
        :return: The info_codes of this PtsV2PaymentsPost201ResponseWatchlistScreeningInformation.
        :rtype: list[str]
        """
    ...
    def info_codes(self, info_codes):
        """
        Sets the info_codes of this PtsV2PaymentsPost201ResponseWatchlistScreeningInformation.
        Returned when the Denied Parties List check (first two codes) or the export service (all others) would have declined the transaction. This field can contain one or more of these values: - `MATCH-DPC`: Denied Parties List match. - `UNV-DPC`: Denied Parties List unavailable. - `MATCH-BCO`: Billing country restricted. - `MATCH-EMCO`: Email country restricted. - `MATCH-HCO`: Host name country restricted. - `MATCH-IPCO`: IP country restricted. - `MATCH-SCO`: Shipping country restricted. 

        :param info_codes: The info_codes of this PtsV2PaymentsPost201ResponseWatchlistScreeningInformation.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PtsV2PaymentsPost201ResponseWatchlistScreeningInformation):
            return False
