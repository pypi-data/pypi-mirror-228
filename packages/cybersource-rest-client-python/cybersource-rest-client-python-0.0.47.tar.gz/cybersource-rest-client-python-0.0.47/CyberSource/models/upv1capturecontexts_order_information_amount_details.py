...
class Upv1capturecontextsOrderInformationAmountDetails(object):
    """
    ...
    def __init__(self, total_amount=None, currency=None):
        """
        Upv1capturecontextsOrderInformationAmountDetails - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Upv1capturecontextsOrderInformationAmountDetails):
            return False
