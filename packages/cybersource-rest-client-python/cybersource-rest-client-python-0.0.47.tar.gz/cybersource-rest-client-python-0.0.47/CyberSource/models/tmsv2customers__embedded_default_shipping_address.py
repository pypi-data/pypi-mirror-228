...
class Tmsv2customersEmbeddedDefaultShippingAddress(object):
    """
    ...
    def links(self):
        """
        Gets the links of this Tmsv2customersEmbeddedDefaultShippingAddress.

        :return: The links of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def links(self, links):
        """
        Sets the links of this Tmsv2customersEmbeddedDefaultShippingAddress.

        :param links: The links of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def ship_to(self):
        """
        Gets the ship_to of this Tmsv2customersEmbeddedDefaultShippingAddress.

        :return: The ship_to of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def ship_to(self, ship_to):
        """
        Sets the ship_to of this Tmsv2customersEmbeddedDefaultShippingAddress.

        :param ship_to: The ship_to of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def metadata(self):
        """
        Gets the metadata of this Tmsv2customersEmbeddedDefaultShippingAddress.

        :return: The metadata of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this Tmsv2customersEmbeddedDefaultShippingAddress.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersEmbeddedDefaultShippingAddress):
            return False
