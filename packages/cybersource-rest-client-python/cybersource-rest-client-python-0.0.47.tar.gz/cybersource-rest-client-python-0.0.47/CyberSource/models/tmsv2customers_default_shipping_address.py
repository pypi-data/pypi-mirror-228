...
class Tmsv2customersDefaultShippingAddress(object):
    """
    ...
    def __init__(self, id=None):
        """
        Tmsv2customersDefaultShippingAddress - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersDefaultShippingAddress):
            return False
