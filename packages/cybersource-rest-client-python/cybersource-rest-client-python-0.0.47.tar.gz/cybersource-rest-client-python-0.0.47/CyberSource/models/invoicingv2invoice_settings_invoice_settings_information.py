...
class Invoicingv2invoiceSettingsInvoiceSettingsInformation(object):
    """
    ...
    def merchant_logo(self):
        """
        Gets the merchant_logo of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The merchant_logo of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
    ...
    def merchant_logo(self, merchant_logo):
        """
        Sets the merchant_logo of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The image file, which must be encoded in Base64 format. Supported file formats are `png`, `jpg`, and `gif`. The image file size restriction is 1 MB.
    ...
    def merchant_display_name(self):
        """
        Gets the merchant_display_name of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The merchant's display name shown on the invoice.

        :return: The merchant_display_name of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
    ...
    def merchant_display_name(self, merchant_display_name):
        """
        Sets the merchant_display_name of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The merchant's display name shown on the invoice.
    ...
    def custom_email_message(self):
        """
        Gets the custom_email_message of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The content of the email message that we send to your customers.

        :return: The custom_email_message of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
    ...
    def custom_email_message(self, custom_email_message):
        """
        Sets the custom_email_message of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The content of the email message that we send to your customers.
    ...
    def enable_reminders(self):
        """
        Gets the enable_reminders of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The enable_reminders of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: bool
        """
    ...
    def enable_reminders(self, enable_reminders):
        """
        Sets the enable_reminders of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        Whether you would like us to send an auto-generated reminder email to your invoice recipients. Currently, this reminder email is sent five days before the invoice is due and one day after it is past due.

        :param enable_reminders: The enable_reminders of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :type: bool
        """
    ...
    def header_style(self):
        """
        Gets the header_style of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.

        :return: The header_style of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
    ...
    def header_style(self, header_style):
        """
        Sets the header_style of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.

        :param header_style: The header_style of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
    ...
    def delivery_language(self):
        """
        Gets the delivery_language of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The delivery_language of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
    ...
    def delivery_language(self, delivery_language):
        """
        Sets the delivery_language of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        The language of the email that we send to your customers. Possible values are `zh-CN`, `zh-TW`, `en-US`, `fr-FR`, `de-DE`, `ja-JP`, `pt-BR`, `ru-RU` and `es-419`.
    ...
    def default_currency_code(self):
        """
        Gets the default_currency_code of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The default_currency_code of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
    ...
    def default_currency_code(self, default_currency_code):
        """
        Sets the default_currency_code of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        Currency used for the order. Use the three-character [ISO Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)  #### Used by **Authorization** Required field.  **Authorization Reversal** For an authorization reversal (`reversalInformation`) or a capture (`processingOptions.capture` is set to `true`), you must use the same currency that you used in your payment authorization request.  #### PIN Debit Currency for the amount you requested for the PIN debit purchase. This value is returned for partial authorizations. The issuing bank can approve a partial amount if the balance on the debit card is less than the requested transaction amount. For the possible values, see the [ISO Standard Currency Codes](https://developer.cybersource.com/library/documentation/sbc/quickref/currencies.pdf). Returned by PIN debit purchase.  For PIN debit reversal requests, you must use the same currency that was used for the PIN debit purchase or PIN debit credit that you are reversing. For the possible values, see the [ISO Standard Currency Codes](https://developer.cybersource.com/library/documentation/sbc/quickref/currencies.pdf).  Required field for PIN Debit purchase and PIN Debit credit requests. Optional field for PIN Debit reversal requests.  #### GPX This field is optional for reversing an authorization or credit.  #### DCC for First Data Your local currency. For details, see the `currency` field description in [Dynamic Currency Conversion For First Data Using the SCMP API](http://apps.cybersource.com/library/documentation/dev_guides/DCC_FirstData_SCMP/DCC_FirstData_SCMP_API.pdf).  #### Tax Calculation Required for international tax and value added tax only. Optional for U.S. and Canadian taxes. Your local currency. 
    ...
    @property
    def payer_authentication_in_invoicing(self):
        """
        Gets the payer_authentication_in_invoicing of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The payer_authentication_in_invoicing of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        :rtype: str
        """
        return self._payer_authentication_in_invoicing

    @payer_authentication_in_invoicing.setter
    def payer_authentication_in_invoicing(self, payer_authentication_in_invoicing):
        """
        Sets the payer_authentication_in_invoicing of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        For a merchant's invoice payments, enable 3D Secure payer authentication version 1, update to 3D Secure version 2, or disable 3D Secure. Possible values are:  - `enable` - `update` - `disable`  
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Invoicingv2invoiceSettingsInvoiceSettingsInformation):
            return False
