...
class InvoicingV2InvoicesAllGet502Response(object):
    """
    ...
    def __init__(self, submit_time_utc=None, status=None, reason=None, message=None):
        """
        InvoicingV2InvoicesAllGet502Response - a model defined in Swagger
        """
    ...
    def status(self):
        """
        Gets the status of this InvoicingV2InvoicesAllGet502Response.
        The status of the submitted transaction.  Possible values:  - SERVER_ERROR 

        :return: The status of this InvoicingV2InvoicesAllGet502Response.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this InvoicingV2InvoicesAllGet502Response.
        The status of the submitted transaction.  Possible values:  - SERVER_ERROR 
    ...
    def message(self):
        """
        Gets the message of this InvoicingV2InvoicesAllGet502Response.
        The detail message related to the status and reason listed above.

        :return: The message of this InvoicingV2InvoicesAllGet502Response.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this InvoicingV2InvoicesAllGet502Response.
        The detail message related to the status and reason listed above.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InvoicingV2InvoicesAllGet502Response):
            return False
