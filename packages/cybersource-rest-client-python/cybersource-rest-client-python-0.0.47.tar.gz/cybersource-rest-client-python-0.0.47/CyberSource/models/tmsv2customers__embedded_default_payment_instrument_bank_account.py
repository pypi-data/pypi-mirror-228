...
class Tmsv2customersEmbeddedDefaultPaymentInstrumentBankAccount(object):
    """
    ...
    def __init__(self, type=None):
        """
        Tmsv2customersEmbeddedDefaultPaymentInstrumentBankAccount - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersEmbeddedDefaultPaymentInstrumentBankAccount):
            return False
