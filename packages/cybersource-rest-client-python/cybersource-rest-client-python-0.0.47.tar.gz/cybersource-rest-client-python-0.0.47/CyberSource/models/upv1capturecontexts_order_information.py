...
class Upv1capturecontextsOrderInformation(object):
    """
    ...
    def __init__(self, amount_details=None, bill_to=None, ship_to=None):
        """
        Upv1capturecontextsOrderInformation - a model defined in Swagger
        """
    ...
    def amount_details(self):
        """
        Gets the amount_details of this Upv1capturecontextsOrderInformation.

        :return: The amount_details of this Upv1capturecontextsOrderInformation.
        :rtype: Upv1capturecontextsOrderInformationAmountDetails
        """
    ...
    def amount_details(self, amount_details):
        """
        Sets the amount_details of this Upv1capturecontextsOrderInformation.

        :param amount_details: The amount_details of this Upv1capturecontextsOrderInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Upv1capturecontextsOrderInformation):
            return False
