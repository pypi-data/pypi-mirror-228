...
class ContextApi(object):
    ...
    def delete_context_opaque_with_http_info(self, **kwargs):
        ...
        all_params = ['item_id', 'opaque_id', 'delete']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_context(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_context(item_id=item_id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str item_id: Returns context associated with this Item ID (required)
        :param list[str] datum_id: If specified, only context that are also associated with this specific datumId will be returned
        :param bool archived: If true, returns only archived context. If false, returns non-archived comments.
        :return: ContextOutputListV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ContextOutputListV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_context_with_http_info(**kwargs)
        else:
            (data) = self.get_context_with_http_info(**kwargs)
            return data

    def get_context_with_http_info(self, **kwargs):
        """
        Get all context associated with an Item or with a specific datum of that Item
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_context_with_http_info(item_id=item_id_value, callback=callback_function)
        ...
        all_params = ['item_id', 'datum_id', 'archived']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'item_id' is set
        if ('item_id' not in params) or (params['item_id'] is None):
            raise ValueError("Missing the required parameter `item_id` when calling `get_context`")
        ...
        if 'datum_id' in params:
            ...
            collection_formats['datumId'] = 'multi'
        ...
        return self.api_client.call_api('/context/{itemId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type=params.get('_response_type', 'ContextOutputListV1'),
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
