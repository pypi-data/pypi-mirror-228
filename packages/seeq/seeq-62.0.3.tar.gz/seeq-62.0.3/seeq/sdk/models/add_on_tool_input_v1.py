...
class AddOnToolInputV1(object):
    ...
    def __init__(self, description=None, icon_class=None, in_development=False, link_type=None, name=None, reuse_window=False, sort_key=None, target_url=None, window_details=None):
        """
