...
class ContextLabelOutputV1(object):
    ...
    def __init__(self, archived=None, context=None, context_id=None, created_at=None, creator_id=None, datum_id=None, item_id=None, label=None, label_category_id=None, updated_at=None):
        """
