...
class FormulaRunInputV1(object):
    ...
    def __init__(self, end=None, formula=None, fragments=None, function=None, limit=None, offset=None, parameters=None, reduce_formula=None, root=None, start=None, time_format=None):
        """
