...
class TableDefinitionInputV1(object):
    ...
    def __init__(self, column_definitions=None, data_id=None, datasource_class=None, datasource_id=None, description=None, name=None, scoped_to=None, subscription_id=None):
        """
