...
class ItemFinderOutputV1(object):
    ...
    def __init__(self, cron_schedule=None, description=None, effective_permissions=None, enabled=None, executor_id=None, finder_configurations=None, id=None, is_archived=False, is_redacted=False, last_run_warnings=None, name=None, status_message=None, translation_key=None, type=None):
        """
    ...
    def finder_configurations(self):
        """
        Gets the finder_configurations of this ItemFinderOutputV1.
        The list of configurations for finding items

        :return: The finder_configurations of this ItemFinderOutputV1.
    ...
    def finder_configurations(self, finder_configurations):
        """
        Sets the finder_configurations of this ItemFinderOutputV1.
        The list of configurations for finding items

        :param finder_configurations: The finder_configurations of this ItemFinderOutputV1.
