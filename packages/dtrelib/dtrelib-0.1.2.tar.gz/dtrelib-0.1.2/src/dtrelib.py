...
class ResultSetStream(object):
    ...
    def getRecordWithPromote(self):
        ...
        if self.curLogFileIdx in range(0, len(self.logFiles)):
            ...
            if rs.rowCount > 0 and self.curRow < rs.rowCount:
                row = rs.data[self.curRow]
                self.curRow += 1
                return row, True
            else:
                ...
                if self.curLogFileIdx < len(self.logFiles):
                    ...
                    if rs and rs.rowCount > 0:
                        ...
                        return rs.data[0], False  # а вернуть при этом самую первую (нулевую)
                    else:
                        return None, None
                else:
                    return None, None
...
class Processor(object):
    ...
    def _dump(source_rss, target_rss, data, columns, keyfield, signature):
        ...
        target_rss.query._Query__resultset.data = data
