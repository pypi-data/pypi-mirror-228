...
belongs to a given Board."""),
    ...
    'lino_xl.lib.countries.Plugin.allow_duplicate_cities' : _("""In a default configuration (when allow_duplicate_cities is
...
countries there is a mandatory intermediate field."""),
    'lino_xl.lib.countries.Plugin.region_label' : _("""The verbose_name of the region field."""),
...
but is stored as a Couple instance."""),
    'lino_xl.lib.google.Plugin' : _("""See lino.core.plugin.Plugin."""),
    'lino_xl.lib.google.Plugin.client_secret_file' : _("""The path to the GoogleAPI secret file."""),
    'lino_xl.lib.google.Plugin.scopes' : _("""GoogleAPi Scopes"""),
    'lino_xl.lib.google.Plugin.application_name' : _("""The Application's name defined in the google API Console"""),
...
model."""),
    ...
    'lino_xl.lib.tickets.roles.Triager' : _("""Can modify administrative ticket data like assigned worker, site,
ticket type...."""),
...
that represents a votable in your application."""),
    'lino_xl.lib.votes.Plugin.use_candidatures' : _("""Whether to use votes for implementing a kind of polling: when somebody posts
...
you specified a total amount."""),
    ...
    'lino_xl.lib.bevat.Declaration.write_intracom_statement' : _("""Generate an XML file for the intra-community statement attached to
this VAT declaration."""),
    ...
    'lino_xl.lib.cal.Event.end_date' : _("""The ending date of this calendar entry.
Leave empty for same-day entries."""),
    'lino_xl.lib.cal.Event.start_time' : _("""The starting time.  If this is empty, the entry is considered an
all-day entry."""),
    'lino_xl.lib.cal.Event.end_time' : _("""The ending time.  If this is before the starting time, and no ending
...
rules defined by the workflow."""),
    'lino_xl.lib.cal.Event.owner' : _("""The event generator that generated and controls this
calendar entry."""),
    ...
    'lino_xl.lib.cal.Event.when_html' : _("""Shows the date and time of the calendar entry with a link that
...
button which opens the ConflictingEvents table for this event."""),
    'lino_xl.lib.cal.Event.notify_before' : _("""The multiples of a time unit (notify_unit) before which to send
a notification to the corresponding user."""),
    'lino_xl.lib.cal.Event.notify_unit' : _("""The unit of time to compute before sending a notification. Example
values are: minute, hour, day, week et cetera."""),
    'lino_xl.lib.cal.Event.notified' : _("""Stores a boolean value as an indication of whether the user has been
notified or NOT."""),
...
this generator."""),
    'lino_xl.lib.cal.EventGenerator.get_wanted_auto_events' : _("""Return a tuple of (wanted, unwanted), where
...
for the given calendar entry we (in resolve_conflicts())"""),
...
with increasing times."""),
    ...
    'lino_xl.lib.cal.OverdueAppointments' : _("""Shows overdue appointments, i.e. appointments that happened before today
...
for contracts."""),
    ...
    'lino_xl.lib.contacts.PartnerRelated' : _("""Abstract model mixin for things that are related to one and only one
partner."""),
    'lino_xl.lib.contacts.PartnerRelated.partner' : _("""The recipient of this document. A pointer to
...
Enrolment."""),
    ...
    'lino_xl.lib.finan.PaymentOrder.write_xml' : _("""Write the XML file for the SEPA payment initiation from this payment
order."""),
...
item for which it was called."""),
    ...
    'lino_xl.lib.google.GoogleCalendarSynchronized.get_outward_insert_update_queryset' : _("""This method returns a queryset of Calendar
that are not stored in Google or should be updated."""),
    'lino_xl.lib.google.GoogleCalendarSynchronized.delete_google_calendar' : _("""This method deletes a Calendar at sync time
when the calendar is deleted from the Google calendar."""),
    ...
    'lino_xl.lib.google.GoogleCalendarEventSynchronized.delete_google_event' : _("""This method deletes a Event at sync time
when the event is deleted from the Google calendar."""),
    ...
    'lino_xl.lib.google.GoogleCalendarEventSynchronized.get_outward_insert_update_queryset' : _("""This method yields Event (s)
which are not stored in Google or should be updated."""),
    ...
    'lino_xl.lib.google.GoogleCalendarEventSynchronized.insert_or_update_google_event' : _("""Inserts or updates a calendar Event and related
Room and Guest 's."""),
    ...
    'lino_xl.lib.google.CalendarSubscription.modified' : _("""Keeps the last modification timestamp."""),
    'lino_xl.lib.google.CalendarSubscription.primary' : _("""A boolean field which indicated whether calendar referenced in this
subscription is the primary calendar for the user in Google."""),
    ...
    'lino_xl.lib.google.CalendarSubscription.sync_token' : _("""Token given by Google to sync later Event
entries on the subscribed calendar."""),
    'lino_xl.lib.google.CalendarSubscription.page_token' : _("""Whether the sync_token is a nextSyncToken or a nextPageToken."""),
    'lino_xl.lib.google.DeletedEntry' : _("""Keeps a record of the natively deleted Calendar
or Event for deleting from Google when
the next sync is run."""),
    'lino_xl.lib.google.DeletedEntry.calendar' : _("""A boolean field which says whether the deleted item is a Calendar if not it is
an Event."""),
    'lino_xl.lib.google.DeletedEntry.event_id' : _("""Takes the value of the Event.google_id
when the deleted record is an Event
otherwise an empty string."""),
    'lino_xl.lib.google.DeletedEntry.calendar_id' : _("""Takes the value of the Calendar.google_id"""),
    'lino_xl.lib.invoicing.InvoicingTargetVoucher' : _("""Mixin for Django models that can be used as
invoicing.voucher_model."""),
    'lino_xl.lib.invoicing.InvoicingTargetItem.invoiceable' : _("""A generic foreign key pointing to the generator that caused this
item to be generated."""),
    ...
    'lino_xl.lib.invoicing.InvoiceGenerator.get_invoiceable_event_formatter' : _("""Return a callable that formats an invoicing event as an HTML
etree element."""),
    'lino_xl.lib.invoicing.InvoiceGenerator.get_generators_for_plan' : _("""Return a queryset of the database objects (of this model) that
potentially will generate an invoice item."""),
    ...
    'lino_xl.lib.invoicing.InvoiceGenerator.get_invoiceable_product' : _("""Return the product to put into
the generated invoice item."""),
    ...
    'lino_xl.lib.invoicing.InvoiceGenerator.invoicings' : _("""A GenericRelation
to all invoice items pointing to this
invoiceable."""),
    'lino_xl.lib.invoicing.InvoiceGenerator.get_invoicings' : _("""Get a queryset with the invoicings that point to this
invoiceable."""),
...
According to the invoice's voucher_date."""),
    'lino_xl.lib.invoicing.InvoiceGenerator.allow_group_invoices' : _("""Whether this is a grouping generator, i.e. the invoicings of which can
be grouped together with those of other invoice generators into a same
invoice."""),
    'lino_xl.lib.invoicing.InvoicingInfo' : _("""A volatile object in memory that holds information about a given
invoicing event."""),
...
generated."""),
    ...
    'lino_xl.lib.invoicing.SalesRules' : _("""Shows the list of sales rules."""),
    ...
    'lino_xl.lib.invoicing.Tariff.min_asset' : _("""The minimum number of invoicing events a
customer should pay in advance."""),
    'lino_xl.lib.invoicing.Tariff.max_asset' : _("""Maximum quantity of invoicing events to allow
per invoicing."""),
    ...
    'lino_xl.lib.invoicing.Plan.invoicing_state' : _("""The invoicing state for which this plan is to generate invoices."""),
    'lino_xl.lib.invoicing.Plan.target_journal' : _("""The journal into which invoices will be generated."""),
...
to the generated invoice."""),
    ...
    'lino_xl.lib.invoicing.Area' : _("""The Django model used to represent an invoicing area."""),
    'lino_xl.lib.invoicing.Area.journal' : _("""The journal into which invoices are to be generated."""),
    'lino_xl.lib.ledger.LedgerPartner' : _("""Can see transactions related to their partner account."""),
    'lino_xl.lib.ledger.AccountingReader' : _("""Can read all accounting data and create reports,
but cannot change any relevant data."""),
    'lino_xl.lib.ledger.LedgerUser' : _("""Can see all journals, create vouchers of any kind, can see vouchers of other
users but cannot edit them."""),
    'lino_xl.lib.ledger.VoucherSupervisor' : _("""Can edit vouchers that have been written by other users."""),
    'lino_xl.lib.ledger.LedgerStaff' : _("""Can configure ledger functionality."""),
...
CommonAccounts."""),
    ...
    'lino_xl.lib.ledger.Account.default_amount' : _("""The default amount to book in bank statements or journal entries when
this account has been selected manually. The default booking
direction is that of the type."""),
...
that will report the movements of this account."""),
    ...
    'lino_xl.lib.ledger.CommonAccounts.waiting' : _("""The waiting account, used to temporarily book movements for which you
do not know where to book them."""),
    'lino_xl.lib.ledger.CommonAccounts.undeclared_costs' : _("""Used to books costs that will be reculated internally and are irrelevant
...
following items:"""),
    ...
    'lino_xl.lib.ledger.Voucher.state' : _("""The workflow state (voucher state) of this voucher."""),
...
lino_xl.lib.contacts.PartnerRelated vouchers."""),
...
list of unsaved Movement instances."""),
    ...
    'lino_xl.lib.ledger.RegistrableVoucher.hide_editable_number' : _("""Whether to hide the number that will be used for this voucher in its journal
...
vouchers should restart at 1 every year."""),
    'lino_xl.lib.ledger.Journal.make_ledger_movements' : _("""Whether vouchers in this journal generate ledger movements."""),
...
vouchers in this journal."""),
    'lino_xl.lib.ledger.Journal.partner' : _("""The partner to use as default partner for vouchers in this journal."""),
    'lino_xl.lib.ledger.Journal.must_declare' : _("""Whether movements made by this journal should be included in VAT
declarations."""),
    'lino_xl.lib.ledger.Journal.dc' : _("""The primary booking direction. Voucher items in this direction
increase the total amount of the voucher."""),
    'lino_xl.lib.ledger.Journal.auto_check_clearings' : _("""Whether to automatically check and update the 'cleared' status of ledger
...
follows:"""),
    ...
    'lino_xl.lib.ledger.PaymentMethod.payment_account' : _("""Which ledger account to book."""),
    'lino_xl.lib.ledger.PaymentMethod.is_cash' : _("""Whether this is considered a cash payment."""),
...
Inherits from DebtorsCreditors."""),
    'lino_xl.lib.ledger.TradeTypes' : _("""The choicelist with the trade types defined for this application."""),
...
movements in the ledger."""),
    'lino_xl.lib.ledger.VoucherStates.cancelled' : _("""The Cancelled state is similar to Draft, except that you cannot edit
...
this movement."""),
    'lino_xl.lib.ledger.PaymentRelated' : _("""This is base class for both (1) trade document vouchers
(e.g. invoices or offers) and (2) for the individual entries of
financial vouchers and ledger movements."""),
    'lino_xl.lib.ledger.PaymentRelated.payment_term' : _("""The payment terms to be used in this document.  A pointer to
PaymentTerm."""),
...
and returns the first one that applies."""),
    ...
    'lino_xl.lib.publisher.PublisherViews' : _("""A choicelist with the publisher views available on this site."""),
    'lino_xl.lib.publisher.PublisherBuildMethod' : _("""This deserves better documentation."""),
    'lino_xl.lib.publisher.Publishable' : _("""This deserves better documentation."""),
    'lino_xl.lib.publisher.PreviewPublication' : _("""This deserves better documentation."""),
...
report."""),
    'lino_xl.lib.vat.VatRegime' : _("""Base class for the items of VatRegimes.  Each VAT regime is
an instance of this and has two properties:"""),
    ...
    'lino_xl.lib.vat.VatRegime.item_vat' : _("""No longer used. See vat.item_vat instead."""),
    'lino_xl.lib.vat.VatRegime.needs_vat_id' : _("""Whether this VAT regime requires that partner to have a
vat_id."""),
    'lino_xl.lib.vat.VatRegimes' : _("""The global list of VAT regimes.  Each item of this list
is an instance of VatRegime."""),
...
vat_returnable_account. See Returnable VAT."""),
...
account. See Returnable VAT."""),
    ...
    'lino_xl.lib.vat.InvoicesByJournal' : _("""Shows all invoices of a given journal. Works only when the
voucher_type of the
specified master instance is VatAccountInvoice."""),
...
IntracomPurchases"""),
    'lino_xl.lib.vat.VatSubjectable' : _("""Model mixin that defines the database fields vat_regime and
vat_id, and adds related behaviour."""),
    ...
    'lino_xl.lib.vat.VatTotal' : _("""Model mixin that defines the database fields total_incl,
...
disabled, so this method will never be called."""),
    ...
    'lino_xl.lib.vat.VatDocument.edit_totals' : _("""Whether the user wants to edit the total amounts of the voucher."""),
...
VatItemBase by adding unit_price and qty."""),
    ...
    'lino_xl.lib.vat.VatDeclaration.intracom_statement_iterator' : _("""Yield a list of lino_xl.lib.contacts.Partner objects, annotated
with a field total_base that contains the sum of intra-community
...
tax office."""),
    ...
    'lino_xl.lib.votes.Vote' : _("""Django model for representing a vote.
...
must resolve using resolve_states."""),
    ...
    'lino_xl.lib.votes.VoteStates' : _("""The list of possible states of a vote.  This is used as choicelist for the
state field of a vote."""),
...
get_vote_raters)."""),
    ...
    'lino_xl.lib.votes.Votable' : _("""This model mixin adds two workflow actions ☆ and ★, which are mutually
exclusive."""),
...
The default configuration has "AM", "PM" and "All day"."""),
    ...
    'lino_xl.lib.calview.DayNavigator' : _("""Base class for the three calendar views, but also used for independent
...
Checking this field will automatically disable any other primary memberships."""),
    ...
    'lino_xl.lib.humanlinks.Link.check_autocreate' : _("""Check whether there is a human link of type "parent" between the given
...
same sex, then it becomes a foster child, otherwise a natural child."""),
    'lino_xl.lib.humanlinks.LinkTypes' : _("""The global list of human link types.  This is used as choicelist for the
Link.type field of a human link."""),
...
father (mother). [thefreedictionary]"""),
    'lino_xl.lib.humanlinks.LinkType.symmetric' : _("""Whether this link is symmetric (i.e. text is the same for both directions).
...
version."""),
    'lino_xl.lib.tickets.Ticket.order' : _("""The business document used by both partners as reference for invoicing
this ticket."""),
    'lino_xl.lib.tickets.Ticket.site' : _("""The site this ticket belongs to.
You can select only sites you are subscribed to."""),
    'lino_xl.lib.tickets.Ticket.ticket_type' : _("""The type of this ticket. The site manager can configure the list
...
site.  See ReportingTypes."""),
    'lino_xl.lib.tickets.Ticket.quick_assign_to' : _("""Show the site user who is assigned to work on this ticket, along
...
See :class:ReportingTypes`."""),
    ...
    'lino_xl.lib.tickets.Tickets.show_todo' : _("""Show only (or hide) tickets that are todo (i.e. state is New
or ToDo)."""),
...
after the first day of this month or year."""),
    'lino_xl.lib.working.SessionType' : _("""Django model representing the type of a work session."""),
...
on the ticket."""),
    'lino_xl.lib.working.Session.duration' : _("""The duration of this session as a Duration."""),
...
This will simply set the end_time to the current time."""),
    ...
    'lino_xl.lib.working.MySessionsByDate' : _("""Shows my sessions of a given day."""),
...
created or modified."""),
    'lino_xl.lib.working.Workable.start_session' : _("""Start a work session on this ticket."""),
...
This will simply set the Session.end_time to the current time."""),
    'lino_xl.lib.working.ShowMySessionsByDay' : _("""Shows your work sessions per day."""),
