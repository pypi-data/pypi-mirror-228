...
class DwUnifiedLLM(LLM):
    client: Any
    model_key: str = "alibaba.qwen-plus-v1"
    api_key: str = "dw-BBAa68XBJUqiIj6xUQcC0KREnqmt5mPKQ52wkylD-Tw"
    api_base: str = "https://dwai.shizhuang-inc.com"
    api_base_singapore: str = "https://openai.shizhuang-inc.com"

    def __init__(self, model_key: str, api_key: str, api_base: str ="https://dwai.shizhuang-inc.com", api_base_singapore: str = "https://openai.shizhuang-inc.com", **kwargs: Any):
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        try:
            response = self.client.call(self.model_key, prompt=prompt)
