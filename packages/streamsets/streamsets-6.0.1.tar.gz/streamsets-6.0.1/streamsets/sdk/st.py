...
class Transformer:
    ...
    def __init__(self,
        ...
        if self.server_url:
            ...
            self.api_client = st_api.ApiClient(server_url=current_server_url,
    ...
    def get_pipeline_builder(self, **kwargs):
        ...
        if not self._pipeline:
            ...
            if not fragment:
                ...
                create_pipeline_response = self.api_client.create_pipeline_fragment(pipeline_fragment_title=title,
    ...
    def validate_pipeline(self, pipeline, **kwargs):
        ...
        validate_command = self.api_client.validate_pipeline(pipeline_id=pipeline.id,
                                                             ...
                                                             remote=using_configured_cluster_manager).wait_for_validate(
