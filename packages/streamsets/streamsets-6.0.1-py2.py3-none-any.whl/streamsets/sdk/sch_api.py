...
class ApiClient(object):
    ...
    def validate_engine_pipeline(self, engine_id, pipeline_id, tunneling_instance_id, rev=0, timeout=2000):
        ...
        response = self._get_via_tunneling(endpoint=endpoint, tunneling_instance_id=tunneling_instance_id,
    ...
    def import_pipelines(self, commit_message, pipelines_file, fragments, fail_if_exists=False, import_as_new=False,
                         remove_missing_connection=False):
    ...
    def verify_import_pipelines(self, commit_message, pipelines_file, fragments=False, fail_if_exists=False,
                                import_as_new=False):
    ...
    def get_snowflake_generated_queries(self, job_id, run_count, len=-1, offset=0, order='DESC'):
        ...
        response = self._get(app='jobrunner',
                             endpoint='/v{}/snowflakeQueries'.format(self.api_version),
                             params=params)
        return Command(self, response)
    ...
    def return_all_jobs(self, organization, offset=None, len=None, order_by='NAME', order='ASC', removed=False,
                        system=False, filter_text=None, job_search_operation='EQUALS', job_search_text=None,
                        job_status=None, job_label=None, edge=False, executor_type=None, job_status_color=None,
                        job_tag=None, with_wrapper=False, job_template=None, template_job_id=None, archived=False,
                        draft_run=False):
    ...
    def return_all_job_labels(self):
        ...
        """
        response = self._get(app='jobrunner',
                             endpoint='/v{}/jobs/labels'.format(self.api_version))
        return Command(self, response)

    def get_jobs_by_status(self, organization, offset=None, len=None, order_by='NAME', order='ASC', removed=False,
                           system=False, filter_text=None, job_search_operation='EQUALS', job_search_text=None,
                           job_status=None, edge=False, executor_type=None, job_tag=None, with_wrapper=False):
    ...
    def get_active_jobs(self, organization, pipeline_commit_id, offset=None, len=None, order_by='NAME', order='ASC',
                        template_job_id=None, job_template=None, draft_run=False, with_wrapper=False):
    ...
    def get_job_run_logs(self, job_id, run_count, len=-1, offset=0, order='DESC'):
        ...
        params = get_params(parameters=locals(), exclusions=('self', ))
        response = self._get(app='jobrunner',
                             endpoint='/v{}/job/logMessages'.format(self.api_version),
                             params=params)
        return Command(self, response)
    ...
    def create_jobs(self, body):
        ...
        """
        response = self._put(app='jobrunner',
                             endpoint='/v{}/jobs/createJobs'.format(self.api_version),
                             data=body)
        return Command(self, response)
    ...
    def create_and_start_job_instances_async(self, template_job_id, body, inherit_permissions=False):
        ...
        params = get_params(parameters=locals(), exclusions=('self', 'template_job_id', 'body'))
        response = self._post(app='jobrunner',
                              endpoint='/v{}/job/{}/createAndStartJobInstancesAsync'.format(self.api_version,
                                                                                            template_job_id),
                              data=body,
                              params=params)
        return Command(self, response)
    ...
    def import_jobs_from_json(self, body, force_import=False, update_pipeline_refs=True, update_num_instances=False,
                              update_runtime_parameters=False, update_labels=False, update_migrate_offsets=True):
        ...
        params = get_params(parameters=locals(), exclusions=('self', 'body'))
        response = self._post(app='jobrunner',
                              endpoint='/v{}/jobs/importJobsFromJson'.format(self.api_version),
                              data=body,
                              params=params)
        return Command(self, response)
    ...
    def get_draft_run_job_for_pipeline_id(self, pipeline_id):
        ...
        params = get_params(parameters=locals(), exclusions=('self', ))
        response = self._get(app='jobrunner',
                             endpoint='/v{}/jobs/draftRunJobForPipelineId'.format(self.api_version),
                             params=params)
        return Command(self, response)
    ...
    def validate_access_to_job(self, job_id):
        ...
        """
        response = self._get(app='jobrunner',
                             endpoint='/v{}/{}/validateAccess'.format(self.api_version, job_id))
        return Command(self, response)
    ...
    def get_all_registered_engines(self, organization, executor_type, edge, label, version, offset, len_, order_by,
    ...
    def delete_non_registered_components(self, organization, executor_type):
        ...
        """
        response = self._post(app='security',
                              endpoint='/v{}/organization/{}/components/deleteNonRegistered/{}'.format(self.api_version,
                                                                                                       organization,
                                                                                                       executor_type))
        return Command(self, response)
    ...
    def get_draft_run_logs(self, engine_id, engine_pipeline_id, tunneling_instance_id, ending_offset=-1):
        ...
        response = self._get_via_tunneling(endpoint=endpoint,
    ...
    def get_draft_run_snapshots(self, engine_id, engine_pipeline_id, job_id, tunneling_instance_id, job_run_count=1):
        ...
        Returns:
            An instance of :py:class:`streamsets.sdk.sch_api.Command`.
        """
        params = get_params(parameters=locals(), exclusions=('engine_id',
                                                             'engine_pipeline_id',
                                                             'tunneling_instance_id',
                                                             'self'))
    ...
    def get_snapshot_data(self, engine_id, engine_pipeline_id, snapshot_id, job_id, tunneling_instance_id,
                          job_run_count=1):
        """Get snapshot data.
    ...
    def generate_snapshot(self, engine_id, engine_pipeline_id, snapshot_label, tunneling_instance_id, batch_size=50000):
        ...
        response = self._put_via_tunneling(endpoint=endpoint,
                                           tunneling_instance_id=tunneling_instance_id,
                                           engine_id=engine_id,
                                           params=params)
        return Command(self, response)
    ...
    def remove_snapshot(self, engine_id, engine_pipeline_id, snapshot_id, tunneling_instance_id, job_run_count=1):
        ...
        params = get_params(parameters=locals(), exclusions=('engine_id',
                                                             ...
                                                             'self'))
        endpoint = 'v{}/pipeline/{}/snapshot/{}'.format(self.api_version, engine_pipeline_id, snapshot_id)
        response = self._delete_via_tunneling(endpoint=endpoint,
                                              tunneling_instance_id=tunneling_instance_id,
                                              engine_id=engine_id,
                                              params=params)
        return Command(self, response)
    ...
    def import_topologies(self, topologies_file, force_import=False, update_num_instances=False,
                          update_runtime_parameters=False, update_labels=False, update_migrate_offsets=False):
    ...
    def get_metering_event(self, order_by=None, order=None, page=None, size=None, search=None, with_wrapper=False):
        ...
        params = get_params(parameters=locals(), exclusions=('self', ))
        response = self._get(app='metering',
                             endpoint='v{}/event'.format(self.metering_api_version),
                             params=params)
        return Command(self, response)

    def get_metering_record_count_events(self, order_by=None, order=None, page=None, size=None, search=None,
                                         with_wrapper=False):
        ...
        params = get_params(parameters=locals(), exclusions=('self', ))
        response = self._get(app='metering',
                             endpoint='v{}/record-count/event'.format(self.metering_api_version),
                             params=params)
        return Command(self, response)
    ...
    def set_labels_to_pipelines(self, labels, pipeline_commit_ids):
        ...
        params = get_params(parameters=locals(), exclusions=('self',))
        response = self._post(app='pipelinestore',
                              endpoint='/v{}/pipelines/setLabelsToPipelines'.format(self.api_version),
                              params=params)
        return Command(self, response)
    ...
    def set_engine_acl(self, engine_id, engine_acl_json):
        ...
        """
        response = self._post(app='jobrunner',
                              endpoint='/v{}/sdc/{}/acl'.format(self.api_version, engine_id),
                              data=engine_acl_json)
        return Command(self, response)
    ...
    def update_scheduled_task(self, data, id, api_version):
        ...
        response = self._post(app='scheduler',
                              endpoint='/v{}/jobs/{}/pageId={}'.format(api_version, id, page_id),
                              data=data)
        return Command(self, response)
    ...
    def perform_bulk_action_on_scheduled_tasks(self, task_ids, action, api_version):
        ...
        pageId = 'SchedulerJobListPage'
        response = self._post(app='scheduler',
                              endpoint='/v{}/jobs/o:action/pageId={}'.format(api_version, pageId),
                              params=params)
        return Command(self, response)
    ...
    def get_all_current_metrics_engines(self, job_id, sdc_id=None):
        ...
        params = get_params(parameters=locals(), exclusions=('self', 'job_id'))
        response = self._get(app='timeseries',
                             endpoint='/v{}/metrics/job/{}/getAllMetricsEngines'
                             .format(self.api_version, job_id),
                             params=params)
        return Command(self, response)
    ...
    def get_kubernetes_agent_versions(self, releases_only=None, disabled_filter='ONLY_ALLOWED', offset=None, len=None,
        ...
        params = get_params(parameters=locals(), exclusions=('self',))
        response = self._get(app='provisioning',
                             endpoint='/v{}/csp/kubernetes/agentVersions'.format(self.api_version),
                             params=params)
        return Command(self, response)
    ...
    def wait_for_kubernetes_environment_agent_status(self, environment_id, agent_status, timeout_sec=900):
        ...
        logger.debug('Environment with id %s waiting for agent status %s ...', environment_id,
                     agent_status)
    ...
    def get_deployment_events(self, deployment_id, source_type=None, source_id=None, hostname=None,
                              offset=None, len=None, order='ASC'):
    ...
    def get_all_engine_versions(self, offset=None, len=None, order_by='CREATE_TIME', order='ASC',
                                ...
                                designer=False, releases_only=False):
    ...
    def add_external_resource_to_engine(self, engine_id, resource, tunneling_instance_id):
        ...
        response = self._post_via_tunneling(endpoint=endpoint,
                                            engine_id=engine_id,
                                            tunneling_instance_id=tunneling_instance_id,
                                            form_data='formData',
    ...
    def start_streamflake_explorer_search(self, pipeline_id, rev, stage_id, element='', extra_depth=0,
                                          fixed_params=None, len_=100, offset=0, search='', up_truncate=False,
                                          timeout=60000):
    ...
    def expire_free_trial_orgs(self):
        ...
        """
        response = self._post(app='security',
                              endpoint='/v{}/organizations/expireFreeTrial'.format(self.api_version))
        return Command(self, response)
    ...
    def _delete_via_tunneling(self, endpoint, tunneling_instance_id, rest='rest', tunneling='tunneling', engine_id=None,
                              params=None):
        url = join_url_parts(self.base_url, '/{}'.format(tunneling), '/{}'.format(rest), '/{}'.format(engine_id),
                             '/{}'.format(rest), endpoint)
        if params is None:
            params = {}
        # DataOps Platform's APIs use an unconventional parameter for tunneling instance ID that doesn't conform to the
    ...
    def _get_via_tunneling(self, endpoint, tunneling_instance_id, rest='rest', tunneling='tunneling', engine_id=None,
                           params=None):
        url = join_url_parts(self.base_url, '/{}'.format(tunneling), '/{}'.format(rest), '/{}'.format(engine_id),
                             '/{}'.format(rest), endpoint)
        if params is None:
    ...
    def _post(self, endpoint, app=None, rest='rest', params=None, data=None, files=None, headers=None,
    ...
    def _post_via_tunneling(self, endpoint, tunneling_instance_id, rest='rest', tunneling='tunneling',
                            form_data=None, params=None, data=None, files=None, headers=None, engine_id=None):
    ...
    def _put_via_tunneling(self, endpoint, tunneling_instance_id, rest='rest', tunneling='tunneling', engine_id=None,
        ...
        while time() < stop_waiting_time:
            ...
            if current_status not in ['VALIDATING', 'RUNNING']:
                if current_status != 'VALID':
                    if engine_id:
                        preview = self.api_client.get_pipeline_preview_data(engine_id=engine_id,
                                                                            pipeline_id=self.pipeline_id,
                                                                            previewer_id=self.previewer_id,
                                                                            tunneling_instance_id=tunneling_instance_id)
                    else:
    ...
    def wait_for_pipelines(self, timeout_sec=300):
        ...
        for job in self.jobs:
            ...
            if job.executor_type != 'SNOWPARK':
                ...
                logger.debug('Waiting for job %s to start successfully ...', job.job_name)
                wait_for_condition(snowflake_pipeline_started, [job], timeout=timeout_sec, success=success, failure=failure)
