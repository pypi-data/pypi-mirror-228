...
def imap(func: callable, args: typing.Iterable, maxsize: int=None):
    """
    ** Same as multiprocessing.pool.ThreadPool.imap but with a limited output buffer. **
    ...
    Examples
    --------
    >>> from cutcutcodec.core.optimisation.parallel.buffer import imap
    ...
    >>>
    """
    assert hasattr(args, "__iter__"), args.__class__.__name__
    yield from starimap(func, ((a,) for a in args), maxsize)


def starimap(func: callable, args: typing.Iterable, maxsize: int=None):
    """
    ** Like ``cutcutcodec.core.optimisation.parallel.imap`` with stared args. **
    """
