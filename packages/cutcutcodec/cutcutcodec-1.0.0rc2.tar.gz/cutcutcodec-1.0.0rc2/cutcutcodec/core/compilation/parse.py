...
def parse_to_number(number: typing.Union[str, numbers.Real]) -> typing.Union[Fraction, float]:
    """
    ** Converts the number into fraction, or inf float. **
...
def parse_to_sympy(
    expr: typing.Union[str, Basic, numbers.Complex], symbols: dict[str, Symbol]=None
) -> Basic:
    """
