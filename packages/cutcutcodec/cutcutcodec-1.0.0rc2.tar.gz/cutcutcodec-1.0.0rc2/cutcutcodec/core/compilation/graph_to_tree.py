...
def update_trees(graph: networkx.MultiDiGraph) -> None:
    ...
    ** Updates on each node the ``tree`` attribute. **
    ...
    ...     FilterSubclip(GeneratorAudioNoise.default().out_streams, 1, 2).out_streams
    ... )
    >>> graph = tree_to_graph(container_out)
    >>> update_trees(graph)
    >>> pprint(dict(graph.nodes("cache"))) # doctest: +ELLIPSIS
    {'container_output_1': ('49fa7995df7857e129f7fd01b638064e',
                            {'tree': <cutcutcodec.core.classes.container.ContainerOutput...>}),
     'filter_subclip_1': ('f1e40111262c46a22c2200a9dd45d986',
                          {'tree': <cutcutcodec.core.filters.basic.meta.subclip.FilterSubclip...>}),
    ...
    [('filter_subclip_1',
      'container_output_1',
      '0->0',
      {'cache': ('f1e40111262c46a22c2200a9dd45d986|0',
                 {'tree': <cutcutcodec.core.filters.basic.cut._StreamAudioCut...>})}),
