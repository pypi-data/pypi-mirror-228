...
"""
** Properties of a ``cutcutcodec.core.filters.equation.FilterVideoEquation``. **
--------------------------------------------------------------------------------
"""
...
class EditFilterVideoEquation(EditBase):
    """
    ** Allows to view and modify the properties of a node of type ``FilterVideoEquation``.
    """
    ...
    def reset(self):
        """
        ** Called by the colors interface. **
        """
