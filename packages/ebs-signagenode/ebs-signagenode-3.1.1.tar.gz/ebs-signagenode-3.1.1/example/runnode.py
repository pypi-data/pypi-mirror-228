...
def run_node():
    nodeconfig = prepare_config('signagenode-base')
    ...
    from app import ExampleSignageApplication

    print("Creating Application : {}".format(ExampleSignageApplication))
    app = ExampleSignageApplication(config=nodeconfig)
    app.run()
