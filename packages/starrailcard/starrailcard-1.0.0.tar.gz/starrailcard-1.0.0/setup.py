...
{'': ['*'],
 'starrailcard.src': ['assets/*',
                      ...
                      'assets/relict/*',
                      'assets/stars/*',
                      'assets/teample_enkcard/*',
                      'assets/teample_enkcard/artifact/*',
                      'assets/teample_enkcard/background/*',
                      'assets/teample_enkcard/const/*',
                      'assets/teample_enkcard/stars/*',
                      'assets/teample_enkcard/stats/*',
                      'assets/teample_enkcard/talants/*',
