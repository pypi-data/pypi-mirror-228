...
workbench_utils.DEFAULT_WORKBENCH_DESTINATION = "https://workbench.omics.ai"
APP_NAME = sys.argv[0]
...
# noinspection PyTypeChecker
omics.add_command(auth)
# noinspection PyTypeChecker
omics.add_command(collection_command_group)
# noinspection PyTypeChecker
omics.add_command(context_command_group)
# noinspection PyTypeChecker
