...
from PyQt6.QtCore import QEvent, QObject, QPoint, QTimer, Qt, QPropertyAnimation, QSize
...
class ToolTip(QFrame):
    ...
    def __setQss(self):
        ...
        MaterialStyleSheet.TOOL_TIP.apply(self)
...
class ToolTipPositionManager:
    ...
    def position(self, tooltip: ToolTip, parent: QWidget) -> QPoint:
        ...
        x = min(max(-2, x) if QCursor().pos().x() >=
                0 else x, rect.width() - tooltip.width() - 4)
