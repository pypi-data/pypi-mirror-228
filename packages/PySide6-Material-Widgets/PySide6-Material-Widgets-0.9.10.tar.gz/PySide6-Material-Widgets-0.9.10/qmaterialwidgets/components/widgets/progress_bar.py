...
class ProgressBar(QProgressBar):
    ...
    def __init__(self, parent=None, useAni=True):
        ...
        self._useAni = useAni
        self._isRoundBorder = True
        self.lightBackgroundColor = argbToQColor(palette.lightScheme.surfaceContainerHighest)
        self.darkBackgroundColor =  argbToQColor(palette.darkScheme.surfaceContainerHighest)
    ...
    def paintEvent(self, e):
        ...
        r = self.height() / 2 if self.isRoundBorder() else 0
        painter.setBrush(bc)
    ...
    def isRoundBorder(self):
        return self._isRoundBorder

    def setRoundBorderEnabled(self, isEnabled):
