...
class GraphCovReg(CovReg):
    ...
    def F_secant_optim(self,B, A, m,v, psi_inv):
            ...
            out = minimize(self.secant_objective, np.ones(self.n*self.r), args = (self.r, m, v, self.Y, psi_inv, B,A, self.K_inv, self.omega, self.H_sq_inv), jac=True, method= 'L-BFGS-B', bounds= [(-5, 5)]*(self.n*self.r))
