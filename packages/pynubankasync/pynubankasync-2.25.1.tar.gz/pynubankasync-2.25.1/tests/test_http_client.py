...
async def test_http_get_handler_throws_exception_on_status_different_of_200(
...
async def test_http_post_handler_throws_exception_on_status_different_of_200(
    monkeypatch, http_status
):
    response = Response(http_status)
