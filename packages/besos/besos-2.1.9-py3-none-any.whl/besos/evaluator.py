...
class EvaluatorEP(AbstractEvaluator, ABC):
    ...
    def df_apply(
        ...
        **kwargs,
        ...
        :param stdout_mode: Stdout mode selection. One of {"Silent", "Verbose"} raise warning otherwise.
            Silent: EnergyPlus stdout output is suppressed. This is the default.
            Verbose: EnergyPlus output is printed to stdout.
        :return: Returns a DataFrame with one column containing the results for each objective.
        """
