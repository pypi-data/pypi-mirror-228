...
def top(data: types.ModuleType | StrOrBytesPath | None = None) -> Top:
    ...
    Examples:
        ...
        ...     t_top = top()
        ...     t_top  # doctest: +ELLIPSIS
        Top(init_py=PosixPath('.../sitec/src/sitec/__init__.py'), installed=None, name='sitec', \
path=PosixPath('.../sitec/src/sitec'), prefix='SITEC_', \
pth=..., pth_source=PosixPath('.../sitec/src/sitec/sitec.pth'), \
pyproject_toml=PosixPath('.../sitec/pyproject.toml'), \
root=PosixPath('.../sitec/src/sitec'), venv=PosixPath('.../sitec/venv'))
        >>>
        >>> t_module = top(sitec)
        ...
        Top(init_py=PosixPath('/.../sitec/venv/lib/python3.11/site-packages/semantic_release/__init__.py'), \
installed=True, name='semantic_release', \
path=PosixPath('/.../sitec/venv/lib/python3.11/site-packages/semantic_release'), \
prefix='SEMANTIC_RELEASE_', pth=None, pth_source=None, \
pyproject_toml=None, \
root=PosixPath('/.../sitec/venv/lib/python3.11/site-packages/semantic_release'), \
venv=PosixPath('/.../sitec/venv'))
        >>>
        >>> t_pytest_cov = top(pytest_cov)
        >>> t_pytest_cov  # doctest: +ELLIPSIS
        Top(init_py=PosixPath('.../sitec/venv/lib/python3.11/site-packages/pytest_cov/__init__.py'), \
installed=True, name='pytest_cov', \
path=PosixPath('.../sitec/venv/lib/python3.11/site-packages/pytest_cov'), \
prefix='PYTEST_COV_', \
pth=PosixPath('.../sitec/venv/lib/python3.11/site-packages/pytest-cov.pth'), \
pth_source=None, \
pyproject_toml=None, root=PosixPath('.../sitec/venv/lib/python3.11/site-packages/pytest_cov'), \
venv=PosixPath('.../sitec/venv'))
