...
class CraftAiSdk:
    ...
    _version = "0.23.3rc1"  # Would be better to share it somewhere
    ...
    def run_pipeline(
        ...
        Returns:
            :obj:`list` of :obj:`dict`: List of outputs represented
...
?include_io_values=false"
    ...
    @experimental_parameters(
        {
            "execution_rule": {
                "periodic": PERIODIC_WARNING_MESSAGE,
            },
        }
    )
