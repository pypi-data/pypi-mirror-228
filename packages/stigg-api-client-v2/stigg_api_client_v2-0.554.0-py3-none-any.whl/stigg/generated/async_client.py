...
class AsyncClient(AsyncBaseClient):
    ...
    async def import_customer_bulk(
        self, input: ImportCustomerBulk
    ) -> ImportCustomerBulk:
        query = gql(
            """
    ...
    async def import_customer(self, input: ImportCustomerInput) -> ImportCustomer:
        query = gql(
            """
    ...
    async def update_customer(self, input: UpdateCustomerInput) -> UpdateCustomer:
        query = gql(
            """
    ...
    async def revoke_promotional_entitlement(
    ...
    async def apply_subscription(
        self, input: ApplySubscriptionInput
    ) -> ApplySubscription:
        query = gql(
            """
    ...
    async def import_subscriptions_bulk(
    ...
    async def update_subscription(
        self, input: UpdateSubscriptionInput
    ) -> UpdateSubscription:
        query = gql(
            """
    ...
    async def estimate_subscription_update(
    ...
    async def cancel_subscription_updates(
    ...
    async def report_usage(self, input: UsageMeasurementCreateInput) -> ReportUsage:
        query = gql(
            """
    ...
    async def create_subscription(self, input: SubscriptionInput) -> CreateSubscription:
        query = gql(
            """
    ...
    async def migrate_subscription_to_latest(
    ...
    async def get_coupons(self) -> GetCoupons:
        query = gql(
            """
            query GetCoupons {
    ...
    async def get_entitlement(self, query: FetchEntitlementQuery) -> GetEntitlement:
        query = gql(
            """
    ...
    async def get_products(self) -> GetProducts:
        query = gql(
            """
            query GetProducts {
    ...
    async def get_sdk_configuration(self) -> GetSdkConfiguration:
        query = gql(
            """
    ...
    async def get_customer_portal_by_ref_id(
    ...
    async def get_checkout_state(self, input: CheckoutStateInput) -> GetCheckoutState:
        query = gql(
            """
    ...
    async def get_mock_paywall(self, input: GetPaywallInput) -> GetMockPaywall:
        query = gql(
            """
