...
class PriceTierFragment(BaseModel):
    ...
    unit_price: "PriceTierFragmentUnitPrice" = Field(alias="unitPrice")
...
class CheckoutConfigurationFragmentPalette(BaseModel):
    ...
    selection_color: Optional[str] = Field(alias="selectionColor")
...
PriceTierFragment.update_forward_refs()
PriceTierFragmentUnitPrice.update_forward_refs()
PriceFragment.update_forward_refs()
PriceFragmentPrice.update_forward_refs()
PriceFragmentTiers.update_forward_refs()
...
FontVariantFragment.update_forward_refs()
TypographyConfigurationFragment.update_forward_refs()
TypographyConfigurationFragmentH1.update_forward_refs()
TypographyConfigurationFragmentH2.update_forward_refs()
TypographyConfigurationFragmentH3.update_forward_refs()
TypographyConfigurationFragmentBody.update_forward_refs()
CheckoutConfigurationFragment.update_forward_refs()
CheckoutConfigurationFragmentPalette.update_forward_refs()
CheckoutConfigurationFragmentTypography.update_forward_refs()
CheckoutConfigurationFragmentContent.update_forward_refs()
...
SubscriptionFutureUpdateDataScheduleVariablesAddonChangeVariables.update_forward_refs()
...
SubscriptionInvoiceFragment.update_forward_refs()
SubscriptionScheduledUpdateData.update_forward_refs()
SubscriptionScheduledUpdateDataTargetPackage.update_forward_refs()
SubscriptionScheduledUpdateDataScheduleVariablesAddonChangeVariables.update_forward_refs()
...
SubscriptionFragmentLatestInvoice.update_forward_refs()
...
CheckoutStateFragment.update_forward_refs()
CheckoutStateFragmentConfiguration.update_forward_refs()
CheckoutStateFragmentCustomer.update_forward_refs()
CheckoutStateFragmentActiveSubscription.update_forward_refs()
CheckoutStateFragmentResource.update_forward_refs()
CheckoutStateFragmentPlan.update_forward_refs()
CheckoutStateFragmentBillingIntegration.update_forward_refs()
CheckoutStateFragmentBillingIntegrationCredentials.update_forward_refs()
CustomerPortalBillingInformationFragment.update_forward_refs()
CustomerPortalConfigurationFragment.update_forward_refs()
...
CustomerPortalEntitlementFragment.update_forward_refs()
CustomerPortalEntitlementFragmentResetPeriodConfigurationMonthlyResetPeriodConfig.update_forward_refs()
CustomerPortalEntitlementFragmentResetPeriodConfigurationWeeklyResetPeriodConfig.update_forward_refs()
CustomerPortalEntitlementFragmentFeature.update_forward_refs()
...
CustomerPortalSubscriptionAddonFragment.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragment.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragmentTargetPackage.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragmentScheduleVariablesAddonChangeVariables.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragmentScheduleVariablesBillingPeriodChangeVariables.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragmentScheduleVariablesDowngradeChangeVariables.update_forward_refs()
CustomerPortalSubscriptionScheduledUpdateDataFragmentScheduleVariablesUnitAmountChangeVariables.update_forward_refs()
...
CustomerPortalPromotionalEntitlementFragment.update_forward_refs()
