...
def compare_elements(elem1, elem2, differences):
    ...
    if elem1.attrib != elem2.attrib:
        differences.append(f"Different attributes in tag {elem1.tag}: {elem1.attrib} != {elem2.attrib}")
        return False
    if elem1.text != elem2.text:
        differences.append(f"Different text in tag {elem1.tag}: {elem1.text} != {elem2.text}")
        return False
