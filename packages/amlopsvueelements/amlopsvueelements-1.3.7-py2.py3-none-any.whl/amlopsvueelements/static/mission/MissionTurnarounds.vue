                    ...
                    <div class="flex gap-x-3 justify-center">
                      <div class="flex flex-col items-center">
                        ...
                        <UCheckboxWrapper
                          ...
                          :disabled="
                            ...
                            !findServiceById(turnaround.id, serviceOptions).arrival
                          "
                      ...
                      <div class="flex flex-col items-center">
                        ...
                        <UCheckboxWrapper
                          ...
                          :disabled="
                            isDisabledService(turnaround.id, serviceOptions) ||
                            !findServiceById(turnaround.id, serviceOptions).departure
                          "
                          class="!mb-0 d-flex shrink-0"
                          size="24px"
                        />
...
const { groundServicing, isFetchingTurnarounds, turnaroundsModel, generateServices } =
...
const fetchData = () => {
  ...
  return Promise.allSettled([
    fetchServices(TEMPRORARY_SERVICE_DATA.LOCATION, TEMPRORARY_SERVICE_DATA.ORGANISATION),
