<template>
  <div class="mission-itinerary" :class="$style['mission-itinerary']">
    ...
    <div class="flex flex-col lg:w-[45%] gap-[30px] my-auto">
...
import { useCalculateLegHeight } from '@/composables/mission/useCalculateLegHeight'
...
const { calculateLegHeight } = useCalculateLegHeight()
