...
class CreateModelRequestBodyInitialHyperparametersTrainingArguments(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModelRequestBodyInitialHyperparametersTrainingArguments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModelRequestBodyInitialHyperparametersTrainingArguments:
        """Create an instance of CreateModelRequestBodyInitialHyperparametersTrainingArguments from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModelRequestBodyInitialHyperparametersTrainingArguments.parse_obj(obj)

        _obj = CreateModelRequestBodyInitialHyperparametersTrainingArguments.parse_obj({
