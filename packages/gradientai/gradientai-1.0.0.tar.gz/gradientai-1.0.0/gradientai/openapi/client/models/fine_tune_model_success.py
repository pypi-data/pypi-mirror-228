...
class FineTuneModelSuccess(BaseModel):
    ...
    """
    number_of_trainable_tokens: conint(strict=True, ge=0) = Field(..., alias="numberOfTrainableTokens")
    sum_loss: Union[StrictFloat, StrictInt] = Field(..., alias="sumLoss")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FineTuneModelSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FineTuneModelSuccess:
        """Create an instance of FineTuneModelSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FineTuneModelSuccess.parse_obj(obj)

        _obj = FineTuneModelSuccess.parse_obj({
