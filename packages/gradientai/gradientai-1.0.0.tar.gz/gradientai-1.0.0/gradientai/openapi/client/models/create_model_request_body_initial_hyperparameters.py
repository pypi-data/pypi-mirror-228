...
class CreateModelRequestBodyInitialHyperparameters(BaseModel):
    """
    CreateModelRequestBodyInitialHyperparameters
    """
    lora_hyperparameters: Optional[CreateModelRequestBodyInitialHyperparametersLoraHyperparameters] = Field(None, alias="loraHyperparameters")
    training_arguments: Optional[CreateModelRequestBodyInitialHyperparametersTrainingArguments] = Field(None, alias="trainingArguments")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModelRequestBodyInitialHyperparameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModelRequestBodyInitialHyperparameters:
        """Create an instance of CreateModelRequestBodyInitialHyperparameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModelRequestBodyInitialHyperparameters.parse_obj(obj)

        _obj = CreateModelRequestBodyInitialHyperparameters.parse_obj({
            "lora_hyperparameters": CreateModelRequestBodyInitialHyperparametersLoraHyperparameters.from_dict(obj.get("loraHyperparameters")) if obj.get("loraHyperparameters") is not None else None,
            "training_arguments": CreateModelRequestBodyInitialHyperparametersTrainingArguments.from_dict(obj.get("trainingArguments")) if obj.get("trainingArguments") is not None else None
        })
