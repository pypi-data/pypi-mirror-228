...
class CreateModelError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModelError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModelError:
        """Create an instance of CreateModelError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModelError.parse_obj(obj)

        _obj = CreateModelError.parse_obj({
