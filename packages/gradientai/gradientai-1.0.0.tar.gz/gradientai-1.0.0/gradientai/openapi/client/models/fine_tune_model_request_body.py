...
class FineTuneModelRequestBody(BaseModel):
    """
    FineTuneModelRequestBody
    """
    samples: conlist(FineTuneModelRequestBodySamplesInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FineTuneModelRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FineTuneModelRequestBody:
        """Create an instance of FineTuneModelRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FineTuneModelRequestBody.parse_obj(obj)

        _obj = FineTuneModelRequestBody.parse_obj({
            "samples": [FineTuneModelRequestBodySamplesInner.from_dict(_item) for _item in obj.get("samples")] if obj.get("samples") is not None else None
        })
