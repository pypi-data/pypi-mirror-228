...
class FineTuneModelErrorOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FineTuneModelErrorOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FineTuneModelErrorOneOf:
        """Create an instance of FineTuneModelErrorOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FineTuneModelErrorOneOf.parse_obj(obj)

        _obj = FineTuneModelErrorOneOf.parse_obj({
