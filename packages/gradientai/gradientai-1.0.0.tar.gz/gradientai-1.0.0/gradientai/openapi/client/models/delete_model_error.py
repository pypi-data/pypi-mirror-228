...
class DeleteModelError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteModelError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteModelError:
        """Create an instance of DeleteModelError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteModelError.parse_obj(obj)

        _obj = DeleteModelError.parse_obj({
