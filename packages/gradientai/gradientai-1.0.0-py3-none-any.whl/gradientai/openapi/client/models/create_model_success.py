...
class CreateModelSuccess(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModelSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModelSuccess:
        """Create an instance of CreateModelSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModelSuccess.parse_obj(obj)

        _obj = CreateModelSuccess.parse_obj({
            "id": obj.get("id")
        })
