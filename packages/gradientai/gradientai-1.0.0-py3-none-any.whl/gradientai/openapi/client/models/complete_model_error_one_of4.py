...
class CompleteModelErrorOneOf4(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteModelErrorOneOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteModelErrorOneOf4:
        """Create an instance of CompleteModelErrorOneOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteModelErrorOneOf4.parse_obj(obj)

        _obj = CompleteModelErrorOneOf4.parse_obj({
