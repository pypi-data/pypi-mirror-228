...
class CompleteModelErrorOneOf(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('flaggedContent', 'bodyParsingError', 'queryOrPathParsingError', 'unknownBaseModel', 'unknownModelAdapter'):
            raise ValueError("must be one of enum values ('flaggedContent', 'bodyParsingError', 'queryOrPathParsingError', 'unknownBaseModel', 'unknownModelAdapter')")
        return value
