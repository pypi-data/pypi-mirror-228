...
class ListModelsError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListModelsError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListModelsError:
        """Create an instance of ListModelsError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListModelsError.parse_obj(obj)

        _obj = ListModelsError.parse_obj({
