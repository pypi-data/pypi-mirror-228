...
class ModelsApi(object):
    ...
    @validate_arguments
    def create_model(self, x_gradient_workspace_id : constr(strict=True, min_length=1), create_model_request_body : CreateModelRequestBody, **kwargs) -> CreateModelSuccess:  # noqa: E501
        ...
        >>> thread = api.create_model(x_gradient_workspace_id, create_model_request_body, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_model_with_http_info(x_gradient_workspace_id, create_model_request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def create_model_with_http_info(self, x_gradient_workspace_id : constr(strict=True, min_length=1), create_model_request_body : CreateModelRequestBody, **kwargs) -> ApiResponse:  # noqa: E501
        """Create model  # noqa: E501
        ...
        >>> thread = api.create_model_with_http_info(x_gradient_workspace_id, create_model_request_body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def fine_tune_model(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), fine_tune_model_request_body : FineTuneModelRequestBody, **kwargs) -> FineTuneModelSuccess:  # noqa: E501
        ...
        >>> thread = api.fine_tune_model(id, x_gradient_workspace_id, fine_tune_model_request_body, async_req=True)
        >>> result = thread.get()
        ...
        :param x_gradient_workspace_id: (required)
        :type x_gradient_workspace_id: str
        :param fine_tune_model_request_body: (required)
        :type fine_tune_model_request_body: FineTuneModelRequestBody
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        return self.fine_tune_model_with_http_info(id, x_gradient_workspace_id, fine_tune_model_request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def fine_tune_model_with_http_info(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), fine_tune_model_request_body : FineTuneModelRequestBody, **kwargs) -> ApiResponse:  # noqa: E501
        """Fine-tune model  # noqa: E501
        ...
        >>> thread = api.fine_tune_model_with_http_info(id, x_gradient_workspace_id, fine_tune_model_request_body, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['fine_tune_model_request_body'] is not None:
            _body_params = _params['fine_tune_model_request_body']
