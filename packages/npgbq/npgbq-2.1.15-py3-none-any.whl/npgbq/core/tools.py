...
class NPGBQ:
    ...
    def get_transfer_config(self, transfer_name: str):
    ...
    def get_transfer_config_v1(self, transfer_name: str):
    ...
    def copy_table(self, tbl_id_src, tbl_id_dst):
        self.client.copy_table(tbl_id_src, tbl_id_dst)
