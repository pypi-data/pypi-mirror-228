"""ens_tool_revolution module

The ens_tool_revolution module provides a proxy interface to EnSight ENS_TOOL_REVOLUTION instances
...
class ENS_TOOL_REVOLUTION(ENS_TOOL):
    ...
    def NUMPOINTS(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.NUMPOINTS)
        _value = cast(int, value)
        return _value

    @NUMPOINTS.setter
    def NUMPOINTS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.NUMPOINTS, value)
    ...
    def numpoints(self) -> int:
        ...
        Note: both 'numpoints' and 'NUMPOINTS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.NUMPOINTS)
        _value = cast(int, value)
        return _value
    ...
    @DISTANCE.setter
    def DISTANCE(self, value: List[float]) -> None:
    ...
    @RADIUS.setter
    def RADIUS(self, value: List[float]) -> None:
