"""ens_part_aux_geom module

The ens_part_aux_geom module provides a proxy interface to EnSight ENS_PART_AUX_GEOM instances
...
class ENS_PART_AUX_GEOM(ENS_PART):
    ...
    @SIZE.setter
    def SIZE(self, value: List[float]) -> None:
    ...
    def TYPE(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.AUX_GEOM_SHAPE_BOX - box
    ...
    @property
    def SHOWPLANEXMIN(self) -> int:
        """SHOWPLANEXMIN property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEXMIN)
        _value = cast(int, value)
        return _value

    @SHOWPLANEXMIN.setter
    def SHOWPLANEXMIN(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEXMIN, value)
    ...
    def showplanexmin(self) -> int:
        ...
        Note: both 'showplanexmin' and 'SHOWPLANEXMIN' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEXMIN)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SHOWPLANEXMAX(self) -> int:
        """SHOWPLANEXMAX property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEXMAX)
        _value = cast(int, value)
        return _value

    @SHOWPLANEXMAX.setter
    def SHOWPLANEXMAX(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEXMAX, value)
    ...
    def showplanexmax(self) -> int:
        ...
        Note: both 'showplanexmax' and 'SHOWPLANEXMAX' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEXMAX)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SHOWPLANEYMIN(self) -> int:
        """SHOWPLANEYMIN property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEYMIN)
        _value = cast(int, value)
        return _value

    @SHOWPLANEYMIN.setter
    def SHOWPLANEYMIN(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEYMIN, value)
    ...
    def showplaneymin(self) -> int:
        ...
        Note: both 'showplaneymin' and 'SHOWPLANEYMIN' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEYMIN)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SHOWPLANEYMAX(self) -> int:
        """SHOWPLANEYMAX property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEYMAX)
        _value = cast(int, value)
        return _value

    @SHOWPLANEYMAX.setter
    def SHOWPLANEYMAX(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEYMAX, value)
    ...
    def showplaneymax(self) -> int:
        ...
        Note: both 'showplaneymax' and 'SHOWPLANEYMAX' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEYMAX)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SHOWPLANEZMIN(self) -> int:
        """SHOWPLANEZMIN property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEZMIN)
        _value = cast(int, value)
        return _value

    @SHOWPLANEZMIN.setter
    def SHOWPLANEZMIN(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEZMIN, value)
    ...
    def showplanezmin(self) -> int:
        ...
        Note: both 'showplanezmin' and 'SHOWPLANEZMIN' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEZMIN)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SHOWPLANEZMAX(self) -> int:
        """SHOWPLANEZMAX property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEZMAX)
        _value = cast(int, value)
        return _value

    @SHOWPLANEZMAX.setter
    def SHOWPLANEZMAX(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWPLANEZMAX, value)
    ...
    def showplanezmax(self) -> int:
        ...
        Note: both 'showplanezmax' and 'SHOWPLANEZMAX' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWPLANEZMAX)
        _value = cast(int, value)
        return _value
    ...
    def MESHRESOLUTION(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MESHRESOLUTION)
        _value = cast(int, value)
        return _value

    @MESHRESOLUTION.setter
    def MESHRESOLUTION(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MESHRESOLUTION, value)
    ...
    def meshresolution(self) -> int:
        ...
        Note: both 'meshresolution' and 'MESHRESOLUTION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MESHRESOLUTION)
        _value = cast(int, value)
        return _value
    ...
    def SHOWOUTLINE(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWOUTLINE)
        _value = cast(int, value)
        return _value

    @SHOWOUTLINE.setter
    def SHOWOUTLINE(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SHOWOUTLINE, value)
    ...
    def showoutline(self) -> int:
        ...
        Note: both 'showoutline' and 'SHOWOUTLINE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SHOWOUTLINE)
        _value = cast(int, value)
        return _value
    ...
    @property
    def NORMALSPOINT(self) -> int:
        """NORMALSPOINT property
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.AUX_GEOM_NORMAL_INWARD - inward
            * ensight.objs.enums.AUX_GEOM_NORMAL_OUTWARD - outward
        
        """
        value = self.getattr(self._session.ensight.objs.enums.NORMALSPOINT)
        _value = cast(int, value)
        return _value

    @NORMALSPOINT.setter
    def NORMALSPOINT(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.NORMALSPOINT, value)
    ...
    def normalspoint(self) -> int:
        ...
        Note: both 'normalspoint' and 'NORMALSPOINT' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.NORMALSPOINT)
        _value = cast(int, value)
        return _value
    ...
    @property
    def USEDOUBLESIDEDWALLS(self) -> int:
        """USEDOUBLESIDEDWALLS property
        
        Use doublesided walls
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.USEDOUBLESIDEDWALLS)
        _value = cast(int, value)
        return _value

    @USEDOUBLESIDEDWALLS.setter
    def USEDOUBLESIDEDWALLS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.USEDOUBLESIDEDWALLS, value)
    ...
    def usedoublesidedwalls(self) -> int:
        ...
        Note: both 'usedoublesidedwalls' and 'USEDOUBLESIDEDWALLS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.USEDOUBLESIDEDWALLS)
        _value = cast(int, value)
        return _value
    ...
    def WALLTHICKNESS(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.WALLTHICKNESS)
        _value = cast(float, value)
        return _value

    @WALLTHICKNESS.setter
    def WALLTHICKNESS(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.WALLTHICKNESS, value)
    ...
    def wallthickness(self) -> float:
        ...
        Note: both 'wallthickness' and 'WALLTHICKNESS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.WALLTHICKNESS)
        _value = cast(float, value)
        return _value
