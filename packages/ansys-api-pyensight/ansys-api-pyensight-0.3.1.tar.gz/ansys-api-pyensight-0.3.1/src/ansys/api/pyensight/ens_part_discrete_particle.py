"""ens_part_discrete_particle module

The ens_part_discrete_particle module provides a proxy interface to EnSight ENS_PART_DISCRETE_PARTICLE instances
...
class ENS_PART_DISCRETE_PARTICLE(ENS_PART):
