...
The ens_animobj module provides a proxy interface to EnSight ens_animobj instances
...
class ens_animobj(ENSOBJ):
    """This class acts as a proxy for the EnSight Python class ensight.objs.ens_animobj
