"""ens_part_particle_trace module

The ens_part_particle_trace module provides a proxy interface to EnSight ENS_PART_PARTICLE_TRACE instances
...
class ENS_PART_PARTICLE_TRACE(ENS_PART):
    ...
    @property
    def EMITTERS(self) -> List['ens_emitterobj']:
        """EMITTERS property
        ...
        Supported operations:
            getattr, setattr
        Datatype:
            ens_emitterobj list, scalar
        
        """
        value = self.getattr(self._session.ensight.objs.enums.EMITTERS)
        _value = cast(List['ens_emitterobj'], value)
        return _value

    @EMITTERS.setter
    def EMITTERS(self, value: List['ens_emitterobj']) -> None:
        self.setattr(self._session.ensight.objs.enums.EMITTERS, value)
    ...
    def emitters(self) -> List['ens_emitterobj']:
        ...
        Note: both 'emitters' and 'EMITTERS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.EMITTERS)
        _value = cast(List['ens_emitterobj'], value)
        return _value
    ...
    def TYPE(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.STREAMLINE - streamline
            * ensight.objs.enums.PATHLINE - pathline
            * ensight.objs.enums.NODE_TRACKS - nodetrack
            * ensight.objs.enums.MIN_TRACK - variablemintrack
            * ensight.objs.enums.MAX_TRACK - variablemaxtrack
    ...
    def ANIMATE(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.ANIMATE)
        _value = cast(int, value)
        return _value

    @ANIMATE.setter
    def ANIMATE(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.ANIMATE, value)
    ...
    def animate(self) -> int:
        ...
        Note: both 'animate' and 'ANIMATE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.ANIMATE)
        _value = cast(int, value)
        return _value
    ...
    def REPRESENTATION(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.TRACE_LINE - line
            * ensight.objs.enums.TRACE_RIBBON - ribbon
            * ensight.objs.enums.TRACE_SQUBE - square_tubes
            * ensight.objs.enums.TRACE_TUBE - tubes
        
        """
        value = self.getattr(self._session.ensight.objs.enums.REPRESENTATION)
        _value = cast(int, value)
        return _value

    @REPRESENTATION.setter
    def REPRESENTATION(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.REPRESENTATION, value)
    ...
    def representation(self) -> int:
        ...
        Note: both 'representation' and 'REPRESENTATION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.REPRESENTATION)
        _value = cast(int, value)
        return _value
    ...
    def WIDTHSCALEFACTOR(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.WIDTHSCALEFACTOR)
        _value = cast(float, value)
        return _value

    @WIDTHSCALEFACTOR.setter
    def WIDTHSCALEFACTOR(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.WIDTHSCALEFACTOR, value)
    ...
    def widthscalefactor(self) -> float:
        ...
        Note: both 'widthscalefactor' and 'WIDTHSCALEFACTOR' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.WIDTHSCALEFACTOR)
        _value = cast(float, value)
        return _value
    ...
    def ARROWS(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.SHP_NONE - none
            * ensight.objs.enums.SHP_NORM - 2d_arrow
            * ensight.objs.enums.SHP_TRI - triangle
            * ensight.objs.enums.SHP_CONE - cone
        
        """
        value = self.getattr(self._session.ensight.objs.enums.ARROWS)
        _value = cast(int, value)
        return _value

    @ARROWS.setter
    def ARROWS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.ARROWS, value)
    ...
    def arrows(self) -> int:
        ...
        Note: both 'arrows' and 'ARROWS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.ARROWS)
        _value = cast(int, value)
        return _value
    ...
    def ARROWSIZE(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.ARROWSIZE)
        _value = cast(float, value)
        return _value

    @ARROWSIZE.setter
    def ARROWSIZE(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.ARROWSIZE, value)
    ...
    def arrowsize(self) -> float:
        ...
        Note: both 'arrowsize' and 'ARROWSIZE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.ARROWSIZE)
        _value = cast(float, value)
        return _value
    ...
    @property
    def NUMOFARROWS(self) -> int:
        """NUMOFARROWS property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.NUMOFARROWS)
        _value = cast(int, value)
        return _value

    @NUMOFARROWS.setter
    def NUMOFARROWS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.NUMOFARROWS, value)
    ...
    def numofarrows(self) -> int:
        ...
        Note: both 'numofarrows' and 'NUMOFARROWS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.NUMOFARROWS)
        _value = cast(int, value)
        return _value
    ...
    @property
    def TRACEDIRECTION(self) -> int:
        """TRACEDIRECTION property
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.POS_TIME - +
            * ensight.objs.enums.NEG_TIME - -
            * ensight.objs.enums.POS_NEG_TIME - +/-
        
        """
        value = self.getattr(self._session.ensight.objs.enums.TRACEDIRECTION)
        _value = cast(int, value)
        return _value

    @TRACEDIRECTION.setter
    def TRACEDIRECTION(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.TRACEDIRECTION, value)
    ...
    def tracedirection(self) -> int:
        ...
        Note: both 'tracedirection' and 'TRACEDIRECTION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.TRACEDIRECTION)
        _value = cast(int, value)
        return _value
    ...
    def TOTALTIME(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.TOTALTIME)
        _value = cast(float, value)
        return _value

    @TOTALTIME.setter
    def TOTALTIME(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.TOTALTIME, value)
    ...
    def totaltime(self) -> float:
        ...
        Note: both 'totaltime' and 'TOTALTIME' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.TOTALTIME)
        _value = cast(float, value)
        return _value
    ...
    @property
    def EMITATCURRENTTIME(self) -> int:
        """EMITATCURRENTTIME property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.EMITATCURRENTTIME)
        _value = cast(int, value)
        return _value

    @EMITATCURRENTTIME.setter
    def EMITATCURRENTTIME(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.EMITATCURRENTTIME, value)
    ...
    def emitatcurrenttime(self) -> int:
        ...
        Note: both 'emitatcurrenttime' and 'EMITATCURRENTTIME' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.EMITATCURRENTTIME)
        _value = cast(int, value)
        return _value
    ...
    def MINSTEPS(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MINSTEPS)
        _value = cast(float, value)
        return _value

    @MINSTEPS.setter
    def MINSTEPS(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MINSTEPS, value)
    ...
    def minsteps(self) -> float:
        ...
        Note: both 'minsteps' and 'MINSTEPS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MINSTEPS)
        _value = cast(float, value)
        return _value
    ...
    def MINANGLE(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MINANGLE)
        _value = cast(float, value)
        return _value

    @MINANGLE.setter
    def MINANGLE(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MINANGLE, value)
    ...
    def minangle(self) -> float:
        ...
        Note: both 'minangle' and 'MINANGLE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MINANGLE)
        _value = cast(float, value)
        return _value
    ...
    def MAXANGLE(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MAXANGLE)
        _value = cast(float, value)
        return _value

    @MAXANGLE.setter
    def MAXANGLE(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MAXANGLE, value)
    ...
    def maxangle(self) -> float:
        ...
        Note: both 'maxangle' and 'MAXANGLE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MAXANGLE)
        _value = cast(float, value)
        return _value
    ...
    def ROTANGLE(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.ROTANGLE)
        _value = cast(float, value)
        return _value

    @ROTANGLE.setter
    def ROTANGLE(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.ROTANGLE, value)
    ...
    def rotangle(self) -> float:
        ...
        Note: both 'rotangle' and 'ROTANGLE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.ROTANGLE)
        _value = cast(float, value)
        return _value
    ...
    @property
    def COMPUTEUSINGPERIODICITY(self) -> int:
        """COMPUTEUSINGPERIODICITY property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.COMPUTEUSINGPERIODICITY)
        _value = cast(int, value)
        return _value

    @COMPUTEUSINGPERIODICITY.setter
    def COMPUTEUSINGPERIODICITY(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.COMPUTEUSINGPERIODICITY, value)
    ...
    def computeusingperiodicity(self) -> int:
        ...
        Note: both 'computeusingperiodicity' and 'COMPUTEUSINGPERIODICITY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.COMPUTEUSINGPERIODICITY)
        _value = cast(int, value)
        return _value
    ...
    @property
    def NODEID(self) -> float:
        """NODEID property
        
        Node to track(or ALL)
    ...
    @NODEID.setter
    def NODEID(self, value: float) -> None:
    ...
    @property
    def TIMESTEPBEGIN(self) -> int:
        """TIMESTEPBEGIN property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.TIMESTEPBEGIN)
        _value = cast(int, value)
        return _value

    @TIMESTEPBEGIN.setter
    def TIMESTEPBEGIN(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.TIMESTEPBEGIN, value)
    ...
    def timestepbegin(self) -> int:
        ...
        Note: both 'timestepbegin' and 'TIMESTEPBEGIN' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.TIMESTEPBEGIN)
        _value = cast(int, value)
        return _value
    ...
    @property
    def TIMESTEPEND(self) -> int:
        """TIMESTEPEND property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.TIMESTEPEND)
        _value = cast(int, value)
        return _value

    @TIMESTEPEND.setter
    def TIMESTEPEND(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.TIMESTEPEND, value)
    ...
    def timestepend(self) -> int:
        ...
        Note: both 'timestepend' and 'TIMESTEPEND' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.TIMESTEPEND)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SURFACERESTRICTED(self) -> int:
        """SURFACERESTRICTED property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SURFACERESTRICTED)
        _value = cast(int, value)
        return _value

    @SURFACERESTRICTED.setter
    def SURFACERESTRICTED(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SURFACERESTRICTED, value)
    ...
    def surfacerestricted(self) -> int:
        ...
        Note: both 'surfacerestricted' and 'SURFACERESTRICTED' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SURFACERESTRICTED)
        _value = cast(int, value)
        return _value
    ...
    @property
    def VARIABLEOFFSET(self) -> float:
        """VARIABLEOFFSET property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.VARIABLEOFFSET)
        _value = cast(float, value)
        return _value

    @VARIABLEOFFSET.setter
    def VARIABLEOFFSET(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.VARIABLEOFFSET, value)
    ...
    def variableoffset(self) -> float:
        ...
        Note: both 'variableoffset' and 'VARIABLEOFFSET' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.VARIABLEOFFSET)
        _value = cast(float, value)
        return _value
    ...
    def DISPLAYOFFSET(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.DISPLAYOFFSET)
        _value = cast(float, value)
        return _value

    @DISPLAYOFFSET.setter
    def DISPLAYOFFSET(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.DISPLAYOFFSET, value)
    ...
    def displayoffset(self) -> float:
        ...
        Note: both 'displayoffset' and 'DISPLAYOFFSET' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.DISPLAYOFFSET)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDPARTICLES(self) -> int:
        """MASSEDPARTICLES property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLES)
        _value = cast(int, value)
        return _value

    @MASSEDPARTICLES.setter
    def MASSEDPARTICLES(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDPARTICLES, value)
    ...
    def massedparticles(self) -> int:
        ...
        Note: both 'massedparticles' and 'MASSEDPARTICLES' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLES)
        _value = cast(int, value)
        return _value
    ...
    def MASSEDDRAG(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAG)
        _value = cast(int, value)
        return _value

    @MASSEDDRAG.setter
    def MASSEDDRAG(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDDRAG, value)
    ...
    def masseddrag(self) -> int:
        ...
        Note: both 'masseddrag' and 'MASSEDDRAG' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAG)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDPARTICLEDIAMETER(self) -> float:
        """MASSEDPARTICLEDIAMETER property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLEDIAMETER)
        _value = cast(float, value)
        return _value

    @MASSEDPARTICLEDIAMETER.setter
    def MASSEDPARTICLEDIAMETER(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDPARTICLEDIAMETER, value)
    ...
    def massedparticlediameter(self) -> float:
        ...
        Note: both 'massedparticlediameter' and 'MASSEDPARTICLEDIAMETER' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLEDIAMETER)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDPARTICLEDENSITY(self) -> float:
        """MASSEDPARTICLEDENSITY property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLEDENSITY)
        _value = cast(float, value)
        return _value

    @MASSEDPARTICLEDENSITY.setter
    def MASSEDPARTICLEDENSITY(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDPARTICLEDENSITY, value)
    ...
    def massedparticledensity(self) -> float:
        ...
        Note: both 'massedparticledensity' and 'MASSEDPARTICLEDENSITY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPARTICLEDENSITY)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDDRAGCOEFFICIENT(self) -> int:
        """MASSEDDRAGCOEFFICIENT property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENT)
        _value = cast(int, value)
        return _value

    @MASSEDDRAGCOEFFICIENT.setter
    def MASSEDDRAGCOEFFICIENT(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENT, value)
    ...
    def masseddragcoefficient(self) -> int:
        ...
        Note: both 'masseddragcoefficient' and 'MASSEDDRAGCOEFFICIENT' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENT)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDDRAGCOEFFICIENTVAL(self) -> float:
        """MASSEDDRAGCOEFFICIENTVAL property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENTVAL)
        _value = cast(float, value)
        return _value

    @MASSEDDRAGCOEFFICIENTVAL.setter
    def MASSEDDRAGCOEFFICIENTVAL(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENTVAL, value)
    ...
    def masseddragcoefficientval(self) -> float:
        ...
        Note: both 'masseddragcoefficientval' and 'MASSEDDRAGCOEFFICIENTVAL' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDDRAGCOEFFICIENTVAL)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDFLUIDVISCOSITY(self) -> ensobjlist['ENS_VAR']:
        """MASSEDFLUIDVISCOSITY property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITY)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value

    @MASSEDFLUIDVISCOSITY.setter
    def MASSEDFLUIDVISCOSITY(self, value: ensobjlist['ENS_VAR']) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITY, value)
    ...
    def massedfluidviscosity(self) -> ensobjlist['ENS_VAR']:
        ...
        Note: both 'massedfluidviscosity' and 'MASSEDFLUIDVISCOSITY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITY)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value
    ...
    @property
    def MASSEDFLUIDVISCOSITYVAL(self) -> float:
        """MASSEDFLUIDVISCOSITYVAL property
        
        Fluid dynamic viscosity value
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITYVAL)
        _value = cast(float, value)
        return _value

    @MASSEDFLUIDVISCOSITYVAL.setter
    def MASSEDFLUIDVISCOSITYVAL(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITYVAL, value)
    ...
    def massedfluidviscosityval(self) -> float:
        ...
        Note: both 'massedfluidviscosityval' and 'MASSEDFLUIDVISCOSITYVAL' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDVISCOSITYVAL)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDUSEBALLISTIC(self) -> int:
        """MASSEDUSEBALLISTIC property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDUSEBALLISTIC)
        _value = cast(int, value)
        return _value

    @MASSEDUSEBALLISTIC.setter
    def MASSEDUSEBALLISTIC(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDUSEBALLISTIC, value)
    ...
    def masseduseballistic(self) -> int:
        ...
        Note: both 'masseduseballistic' and 'MASSEDUSEBALLISTIC' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDUSEBALLISTIC)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDBALLISTICCOEF(self) -> float:
        """MASSEDBALLISTICCOEF property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDBALLISTICCOEF)
        _value = cast(float, value)
        return _value

    @MASSEDBALLISTICCOEF.setter
    def MASSEDBALLISTICCOEF(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDBALLISTICCOEF, value)
    ...
    def massedballisticcoef(self) -> float:
        ...
        Note: both 'massedballisticcoef' and 'MASSEDBALLISTICCOEF' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDBALLISTICCOEF)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDINITIALUSEFLUID(self) -> int:
        """MASSEDINITIALUSEFLUID property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDINITIALUSEFLUID)
        _value = cast(int, value)
        return _value
    ...
    def massedinitialusefluid(self) -> int:
        ...
        Note: both 'massedinitialusefluid' and 'MASSEDINITIALUSEFLUID' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDINITIALUSEFLUID)
        _value = cast(int, value)
        return _value
    ...
    def MASSEDFLUIDDENSITY(self) -> ensobjlist['ENS_VAR']:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDDENSITY)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value
    ...
    def massedfluiddensity(self) -> ensobjlist['ENS_VAR']:
        ...
        Note: both 'massedfluiddensity' and 'MASSEDFLUIDDENSITY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDDENSITY)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value
    ...
    def MASSEDFLUIDDENSITYVAL(self) -> float:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDDENSITYVAL)
        _value = cast(float, value)
        return _value

    @MASSEDFLUIDDENSITYVAL.setter
    def MASSEDFLUIDDENSITYVAL(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDFLUIDDENSITYVAL, value)
    ...
    def massedfluiddensityval(self) -> float:
        ...
        Note: both 'massedfluiddensityval' and 'MASSEDFLUIDDENSITYVAL' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDFLUIDDENSITYVAL)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDGRAVITY(self) -> int:
        """MASSEDGRAVITY property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDGRAVITY)
        _value = cast(int, value)
        return _value

    @MASSEDGRAVITY.setter
    def MASSEDGRAVITY(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDGRAVITY, value)
    ...
    def massedgravity(self) -> int:
        ...
        Note: both 'massedgravity' and 'MASSEDGRAVITY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDGRAVITY)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDGRAVITYVECTOR(self) -> List[float]:
        """MASSEDGRAVITYVECTOR property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDGRAVITYVECTOR)
        _value = cast(List[float], value)
        return _value

    @MASSEDGRAVITYVECTOR.setter
    def MASSEDGRAVITYVECTOR(self, value: List[float]) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDGRAVITYVECTOR, value)
    ...
    def massedgravityvector(self) -> List[float]:
        ...
        Note: both 'massedgravityvector' and 'MASSEDGRAVITYVECTOR' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDGRAVITYVECTOR)
        _value = cast(List[float], value)
        return _value
    ...
    @property
    def MASSEDBUOYANCY(self) -> int:
        """MASSEDBUOYANCY property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDBUOYANCY)
        _value = cast(int, value)
        return _value

    @MASSEDBUOYANCY.setter
    def MASSEDBUOYANCY(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDBUOYANCY, value)
    ...
    def massedbuoyancy(self) -> int:
        ...
        Note: both 'massedbuoyancy' and 'MASSEDBUOYANCY' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDBUOYANCY)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDPRESSURE(self) -> int:
        """MASSEDPRESSURE property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPRESSURE)
        _value = cast(int, value)
        return _value

    @MASSEDPRESSURE.setter
    def MASSEDPRESSURE(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDPRESSURE, value)
    ...
    def massedpressure(self) -> int:
        ...
        Note: both 'massedpressure' and 'MASSEDPRESSURE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPRESSURE)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDPRESSUREGRADIENT(self) -> ensobjlist['ENS_VAR']:
        """MASSEDPRESSUREGRADIENT property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPRESSUREGRADIENT)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value

    @MASSEDPRESSUREGRADIENT.setter
    def MASSEDPRESSUREGRADIENT(self, value: ensobjlist['ENS_VAR']) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDPRESSUREGRADIENT, value)
    ...
    def massedpressuregradient(self) -> ensobjlist['ENS_VAR']:
        ...
        Note: both 'massedpressuregradient' and 'MASSEDPRESSUREGRADIENT' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDPRESSUREGRADIENT)
        _value = cast(ensobjlist['ENS_VAR'], value)
        return _value
    ...
    @property
    def MASSEDREBOUND(self) -> int:
        """MASSEDREBOUND property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUND)
        _value = cast(int, value)
        return _value

    @MASSEDREBOUND.setter
    def MASSEDREBOUND(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDREBOUND, value)
    ...
    def massedrebound(self) -> int:
        ...
        Note: both 'massedrebound' and 'MASSEDREBOUND' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUND)
        _value = cast(int, value)
        return _value
    ...
    @property
    def MASSEDCOEFRESTITUTION(self) -> float:
        """MASSEDCOEFRESTITUTION property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDCOEFRESTITUTION)
        _value = cast(float, value)
        return _value

    @MASSEDCOEFRESTITUTION.setter
    def MASSEDCOEFRESTITUTION(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDCOEFRESTITUTION, value)
    ...
    def massedcoefrestitution(self) -> float:
        ...
        Note: both 'massedcoefrestitution' and 'MASSEDCOEFRESTITUTION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDCOEFRESTITUTION)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDCOEFFRICTION(self) -> float:
        """MASSEDCOEFFRICTION property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDCOEFFRICTION)
        _value = cast(float, value)
        return _value

    @MASSEDCOEFFRICTION.setter
    def MASSEDCOEFFRICTION(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDCOEFFRICTION, value)
    ...
    def massedcoeffriction(self) -> float:
        ...
        Note: both 'massedcoeffriction' and 'MASSEDCOEFFRICTION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDCOEFFRICTION)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDREBOUNDFRACTION(self) -> float:
        """MASSEDREBOUNDFRACTION property
        
        Stop criteria: Fraction of initial impact velocity
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUNDFRACTION)
        _value = cast(float, value)
        return _value

    @MASSEDREBOUNDFRACTION.setter
    def MASSEDREBOUNDFRACTION(self, value: float) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDREBOUNDFRACTION, value)
    ...
    def massedreboundfraction(self) -> float:
        ...
        Note: both 'massedreboundfraction' and 'MASSEDREBOUNDFRACTION' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUNDFRACTION)
        _value = cast(float, value)
        return _value
    ...
    @property
    def MASSEDREBOUNDWALLHITS(self) -> int:
        """MASSEDREBOUNDWALLHITS property
        
        Stop criteria: Max number of wall hits
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUNDWALLHITS)
        _value = cast(int, value)
        return _value

    @MASSEDREBOUNDWALLHITS.setter
    def MASSEDREBOUNDWALLHITS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.MASSEDREBOUNDWALLHITS, value)
    ...
    def massedreboundwallhits(self) -> int:
        ...
        Note: both 'massedreboundwallhits' and 'MASSEDREBOUNDWALLHITS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.MASSEDREBOUNDWALLHITS)
        _value = cast(int, value)
        return _value
