"""ens_part_elevated_surface module

The ens_part_elevated_surface module provides a proxy interface to EnSight ENS_PART_ELEVATED_SURFACE instances
...
class ENS_PART_ELEVATED_SURFACE(ENS_PART):
    ...
    def TYPE(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.TYPE_ELEVATED_SURFACE - elevated
            * ensight.objs.enums.TYPE_OFFSET_SURFACE - offset
    ...
    def SURFACE(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SURFACE)
        _value = cast(int, value)
        return _value

    @SURFACE.setter
    def SURFACE(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SURFACE, value)
    ...
    def surface(self) -> int:
        ...
        Note: both 'surface' and 'SURFACE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SURFACE)
        _value = cast(int, value)
        return _value
    ...
    def SIDEWALL(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SIDEWALL)
        _value = cast(int, value)
        return _value

    @SIDEWALL.setter
    def SIDEWALL(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SIDEWALL, value)
    ...
    def sidewall(self) -> int:
        ...
        Note: both 'sidewall' and 'SIDEWALL' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SIDEWALL)
        _value = cast(int, value)
        return _value
    ...
    @property
    def USESURFACENORMALS(self) -> int:
        """USESURFACENORMALS property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.USESURFACENORMALS)
        _value = cast(int, value)
        return _value

    @USESURFACENORMALS.setter
    def USESURFACENORMALS(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.USESURFACENORMALS, value)
    ...
    def usesurfacenormals(self) -> int:
        ...
        Note: both 'usesurfacenormals' and 'USESURFACENORMALS' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.USESURFACENORMALS)
        _value = cast(int, value)
        return _value
    ...
    @property
    def OFFSETFROMPART(self) -> int:
        """OFFSETFROMPART property
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.OFFSETFROMPART)
        _value = cast(int, value)
        return _value
    ...
    def offsetfrompart(self) -> int:
        ...
        Note: both 'offsetfrompart' and 'OFFSETFROMPART' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.OFFSETFROMPART)
        _value = cast(int, value)
        return _value
