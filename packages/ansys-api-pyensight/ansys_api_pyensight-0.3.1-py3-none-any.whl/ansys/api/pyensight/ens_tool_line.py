"""ens_tool_line module

The ens_tool_line module provides a proxy interface to EnSight ENS_TOOL_LINE instances
...
class ENS_TOOL_LINE(ENS_TOOL):
    ...
    def rawdata(self, *args, **kwargs) -> Any:
        ...
        for key, value in kwargs.items():
            arg_list.append(f"{key}={value.__repr__()}")
        arg_string = ",".join(arg_list)
        cmd = f"{arg_obj}.rawdata({arg_string})"
        return self._session.cmd(cmd)

    def fit_to_selected(self, *args, **kwargs) -> Any:
        ...
        for key, value in kwargs.items():
            arg_list.append(f"{key}={value.__repr__()}")
        arg_string = ",".join(arg_list)
        cmd = f"{arg_obj}.fit_to_selected({arg_string})"
        return self._session.cmd(cmd)
    ...
    def TOOLTYPE(self) -> int:
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.TOOL_CURSOR - cursor tool
            * ensight.objs.enums.TOOL_LINE - line tool
            * ensight.objs.enums.TOOL_PLANE - plane tool
            * ensight.objs.enums.TOOL_BOX - box tool
            * ensight.objs.enums.TOOL_CYLINDER - cylinder tool
            * ensight.objs.enums.TOOL_CONE - cone tool
            * ensight.objs.enums.TOOL_SPHERE - sphere tool
            * ensight.objs.enums.TOOL_REVOLUTION - revolution tool
            * ensight.objs.enums.TOOL_USERDEFINED - userdefined tool
        
        """
        value = self.getattr(self._session.ensight.objs.enums.TOOLTYPE)
        _value = cast(int, value)
        return _value
    ...
    def tooltype(self) -> int:
        ...
        Note: both 'tooltype' and 'TOOLTYPE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.TOOLTYPE)
        _value = cast(int, value)
        return _value
    ...
    def CORE(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.CORE)
        _value = cast(int, value)
        return _value
    ...
    def core(self) -> int:
        ...
        Note: both 'core' and 'CORE' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.CORE)
        _value = cast(int, value)
        return _value
    ...
    def POINT1(self) -> List[float]:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.POINT1)
        _value = cast(List[float], value)
        return _value

    @POINT1.setter
    def POINT1(self, value: List[float]) -> None:
        self.setattr(self._session.ensight.objs.enums.POINT1, value)
    ...
    def point1(self) -> List[float]:
        ...
        Note: both 'point1' and 'POINT1' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.POINT1)
        _value = cast(List[float], value)
        return _value
    ...
    def POINT2(self) -> List[float]:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.POINT2)
        _value = cast(List[float], value)
        return _value

    @POINT2.setter
    def POINT2(self, value: List[float]) -> None:
        self.setattr(self._session.ensight.objs.enums.POINT2, value)
    ...
    def point2(self) -> List[float]:
        ...
        Note: both 'point2' and 'POINT2' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.POINT2)
        _value = cast(List[float], value)
        return _value
    ...
    def SNAP_SURF(self) -> int:
        ...
        """
        value = self.getattr(self._session.ensight.objs.enums.SNAP_SURF)
        _value = cast(int, value)
        return _value

    @SNAP_SURF.setter
    def SNAP_SURF(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SNAP_SURF, value)
    ...
    def snap_surf(self) -> int:
        ...
        Note: both 'snap_surf' and 'SNAP_SURF' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SNAP_SURF)
        _value = cast(int, value)
        return _value
    ...
    @property
    def SNAP_NORM(self) -> int:
        """SNAP_NORM property
        
        snap normal direction
        ...
        Datatype:
            Enum, scalar
        Enums:
            * ensight.objs.enums.POSITIVE_SURFACE_DIRECTION - positive
            * ensight.objs.enums.NEGATIVE_SURFACE_DIRECTION - negative
        
        """
        value = self.getattr(self._session.ensight.objs.enums.SNAP_NORM)
        _value = cast(int, value)
        return _value

    @SNAP_NORM.setter
    def SNAP_NORM(self, value: int) -> None:
        self.setattr(self._session.ensight.objs.enums.SNAP_NORM, value)
    ...
    def snap_norm(self) -> int:
        ...
        Note: both 'snap_norm' and 'SNAP_NORM' property names are supported.
        """
        value = self.getattr(self._session.ensight.objs.enums.SNAP_NORM)
        _value = cast(int, value)
        return _value
