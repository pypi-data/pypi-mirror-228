...
def train(
    ...
    autodeploy_requirements_file = autodeploy_requirements_file if autodeploy_requirements_file else autodeploy.get("requirements_file", None)
    autodeploy_pkglist_file = autodeploy_pkglist_file if autodeploy_pkglist_file else autodeploy.get("pkglist_file", None)
