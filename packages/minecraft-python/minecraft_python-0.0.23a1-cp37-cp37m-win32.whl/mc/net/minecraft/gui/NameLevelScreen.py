...
class NameLevelScreen(Screen):
    ...
    def init(self, minecraft, width, height):
        ...
        self._buttons.clear()
        self._buttons.append(Button(0, self._width // 2 - 100, self._height // 4 + 120, 'Save'))
        self._buttons.append(Button(1, self._width // 2 - 100, self._height // 4 + 144, 'Cancel'))
    ...
    def render(self, xm, ym):
        ...
        self.drawCenteredString(self._font, self.__title, self._width / 2, 40, 0xFFFFFF)
        i3 = self._width // 2 - 100
        i4 = self._height // 2 - 10
        self._fill(i3 - 1, i4 - 1, i3 + 200 + 1, i4 + 20 + 1, -6250336)
        self._fill(i3, i4, i3 + 200, i4 + 20, -16777216)
        self.drawString(self._font, self.__name + ('_' if self.__counter // 6 % 2 == 0 else ''), i3 + 4, i4 + 6, 14737632)
        super().render(xm, ym)
