...
class Gui:
    ...
    def blit(self, i1, i2, i3, i4, i5, i6):
        ...
        t = tesselator
        t.begin()
        t.vertexUV(i1, i2 + i6, self._zLevel, i3 * f7, (i4 + i6) * f8)
        t.vertexUV(i1 + i5, i2 + i6, self._zLevel, (i3 + i5) * f7, (i4 + i6) * f8)
        t.vertexUV(i1 + i5, i2, self._zLevel, (i3 + i5) * f7, i4 * f8)
        t.vertexUV(i1, i2, self._zLevel, i3 * f7, i4 * f8)
        t.end()
