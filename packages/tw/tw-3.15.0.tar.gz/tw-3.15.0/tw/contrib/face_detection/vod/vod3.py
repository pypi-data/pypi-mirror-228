...
class VOD3():
  ...
  def __init__(self, device='cuda:0', pretrain='/cephFS/video_lab/checkpoints/detection/bigolive_face_detector/bigolive_face_detector.mobilenet.Y.G17.giou.bbox.epoch-250.pth'):
    self.device = device
