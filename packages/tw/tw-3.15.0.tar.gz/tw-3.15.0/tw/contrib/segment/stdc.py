...
class ContextPath(nn.Module):
  def __init__(self, backbone='CatNetSmall', pretrain_model='', use_conv_last=False, is_replace_upsample=False, *args, **kwargs):
...
class BiSeNet(nn.Module):
  def __init__(self, backbone, seg_classes, sod_classes, aux_mode='train', pretrain_model='', use_conv_last=False, is_replace_upsample=False, mode='seg', is_onnx=False, *args, **kwargs):
