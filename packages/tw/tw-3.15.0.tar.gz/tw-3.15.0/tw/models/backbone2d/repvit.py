"""Ref: https://github.com/THU-MIG/RepViT/blob/main/model/repvit.py
"""
...
@register_model
def repvit_t2(pretrained=False, num_classes = 1000, distillation=False):
    """
    Constructs a MobileNetV3-Large model
    """
    cfgs = [
        # k, t, c, SE, HS, s 
        [3,   2,  int(48 * 0.5), 1, 0, 1],
        [3,   2,  int(48 * 0.5), 0, 0, 1],
        [3,   2,  int(48 * 0.5), 0, 0, 1],
        [3,   2,  int(96 * 0.5), 0, 0, 2],
        [3,   2,  int(96 * 0.5), 1, 0, 1],
        [3,   2,  int(96 * 0.5), 0, 0, 1],
        [3,   2,  int(96 * 0.5), 0, 0, 1],
        [3,   2,  int(192 * 0.5), 0, 1, 2],
        [3,   2,  int(192 * 0.5), 1, 1, 1],
        [3,   2,  int(192 * 0.5), 0, 1, 1],
        [3,   2,  int(192 * 0.5), 1, 1, 1],
        [3,   2, int(192 * 0.5), 0, 1, 1],
        [3,   2, int(192 * 0.5), 1, 1, 1],
        [3,   2, int(192 * 0.5), 0, 1, 1],
        ...
        [3,   2, int(192 * 0.5), 0, 1, 1],
        [3,   2, int(192 * 0.5), 0, 1, 1],
        [3,   2, int(384 * 0.5), 0, 1, 2],
        [3,   2, int(384 * 0.5), 1, 1, 1],
        [3,   2, int(384 * 0.5), 0, 1, 1]
    ]
