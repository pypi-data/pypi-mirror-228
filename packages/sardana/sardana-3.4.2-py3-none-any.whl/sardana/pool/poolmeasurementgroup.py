...
class MeasurementConfiguration(object):
    ...
    def get_synchs(self, enabled=None):
        ...
        :rtype: list<:class:`~sardana.pool.poolmeasurementgroup.SynchronizerConfiguration`>  # noqa
        """
        synchs = []
...
class PoolMeasurementGroup(PoolGroupElement):
    ...
    def init_attribute_values(self, attr_values=None):
        ...
        :type attr_values: `dict` {`str`: `object`}
        """
