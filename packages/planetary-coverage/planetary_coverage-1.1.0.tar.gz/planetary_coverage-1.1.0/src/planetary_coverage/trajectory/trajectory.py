...
class Trajectory:  # pylint: disable=too-many-public-methods
    ...
    def radec(self):
        ...
        return radec(np.einsum('ijk,i->jk',
                               self.attitude,
                               self.boresight,
                               optimize=True))
    ...
    @check_kernels
    def target_separation(self, target_1, target_2=None, *,
    ...
    def station_azel(self, station, *, az_spice=False, el_spice=True):
        ...
        """
        log_traj.info('Compute %s azimuth and elevation at %s station.',
                      self.spacecraft, station)
...
class Flyby(Trajectory):
    ...
    *dt: tuple(s), optional
    ...
    def __init__(self, kernels, observer, target, approx_ca_utc, *dt,
                 abcorr='NONE', exclude=None, alt_min=150_000):
