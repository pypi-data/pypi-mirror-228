...
\b
CLUSTER EXECUTION:
aerial_utils run ... -profile [profile],[profile],...
For information on Nextflow config and profiles see:
https://www.nextflow.io/docs/latest/config.html#config-profiles
\b
RUN EXAMPLES:
Required:           aerial_utils run --input [file]
Specify threads:    aerial_utils run ... --threads [threads]
Enable conda:       aerial_utils run ... --use-conda 
Add NextFlow args:  aerial_utils run ... -work-dir workDir -with-docker
"""
