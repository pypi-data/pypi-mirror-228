...
class Ui_CaveStoryGameTabWidget(object):
    def setupUi(self, CaveStoryGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 417, 390))
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 407, 721))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 417, 390))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 417, 390))
        ...
        CaveStoryGameTabWidget.addTab(self.hint_item_names_tab, "")
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 417, 390))
...
"**Numahachi**: In the Statue Chamber, Numahachi will provide two hints about the items found in Sacred Grounds.", None))
        ...
        self.hint_item_names_label.setText(QCoreApplication.translate("CaveStoryGameTabWidget", u"<html><head/><body><p>When\n"
...
"                                            ", None))
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("CaveStoryGameTabWidget", u"Item", None));
        ___qtablewidgetitem1 = self.hint_item_names_tree_widget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("CaveStoryGameTabWidget", u"Precise Category", None));
        ___qtablewidgetitem2 = self.hint_item_names_tree_widget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("CaveStoryGameTabWidget", u"General Category", None));
        ___qtablewidgetitem3 = self.hint_item_names_tree_widget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("CaveStoryGameTabWidget", u"Broad Category", None));
        CaveStoryGameTabWidget.setTabText(CaveStoryGameTabWidget.indexOf(self.hint_item_names_tab), QCoreApplication.translate("CaveStoryGameTabWidget", u"Hint Item Names", None))
...
"                                            ", None))
        ...
        CaveStoryGameTabWidget.setTabText(CaveStoryGameTabWidget.indexOf(self.hint_locations_tab), QCoreApplication.translate("CaveStoryGameTabWidget", u"Hints Locations", None))
        pass
    # retranslateUi
