...
class Ui_DreadGameTabWidget(object):
    def setupUi(self, DreadGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 631, 464))
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 631, 464))
        ...
        self.known_crashes_contents.setGeometry(QRect(0, 0, 617, 678))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 631, 464))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 631, 464))
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 631, 464))
...
"", None))
        ...
        self.hint_locations_label.setText(QCoreApplication.translate("DreadGameTabWidget", u"<html><head/><body><p>Hints\n"
