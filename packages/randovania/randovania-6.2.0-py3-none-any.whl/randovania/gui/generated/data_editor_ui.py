...
from randovania.gui.lib.data_editor_canvas import *  # type: ignore
...
class Ui_DataEditorWindow(object):
    def setupUi(self, DataEditorWindow):
        ...
        self.rename_area_button = QPushButton(self.points_of_interest_content)
        self.rename_area_button.setObjectName(u"rename_area_button")

        self.points_of_interest_layout.addWidget(self.rename_area_button)
        ...
        self.nodes_scroll_contents.setGeometry(QRect(0, 0, 156, 193))
        ...
        DataEditorWindow.addDockWidget(Qt.LeftDockWidgetArea, self.points_of_interest_dock)
        ...
        self.gridLayout.addWidget(self.other_node_connection_edit_button, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.other_node_alternatives_contents, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.other_node_connection_swap_button, 0, 1, 1, 1)


        self.verticalLayout.addWidget(self.connections_group)

        self.node_info_dock.setWidget(self.node_info_content)
        DataEditorWindow.addDockWidget(Qt.RightDockWidgetArea, self.node_info_dock)
        ...
        DataEditorWindow.addDockWidget(Qt.BottomDockWidgetArea, self.area_view_dock)
    ...
    def retranslateUi(self, DataEditorWindow):
        ...
        self.rename_area_button.setText(QCoreApplication.translate("DataEditorWindow", u"Rename Area", None))
