...
class Ui_PresetPrimeQol(object):
    def setupUi(self, PresetPrimeQol):
        ...
        self.scroll_contents.setGeometry(QRect(0, -271, 487, 956))
        ...
        self.logical_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.blue_save_doors_check = QCheckBox(self.logical_group)
        ...
        self.blue_save_doors_label = QLabel(self.logical_group)
    ...
    def retranslateUi(self, PresetPrimeQol):
        ...
        self.description_label.setText(QCoreApplication.translate("PresetPrimeQol", u"<html><head/><body><p>This tab offers various impovements over the base game to better suit it for randomization and frequent playing.</p></body></html>", None))
        ...
        self.blue_save_doors_check.setText(QCoreApplication.translate("PresetPrimeQol", u"Unlock Save Station Doors", None))
        self.blue_save_doors_label.setText(QCoreApplication.translate("PresetPrimeQol", u"Ensure all Save Station doors are blue doors, even with door lock rando enabled", None))
        ...
        self.cutscene_combo.setItemText(1, QCoreApplication.translate("PresetPrimeQol", u"Competitive", None))
        self.cutscene_combo.setItemText(2, QCoreApplication.translate("PresetPrimeQol", u"Minor", None))
        self.cutscene_combo.setItemText(3, QCoreApplication.translate("PresetPrimeQol", u"Major", None))
        self.cutscene_combo.setItemText(4, QCoreApplication.translate("PresetPrimeQol", u"Skippable (Experimental)", None))
        self.cutscene_combo.setItemText(5, QCoreApplication.translate("PresetPrimeQol", u"Competitive (Experimental)", None))

        self.cutscene_label.setText(QCoreApplication.translate("PresetPrimeQol", u"<html><head/><body><p><span style=\" font-weight:600;\">Original</span>: No changes to the cutscenes are made.</p><p><span style=\" font-weight:600;\">Competitive</span>: Similar to minor, but leaves a few rooms alone where skipping cutscenes would be inappropriate for races.</p><p><span style=\" font-weight:600;\">Minor</span>: Removes cutscenes that don't affect the game too much when removed.</p><p><span style=\" font-weight:600;\">Major</span>: Allows you to continue playing the game while cutscenes happen.</p></body></html>", None))
