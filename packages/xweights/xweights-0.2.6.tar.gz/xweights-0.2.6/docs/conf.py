#
# xweights documentation build configuration file
#
...
project = "xweights"
copyright = "2022, Ludwig Lierhammer"
...
version = xweights.__version__  # .split("+")[0]
# The full version, including alpha/beta/rc tags.
release = xweights.__version__
