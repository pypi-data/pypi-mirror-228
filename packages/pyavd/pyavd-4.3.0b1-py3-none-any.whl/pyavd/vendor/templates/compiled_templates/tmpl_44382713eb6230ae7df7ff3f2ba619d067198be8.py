...
def root(context, missing=missing):
    ...
    pass
    if ((((((((t_1((undefined(name='switchport_default') if l_0_switchport_default is missing else l_0_switchport_default)) or t_1((undefined(name='interface_defaults') if l_0_interface_defaults is missing else l_0_interface_defaults))) or t_1((undefined(name='interface_profiles') if l_0_interface_profiles is missing else l_0_interface_profiles))) or t_1((undefined(name='ethernet_interfaces') if l_0_ethernet_interfaces is missing else l_0_ethernet_interfaces))) or t_1((undefined(name='port_channel_interfaces') if l_0_port_channel_interfaces is missing else l_0_port_channel_interfaces))) or t_1((undefined(name='loopback_interfaces') if l_0_loopback_interfaces is missing else l_0_loopback_interfaces))) or t_1((undefined(name='tunnel_interfaces') if l_0_tunnel_interfaces is missing else l_0_tunnel_interfaces))) or t_1((undefined(name='vlan_interfaces') if l_0_vlan_interfaces is missing else l_0_vlan_interfaces))) or t_1((undefined(name='vxlan_interface') if l_0_vxlan_interface is missing else l_0_vxlan_interface))):
        pass
        yield '\n## Interfaces\n'
...
blocks = {}
debug_info = '6=26&18=29&20=32&22=35&24=38&26=41&28=44&30=47&32=50&34=53'