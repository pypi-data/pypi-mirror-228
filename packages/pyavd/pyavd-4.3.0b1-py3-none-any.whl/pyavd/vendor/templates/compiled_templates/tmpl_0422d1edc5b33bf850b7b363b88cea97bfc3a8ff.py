...
def root(context, missing=missing):
    ...
    pass
    if t_4((undefined(name='tacacs_servers') if l_0_tacacs_servers is missing else l_0_tacacs_servers)):
        pass
        yield '!\n'
        for l_1_host in t_3(environment.getattr((undefined(name='tacacs_servers') if l_0_tacacs_servers is missing else l_0_tacacs_servers), 'hosts')):
            ...
            if t_4(environment.getattr(l_1_host, 'single_connection'), True):
                pass
            ...
            if t_4(environment.getattr(l_1_host, 'vrf')):
                ...
                if (environment.getattr(l_1_host, 'vrf') != 'default'):
                    ...
                    _loop_vars['host_cli'] = l_1_host_cli
            if t_4(environment.getattr(l_1_host, 'timeout')):
                pass
                ...
                _loop_vars['host_cli'] = l_1_host_cli
            if t_4(environment.getattr(l_1_host, 'key')):
                pass
        ...
        if t_4(environment.getattr((undefined(name='tacacs_servers') if l_0_tacacs_servers is missing else l_0_tacacs_servers), 'policy_unknown_mandatory_attribute_ignore'), True):
            pass
            yield 'tacacs-server policy unknown-mandatory-attribute ignore\n'

blocks = {}
debug_info = '7=36&9=39&10=44&11=46&13=48&14=50&16=52&17=54&18=56&21=58&22=60&24=62&25=64&27=66&29=69'