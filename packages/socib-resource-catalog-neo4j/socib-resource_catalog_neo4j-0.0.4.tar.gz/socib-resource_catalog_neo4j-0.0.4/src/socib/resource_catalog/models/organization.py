...
class OrganizationImpl (object): 
    ...
    address = RelationshipTo("socib.resource_catalog.models.Address", "HAS_ADDRESS")
    affiliations = RelationshipTo("socib.resource_catalog.models.Organization", "IS_AFFILIATED")
    email = EmailProperty(required=False)#(required=True, unique_index=True) 

    def __init__ (self):
        logging.debug("[OrganizationImpl::__init__] entering method")
