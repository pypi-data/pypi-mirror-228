...
class Relationship:
    ...
    def get_child_message(self, message_id: str) -> List[str]:
        """
        Get the children of a message with a given id.
            ...
            if message is not None:
                ...
                for child_message in children:
                    if child_message is not None and child_message.id is not None:
                        ...
                        print(f"Warning: Invalid child message or child message id: {child_message}")
