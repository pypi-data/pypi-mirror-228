...
def semantic_similarity_cosine(sentence1: str, sentence2: str):
...
def should_connect_semantic(node1: Tuple[Any, ...], node2: Tuple[Any, ...]) -> bool:
    ...
    if (
        semantic_similarity_cross_entropy_adjusted(sentence1, sentence2)
        < cross_entropy_threshold
        and semantic_similarity_cosine(sentence1, sentence2)
