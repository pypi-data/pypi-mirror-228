...
class MessageLayout(Relationship):
    ...
    def time_decay_factor(
        ...
        try:
            if (
                ...
                or not message.message.create_time
            ):
            ...
            if (
                ...
                or not sub_thread_root.message.create_time
            ):
    ...
    def calculate_t_coordinate(
        ...
        dynamic_alpha_scale = alpha_scale(sub_thread_root, mapping.message.content.content_type,) if callable(alpha_scale) else alpha_scale
