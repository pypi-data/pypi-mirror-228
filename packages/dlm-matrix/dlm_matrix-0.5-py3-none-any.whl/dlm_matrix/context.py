...
def get_file_paths(base_persist_dir, title):
    ...
    main_df_name = f"main_df.csv"
    global_embedding_name = f"global_embedding.npy"
    conversation_tree_name = f"conversation_tree.json"
    relationship_name = f"relationship.csv"
