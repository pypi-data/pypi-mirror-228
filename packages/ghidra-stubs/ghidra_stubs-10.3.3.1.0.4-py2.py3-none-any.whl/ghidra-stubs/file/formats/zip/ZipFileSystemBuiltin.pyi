...
class ZipFileSystemBuiltin(object, ghidra.formats.gfilesystem.GFileSystem):
    ...
    def mount(self, __a0: java.io.File, __a1: bool, __a2: ghidra.util.task.TaskMonitor) -> None: ...
