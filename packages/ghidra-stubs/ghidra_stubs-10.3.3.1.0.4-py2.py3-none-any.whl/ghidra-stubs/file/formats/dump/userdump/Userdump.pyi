...
import ghidra.file.formats.dump.userdump
...
class Userdump(ghidra.file.formats.dump.DumpFile):
    SIGNATURE: int = 1380275029
    ...
    def getFileHeader(self) -> ghidra.file.formats.dump.userdump.UserdumpFileHeader: ...
    ...
    @property
    def fileHeader(self) -> ghidra.file.formats.dump.userdump.UserdumpFileHeader: ...