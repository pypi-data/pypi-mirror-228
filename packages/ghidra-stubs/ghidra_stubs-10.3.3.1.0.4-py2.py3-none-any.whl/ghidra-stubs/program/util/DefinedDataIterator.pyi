...
class DefinedDataIterator(object, ghidra.program.model.listing.DataIterator):
    ...
    EMPTY: ghidra.program.model.listing.DataIterator = ghidra.program.model.listing.DataIterator$IteratorWrapper@3b22860b
    ...
    @overload
    @staticmethod
    def byDataType(program: ghidra.program.model.listing.Program, addresses: ghidra.program.model.address.AddressSetView, dataTypePredicate: java.util.function.Predicate) -> ghidra.program.util.DefinedDataIterator:
        """
