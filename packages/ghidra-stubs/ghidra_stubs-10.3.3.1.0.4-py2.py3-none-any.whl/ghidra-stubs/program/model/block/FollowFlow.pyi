...
class FollowFlow(object):
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addressSet: ghidra.program.model.address.AddressSet, doNotFollow: List[ghidra.program.model.symbol.FlowType], followIntoFunctions: bool, includeData: bool):
        """
        Constructor
        @param program the program whose flow we are following.
        @param addressSet the initial addresses that should be flowed from or flowed to.
