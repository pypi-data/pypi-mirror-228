...
class CycleGroup(object):
    ...
    ALL_CYCLE_GROUPS: List[object] = [ghidra.program.model.data.CycleGroup$ByteCycleGroup@c440427, ghidra.program.model.data.CycleGroup$FloatCycleGroup@75432b7d, ghidra.program.model.data.CycleGroup$StringCycleGroup@1866548c]
    BYTE_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$ByteCycleGroup@c440427
    FLOAT_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$FloatCycleGroup@75432b7d
    STRING_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$StringCycleGroup@1866548c
