...
class EndianSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    BIG: int = 2
    DEF: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@283f8dd1
    DEFAULT: int = 0
    ENDIAN: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@283f8dd1
    LITTLE: int = 1
