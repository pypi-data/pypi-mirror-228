...
class AbstractStringDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic, ghidra.program.model.data.DataTypeWithCharset):
    """
    ...
    COMMON_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@5f779733, ghidra.program.model.data.RenderUnicodeSettingsDefinition@b842f31])
    COMMON_WITH_CHARSET_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@5f779733, ghidra.program.model.data.RenderUnicodeSettingsDefinition@b842f31, ghidra.program.model.data.CharsetSettingsDefinition@3538d79])
    DEFAULT_ABBREV_PREFIX: unicode = u's'
    DEFAULT_LABEL: unicode = u'STRING'
    DEFAULT_LABEL_PREFIX: unicode = u'STR'
    DEFAULT_UNICODE_ABBREV_PREFIX: unicode = u'u'
    DEFAULT_UNICODE_LABEL: unicode = u'UNICODE'
    DEFAULT_UNICODE_LABEL_PREFIX: unicode = u'UNI'
    USE_CHARSET_DEF_DEFAULT: unicode = None
    ...
    def encodeCharacterRepresentation(self, __a0: unicode, __a1: ghidra.program.model.mem.MemBuffer, __a2: ghidra.docking.settings.Settings) -> List[int]: ...

    def encodeCharacterValue(self, __a0: object, __a1: ghidra.program.model.mem.MemBuffer, __a2: ghidra.docking.settings.Settings) -> List[int]: ...
    ...
    @property
    def stringLayout(self) -> ghidra.program.model.data.StringLayoutEnum: ...