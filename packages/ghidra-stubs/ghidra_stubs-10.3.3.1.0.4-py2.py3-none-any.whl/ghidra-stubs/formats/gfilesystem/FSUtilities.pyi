...
class FSUtilities(object):
    GFILE_NAME_TYPE_COMPARATOR: java.util.Comparator = ghidra.formats.gfilesystem.FSUtilities$$Lambda$207/0x00000001006099b8@93d12fd
    SEPARATOR: unicode = u'/'
    ...
    @overload
    @staticmethod
    def getMD5(is_: java.io.InputStream, monitor: ghidra.util.task.TaskMonitor) -> unicode:
        """
