...
class TaskMonitorComponent(javax.swing.JPanel, ghidra.util.task.TaskMonitor):
    """
    ...
    @overload
    def __init__(self, includeTextField: bool, includeCancelButton: bool):
        """
        Constructor
    ...
    def setCancelButtonVisibility(self, visible: bool) -> None:
        """
    ...
    def setTaskName(self, name: unicode) -> None:
        """
    ...
    def showProgress(self, show: bool) -> None:
        """
    ...
    def showProgressIcon(self, visible: bool) -> None:
        """
    ...
    @property
    def cancelButtonVisibility(self) -> None: ...  # No getter available.

    @cancelButtonVisibility.setter
    def cancelButtonVisibility(self, value: bool) -> None: ...
    ...
    @property
    def taskName(self) -> None: ...  # No getter available.

    @taskName.setter
    def taskName(self, value: unicode) -> None: ...