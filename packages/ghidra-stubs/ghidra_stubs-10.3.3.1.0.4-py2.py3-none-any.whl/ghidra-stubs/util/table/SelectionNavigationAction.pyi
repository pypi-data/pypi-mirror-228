...
class SelectionNavigationAction(ghidra.util.table.AbstractSelectionNavigationAction):
    """
    This action is used by GhidraTables to allow the user to trigger navigation when 
     selections are made.
    ...
    @overload
    def __init__(self, owner: unicode, table: ghidra.util.table.GhidraTable):
        """
