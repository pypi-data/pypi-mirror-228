...
class DataReferenceGraphDisplayListener(ghidra.app.plugin.core.graph.AddressBasedGraphDisplayListener):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.service.graph.GraphDisplay, __a2: ghidra.program.model.listing.Program, __a3: int): ...
