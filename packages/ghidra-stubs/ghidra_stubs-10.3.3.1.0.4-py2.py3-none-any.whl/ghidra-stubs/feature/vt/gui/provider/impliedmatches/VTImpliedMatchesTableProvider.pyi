...
class VTImpliedMatchesTableProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.feature.vt.gui.plugin.VTControllerListener):
    ...
    def getSelectedImpliedMatches(self) -> List[object]: ...
    ...
    @property
    def selectedImpliedMatches(self) -> List[object]: ...
