...
class CreateImpliedMatchAction(docking.action.DockingAction):




    def __init__(self, __a0: ghidra.feature.vt.gui.plugin.VTController, __a1: ghidra.feature.vt.gui.provider.impliedmatches.VTImpliedMatchesTableProvider): ...
