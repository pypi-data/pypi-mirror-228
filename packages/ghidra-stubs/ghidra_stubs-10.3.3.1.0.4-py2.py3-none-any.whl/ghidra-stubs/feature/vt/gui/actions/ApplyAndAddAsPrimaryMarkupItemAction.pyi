...
class ApplyAndAddAsPrimaryMarkupItemAction(ghidra.feature.vt.gui.actions.AbstractMarkupItemAction):
    ...
    def getActionType(self) -> ghidra.feature.vt.api.main.VTMarkupItemApplyActionType: ...

    def getApplyOptions(self) -> ghidra.framework.options.ToolOptions: ...
    ...
    @property
    def actionType(self) -> ghidra.feature.vt.api.main.VTMarkupItemApplyActionType: ...

    @property
    def applyOptions(self) -> ghidra.framework.options.ToolOptions: ...