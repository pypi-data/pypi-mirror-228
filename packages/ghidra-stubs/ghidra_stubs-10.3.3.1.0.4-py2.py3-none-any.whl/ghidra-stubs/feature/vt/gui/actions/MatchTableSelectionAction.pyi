...
class MatchTableSelectionAction(docking.menu.MultiStateDockingAction):
    NAME: unicode = u'Table Selection Mode'



    def __init__(self, __a0: ghidra.feature.vt.gui.provider.matchtable.VTMatchTableProvider): ...
