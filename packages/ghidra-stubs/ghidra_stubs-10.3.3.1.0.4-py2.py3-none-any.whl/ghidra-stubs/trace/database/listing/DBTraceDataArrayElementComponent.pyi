...
class DBTraceDataArrayElementComponent(ghidra.trace.database.listing.AbstractDBTraceDataComponent):
    ...
    def getPrimaryReference(self, __a0: int) -> ghidra.trace.database.symbol.DBTraceReference: ...

    def getPrimarySymbol(self) -> ghidra.program.model.symbol.Symbol: ...

    def getPrimarySymbolOrDynamicName(self) -> unicode: ...

    def getPrimitiveAt(self, __a0: int) -> ghidra.program.model.listing.Data: ...
    ...
    def getSettingsSpace(self, __a0: bool) -> ghidra.trace.database.data.DBTraceDataSettingsAdapter.DBTraceDataSettingsSpace: ...
