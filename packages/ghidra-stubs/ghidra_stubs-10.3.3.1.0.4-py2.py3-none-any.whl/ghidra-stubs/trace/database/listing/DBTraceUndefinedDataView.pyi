...
class DBTraceUndefinedDataView(ghidra.trace.database.listing.AbstractSingleDBTraceCodeUnitsView, ghidra.trace.model.listing.TraceUndefinedDataView, ghidra.trace.database.listing.InternalBaseCodeUnitsView):
    ...
    def getFloor(self, __a0: long, __a1: ghidra.program.model.address.Address) -> ghidra.trace.database.listing.UndefinedDBTraceData: ...
