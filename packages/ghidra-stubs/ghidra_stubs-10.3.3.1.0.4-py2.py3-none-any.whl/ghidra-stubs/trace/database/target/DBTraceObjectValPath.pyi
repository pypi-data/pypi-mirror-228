...
class DBTraceObjectValPath(object, ghidra.trace.model.target.TraceObjectValPath):
    EMPTY: ghidra.trace.database.target.DBTraceObjectValPath = ghidra.trace.database.target.DBTraceObjectValPath@45bccbe9
    ...
    @overload
    @staticmethod
    def of(__a0: List[ghidra.trace.database.target.InternalTraceObjectValue]) -> ghidra.trace.database.target.DBTraceObjectValPath: ...

    @overload
    @staticmethod
    def of(__a0: java.util.Collection) -> ghidra.trace.database.target.DBTraceObjectValPath: ...

    def prepend(self, __a0: ghidra.trace.model.target.TraceObjectValue) -> ghidra.trace.database.target.DBTraceObjectValPath: ...
    ...
    @property
    def firstEntry(self) -> ghidra.trace.database.target.InternalTraceObjectValue: ...

    @property
    def keyList(self) -> List[object]: ...

    @property
    def lastEntry(self) -> ghidra.trace.database.target.InternalTraceObjectValue: ...