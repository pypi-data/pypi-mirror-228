...
class DBTraceDataSettingsAdapter(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMap, ghidra.trace.database.data.DBTraceDataSettingsOperations):
    NAME: unicode = u'DataSettings'




    class DBTraceDataSettingsSpace(ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapSpace, ghidra.trace.database.data.DBTraceDataSettingsOperations):




        def __init__(self, __a0: ghidra.trace.database.data.DBTraceDataSettingsAdapter, __a1: unicode, __a2: ghidra.util.database.DBCachedObjectStoreFactory, __a3: java.util.concurrent.locks.ReadWriteLock, __a4: ghidra.program.model.address.AddressSpace, __a5: ghidra.trace.model.thread.TraceThread, __a6: int, __a7: java.lang.Class, __a8: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMap.DBTraceAddressSnapRangePropertyMapDataFactory): ...
    ...
    def __init__(self, __a0: db.DBHandle, __a1: ghidra.util.database.DBOpenMode, __a2: java.util.concurrent.locks.ReadWriteLock, __a3: ghidra.util.task.TaskMonitor, __a4: ghidra.program.model.lang.Language, __a5: ghidra.trace.database.DBTrace, __a6: ghidra.trace.database.thread.DBTraceThreadManager): ...
    ...
    @overload
    def getRegisterSpace(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: bool) -> ghidra.trace.database.data.DBTraceDataSettingsAdapter.DBTraceDataSettingsSpace: ...
