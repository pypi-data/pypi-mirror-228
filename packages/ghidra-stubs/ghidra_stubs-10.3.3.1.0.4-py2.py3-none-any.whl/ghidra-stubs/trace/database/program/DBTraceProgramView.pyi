...
class DBTraceProgramView(object, ghidra.trace.model.program.TraceProgramView):
    ...
    @property
    def listing(self) -> ghidra.trace.database.program.DBTraceProgramViewListing: ...
    ...
    @property
    def memory(self) -> ghidra.trace.database.program.DBTraceProgramViewMemory: ...
