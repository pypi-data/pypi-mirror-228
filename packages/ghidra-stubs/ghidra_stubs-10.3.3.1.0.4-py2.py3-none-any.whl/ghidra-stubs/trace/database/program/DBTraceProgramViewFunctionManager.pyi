...
class DBTraceProgramViewFunctionManager(object, ghidra.program.model.listing.FunctionManager):
    ...
    @overload
    def createFunction(self, __a0: unicode, __a1: ghidra.program.model.symbol.Namespace, __a2: ghidra.program.model.address.Address, __a3: ghidra.program.model.address.AddressSetView, __a4: ghidra.program.model.symbol.SourceType) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...

    def createThunkFunction(self, __a0: unicode, __a1: ghidra.program.model.symbol.Namespace, __a2: ghidra.program.model.address.Address, __a3: ghidra.program.model.address.AddressSetView, __a4: ghidra.program.model.listing.Function, __a5: ghidra.program.model.symbol.SourceType) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...
    ...
    def getFunction(self, __a0: long) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...
    ...
    def programReady(self, __a0: int, __a1: int, __a2: ghidra.util.task.TaskMonitor) -> None: ...
