...
class DBTraceProgramViewRegisterListing(ghidra.trace.database.program.AbstractDBTraceProgramViewListing, ghidra.trace.model.program.TraceProgramViewRegisterListing):




    def __init__(self, __a0: ghidra.trace.database.program.DBTraceProgramView, __a1: ghidra.trace.database.listing.DBTraceCodeSpace): ...
    ...
    def createInstruction(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.lang.InstructionPrototype, __a2: ghidra.program.model.mem.MemBuffer, __a3: ghidra.program.model.lang.ProcessorContextView) -> ghidra.program.model.listing.Instruction: ...

    def createRootModule(self, __a0: unicode) -> ghidra.program.model.listing.ProgramModule: ...

    def doCreateUndefinedUnit(self, __a0: ghidra.program.model.address.Address) -> ghidra.trace.database.listing.UndefinedDBTraceData: ...
