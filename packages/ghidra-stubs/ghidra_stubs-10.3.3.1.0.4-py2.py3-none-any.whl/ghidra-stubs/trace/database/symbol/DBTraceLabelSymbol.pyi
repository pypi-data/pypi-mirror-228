...
class DBTraceLabelSymbol(ghidra.trace.database.symbol.AbstractDBTraceSymbol, ghidra.trace.model.symbol.TraceLabelSymbol, ghidra.trace.database.space.DBTraceSpaceKey):
    ...
    @property
    def codeUnit(self) -> ghidra.trace.database.listing.DBTraceCodeUnitAdapter: ...
