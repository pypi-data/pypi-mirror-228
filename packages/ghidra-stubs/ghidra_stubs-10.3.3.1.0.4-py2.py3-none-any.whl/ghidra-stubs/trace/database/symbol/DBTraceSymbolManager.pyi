...
class DBTraceSymbolManager(object, ghidra.trace.model.symbol.TraceSymbolManager, ghidra.trace.database.DBTraceManager):
    ...
    class DBTraceFunctionTagMapping(ghidra.util.database.DBAnnotatedObject):
        ...
        @property
        def functionKey(self) -> long: ...

        @property
        def tagKey(self) -> long: ...
    ...
    class MySymbolTypes(java.lang.Enum):
        CLASS: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = CLASS
        FUNCTION: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = FUNCTION
        GLOBAL_VAR: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = GLOBAL_VAR
        LABEL: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = LABEL
        LOCAL_VAR: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = LOCAL_VAR
        NAMESPACE: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = NAMESPACE
        NO_LIBRARY: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = NO_LIBRARY
        NO_NULL: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = NO_NULL
        PARAMETER: ghidra.trace.database.symbol.DBTraceSymbolManager.MySymbolTypes = PARAMETER
        VALUES: List[object] = [LABEL, NO_LIBRARY, NO_NULL, NAMESPACE, CLASS, FUNCTION, PARAMETER, LOCAL_VAR, GLOBAL_VAR]
    ...
    class DBTraceFunctionTag(ghidra.util.database.DBAnnotatedObject, ghidra.program.model.listing.FunctionTag):
        ...
        @overload
        def compareTo(self, __a0: ghidra.program.model.listing.FunctionTag) -> int: ...
    ...
    @overload
    def assertIsMine(self, __a0: ghidra.program.model.listing.Function) -> ghidra.trace.database.symbol.DBTraceFunctionSymbol: ...
    ...
    @overload
    def checkIsMine(self, __a0: ghidra.program.model.listing.Function) -> ghidra.trace.database.symbol.DBTraceFunctionSymbol: ...
    ...
    def replaceDataTypes(self, __a0: long, __a1: long) -> None: ...
