...
class DBTraceEquateManager(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.symbol.TraceEquateManager, ghidra.trace.database.space.DBTraceDelegatingManager):
    ...
    def getByKey(self, __a0: long) -> ghidra.trace.database.symbol.DBTraceEquate: ...

    def getByName(self, __a0: unicode) -> ghidra.trace.database.symbol.DBTraceEquate: ...
    ...
    @overload
    def getEquateRegisterSpace(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: bool) -> ghidra.trace.database.symbol.DBTraceEquateSpace: ...

    def getEquateSpace(self, __a0: ghidra.program.model.address.AddressSpace, __a1: bool) -> ghidra.trace.database.symbol.DBTraceEquateSpace: ...

    def getForSpace(self, __a0: ghidra.program.model.address.AddressSpace, __a1: bool) -> ghidra.trace.database.symbol.DBTraceEquateSpace: ...
