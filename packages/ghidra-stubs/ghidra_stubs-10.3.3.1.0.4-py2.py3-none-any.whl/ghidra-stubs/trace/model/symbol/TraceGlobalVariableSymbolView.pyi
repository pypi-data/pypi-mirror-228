...
class TraceGlobalVariableSymbolView(ghidra.trace.model.symbol.TraceSymbolWithAddressNoDuplicatesView, object):
    ...
    def getChildWithNameAt(self, __a0: unicode, __a1: ghidra.program.model.address.Address, __a2: ghidra.trace.model.symbol.TraceNamespaceSymbol) -> ghidra.trace.model.symbol.TraceSymbol: ...
    ...
    def getGlobalWithNameAt(self, __a0: unicode, __a1: ghidra.program.model.address.Address) -> ghidra.trace.model.symbol.TraceSymbol: ...
    ...
    def hasAt(self, __a0: ghidra.program.model.address.Address, __a1: bool) -> bool: ...
