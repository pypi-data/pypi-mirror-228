...
class TraceLocalVariableSymbol(ghidra.trace.model.symbol.TraceVariableSymbol, ghidra.program.model.listing.LocalVariable, object):
    ...
    @property
    def function(self) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...
