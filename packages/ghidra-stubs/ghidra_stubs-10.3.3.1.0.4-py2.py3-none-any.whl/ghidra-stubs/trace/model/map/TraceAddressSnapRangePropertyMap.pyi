...
class TraceAddressSnapRangePropertyMap(ghidra.trace.model.map.TraceAddressSnapRangePropertyMapOperations, object):
    EMPTY_MAP: ghidra.util.database.spatial.SpatialMap = ghidra.util.database.spatial.SpatialMap$EmptySpatialMap@64d458fb
    ...
    @overload
    def getRegisterSpace(self, __a0: ghidra.trace.model.stack.TraceStackFrame, __a1: bool) -> ghidra.trace.model.map.TraceAddressSnapRangePropertyMapSpace: ...
