...
class ClearCutAction(ghidra.framework.main.datatable.ProjectTreeAction):
    ...
    @overload
    def actionPerformed(self, context: ghidra.framework.main.datatree.FrontEndProjectTreeContext) -> None: ...
    ...
    @overload
    def isEnabledForContext(self, context: ghidra.framework.main.datatree.FrontEndProjectTreeContext) -> bool: ...
