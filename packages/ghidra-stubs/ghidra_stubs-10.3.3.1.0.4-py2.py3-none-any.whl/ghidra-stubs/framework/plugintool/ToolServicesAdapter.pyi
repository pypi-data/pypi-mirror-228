...
class ToolServicesAdapter(object, ghidra.framework.model.ToolServices):
    ...
    def launchDefaultTool(self, domainFile: java.util.Collection) -> ghidra.framework.plugintool.PluginTool: ...

    def launchDefaultToolWithURL(self, url: java.net.URL) -> ghidra.framework.plugintool.PluginTool: ...

    def launchTool(self, toolName: unicode, domainFile: java.util.Collection) -> ghidra.framework.plugintool.PluginTool: ...

    def launchToolWithURL(self, toolName: unicode, url: java.net.URL) -> ghidra.framework.plugintool.PluginTool: ...
