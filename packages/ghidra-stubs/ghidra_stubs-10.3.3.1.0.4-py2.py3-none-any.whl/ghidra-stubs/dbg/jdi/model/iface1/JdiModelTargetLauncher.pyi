...
class JdiModelTargetLauncher(ghidra.dbg.jdi.model.iface2.JdiModelTargetObject, ghidra.dbg.target.TargetLauncher, object):
    ...
    @overload
    @staticmethod
    def getParameters(__a0: java.util.Map) -> java.util.Map: ...
