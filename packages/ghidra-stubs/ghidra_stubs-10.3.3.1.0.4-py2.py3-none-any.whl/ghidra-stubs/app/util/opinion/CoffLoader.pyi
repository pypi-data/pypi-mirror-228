...
class CoffLoader(ghidra.app.util.opinion.AbstractLibrarySupportLoader):
    COFF_NAME: unicode = u'Common Object File Format (COFF)'
    FAKE_LINK_OPTION_NAME: unicode = u'Attempt to link sections located at 0x0'
