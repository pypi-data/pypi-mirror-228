...
class OmfLoader(ghidra.app.util.opinion.AbstractProgramWrapperLoader):
    IMAGE_BASE: long = 0x2000L
    MAX_UNINITIALIZED_FILL: long = 0x2000L
    MIN_BYTE_LENGTH: long = 0xbL
    OMF_NAME: unicode = u'Relocatable Object Module Format (OMF)'
