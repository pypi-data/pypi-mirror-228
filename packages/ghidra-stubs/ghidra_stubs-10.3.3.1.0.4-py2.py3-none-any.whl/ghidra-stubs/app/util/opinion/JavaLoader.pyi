...
class JavaLoader(ghidra.app.util.opinion.AbstractProgramWrapperLoader):
    CODE_OFFSET: long = 0x10000L
    CONSTANT_POOL: unicode = u'constantPool'
    ...
    @overload
    def load(self, __a0: ghidra.app.util.bin.ByteProvider, __a1: ghidra.program.model.listing.Program, __a2: ghidra.util.task.TaskMonitor) -> None: ...
