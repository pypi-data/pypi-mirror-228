...
class EncryptedInformationCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    @property
    def cryptID(self) -> int: ...

    @property
    def cryptOffset(self) -> int: ...

    @property
    def cryptSize(self) -> int: ...