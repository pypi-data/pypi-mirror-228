...
class RunPathCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getPath(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
    ...
    @property
    def path(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...