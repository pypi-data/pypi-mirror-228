...
class DynamicLibraryCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getDynamicLibrary(self) -> ghidra.app.util.bin.format.macho.commands.DynamicLibrary:
        """
    ...
    @property
    def dynamicLibrary(self) -> ghidra.app.util.bin.format.macho.commands.DynamicLibrary: ...