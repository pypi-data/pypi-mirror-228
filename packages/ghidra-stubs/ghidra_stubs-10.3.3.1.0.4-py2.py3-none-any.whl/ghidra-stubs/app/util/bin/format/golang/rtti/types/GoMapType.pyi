...
class GoMapType(ghidra.app.util.bin.format.golang.rtti.types.GoType):
    ...
    def getBucket(self) -> ghidra.app.util.bin.format.golang.rtti.types.GoType: ...
    ...
    def getKey(self) -> ghidra.app.util.bin.format.golang.rtti.types.GoType: ...
    ...
    @property
    def bucket(self) -> ghidra.app.util.bin.format.golang.rtti.types.GoType: ...

    @property
    def element(self) -> ghidra.app.util.bin.format.golang.rtti.types.GoType: ...

    @property
    def key(self) -> ghidra.app.util.bin.format.golang.rtti.types.GoType: ...