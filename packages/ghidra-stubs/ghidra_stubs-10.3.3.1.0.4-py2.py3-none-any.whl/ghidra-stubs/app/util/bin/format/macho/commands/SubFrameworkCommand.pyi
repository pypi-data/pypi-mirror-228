...
class SubFrameworkCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getUmbrellaFrameworkName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
    ...
    @property
    def umbrellaFrameworkName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...