...
class SubUmbrellaCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getSubUmbrellaFrameworkName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
    ...
    @property
    def subUmbrellaFrameworkName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...