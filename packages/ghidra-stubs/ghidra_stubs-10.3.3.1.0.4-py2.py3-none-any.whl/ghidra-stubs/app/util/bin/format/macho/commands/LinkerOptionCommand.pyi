...
class LinkerOptionCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getLinkerOptions(self) -> List[unicode]:
        """
    ...
    @property
    def linkerOptions(self) -> List[object]: ...