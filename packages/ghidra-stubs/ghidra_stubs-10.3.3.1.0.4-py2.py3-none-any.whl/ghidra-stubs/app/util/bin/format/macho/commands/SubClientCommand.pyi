...
class SubClientCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getClientName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString:
        """
    ...
    @property
    def clientName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
