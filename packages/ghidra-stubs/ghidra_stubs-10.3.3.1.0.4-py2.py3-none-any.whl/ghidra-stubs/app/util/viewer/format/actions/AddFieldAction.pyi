...
class AddFieldAction(docking.action.DockingAction):
    ...
    def __init__(self, owner: unicode, fieldFactory: ghidra.app.util.viewer.field.FieldFactory, panel: ghidra.app.util.viewer.format.FieldHeader, formatModel: ghidra.app.util.viewer.format.FieldFormatModel): ...
