...
class ListingComparisonProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    """
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, name: unicode, p1: ghidra.program.model.listing.Program, p2: ghidra.program.model.listing.Program, set1: ghidra.program.model.address.AddressSetView, set2: ghidra.program.model.address.AddressSetView):
        """
    ...
    def adjustFontSize(self, bigger: bool) -> None:
        """
    ...
    def getComponent(self) -> ghidra.app.util.viewer.listingpanel.ListingCodeComparisonPanel: ...
    ...
    @property
    def component(self) -> ghidra.app.util.viewer.listingpanel.ListingCodeComparisonPanel: ...