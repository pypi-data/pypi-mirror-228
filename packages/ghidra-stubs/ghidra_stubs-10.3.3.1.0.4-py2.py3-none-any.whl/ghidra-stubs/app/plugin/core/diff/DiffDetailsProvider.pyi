...
class DiffDetailsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    AUTO_UPDATE_CHECK_BOX: unicode = u'Auto Update Check Box'
    DIFF_DETAILS_HIDDEN_ACTION: unicode = u'Diff Details Hidden'
    DIFF_DETAILS_PANEL: unicode = u'Diff Location Details Panel'
    DIFF_DETAILS_TEXT_AREA: unicode = u'Diff Details Text Area'
    FILTER_DIFFS_CHECK_BOX: unicode = u'Filter Diffs Check Box'
    ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    REFRESH_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    TITLE: unicode = u'Diff Details'
    ...
    def setAutoUpdate(self, __a0: bool) -> None: ...

    def setFilterDiffs(self, __a0: bool) -> None: ...
    ...
    @property
    def autoUpdate(self) -> None: ...  # No getter available.
    ...
    @property
    def filterDiffs(self) -> None: ...  # No getter available.

    @filterDiffs.setter
    def filterDiffs(self, value: bool) -> None: ...