...
class DiffApplySettingsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    APPLY_FILTER_CHANGED_ACTION: unicode = u'Apply Filter Changed'
    ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    TITLE: unicode = u'Diff Apply Settings'
    ...
    def configure(self, __a0: ghidra.program.util.ProgramMergeFilter) -> None: ...
