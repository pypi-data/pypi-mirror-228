...
class CompositeEditorTableAction(docking.action.DockingAction, ghidra.app.plugin.core.compositeeditor.EditorAction):
    EDIT_ACTION_PREFIX: unicode = u'Editor: '



    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider, __a1: unicode, __a2: unicode, __a3: List[unicode], __a4: List[unicode], __a5: javax.swing.Icon): ...
    ...
    def editStateChanged(self, __a0: int) -> None: ...
