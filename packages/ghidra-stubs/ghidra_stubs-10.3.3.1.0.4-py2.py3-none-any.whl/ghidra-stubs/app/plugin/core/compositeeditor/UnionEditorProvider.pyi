...
class UnionEditorProvider(ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider):




    def __init__(self, __a0: ghidra.framework.plugintool.Plugin, __a1: ghidra.program.model.data.Union, __a2: bool): ...
