...
class CreateInternalStructureAction(ghidra.app.plugin.core.compositeeditor.CompositeEditorTableAction):
    ACTION_NAME: unicode = u'Create Structure From Selection'



    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.StructureEditorProvider): ...
