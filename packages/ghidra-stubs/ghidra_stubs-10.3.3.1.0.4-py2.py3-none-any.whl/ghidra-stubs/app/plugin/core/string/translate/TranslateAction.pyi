...
import ghidra.app.plugin.core.string.translate
...
class TranslateAction(ghidra.app.plugin.core.string.translate.AbstractTranslateAction):




    def __init__(self, __a0: unicode, __a1: ghidra.app.services.StringTranslationService): ...
    ...
    @overload
    def actionPerformed(self, __a0: ghidra.program.model.listing.Program, __a1: List[object]) -> None: ...
