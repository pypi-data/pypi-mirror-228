...
class ProgramOptionsAction(ghidra.app.plugin.core.progmgr.AbstractProgramNameSwitchingAction):




    def __init__(self, __a0: ghidra.app.plugin.core.progmgr.ProgramManagerPlugin): ...
