...
class SaveProgramAction(ghidra.app.plugin.core.progmgr.AbstractProgramNameSwitchingAction):




    def __init__(self, __a0: ghidra.app.plugin.core.progmgr.ProgramManagerPlugin, __a1: unicode, __a2: int): ...
    ...
    @overload
    def actionPerformed(self, __a0: ghidra.program.model.listing.Program) -> None: ...
    ...
    @overload
    def isEnabledForContext(self, __a0: ghidra.program.model.listing.Program) -> bool: ...
