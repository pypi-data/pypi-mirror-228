...
class CurrentPlatformTracePatchInstructionAction(ghidra.app.plugin.core.debug.disassemble.AbstractTracePatchInstructionAction):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.disassemble.DebuggerDisassemblerPlugin): ...
