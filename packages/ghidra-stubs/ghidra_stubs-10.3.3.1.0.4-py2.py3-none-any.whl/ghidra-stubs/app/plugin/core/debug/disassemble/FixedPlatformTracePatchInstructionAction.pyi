...
class FixedPlatformTracePatchInstructionAction(ghidra.app.plugin.core.debug.disassemble.AbstractTracePatchInstructionAction):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.disassemble.DebuggerDisassemblerPlugin, __a1: ghidra.program.model.lang.LanguageID, __a2: ghidra.trace.model.guest.TracePlatform): ...
    ...
    @overload
    def accept(self, __a0: ghidra.app.plugin.core.assembler.AssemblyDualTextField.AssemblyInstruction) -> None: ...
