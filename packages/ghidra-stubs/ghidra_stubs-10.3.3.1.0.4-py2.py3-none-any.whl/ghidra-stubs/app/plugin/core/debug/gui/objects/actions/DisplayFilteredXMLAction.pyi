...
class DisplayFilteredXMLAction(ghidra.app.plugin.core.debug.gui.objects.actions.DisplayFilteredAction):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: ghidra.app.plugin.core.debug.gui.objects.DebuggerObjectsProvider): ...
    ...
    def writeXml(self, __a0: ghidra.app.plugin.core.debug.gui.objects.ObjectContainer, __a1: List[object]) -> None: ...
