...
class ExportAsXMLAction(ghidra.app.plugin.core.debug.gui.objects.actions.ImportExportAsAction):
    ...
    def writeXml(self, __a0: ghidra.app.plugin.core.debug.gui.objects.ObjectContainer, __a1: java.io.File) -> None: ...
