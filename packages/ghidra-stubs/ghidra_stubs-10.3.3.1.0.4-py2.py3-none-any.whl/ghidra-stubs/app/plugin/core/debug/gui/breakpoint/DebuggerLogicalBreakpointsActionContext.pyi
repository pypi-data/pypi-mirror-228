...
class DebuggerLogicalBreakpointsActionContext(docking.ActionContext):
    ...
    def getBreakpoints(self) -> java.util.Collection: ...
    ...
    @property
    def breakpoints(self) -> java.util.Collection: ...
