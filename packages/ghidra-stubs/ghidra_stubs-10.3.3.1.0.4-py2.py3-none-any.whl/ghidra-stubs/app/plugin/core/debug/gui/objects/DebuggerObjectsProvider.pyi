...
class DebuggerObjectsProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.plugin.core.debug.gui.objects.ObjectContainerListener):
    COLOR_BACKGROUND: java.awt.Color = #00ffff
    COLOR_FOREGROUND: java.awt.Color = #00ffff
    COLOR_FOREGROUND_ACCESSOR: java.awt.Color = #00ffff
    COLOR_FOREGROUND_ERROR: java.awt.Color = #00ffff
    COLOR_FOREGROUND_INTRINSIC: java.awt.Color = #00ffff
    COLOR_FOREGROUND_INVALIDATED: java.awt.Color = #00ffff
    COLOR_FOREGROUND_INVISIBLE: java.awt.Color = #00ffff
    COLOR_FOREGROUND_LINK: java.awt.Color = #00ffff
    COLOR_FOREGROUND_MODIFIED: java.awt.Color = #00ffff
    COLOR_FOREGROUND_SUBSCRIBED: java.awt.Color = #00ffff
    COLOR_FOREGROUND_TARGET: java.awt.Color = #00ffff
    ...
    def getActionContext(self, __a0: java.awt.event.MouseEvent) -> ghidra.app.plugin.core.debug.gui.objects.DebuggerObjectsProvider.ObjectActionContext: ...
    ...
    def traceActivated(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> None: ...
