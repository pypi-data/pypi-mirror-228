...
class DisplayAsGraphAction(ghidra.app.plugin.core.debug.gui.objects.actions.DisplayAsAction):
    ...
    def addGraph(self, __a0: ghidra.app.plugin.core.debug.gui.objects.ObjectContainer) -> None: ...
