...
class ProgramURLUtils(java.lang.Enum):
    ...
    @staticmethod
    def getFileForHackedUpGhidraURL(__a0: ghidra.framework.model.Project, __a1: java.net.URL) -> ghidra.framework.model.DomainFile: ...
    ...
    @staticmethod
    def openHackedUpGhidraURL(__a0: ghidra.app.services.ProgramManager, __a1: ghidra.framework.model.Project, __a2: java.net.URL, __a3: int) -> ghidra.program.model.listing.Program: ...
