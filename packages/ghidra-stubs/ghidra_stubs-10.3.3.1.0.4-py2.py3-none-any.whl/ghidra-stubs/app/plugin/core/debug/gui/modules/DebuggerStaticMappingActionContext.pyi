...
class DebuggerStaticMappingActionContext(docking.ActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.modules.DebuggerStaticMappingProvider, __a1: java.util.Collection, __a2: docking.widgets.table.GTable): ...
    ...
    def getSelectedMappings(self) -> java.util.Collection: ...
    ...
    @property
    def selectedMappings(self) -> java.util.Collection: ...