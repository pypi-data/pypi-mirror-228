...
class DebuggerRegionActionContext(docking.ActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsProvider, __a1: java.util.Collection, __a2: docking.widgets.table.GTable): ...
    ...
    def getSelectedRegions(self) -> java.util.Set: ...
    ...
    @property
    def selectedRegions(self) -> java.util.Set: ...