...
class DebuggerThreadsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.thread.DebuggerThreadsPlugin): ...
    ...
    def setEmulationService(self, __a0: ghidra.app.services.DebuggerEmulationService) -> None: ...
    ...
    @property
    def emulationService(self) -> None: ...  # No getter available.

    @emulationService.setter
    def emulationService(self, value: ghidra.app.services.DebuggerEmulationService) -> None: ...
