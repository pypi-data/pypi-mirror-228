...
class DebuggerStaticMappingProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.plugin.core.debug.gui.DebuggerProvider):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.modules.DebuggerStaticMappingPlugin): ...
    ...
    def setSelectedMappings(self, __a0: java.util.Set) -> None: ...
    ...
    @property
    def selectedMappings(self) -> None: ...  # No getter available.

    @selectedMappings.setter
    def selectedMappings(self, value: java.util.Set) -> None: ...
