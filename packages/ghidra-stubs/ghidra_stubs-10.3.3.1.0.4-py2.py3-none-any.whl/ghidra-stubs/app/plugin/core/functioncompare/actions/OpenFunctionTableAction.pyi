...
class OpenFunctionTableAction(docking.action.DockingAction):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.functioncompare.FunctionComparisonProvider): ...
