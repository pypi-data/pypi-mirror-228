...
class PatchInstructionAction(ghidra.app.plugin.core.assembler.AbstractPatchAction):
    ...
    @overload
    def __init__(self, __a0: ghidra.framework.plugintool.Plugin, __a1: unicode): ...
