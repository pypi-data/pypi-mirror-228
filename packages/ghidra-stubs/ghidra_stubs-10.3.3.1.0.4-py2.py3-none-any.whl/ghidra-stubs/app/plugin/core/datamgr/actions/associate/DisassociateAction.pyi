...
class DisassociateAction(docking.action.DockingAction):
    MENU_NAME: unicode = u'Disassociate Data Types From'



    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: ghidra.app.plugin.core.datamgr.archive.DataTypeManagerHandler, __a2: ghidra.program.model.data.DataTypeManager, __a3: ghidra.app.plugin.core.datamgr.tree.ArchiveNode, __a4: ghidra.program.model.data.SourceArchive): ...
