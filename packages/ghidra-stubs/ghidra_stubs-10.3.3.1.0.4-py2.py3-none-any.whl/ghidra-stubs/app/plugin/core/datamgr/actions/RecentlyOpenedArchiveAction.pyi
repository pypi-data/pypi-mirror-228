...
class RecentlyOpenedArchiveAction(docking.action.DockingAction):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: unicode, __a2: unicode): ...

    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: unicode, __a2: unicode, __a3: unicode): ...
