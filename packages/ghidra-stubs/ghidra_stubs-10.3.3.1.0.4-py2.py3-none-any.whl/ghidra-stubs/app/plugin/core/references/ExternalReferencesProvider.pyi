...
class ExternalReferencesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.references.ReferencesPlugin): ...
    ...
    def getSelectedExternalNames(self) -> List[object]: ...
    ...
    @property
    def selectedExternalNames(self) -> List[object]: ...