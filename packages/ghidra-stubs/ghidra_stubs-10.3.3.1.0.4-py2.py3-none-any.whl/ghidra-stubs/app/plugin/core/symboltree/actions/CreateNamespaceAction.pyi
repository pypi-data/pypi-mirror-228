...
class CreateNamespaceAction(ghidra.app.plugin.core.symboltree.actions.SymbolTreeContextAction):




    def __init__(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreePlugin, __a1: unicode, __a2: unicode): ...
