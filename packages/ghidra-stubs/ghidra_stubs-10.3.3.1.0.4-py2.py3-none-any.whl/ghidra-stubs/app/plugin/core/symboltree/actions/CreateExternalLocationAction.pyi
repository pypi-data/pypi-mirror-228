...
class CreateExternalLocationAction(ghidra.app.plugin.core.symboltree.actions.SymbolTreeContextAction):




    def __init__(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreePlugin): ...
