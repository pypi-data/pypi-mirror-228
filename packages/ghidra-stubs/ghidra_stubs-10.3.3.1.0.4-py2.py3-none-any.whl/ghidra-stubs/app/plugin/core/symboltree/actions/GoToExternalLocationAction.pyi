...
class GoToExternalLocationAction(ghidra.app.context.ProgramSymbolContextAction):
    ...
    @overload
    def actionPerformed(self, __a0: ghidra.app.context.ProgramSymbolActionContext) -> None: ...
    ...
    @overload
    def isEnabledForContext(self, __a0: ghidra.app.context.ProgramSymbolActionContext) -> bool: ...
