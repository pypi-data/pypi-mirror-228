...
class ByteViewerActionContext(ghidra.app.context.NavigatableActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.byteviewer.ProgramByteViewerComponentProvider): ...
