...
class ProgramByteViewerComponentProvider(ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider, ghidra.framework.model.DomainObjectListener, ghidra.app.nav.Navigatable):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.byteviewer.AbstractByteViewerPlugin, __a2: bool): ...
    ...
    def createProgramActions(self) -> None: ...
    ...
    def notifyEdit(self, __a0: ghidra.app.plugin.core.format.ByteEditInfo) -> None: ...
