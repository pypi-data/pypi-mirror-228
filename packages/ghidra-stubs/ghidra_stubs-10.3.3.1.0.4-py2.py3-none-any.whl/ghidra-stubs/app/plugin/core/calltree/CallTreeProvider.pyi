...
class CallTreeProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.framework.model.DomainObjectListener):




    def __init__(self, __a0: ghidra.app.plugin.core.calltree.CallTreePlugin, __a1: bool): ...
    ...
    def setIncomingFilter(self, __a0: unicode) -> None: ...

    def setIntraGroupPosition(self, __a0: docking.WindowPosition) -> None: ...

    def setOutgoingFilter(self, __a0: unicode) -> None: ...

    def setRecurseDepth(self, __a0: int) -> None: ...
    ...
    @property
    def incomingFilter(self) -> None: ...  # No getter available.

    @incomingFilter.setter
    def incomingFilter(self, value: unicode) -> None: ...

    @property
    def outgoingFilter(self) -> None: ...  # No getter available.

    @outgoingFilter.setter
    def outgoingFilter(self, value: unicode) -> None: ...

    @property
    def recurseDepth(self) -> int: ...

    @recurseDepth.setter
    def recurseDepth(self, value: int) -> None: ...