...
class RecentlyUsedAction(ghidra.app.plugin.core.function.DataAction):




    def __init__(self, __a0: ghidra.app.plugin.core.function.FunctionPlugin): ...
    ...
    def setPopupMenu(self, __a0: unicode, __a1: bool) -> None: ...
