...
class ViewManagerComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.services.ViewManagerService, ghidra.app.plugin.core.programtree.ViewChangeListener):
    CURRENT_VIEW: unicode = u'Current Viewname'
    ...
    def addViewChangeListener(self, __a0: ghidra.app.plugin.core.programtree.ViewChangeListener) -> None: ...
    ...
    def removeViewChangeListener(self, __a0: ghidra.app.plugin.core.programtree.ViewChangeListener) -> None: ...
    ...
    @overload
    def setCurrentViewProvider(self, __a0: unicode) -> None: ...

    @overload
    def setCurrentViewProvider(self, __a0: ghidra.app.plugin.core.programtree.ViewProviderService) -> None: ...
    ...
    def viewChanged(self, __a0: ghidra.program.model.address.AddressSetView) -> None: ...

    def viewNameChanged(self, __a0: ghidra.app.plugin.core.programtree.ViewProviderService, __a1: unicode) -> None: ...
    ...
    @currentViewProvider.setter
    def currentViewProvider(self, value: ghidra.app.plugin.core.programtree.ViewProviderService) -> None: ...