...
class SetVertexMostRecentColorAction(docking.menu.MultiActionDockingAction):
    ...
    def getActionList(self, __a0: docking.ActionContext) -> List[object]: ...
    ...
    def setActions(self, __a0: List[object]) -> None: ...
