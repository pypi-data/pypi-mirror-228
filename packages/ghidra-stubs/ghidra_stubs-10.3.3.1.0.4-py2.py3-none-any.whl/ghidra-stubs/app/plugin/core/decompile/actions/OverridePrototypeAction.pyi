...
class OverridePrototypeAction(ghidra.app.plugin.core.decompile.actions.AbstractDecompilerAction):
    ...
    @staticmethod
    def getCallOp(__a0: ghidra.program.model.listing.Program, __a1: ghidra.app.decompiler.ClangToken) -> ghidra.program.model.pcode.PcodeOp: ...
