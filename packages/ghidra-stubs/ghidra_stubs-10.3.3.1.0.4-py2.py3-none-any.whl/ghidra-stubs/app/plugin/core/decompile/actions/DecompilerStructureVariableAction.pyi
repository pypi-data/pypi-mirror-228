...
class DecompilerStructureVariableAction(ghidra.app.plugin.core.decompile.actions.CreateStructureVariableAction):




    def __init__(self, __a0: unicode, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.app.decompiler.component.DecompilerController): ...
    ...
    @staticmethod
    def getStructureForExtending(__a0: ghidra.program.model.data.DataType) -> ghidra.program.model.data.Structure: ...
