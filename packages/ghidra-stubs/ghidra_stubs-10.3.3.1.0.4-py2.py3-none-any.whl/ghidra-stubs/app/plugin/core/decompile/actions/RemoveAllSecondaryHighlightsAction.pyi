...
class RemoveAllSecondaryHighlightsAction(ghidra.app.plugin.core.decompile.actions.AbstractDecompilerAction):
    NAME: unicode = u'Remove All Secondary Highlights'
