...
class ListingMergePanelProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.actions.PopupActionProvider):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, plugin: ghidra.framework.plugintool.Plugin, owner: unicode, mergePanel: ghidra.app.merge.tool.ListingMergePanel): ...
    ...
    def getPopupActions(self, dt: docking.Tool, context: docking.ActionContext) -> List[docking.action.DockingActionIf]: ...
