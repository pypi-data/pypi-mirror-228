...
class DefaultGraphDisplay(object, ghidra.service.graph.GraphDisplay):
    ...
    ALIGN_LEFT: int = 0
    ALIGN_RIGHT: int = 2
    DISPLAY_VERTICES_AS_ICONS: unicode = u'displayVerticesAsIcons'
    EDGE_TYPE_PRIORITY_LIST: unicode = u'edgeTypePriorityList'
    ENABLE_EDGE_SELECTION: unicode = u'enableEdgeSelection'
    FAVORED_EDGES: unicode = u'favoredEdges'
    INITIAL_LAYOUT_ALGORITHM: unicode = u'initialLayoutAlgorithm'
    SELECTED_EDGE_COLOR: unicode = u'selectedEdgeColor'
    SELECTED_VERTEX_COLOR: unicode = u'selectedVertexColor'
    VERTEX_LABEL_POSITION: unicode = u'vertexLabelPosition'
