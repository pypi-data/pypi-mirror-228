...
class TargetBreakpointSpec(ghidra.dbg.target.TargetObject, ghidra.dbg.target.TargetTogglable, object):
    ...
    class TargetBreakpointKind(java.lang.Enum):
        HW_EXECUTE: ghidra.dbg.target.TargetBreakpointSpec.TargetBreakpointKind = HW_EXECUTE
        READ: ghidra.dbg.target.TargetBreakpointSpec.TargetBreakpointKind = READ
        SW_EXECUTE: ghidra.dbg.target.TargetBreakpointSpec.TargetBreakpointKind = SW_EXECUTE
        WRITE: ghidra.dbg.target.TargetBreakpointSpec.TargetBreakpointKind = WRITE
