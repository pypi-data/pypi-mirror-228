...
class DebuggerObjectModel(object):
    ATTRIBUTE_MAP_TYPE: ghidra.async.TypeSpec = ghidra.async.TypeSpec$1@3049374a
    ELEMENT_MAP_TYPE: ghidra.async.TypeSpec = ghidra.async.TypeSpec$1@3049374a




    class RefreshBehavior(java.lang.Enum):
        REFRESH_ALWAYS: ghidra.dbg.DebuggerObjectModel.RefreshBehavior = REFRESH_ALWAYS
        REFRESH_NEVER: ghidra.dbg.DebuggerObjectModel.RefreshBehavior = REFRESH_NEVER
        REFRESH_WHEN_ABSENT: ghidra.dbg.DebuggerObjectModel.RefreshBehavior = REFRESH_WHEN_ABSENT
