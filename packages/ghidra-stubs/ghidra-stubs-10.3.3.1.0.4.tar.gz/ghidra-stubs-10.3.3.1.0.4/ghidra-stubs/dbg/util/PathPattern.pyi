...
class PathPattern(object, ghidra.dbg.util.PathPredicates):
    EMPTY: ghidra.dbg.util.PathPredicates = ghidra.dbg.util.PathPredicates$1@21d1e646
    ...
    def asPath(self) -> List[object]: ...

    def countWildcards(self) -> int: ...

    def doRemoveRight(self, __a0: int, __a1: ghidra.dbg.util.PathMatcher) -> None: ...
    ...
    @staticmethod
    def isWildcard(__a0: unicode) -> bool: ...

    @staticmethod
    def keyMatches(__a0: unicode, __a1: unicode) -> bool: ...

    def matchKeys(self, __a0: List[object]) -> List[object]: ...
    ...
    def toPatternString(self) -> unicode: ...
