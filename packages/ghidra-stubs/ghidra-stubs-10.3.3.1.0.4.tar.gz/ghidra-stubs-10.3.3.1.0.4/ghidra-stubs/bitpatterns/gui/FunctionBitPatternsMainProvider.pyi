...
class FunctionBitPatternsMainProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.framework.options.OptionsChangeListener):
    EXPLORE_FUNCTION_PATTERNS_TEXT: unicode = u'Explore Function Bit Patterns'
    ...
    def resetExistingTableData(self) -> bool: ...
