...
class SymbolTreeProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.symboltree.SymbolTreePlugin): ...
    ...
    def reparentSymbols(self, __a0: ghidra.program.model.symbol.Namespace, __a1: List[object]) -> int: ...

    def requestFocus(self) -> None: ...

    def setClipboardContents(self, __a0: docking.widgets.tree.support.GTreeNodeTransferable) -> None: ...
    ...
    @property
    def clipboardContents(self) -> None: ...  # No getter available.

    @clipboardContents.setter
    def clipboardContents(self, value: docking.widgets.tree.support.GTreeNodeTransferable) -> None: ...
