...
class BuiltInSourceArchive(object, ghidra.program.model.data.SourceArchive):
    INSTANCE: ghidra.program.model.data.SourceArchive = ghidra.app.plugin.core.datamgr.archive.BuiltInSourceArchive@6b4275b1
    ...
    def setDirtyFlag(self, __a0: bool) -> None: ...

    def setLastSyncTime(self, __a0: long) -> None: ...

    def setName(self, __a0: unicode) -> None: ...

    def setPathname(self, __a0: unicode) -> None: ...
