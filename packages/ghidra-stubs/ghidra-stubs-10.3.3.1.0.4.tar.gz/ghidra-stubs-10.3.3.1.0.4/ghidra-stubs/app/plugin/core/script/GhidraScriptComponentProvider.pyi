...
class GhidraScriptComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def getScriptDirectories(self) -> List[object]: ...
    ...
    def getWritableScriptDirectories(self) -> List[object]: ...
    ...
    @property
    def scriptDirectories(self) -> List[object]: ...

    @property
    def writableScriptDirectories(self) -> List[object]: ...