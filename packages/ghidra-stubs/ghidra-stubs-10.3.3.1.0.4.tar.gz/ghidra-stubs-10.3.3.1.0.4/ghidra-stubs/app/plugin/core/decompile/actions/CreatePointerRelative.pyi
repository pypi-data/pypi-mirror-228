...
class CreatePointerRelative(ghidra.app.plugin.core.decompile.actions.RetypeLocalAction):
    ...
    class RelativePointerDialog(ghidra.app.util.datatype.DataTypeSelectionDialog):
        ...
        def __init__(self, __a0: ghidra.app.plugin.core.decompile.actions.CreatePointerRelative, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.program.model.listing.Program): ...
        ...
        def clearUserChosenDataType(self) -> None: ...
        ...
        def getEditor(self) -> ghidra.app.util.datatype.DataTypeSelectionEditor: ...
        ...
        def setInitialDataType(self, __a0: ghidra.program.model.data.DataType) -> None: ...

        def setInitialLocation(self, __a0: int, __a1: int) -> None: ...

        def setInitialName(self, __a0: unicode) -> None: ...

        def setInitialOffset(self, __a0: int) -> None: ...
        ...
        def setTabCommitsEdit(self, __a0: bool) -> None: ...
        ...
        @property
        def initialName(self) -> None: ...  # No getter available.

        @initialName.setter
        def initialName(self, value: unicode) -> None: ...

        @property
        def initialOffset(self) -> None: ...  # No getter available.

        @initialOffset.setter
        def initialOffset(self, value: int) -> None: ...
    ...
    @staticmethod
    def buildDefaultName(__a0: ghidra.program.model.data.DataType, __a1: int) -> unicode: ...
    ...
    @staticmethod
    def getCompositeDataType(__a0: ghidra.app.decompiler.ClangToken) -> ghidra.program.model.data.Composite: ...
