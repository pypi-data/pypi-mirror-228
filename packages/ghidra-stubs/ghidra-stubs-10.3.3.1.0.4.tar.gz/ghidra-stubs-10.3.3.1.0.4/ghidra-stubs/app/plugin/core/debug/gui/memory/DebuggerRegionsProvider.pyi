...
class DebuggerRegionsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsPlugin): ...
    ...
    def askBlock(self, __a0: ghidra.trace.model.memory.TraceMemoryRegion, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.mem.MemoryBlock) -> java.util.Map.Entry: ...
    ...
    def setSelectedRegions(self, __a0: java.util.Set) -> None: ...
    ...
    @property
    def selectedRegions(self) -> None: ...  # No getter available.

    @selectedRegions.setter
    def selectedRegions(self, value: java.util.Set) -> None: ...