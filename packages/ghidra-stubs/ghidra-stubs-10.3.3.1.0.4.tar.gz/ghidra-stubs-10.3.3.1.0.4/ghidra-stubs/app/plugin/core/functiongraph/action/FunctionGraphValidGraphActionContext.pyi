...
class FunctionGraphValidGraphActionContext(ghidra.app.context.NavigatableActionContext, ghidra.app.plugin.core.functiongraph.action.FunctionGraphValidGraphActionContextIf, ghidra.graph.viewer.actions.VisualGraphActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.functiongraph.FGProvider, __a1: java.util.Set): ...
