...
class NavigateToFunctionAction(docking.action.ToggleDockingAction):




    def __init__(self, __a0: ghidra.app.plugin.core.functioncompare.MultiFunctionComparisonProvider): ...
