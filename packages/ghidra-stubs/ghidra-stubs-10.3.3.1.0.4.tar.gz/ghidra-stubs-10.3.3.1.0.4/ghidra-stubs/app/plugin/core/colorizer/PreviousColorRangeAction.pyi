...
class PreviousColorRangeAction(ghidra.app.nav.PreviousRangeAction):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.colorizer.ColorizingPlugin, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.app.plugin.core.navigation.NavigationOptions): ...
