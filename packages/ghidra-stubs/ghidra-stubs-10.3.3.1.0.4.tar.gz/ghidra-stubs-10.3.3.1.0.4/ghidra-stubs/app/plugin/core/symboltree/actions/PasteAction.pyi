...
class PasteAction(ghidra.app.plugin.core.symboltree.actions.SymbolTreeContextAction):




    def __init__(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreePlugin, __a1: ghidra.app.plugin.core.symboltree.SymbolTreeProvider): ...



    @overload
    def actionPerformed(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreeActionContext) -> None: ...
    ...
    @overload
    def isAddToPopup(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreeActionContext) -> bool: ...
    ...
    @overload
    def isEnabledForContext(self, __a0: ghidra.app.plugin.core.symboltree.SymbolTreeActionContext) -> bool: ...
