...
class FunctionGraphEmptyGraphActionContext(ghidra.app.context.ProgramActionContext, ghidra.graph.viewer.actions.VisualGraphActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.functiongraph.FGProvider): ...
