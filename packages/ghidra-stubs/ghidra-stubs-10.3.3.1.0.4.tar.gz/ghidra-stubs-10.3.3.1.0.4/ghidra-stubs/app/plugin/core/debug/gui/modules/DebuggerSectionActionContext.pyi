...
class DebuggerSectionActionContext(docking.ActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.modules.DebuggerModulesProvider, __a1: java.util.Collection, __a2: docking.widgets.table.GTable): ...
    ...
    def getSelectedSections(self) -> java.util.Set: ...
    ...
    @property
    def selectedSections(self) -> java.util.Set: ...