...
class DecompilerNestedLayout(ghidra.app.plugin.core.functiongraph.graph.layout.AbstractFGLayout):




    def __init__(self, __a0: ghidra.app.plugin.core.functiongraph.graph.FunctionGraph, __a1: unicode): ...
