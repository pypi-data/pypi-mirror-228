...
class ParameterSymbolNode(ghidra.app.plugin.core.symboltree.nodes.SymbolNode):
    PARAMETER_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
