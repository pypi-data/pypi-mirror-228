...
class DisplayAsXMLAction(ghidra.app.plugin.core.debug.gui.objects.actions.DisplayAsAction):
    ...
    def writeXml(self, __a0: ghidra.app.plugin.core.debug.gui.objects.ObjectContainer) -> None: ...
