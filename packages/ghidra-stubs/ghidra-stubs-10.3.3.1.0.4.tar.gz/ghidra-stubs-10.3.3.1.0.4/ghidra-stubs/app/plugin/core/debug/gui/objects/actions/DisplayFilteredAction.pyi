...
class DisplayFilteredAction(docking.action.DockingAction):




    def __init__(self, __a0: unicode, __a1: ghidra.framework.plugintool.PluginTool, __a2: unicode, __a3: ghidra.app.plugin.core.debug.gui.objects.DebuggerObjectsProvider): ...
