...
class NextPreviousBookmarkAction(docking.menu.MultiStateDockingAction):
    ALL_BOOKMARK_TYPES: unicode = u'All Bookmark Types'



    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: unicode): ...



    def actionPerformed(self, __a0: docking.ActionContext) -> None: ...

    def actionStateChanged(self, __a0: docking.menu.ActionState, __a1: docking.widgets.EventTrigger) -> None: ...

    def addActionState(self, __a0: docking.menu.ActionState) -> None: ...
    ...
    def doCreateButton(self) -> javax.swing.JButton: ...
    ...
    def getAllActionStates(self) -> List[object]: ...

    def getClass(self) -> java.lang.Class: ...

    def getCurrentState(self) -> docking.menu.ActionState: ...

    def getCurrentUserData(self) -> object: ...
    ...
    def setActionStates(self, __a0: List[object]) -> None: ...

    def setAddToAllWindows(self, __a0: bool) -> None: ...

    def setCurrentActionState(self, __a0: docking.menu.ActionState) -> None: ...

    def setCurrentActionStateByUserData(self, __a0: object) -> None: ...

    def setCurrentActionStateWithTrigger(self, __a0: docking.menu.ActionState, __a1: docking.widgets.EventTrigger) -> None: ...

    def setDefaultIcon(self, __a0: javax.swing.Icon) -> None: ...

    def setDescription(self, __a0: unicode) -> None: ...

    def setDirection(self, __a0: bool) -> None: ...

    def setEnabled(self, __a0: bool) -> None: ...

    def setGroup(self, __a0: unicode) -> None: ...

    def setHelpLocation(self, __a0: ghidra.util.HelpLocation) -> None: ...

    def setInverted(self, __a0: bool) -> None: ...
    ...
    def setSubGroup(self, __a0: unicode) -> None: ...
    ...
    def setUseCheckboxForIcons(self, __a0: bool) -> None: ...
    ...
    @property
    def direction(self) -> None: ...  # No getter available.

    @direction.setter
    def direction(self, value: bool) -> None: ...

    @property
    def inverted(self) -> None: ...  # No getter available.

    @inverted.setter
    def inverted(self, value: bool) -> None: ...

    @property
    def menuBarData(self) -> docking.action.MenuData: ...

    @menuBarData.setter
    def menuBarData(self, value: docking.action.MenuData) -> None: ...
