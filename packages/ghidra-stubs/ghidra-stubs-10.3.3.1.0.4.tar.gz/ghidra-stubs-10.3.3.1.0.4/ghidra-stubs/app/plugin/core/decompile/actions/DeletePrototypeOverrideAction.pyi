...
class DeletePrototypeOverrideAction(ghidra.app.plugin.core.decompile.actions.AbstractDecompilerAction):
    ...
    @staticmethod
    def getSymbol(__a0: ghidra.program.model.listing.Function, __a1: ghidra.app.decompiler.ClangToken) -> ghidra.program.database.symbol.CodeSymbol: ...
