...
class UpdateAlignmentAction(docking.action.ToggleDockingAction, ghidra.app.util.query.AddressAlignmentListener):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.Plugin, __a1: ghidra.app.plugin.core.analysis.FindReferencesTableModel, __a2: int): ...
    ...
    def alignmentChanged(self) -> None: ...

    def alignmentPermissionChanged(self) -> None: ...
