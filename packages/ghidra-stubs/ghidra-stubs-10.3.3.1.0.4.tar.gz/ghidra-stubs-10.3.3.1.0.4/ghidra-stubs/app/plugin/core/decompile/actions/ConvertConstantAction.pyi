...
class ConvertConstantAction(ghidra.app.plugin.core.decompile.actions.AbstractDecompilerAction):




    def __init__(self, __a0: ghidra.app.plugin.core.decompile.DecompilePlugin, __a1: unicode, __a2: int): ...
    ...
    def getEquateName(self, __a0: long, __a1: int, __a2: bool, __a3: ghidra.program.model.listing.Program) -> unicode: ...
    ...
    def getMenuDisplay(self, __a0: long, __a1: int, __a2: bool, __a3: ghidra.program.model.listing.Program) -> unicode: ...

    def getMenuPrefix(self) -> unicode: ...
