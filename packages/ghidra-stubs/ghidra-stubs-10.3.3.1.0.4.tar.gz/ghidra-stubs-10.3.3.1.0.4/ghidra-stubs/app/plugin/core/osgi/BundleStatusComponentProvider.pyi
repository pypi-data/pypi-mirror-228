...
class BundleStatusComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: ghidra.app.plugin.core.osgi.BundleHost): ...
    ...
    def setBundleFilesForTesting(self, __a0: List[object]) -> None: ...
    ...
    @property
    def bundleFilesForTesting(self) -> None: ...  # No getter available.

    @bundleFilesForTesting.setter
    def bundleFilesForTesting(self, value: List[object]) -> None: ...
