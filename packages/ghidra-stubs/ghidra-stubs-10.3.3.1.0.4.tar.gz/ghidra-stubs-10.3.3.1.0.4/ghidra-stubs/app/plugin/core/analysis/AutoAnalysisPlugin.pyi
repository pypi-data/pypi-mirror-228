...
class AutoAnalysisPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.plugin.core.analysis.AutoAnalysisManagerListener):
    ...
    def analysisEnded(self, __a0: ghidra.app.plugin.core.analysis.AutoAnalysisManager) -> None: ...
