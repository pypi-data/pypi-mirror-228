...
class FGEdgeRenderer(ghidra.graph.viewer.renderer.ArticulatedEdgeRenderer):
    ...
    @overload
    def getDrawColor(self, __a0: edu.uci.ics.jung.graph.Graph, __a1: ghidra.app.plugin.core.functiongraph.graph.FGEdge) -> java.awt.Color: ...
    ...
    @overload
    def getFocusedColor(self, __a0: edu.uci.ics.jung.graph.Graph, __a1: ghidra.app.plugin.core.functiongraph.graph.FGEdge) -> java.awt.Color: ...
    ...
    @overload
    def getSelectedColor(self, __a0: edu.uci.ics.jung.graph.Graph, __a1: ghidra.app.plugin.core.functiongraph.graph.FGEdge) -> java.awt.Color: ...
    ...
    def setDrawColorTransformer(self, __a0: com.google.common.base.Function) -> None: ...

    def setEdgeArrowRenderingSupport(self, __a0: edu.uci.ics.jung.visualization.renderers.EdgeArrowRenderingSupport) -> None: ...

    def setFocusedColorTransformer(self, __a0: com.google.common.base.Function) -> None: ...

    def setHoveredColorTransformer(self, __a0: com.google.common.base.Function) -> None: ...

    def setSelectedColorTransformer(self, __a0: com.google.common.base.Function) -> None: ...
