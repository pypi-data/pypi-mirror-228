...
class PrimaryDecompilerProvider(ghidra.app.plugin.core.decompile.DecompilerProvider):




    def __init__(self, __a0: ghidra.app.plugin.core.decompile.DecompilePlugin): ...
