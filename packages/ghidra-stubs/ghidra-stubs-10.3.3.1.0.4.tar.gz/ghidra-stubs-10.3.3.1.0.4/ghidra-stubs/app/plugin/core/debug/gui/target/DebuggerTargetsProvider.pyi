...
class DebuggerTargetsProvider(ghidra.framework.plugintool.ComponentProviderAdapter):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.target.DebuggerTargetsPlugin): ...
