...
class FavoritesAction(ghidra.app.plugin.core.compositeeditor.CompositeEditorTableAction):




    def __init__(self, __a0: ghidra.app.plugin.core.compositeeditor.CompositeEditorProvider, __a1: ghidra.program.model.data.DataType): ...
