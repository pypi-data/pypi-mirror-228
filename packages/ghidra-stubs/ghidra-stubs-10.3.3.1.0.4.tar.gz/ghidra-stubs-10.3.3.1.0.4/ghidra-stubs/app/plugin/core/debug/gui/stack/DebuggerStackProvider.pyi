...
class DebuggerStackProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    class UnwindStackAction(object):
        DESCRIPTION: unicode = u'Unwind the stack, placing frames in the dynamic listing'
        HELP_ANCHOR: unicode = u'unwind_stack'
        KEY_STROKE: javax.swing.KeyStroke = pressed U
        NAME: unicode = u'Unwind from frame 0'
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.stack.DebuggerStackPlugin): ...
    ...
    def getFunction(self, __a0: ghidra.program.model.address.Address) -> ghidra.program.model.listing.Function: ...
