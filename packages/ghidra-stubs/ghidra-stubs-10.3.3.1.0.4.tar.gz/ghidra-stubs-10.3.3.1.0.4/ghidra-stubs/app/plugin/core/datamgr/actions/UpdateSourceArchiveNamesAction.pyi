...
class UpdateSourceArchiveNamesAction(docking.action.DockingAction):
    NAME: unicode = u'Update Source Archive Names'



    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: ghidra.program.model.data.DataTypeManager): ...
