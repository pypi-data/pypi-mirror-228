...
class HexNumbersAction(ghidra.app.plugin.core.compositeeditor.CompositeEditorTableAction, docking.action.ToggleDockingActionIf):
    ACTION_NAME: unicode = u'Show Numbers In Hex'
