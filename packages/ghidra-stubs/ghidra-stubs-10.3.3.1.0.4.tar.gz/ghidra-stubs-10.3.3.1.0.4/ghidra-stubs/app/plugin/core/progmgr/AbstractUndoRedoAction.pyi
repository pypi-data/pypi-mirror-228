...
class AbstractUndoRedoAction(docking.action.DockingAction):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.progmgr.ProgramManagerPlugin, __a2: unicode, __a3: unicode, __a4: unicode, __a5: unicode): ...
