...
class ExportAsFactsAction(ghidra.app.plugin.core.debug.gui.objects.actions.ImportExportAsAction):
    JOIN: unicode
    SEP: unicode
    SPLIT: unicode
    fileExt2: unicode
    ...
    def writeFacts(self, __a0: ghidra.app.plugin.core.debug.gui.objects.ObjectContainer, __a1: java.io.File) -> unicode: ...
