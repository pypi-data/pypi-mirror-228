...
class CompositeEditorProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.plugin.core.compositeeditor.EditorProvider, ghidra.app.plugin.core.compositeeditor.EditorActionListener):
