...
class UndoAction(ghidra.app.plugin.core.progmgr.AbstractUndoRedoAction):
    SUBGROUP: unicode = u'1Undo'



    def __init__(self, __a0: ghidra.app.plugin.core.progmgr.ProgramManagerPlugin, __a1: ghidra.framework.plugintool.PluginTool): ...
