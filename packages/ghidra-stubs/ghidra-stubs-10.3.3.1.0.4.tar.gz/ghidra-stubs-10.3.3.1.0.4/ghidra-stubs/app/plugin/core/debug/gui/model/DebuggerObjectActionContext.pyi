...
class DebuggerObjectActionContext(docking.ActionContext):




    def __init__(self, __a0: java.util.Collection, __a1: docking.ComponentProvider, __a2: java.awt.Component): ...
    ...
    def getObjectValues(self) -> List[object]: ...
    ...
    @property
    def objectValues(self) -> List[object]: ...