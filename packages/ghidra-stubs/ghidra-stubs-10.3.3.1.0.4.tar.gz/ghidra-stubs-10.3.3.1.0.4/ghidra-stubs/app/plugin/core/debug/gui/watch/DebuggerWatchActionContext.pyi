...
class DebuggerWatchActionContext(docking.ActionContext):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.watch.DebuggerWatchesProvider, __a1: java.util.Collection, __a2: java.awt.Component): ...
    ...
    def getWatchRow(self) -> ghidra.app.plugin.core.debug.gui.watch.WatchRow: ...

    def getWatchRows(self) -> java.util.Set: ...
    ...
    @property
    def watchRow(self) -> ghidra.app.plugin.core.debug.gui.watch.WatchRow: ...

    @property
    def watchRows(self) -> java.util.Set: ...