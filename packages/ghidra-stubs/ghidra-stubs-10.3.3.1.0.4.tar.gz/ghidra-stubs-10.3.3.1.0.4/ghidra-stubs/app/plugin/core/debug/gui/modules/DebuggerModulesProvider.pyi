...
class DebuggerModulesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.modules.DebuggerModulesPlugin): ...
    ...
    def askBlock(self, __a0: ghidra.trace.model.modules.TraceSection, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.mem.MemoryBlock) -> java.util.Map.Entry: ...

    def askProgram(self, __a0: ghidra.program.model.listing.Program) -> ghidra.framework.model.DomainFile: ...
    ...
    @staticmethod
    def computeBlock(__a0: ghidra.program.util.ProgramLocation) -> ghidra.program.model.mem.MemoryBlock: ...

    @staticmethod
    def computeBlockName(__a0: ghidra.program.util.ProgramLocation) -> unicode: ...

    def contextChanged(self) -> None: ...

    def coordinatesActivated(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> None: ...
    ...
    def setSelectedModules(self, __a0: java.util.Set) -> None: ...

    def setSelectedSections(self, __a0: java.util.Set) -> None: ...
    ...
    @property
    def selectedModules(self) -> None: ...  # No getter available.

    @selectedModules.setter
    def selectedModules(self, value: java.util.Set) -> None: ...

    @property
    def selectedSections(self) -> None: ...  # No getter available.

    @selectedSections.setter
    def selectedSections(self, value: java.util.Set) -> None: ...