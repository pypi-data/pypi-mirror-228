...
class UpdateAction(ghidra.app.plugin.core.datamgr.actions.associate.SyncAction):
    MENU_NAME: unicode = u'Update Data Types From'



    def __init__(self, __a0: ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin, __a1: ghidra.app.plugin.core.datamgr.archive.DataTypeManagerHandler, __a2: ghidra.program.model.data.DataTypeManager, __a3: ghidra.app.plugin.core.datamgr.tree.ArchiveNode, __a4: ghidra.program.model.data.SourceArchive, __a5: bool): ...
    ...
    @overload
    def compareTo(self, __a0: ghidra.app.plugin.core.datamgr.actions.associate.SyncAction) -> int: ...
