...
class GhidraScript(ghidra.program.flatapi.FlatProgramAPI):
    ...
    class AnalysisMode(java.lang.Enum):
        DISABLED: ghidra.app.script.GhidraScript.AnalysisMode = DISABLED
        ENABLED: ghidra.app.script.GhidraScript.AnalysisMode = ENABLED
        SUSPENDED: ghidra.app.script.GhidraScript.AnalysisMode = SUSPENDED
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.script.GhidraScript.AnalysisMode: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.script.GhidraScript.AnalysisMode]: ...
    ...
    @overload
    def askAddress(self, title: unicode, message: unicode, defaultValue: unicode) -> ghidra.program.model.address.Address:
        """
        Returns an Address, using the String parameters for guidance.  The actual behavior of the
         method depends on your environment, which can be GUI or headless.
         <p>
    ...
    def askPassword(self, title: unicode, prompt: unicode) -> ghidra.framework.generic.auth.Password:
        """
    ...
    def createClass(self, parent: ghidra.program.model.symbol.Namespace, className: unicode) -> ghidra.program.model.listing.GhidraClass:
        """
    ...
    def createNamespace(self, parent: ghidra.program.model.symbol.Namespace, namespaceName: unicode) -> ghidra.program.model.symbol.Namespace:
        """
    ...
    def setReusePreviousChoices(self, reuse: bool) -> None:
        """
    ...
    @property
    def currentHighlight(self) -> None: ...  # No getter available.

    @currentHighlight.setter
    def currentHighlight(self, value: ghidra.program.model.address.AddressSetView) -> None: ...

    @property
    def currentLocation(self) -> None: ...  # No getter available.

    @currentLocation.setter
    def currentLocation(self, value: ghidra.program.model.address.Address) -> None: ...

    @property
    def currentSelection(self) -> None: ...  # No getter available.

    @currentSelection.setter
    def currentSelection(self, value: ghidra.program.model.address.AddressSetView) -> None: ...

    @property
    def ghidraVersion(self) -> unicode: ...

    @property
    def potentialPropertiesFileLocations(self) -> None: ...  # No getter available.

    @potentialPropertiesFileLocations.setter
    def potentialPropertiesFileLocations(self, value: List[object]) -> None: ...

    @property
    def projectRootFolder(self) -> ghidra.framework.model.DomainFolder: ...

    @property
    def propertiesFile(self) -> None: ...  # No getter available.

    @propertiesFile.setter
    def propertiesFile(self, value: java.io.File) -> None: ...

    @property
    def reusePreviousChoices(self) -> bool: ...

    @reusePreviousChoices.setter
    def reusePreviousChoices(self, value: bool) -> None: ...

    @property
    def runningHeadless(self) -> bool: ...

    @property
    def scriptAnalysisMode(self) -> ghidra.app.script.GhidraScript.AnalysisMode: ...

    @property
    def scriptArgs(self) -> List[unicode]: ...

    @scriptArgs.setter
    def scriptArgs(self, value: List[unicode]) -> None: ...

    @property
    def scriptName(self) -> unicode: ...

    @property
    def sourceFile(self) -> generic.jar.ResourceFile: ...

    @sourceFile.setter
    def sourceFile(self, value: generic.jar.ResourceFile) -> None: ...
