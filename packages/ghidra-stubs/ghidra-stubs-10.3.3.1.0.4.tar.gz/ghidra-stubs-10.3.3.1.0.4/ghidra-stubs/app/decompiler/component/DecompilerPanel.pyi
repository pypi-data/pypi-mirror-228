...
class DecompilerPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldMouseListener, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, ghidra.app.decompiler.component.ClangHighlightListener, docking.widgets.fieldpanel.listener.LayoutListener):
    """
    ...
    @overload
    def addHighlights(self, varnodes: java.util.Set, colorProvider: ghidra.app.decompiler.component.ColorProvider) -> None: ...

    @overload
    def addHighlights(self, ops: java.util.Set, hlColor: java.awt.Color) -> None: ...
    ...
    @overload
    def addSecondaryHighlight(self, token: ghidra.app.decompiler.ClangToken) -> None: ...

    @overload
    def addSecondaryHighlight(self, token: ghidra.app.decompiler.ClangToken, color: java.awt.Color) -> None: ...
    ...
    def buttonPressed(self, location: docking.widgets.fieldpanel.support.FieldLocation, field: docking.widgets.fieldpanel.field.Field, ev: java.awt.event.MouseEvent) -> None: ...
    ...
    def cloneHighlights(self, sourcePanel: ghidra.app.decompiler.component.DecompilerPanel) -> None:
        """
    ...
    @overload
    def createHighlighter(self, tm: ghidra.app.decompiler.CTokenHighlightMatcher) -> ghidra.app.decompiler.component.ClangDecompilerHighlighter: ...

    @overload
    def createHighlighter(self, id: unicode, tm: ghidra.app.decompiler.CTokenHighlightMatcher) -> ghidra.app.decompiler.component.ClangDecompilerHighlighter: ...
    ...
    def findTokensByName(self, name: unicode) -> List[ghidra.app.decompiler.ClangToken]: ...
    ...
    def getFields(self) -> List[docking.widgets.fieldpanel.field.Field]: ...
    ...
    def getHighlightController(self) -> ghidra.app.decompiler.component.ClangHighlightController: ...

    def getHighlightedText(self) -> unicode: ...

    def getHighlighter(self, id: unicode) -> ghidra.app.decompiler.DecompilerHighlighter: ...

    def getHighlights(self, highligter: ghidra.app.decompiler.DecompilerHighlighter) -> ghidra.app.decompiler.component.TokenHighlights: ...
    ...
    def getLayoutController(self) -> ghidra.app.decompiler.component.ClangLayoutController: ...

    def getLineNumber(self, y: int) -> int:
        """
    ...
    def getSearchResults(self) -> ghidra.app.plugin.core.decompile.actions.FieldBasedSearchLocation: ...
    ...
    def getTextUnderCursor(self) -> unicode: ...
    ...
    def goToToken(self, token: ghidra.app.decompiler.ClangToken) -> None: ...
    ...
    def optionsChanged(self, decompilerOptions: ghidra.app.decompiler.DecompileOptions) -> None: ...
    ...
    def removeSecondaryHighlight(self, token: ghidra.app.decompiler.ClangToken) -> None: ...

    def removeSecondaryHighlights(self, function: ghidra.program.model.listing.Function) -> None:
        """
    ...
    def searchText(self, text: unicode, startLocation: docking.widgets.fieldpanel.support.FieldLocation, forwardDirection: bool) -> docking.widgets.SearchLocation: ...

    def searchTextRegex(self, text: unicode, startLocation: docking.widgets.fieldpanel.support.FieldLocation, forwardDirection: bool) -> docking.widgets.SearchLocation: ...

    def selectAll(self, trigger: docking.widgets.EventTrigger) -> None: ...
    ...
    def setBackground(self, bg: java.awt.Color) -> None: ...
    ...
    def setCursorPosition(self, fieldLocation: docking.widgets.fieldpanel.support.FieldLocation) -> None: ...

    def setDebugGraphicsOptions(self, __a0: int) -> None: ...

    def setDecompilerHoverProvider(self, provider: ghidra.app.decompiler.component.DecompilerHoverProvider) -> None: ...
    ...
    def setHighlightController(self, highlightController: ghidra.app.decompiler.component.ClangHighlightController) -> None: ...
    ...
    @overload
    def setLocation(self, location: ghidra.program.util.ProgramLocation, viewerPosition: docking.widgets.fieldpanel.support.ViewerPosition) -> None: ...
    ...
    def setSearchResults(self, searchLocation: docking.widgets.SearchLocation) -> None: ...
    ...
    def setViewerPosition(self, viewerPosition: docking.widgets.fieldpanel.support.ViewerPosition) -> None: ...
    ...
    def tokenHighlightsChanged(self) -> None: ...

    def tokenRenamed(self, token: ghidra.app.decompiler.ClangToken, newName: unicode) -> None:
        """
    ...
    def cursorPosition(self, value: docking.widgets.fieldpanel.support.FieldLocation) -> None: ...

    @property
    def decompilerHoverProvider(self) -> None: ...  # No getter available.

    @decompilerHoverProvider.setter
    def decompilerHoverProvider(self, value: ghidra.app.decompiler.component.DecompilerHoverProvider) -> None: ...
    ...
    @property
    def highlightController(self) -> ghidra.app.decompiler.component.ClangHighlightController: ...

    @highlightController.setter
    def highlightController(self, value: ghidra.app.decompiler.component.ClangHighlightController) -> None: ...
    ...
    @property
    def layoutController(self) -> ghidra.app.decompiler.component.ClangLayoutController: ...
    ...
    @property
    def searchResults(self) -> ghidra.app.plugin.core.decompile.actions.FieldBasedSearchLocation: ...

    @property
    def secondaryHighlightColors(self) -> ghidra.app.decompiler.component.TokenHighlightColors: ...

    @property
    def selectedText(self) -> unicode: ...
    ...
    @property
    def textUnderCursor(self) -> unicode: ...
