...
class NextRangeAction(ghidra.app.context.NavigatableContextAction):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, name: unicode, owner: unicode, navOptions: ghidra.app.plugin.core.navigation.NavigationOptions): ...



    @overload
    def actionPerformed(self, context: ghidra.app.context.NavigatableActionContext) -> None: ...
    ...
    @overload
    def isEnabledForContext(self, context: ghidra.app.context.NavigatableActionContext) -> bool: ...
