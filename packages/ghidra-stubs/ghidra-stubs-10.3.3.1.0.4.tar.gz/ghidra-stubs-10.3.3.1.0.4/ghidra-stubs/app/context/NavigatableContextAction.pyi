...
class NavigatableContextAction(docking.action.DockingAction):
    ...
    @overload
    def __init__(self, name: unicode, owner: unicode, supportsRestrictedAddressSetContext: bool):
        """
    ...
    @overload
    def __init__(self, name: unicode, owner: unicode, type: docking.action.KeyBindingType):
        """
