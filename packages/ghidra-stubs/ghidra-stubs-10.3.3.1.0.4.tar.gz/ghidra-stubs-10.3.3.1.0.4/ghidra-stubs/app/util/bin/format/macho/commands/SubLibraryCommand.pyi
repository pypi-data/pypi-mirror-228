...
class SubLibraryCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getSubLibraryName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
    ...
    @property
    def subLibraryName(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...