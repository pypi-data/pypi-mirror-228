...
class DyldChainedFixupsCommand(ghidra.app.util.bin.format.macho.commands.LinkEditDataCommand):
    """
    ...
    def getChainHeader(self) -> ghidra.app.util.bin.format.macho.commands.DyldChainedFixupHeader: ...
    ...
    @property
    def chainHeader(self) -> ghidra.app.util.bin.format.macho.commands.DyldChainedFixupHeader: ...
