...
class DynamicLinkerCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    def getLoadCommandString(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...
    ...
    @property
    def loadCommandString(self) -> ghidra.app.util.bin.format.macho.commands.LoadCommandString: ...