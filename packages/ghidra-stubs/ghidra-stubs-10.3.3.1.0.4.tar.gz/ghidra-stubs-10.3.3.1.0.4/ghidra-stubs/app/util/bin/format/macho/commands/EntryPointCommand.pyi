...
class EntryPointCommand(ghidra.app.util.bin.format.macho.commands.LoadCommand):
    """
    ...
    @property
    def entryOffset(self) -> long: ...

    @property
    def stackSize(self) -> long: ...