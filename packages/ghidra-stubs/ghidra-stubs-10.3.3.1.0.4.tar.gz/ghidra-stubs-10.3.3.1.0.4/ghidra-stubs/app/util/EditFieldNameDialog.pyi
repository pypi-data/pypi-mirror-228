...
class EditFieldNameDialog(docking.DialogComponentProvider):
    ...
    @overload
    def editField(self, dataTypeComponent: ghidra.program.model.data.DataTypeComponent, p: ghidra.program.model.listing.Program) -> None: ...

    @overload
    def editField(self, dataTypeComponent: ghidra.program.model.data.DataTypeComponent, p: ghidra.program.model.listing.Program, centeredOverComponent: java.awt.Component) -> None: ...
