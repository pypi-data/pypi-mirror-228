...
class AbstractDemangledFunctionDefinitionDataType(ghidra.app.util.demangler.DemangledDataType):
    """
    ...
    @property
    def constPointer(self) -> bool: ...

    @property
    def modifier(self) -> None: ...  # No getter available.

    @modifier.setter
    def modifier(self, value: unicode) -> None: ...
