...
class AbstractOrdinalSupportLoader(ghidra.app.util.opinion.AbstractLibrarySupportLoader):
    """
    An abstract Loader that provides support for programs that link to external libraries
     with an ordinal mechanism.  Supports caching library lookup information to XML files.
    """

    ORDINAL_LOOKUP_OPTION_NAME: unicode = u'Perform Library Ordinal Lookup'
