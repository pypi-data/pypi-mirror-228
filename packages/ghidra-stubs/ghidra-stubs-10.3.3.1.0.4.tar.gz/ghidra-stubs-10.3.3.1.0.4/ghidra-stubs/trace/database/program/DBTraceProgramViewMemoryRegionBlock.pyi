...
class DBTraceProgramViewMemoryRegionBlock(ghidra.trace.database.program.AbstractDBTraceProgramViewMemoryBlock):




    def __init__(self, __a0: ghidra.trace.database.program.DBTraceProgramView, __a1: ghidra.trace.model.memory.TraceMemoryRegion): ...
