...
class DBTraceAddressSnapRangePropertyMap(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.map.TraceAddressSnapRangePropertyMap, ghidra.trace.database.space.DBTraceDelegatingManager):





    class DBTraceAddressSnapRangePropertyMapDataFactory(object):
        ...
        def create(self, __a0: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree, __a1: ghidra.util.database.DBCachedObjectStore, __a2: db.DBRecord) -> ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.AbstractDBTraceAddressSnapRangePropertyMapData: ...
