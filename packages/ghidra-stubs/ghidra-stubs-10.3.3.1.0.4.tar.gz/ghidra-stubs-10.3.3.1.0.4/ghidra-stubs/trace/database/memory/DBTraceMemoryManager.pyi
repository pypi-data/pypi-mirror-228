...
class DBTraceMemoryManager(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.memory.TraceMemoryManager, ghidra.trace.database.memory.InternalTraceMemoryOperations, ghidra.trace.database.space.DBTraceDelegatingManager):
    ...
    @overload
    def getMemoryRegisterSpace(self, __a0: ghidra.trace.model.stack.TraceStackFrame, __a1: bool) -> ghidra.trace.database.memory.DBTraceMemorySpace: ...

    @overload
    def getMemoryRegisterSpace(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: bool) -> ghidra.trace.database.memory.DBTraceMemorySpace: ...
