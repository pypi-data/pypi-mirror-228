...
class DBTraceObjectManager(object, ghidra.trace.model.target.TraceObjectManager, ghidra.trace.database.DBTraceManager):
    ...
    def __init__(self, __a0: db.DBHandle, __a1: ghidra.util.database.DBOpenMode, __a2: java.util.concurrent.locks.ReadWriteLock, __a3: ghidra.util.task.TaskMonitor, __a4: ghidra.program.model.lang.Language, __a5: ghidra.trace.database.DBTrace): ...
    ...
    def checkMyObject(self, __a0: ghidra.trace.database.target.DBTraceObject) -> bool: ...
    ...
    @overload
    def getAllObjects(self) -> java.util.Collection: ...

    @overload
    def getAllObjects(self, __a0: java.lang.Class) -> java.util.Collection: ...

    def getAllValues(self) -> java.util.Collection: ...
    ...
    def getValuesAt(self, __a0: long, __a1: ghidra.program.model.address.Address) -> java.util.Collection: ...
    ...
    @property
    def allObjects(self) -> java.util.Collection: ...

    @property
    def allValues(self) -> java.util.Collection: ...
