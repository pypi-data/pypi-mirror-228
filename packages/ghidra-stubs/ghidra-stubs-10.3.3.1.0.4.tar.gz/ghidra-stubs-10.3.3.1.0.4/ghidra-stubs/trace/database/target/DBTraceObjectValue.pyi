...
class DBTraceObjectValue(ghidra.util.database.DBAnnotatedObject, ghidra.trace.database.target.InternalTraceObjectValue):
    ...
    class PrimaryTripleDBFieldCodec(ghidra.util.database.DBCachedObjectStoreFactory.AbstractDBFieldCodec):
        ...
        @overload
        def store(self, __a0: ghidra.trace.database.target.DBTraceObjectValue.PrimaryTriple, __a1: db.BinaryField) -> None: ...
