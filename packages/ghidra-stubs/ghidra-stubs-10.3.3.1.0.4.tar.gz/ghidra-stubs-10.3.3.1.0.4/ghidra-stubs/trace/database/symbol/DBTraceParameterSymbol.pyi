...
class DBTraceParameterSymbol(ghidra.trace.database.symbol.AbstractDBTraceVariableSymbol, ghidra.trace.model.symbol.TraceParameterSymbol):
    ...
    @staticmethod
    def areEquivalent(__a0: ghidra.program.model.listing.Variable, __a1: ghidra.program.model.listing.Variable) -> bool: ...

    @overload
    def compareTo(self, __a0: ghidra.program.model.listing.Variable) -> int: ...
    ...
    @overload
    def getReferences(self, __a0: ghidra.util.task.TaskMonitor) -> List[ghidra.trace.database.symbol.DBTraceReference]: ...
    ...
    def setOrdinal(self, __a0: int) -> None: ...
    ...
    @property
    def parentNamespace(self) -> ghidra.trace.database.symbol.DBTraceFunctionSymbol: ...

    @property
    def parentSymbol(self) -> ghidra.trace.database.symbol.DBTraceFunctionSymbol: ...
