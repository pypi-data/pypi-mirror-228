...
class DBTraceNamespaceSymbol(ghidra.trace.database.symbol.AbstractDBTraceSymbol, ghidra.trace.model.symbol.TraceNamespaceSymbol):
    ...
    @property
    def parentNamespace(self) -> None: ...  # No getter available.
