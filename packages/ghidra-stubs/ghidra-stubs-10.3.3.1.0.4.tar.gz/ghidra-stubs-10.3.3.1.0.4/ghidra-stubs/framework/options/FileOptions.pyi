...
class FileOptions(ghidra.framework.options.AbstractOptions):
    ...
    def copy(self) -> ghidra.framework.options.FileOptions: ...
    ...
    def readCustomOption(self, saveState: ghidra.framework.options.SaveState) -> ghidra.framework.options.CustomOption: ...
    ...
    def save(self, saveFile: java.io.File) -> None: ...
