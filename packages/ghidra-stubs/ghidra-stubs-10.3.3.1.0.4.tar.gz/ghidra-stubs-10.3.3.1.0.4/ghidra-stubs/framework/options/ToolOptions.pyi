...
class ToolOptions(ghidra.framework.options.AbstractOptions):
    ...
    PRIMITIVE_CLASSES: java.util.Set = [class java.lang.Short, class java.lang.Byte, class java.lang.Integer, class java.lang.Long, class java.lang.Boolean, class java.lang.String, class java.lang.Double, class java.lang.Float]
    WRAPPABLE_CLASSES: java.util.Set = [class javax.swing.KeyStroke, class java.awt.Color, class java.awt.Font, class java.io.File]
    ...
    def registerThemeColorBinding(self, optionName: unicode, colorId: unicode, help: ghidra.util.HelpLocation, description: unicode) -> None: ...

    def registerThemeFontBinding(self, optionName: unicode, fontId: unicode, help: ghidra.util.HelpLocation, description: unicode) -> None: ...
