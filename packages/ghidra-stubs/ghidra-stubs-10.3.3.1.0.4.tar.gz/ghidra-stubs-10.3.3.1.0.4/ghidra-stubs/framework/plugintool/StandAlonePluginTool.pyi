...
class StandAlonePluginTool(ghidra.framework.plugintool.PluginTool):




    def __init__(self, app: ghidra.framework.plugintool.GenericStandAloneApplication, name: unicode, hasStatus: bool): ...
    ...
    def addExportToolAction(self) -> None: ...
    ...
    def addManagePluginsAction(self) -> None: ...
    ...
    def addSaveToolAction(self) -> None: ...
