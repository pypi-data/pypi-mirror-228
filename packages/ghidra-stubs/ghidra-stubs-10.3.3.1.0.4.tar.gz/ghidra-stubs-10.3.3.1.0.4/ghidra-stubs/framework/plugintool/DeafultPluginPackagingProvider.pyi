...
class DeafultPluginPackagingProvider(object, ghidra.framework.plugintool.PluginPackagingProvider):
    """
    The default plugin package provider that uses the PluginClassManager to supply packages
    """

    EXPERIMENTAL_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Project/lib/Project.jar!/images/applications-science.png
    UNSTABLE_PACKAGE: ghidra.framework.plugintool.util.PluginPackage = Experimental
