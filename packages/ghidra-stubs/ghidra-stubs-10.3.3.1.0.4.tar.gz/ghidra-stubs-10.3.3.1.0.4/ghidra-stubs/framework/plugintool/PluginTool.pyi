...
class PluginTool(docking.AbstractDockingTool):
    ...
    DESCRIPTION_PROPERTY_NAME: unicode = u'Description'
    ICON_PROPERTY_NAME: unicode = u'Icon'
    PLUGIN_COUNT_PROPERTY_NAME: unicode = u'PluginCount'
    TOOL_NAME_PROPERTY: unicode = u'ToolName'
    ...
    @overload
    def __init__(self, project: ghidra.framework.model.Project, name: unicode, isDockable: bool, hasStatus: bool, isModal: bool):
        """
        Construct a new PluginTool.
    ...
    @overload
    def __init__(self, project: ghidra.framework.model.Project, projectManager: ghidra.framework.model.ProjectManager, toolServices: ghidra.framework.model.ToolServices, name: unicode, isDockable: bool, hasStatus: bool, isModal: bool): ...
    ...
    @property
    def activeComponentProvider(self) -> docking.ComponentProvider: ...

    @property
    def activeWindow(self) -> java.awt.Window: ...

    @property
    def configChanged(self) -> None: ...  # No getter available.

    @configChanged.setter
    def configChanged(self, value: bool) -> None: ...

    @property
    def configurable(self) -> bool: ...

    @property
    def consumedToolEventNames(self) -> List[unicode]: ...

    @property
    def defaultComponent(self) -> None: ...  # No getter available.

    @defaultComponent.setter
    def defaultComponent(self, value: docking.ComponentProvider) -> None: ...

    @property
    def defaultToolContext(self) -> docking.ActionContext: ...

    @property
    def domainFiles(self) -> List[ghidra.framework.model.DomainFile]: ...

    @property
    def executingCommand(self) -> bool: ...
    ...
    @property
    def restoringDataState(self) -> bool: ...

    @property
    def size(self) -> java.awt.Dimension: ...

    @property
    def subTitle(self) -> None: ...  # No getter available.
    ...
    @property
    def toolEventNames(self) -> List[unicode]: ...
    ...
    @property
    def windowsOnTop(self) -> bool: ...

    @windowsOnTop.setter
    def windowsOnTop(self, value: bool) -> None: ...