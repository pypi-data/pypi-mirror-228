...
class VTMatchTableProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.feature.vt.gui.filters.FilterDialogModel, ghidra.feature.vt.gui.plugin.VTControllerListener):
    TEXT_FILTER_NAME: unicode = u'matches.text.filter'
    ...
    def setTableSelectionMode(self, __a0: ghidra.feature.vt.gui.actions.TableSelectionTrackingState) -> None: ...
    ...
    @property
    def tableSelectionMode(self) -> None: ...  # No getter available.

    @tableSelectionMode.setter
    def tableSelectionMode(self, value: ghidra.feature.vt.gui.actions.TableSelectionTrackingState) -> None: ...