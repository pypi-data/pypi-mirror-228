...
class ApplyBlockedMatchAction(docking.action.DockingAction):
    APPLY_BLOCKED_MATCH_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    NAME: unicode
