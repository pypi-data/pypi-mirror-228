...
class MatchActionWrapper(docking.action.DockingAction):




    def __init__(self, __a0: ghidra.feature.vt.gui.plugin.VTPlugin, __a1: docking.action.DockingAction): ...
    ...
    def createActionContext(self, __a0: docking.ActionContext) -> docking.ActionContext: ...
    ...
    def getSubToolContext(self) -> ghidra.feature.vt.gui.plugin.SubToolContext: ...
    ...
    @property
    def subToolContext(self) -> ghidra.feature.vt.gui.plugin.SubToolContext: ...