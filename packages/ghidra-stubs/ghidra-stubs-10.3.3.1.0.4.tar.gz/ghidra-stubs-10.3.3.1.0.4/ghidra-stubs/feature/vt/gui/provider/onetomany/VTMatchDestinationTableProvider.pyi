...
class VTMatchDestinationTableProvider(ghidra.feature.vt.gui.provider.onetomany.VTMatchOneToManyTableProvider):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.feature.vt.gui.plugin.VTController, __a2: ghidra.feature.vt.gui.plugin.VTSubToolManager): ...
    ...
    def getMatchesTableModel(self) -> ghidra.feature.vt.gui.provider.onetomany.VTMatchOneToManyTableModel: ...
    ...
    def loadLocalInfo(self, __a0: ghidra.program.model.address.Address) -> None: ...
    ...
    @property
    def matchesTableModel(self) -> ghidra.feature.vt.gui.provider.onetomany.VTMatchOneToManyTableModel: ...