...
class VTFunctionAssociationProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.feature.vt.gui.plugin.VTControllerListener, docking.actions.PopupActionProvider):
    FILTER_NOT_ACCEPTED_ICON: javax.swing.Icon = jar:file:/opt/hostedtoolcache/ghidra/10.3.3/x64/Ghidra/Framework/Gui/lib/Gui.jar!/images/core.png
    ...
    def addSelectionListener(self, __a0: ghidra.feature.vt.gui.provider.functionassociation.VTFunctionAssociationListener) -> None: ...
    ...
    def getSelectedDestinationFunction(self) -> ghidra.program.model.listing.Function: ...
    ...
    @property
    def selectedDestinationFunction(self) -> ghidra.program.model.listing.Function: ...
