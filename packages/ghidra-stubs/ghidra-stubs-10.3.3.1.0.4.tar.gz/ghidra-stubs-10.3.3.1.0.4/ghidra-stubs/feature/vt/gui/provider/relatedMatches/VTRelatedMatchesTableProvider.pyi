...
class VTRelatedMatchesTableProvider(ghidra.framework.plugintool.ComponentProviderAdapter):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.feature.vt.gui.plugin.VTController): ...



    def addLocalAction(self, __a0: docking.action.DockingActionIf) -> None: ...

    def addRelatedMatchSelectionListener(self, __a0: ghidra.feature.vt.gui.provider.relatedMatches.VTRelatedMatchSelectionListener) -> None: ...
