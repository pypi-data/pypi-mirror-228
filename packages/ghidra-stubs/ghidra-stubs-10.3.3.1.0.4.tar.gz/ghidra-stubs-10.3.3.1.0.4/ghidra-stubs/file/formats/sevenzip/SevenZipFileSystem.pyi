...
class SevenZipFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):




    def __init__(self, __a0: ghidra.formats.gfilesystem.FSRLRoot, __a1: ghidra.formats.gfilesystem.FileSystemService): ...
    ...
    def mount(self, __a0: ghidra.app.util.bin.ByteProvider, __a1: ghidra.util.task.TaskMonitor) -> None: ...
