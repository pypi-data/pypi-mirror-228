...
class DumpFileLoader(ghidra.app.util.opinion.AbstractProgramWrapperLoader):
    DF_NAME: unicode = u'Dump File Loader'
    MEMORY: unicode = u'Memory'
    ...
    def groupRanges(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.file.formats.dump.DumpFile, __a2: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    def loadRanges(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.file.formats.dump.DumpFile, __a2: ghidra.util.task.TaskMonitor) -> None: ...
