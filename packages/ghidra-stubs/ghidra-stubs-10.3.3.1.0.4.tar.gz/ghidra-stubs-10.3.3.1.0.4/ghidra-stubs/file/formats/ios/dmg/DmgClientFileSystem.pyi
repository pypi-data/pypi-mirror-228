...
class DmgClientFileSystem(object, ghidra.formats.gfilesystem.GFileSystem):




    def __init__(self, __a0: java.io.File, __a1: bool, __a2: ghidra.formats.gfilesystem.FSRLRoot, __a3: ghidra.formats.gfilesystem.FileSystemService): ...
