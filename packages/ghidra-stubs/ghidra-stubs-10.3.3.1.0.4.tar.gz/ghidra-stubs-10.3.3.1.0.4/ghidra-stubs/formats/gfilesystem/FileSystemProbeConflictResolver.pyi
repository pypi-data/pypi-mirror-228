...
class FileSystemProbeConflictResolver(object):
    ...
    CHOOSEFIRST: ghidra.formats.gfilesystem.FileSystemProbeConflictResolver = ghidra.formats.gfilesystem.FileSystemProbeConflictResolver$1@2e1cd4bd
    GUI_PICKER: ghidra.formats.gfilesystem.FileSystemProbeConflictResolver = ghidra.formats.gfilesystem.FileSystemProbeConflictResolver$2@2e66d3e5
