...
class FSBAction(docking.action.DockingAction):
    """
    ...
    @overload
    def __init__(self, menuText: unicode, plugin: ghidra.framework.plugintool.Plugin): ...

    @overload
    def __init__(self, name: unicode, menuText: unicode, plugin: ghidra.framework.plugintool.Plugin): ...
