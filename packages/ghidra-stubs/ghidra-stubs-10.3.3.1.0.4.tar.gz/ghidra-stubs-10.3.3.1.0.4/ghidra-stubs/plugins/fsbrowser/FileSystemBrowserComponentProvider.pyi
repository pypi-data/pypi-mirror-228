...
class FileSystemBrowserComponentProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.formats.gfilesystem.FileSystemEventListener):
    """
    ...
    def getActionContext(self, event: java.awt.event.MouseEvent) -> ghidra.plugins.fsbrowser.FSBActionContext: ...
