...
class AsyncUtils(object):
    CLEANER: java.lang.ref.Cleaner = java.lang.ref.Cleaner@176cb343
    FRAMEWORK_EXECUTOR: java.util.concurrent.ExecutorService = java.util.concurrent.ForkJoinPool@3b4bf8ba[Running, parallelism = 2, size = 0, active = 0, running = 0, steals = 0, tasks = 0, submissions = 0]
    NIL: java.util.concurrent.CompletableFuture = java.util.concurrent.CompletableFuture@9e3ebc7[Completed normally]
    SWING_EXECUTOR: java.util.concurrent.ExecutorService = ghidra.async.SwingExecutorService$1@5f92fc7d
