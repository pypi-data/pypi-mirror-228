...
class AsyncLazyMap(object):
    ...
    class KeyedFuture(java.util.concurrent.CompletableFuture):
        ...
        def exceptionallyCompose(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
        ...
        def runAfterBoth(self, __a0: java.util.concurrent.CompletionStage, __a1: java.lang.Runnable) -> java.util.concurrent.CompletableFuture: ...

        @overload
        def runAfterBothAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.lang.Runnable) -> java.util.concurrent.CompletableFuture: ...

        @overload
        def runAfterBothAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.lang.Runnable, __a2: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...
        ...
        def thenApply(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
        ...
        @overload
        def thenCombineAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.BiFunction) -> java.util.concurrent.CompletableFuture: ...

        @overload
        def thenCombineAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.BiFunction, __a2: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...

        def thenCompose(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...

        @overload
        def thenComposeAsync(self, __a0: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
        ...
        def whenComplete(self, __a0: java.util.function.BiConsumer) -> java.util.concurrent.CompletableFuture: ...
