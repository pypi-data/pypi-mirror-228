...
class CompilerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Convert = channel.stream_unary(
        ...
        request_serializer=speechly_dot_sal_dot_v1_dot_compiler__pb2.ConvertRequest.SerializeToString,
        response_deserializer=speechly_dot_sal_dot_v1_dot_compiler__pb2.ConvertResult.FromString,
        )
...
def add_CompilerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Convert': grpc.stream_unary_rpc_method_handler(
          servicer.Convert,
          request_deserializer=speechly_dot_sal_dot_v1_dot_compiler__pb2.ConvertRequest.FromString,
          response_serializer=speechly_dot_sal_dot_v1_dot_compiler__pb2.ConvertResult.SerializeToString,
      ),
  }
