...
from speechly.slu.v2beta2 import batch_api_pb2 as speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2
...
class BatchAPIStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ProcessAudioSource = channel.unary_unary(
        ...
        request_serializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.ProcessAudioSourceRequest.SerializeToString,
        response_deserializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.ProcessAudioSourceResponse.FromString,
        )
    self.QueryStatus = channel.unary_unary(
        '/speechly.slu.v2beta2.BatchAPI/QueryStatus',
        request_serializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.QueryStatusRequest.SerializeToString,
        response_deserializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.QueryStatusResponse.FromString,
        )
...
def add_BatchAPIServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ProcessAudioSource': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.ProcessAudioSourceRequest.FromString,
          response_serializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.ProcessAudioSourceResponse.SerializeToString,
      ),
      'QueryStatus': grpc.unary_unary_rpc_method_handler(
          servicer.QueryStatus,
          request_deserializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.QueryStatusRequest.FromString,
          response_serializer=speechly_dot_slu_dot_v2beta2_dot_batch__api__pb2.QueryStatusResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'speechly.slu.v2beta2.BatchAPI', rpc_method_handlers)
