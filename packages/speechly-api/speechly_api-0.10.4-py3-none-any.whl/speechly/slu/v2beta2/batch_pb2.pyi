...
class BatchConfig(_message.Message):
    __slots__ = ["model_id", "language_codes", "batch_reference", "options"]
    ...
    def __init__(self, model_id: _Optional[str] = ..., language_codes: _Optional[_Iterable[str]] = ..., batch_reference: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Option, _Mapping]]] = ...) -> None: ...
