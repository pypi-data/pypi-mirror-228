...
class ProcessAudioBatchConfig(_message.Message):
    __slots__ = ["app_id", "language_codes", "processing_config", "batch_reference", "options"]
    APP_ID_FIELD_NUMBER: _ClassVar[int]
    LANGUAGE_CODES_FIELD_NUMBER: _ClassVar[int]
    PROCESSING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, app_id: _Optional[str] = ..., language_codes: _Optional[_Iterable[str]] = ..., processing_config: _Optional[_Union[ProcessingConfiguration, _Mapping]] = ..., batch_reference: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Option, _Mapping]]] = ...) -> None: ...
...
class ProcessingConfiguration(_message.Message):
    __slots__ = ["tokenize", "translate", "skip_transcribe"]
    TOKENIZE_FIELD_NUMBER: _ClassVar[int]
    TRANSLATE_FIELD_NUMBER: _ClassVar[int]
    SKIP_TRANSCRIBE_FIELD_NUMBER: _ClassVar[int]
    tokenize: bool
    translate: bool
    skip_transcribe: bool
    def __init__(self, tokenize: bool = ..., translate: bool = ..., skip_transcribe: bool = ...) -> None: ...
...
class OperationResult(_message.Message):
    ...
    class ResultType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        RESULT_TYPE_TRANSCRIPT_TRANSLATION: _ClassVar[OperationResult.ResultType]
    ...
    RESULT_TYPE_TRANSCRIPT_TRANSLATION: OperationResult.ResultType
