...
class ModerationStatisticsResponse(_message.Message):
    __slots__ = ["project_id", "app_id", "start_date", "end_date", "aggregation", "items"]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    APP_ID_FIELD_NUMBER: _ClassVar[int]
    START_DATE_FIELD_NUMBER: _ClassVar[int]
    END_DATE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, project_id: _Optional[str] = ..., app_id: _Optional[str] = ..., start_date: _Optional[str] = ..., end_date: _Optional[str] = ..., aggregation: _Optional[_Union[_analytics_pb2.Aggregation, str]] = ..., items: _Optional[_Iterable[_Union[_analytics_pb2.ModerationStatisticsPeriod, _Mapping]]] = ...) -> None: ...
