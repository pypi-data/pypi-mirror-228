...
class ModerationStatisticsPeriod(_message.Message):
    __slots__ = ["start_time", "user_id", "count", "flagged", "decisions"]
    START_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    flagged: int
    decisions: int
    def __init__(self, start_time: _Optional[str] = ..., user_id: _Optional[str] = ..., count: _Optional[int] = ..., flagged: _Optional[int] = ..., decisions: _Optional[int] = ...) -> None: ...
