from speechly.slu.v2beta2 import batch_pb2 as _batch_pb2
...
class ProcessAudioSourceRequest(_message.Message):
    __slots__ = ["tasks", "config", "output", "source"]
    TASKS_FIELD_NUMBER: _ClassVar[int]
    CONFIG_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    SOURCE_FIELD_NUMBER: _ClassVar[int]
    tasks: _batch_pb2.BatchTasks
    config: _batch_pb2.BatchConfig
    output: _batch_pb2.BatchOutput
    source: _containers.RepeatedCompositeFieldContainer[_batch_pb2.ProcessAudioSourceRequestItem]
    def __init__(self, tasks: _Optional[_Union[_batch_pb2.BatchTasks, _Mapping]] = ..., config: _Optional[_Union[_batch_pb2.BatchConfig, _Mapping]] = ..., output: _Optional[_Union[_batch_pb2.BatchOutput, _Mapping]] = ..., source: _Optional[_Iterable[_Union[_batch_pb2.ProcessAudioSourceRequestItem, _Mapping]]] = ...) -> None: ...
