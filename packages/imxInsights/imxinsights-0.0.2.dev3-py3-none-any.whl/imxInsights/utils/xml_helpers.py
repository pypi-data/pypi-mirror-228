...
class XmlFile:
    ...
    Args:
        path (Path): The path of the XML file.

    Attributes:
        root (ET.ElementTree): XML root tree.
        exists (bool): returns True if file exists else False.
    """
    ...
    def __post_init__(self) -> None:
        ...
        # mutcho use of comments for test purposes ET will parse them as nodes so make sure comments are not parsed...
