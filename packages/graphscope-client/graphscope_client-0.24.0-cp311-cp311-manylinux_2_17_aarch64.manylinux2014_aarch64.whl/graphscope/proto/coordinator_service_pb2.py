...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'coordinator_service_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _COORDINATORSERVICE._serialized_start=53
  _COORDINATORSERVICE._serialized_end=1135
