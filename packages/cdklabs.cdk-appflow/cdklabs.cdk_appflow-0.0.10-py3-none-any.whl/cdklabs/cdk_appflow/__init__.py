...
class DataPullConfig:
    def __init__(
        ...
        *,
        ...
        '''
        :param mode: 
        :param timestamp_field: (experimental) The name of the field to use as a timestamp for recurring incremental flows. The default field is set per particular @see ISource.
...
class FilterCondition(
    ...
    def properties(self) -> "TaskProperties":
        ...
        :stability: experimental
        '''
        return typing.cast("TaskProperties", jsii.get(self, "properties"))
...
@jsii.data_type(
    jsii_type="@cdklabs/cdk-appflow.GoogleAnalytics4OAuthEndpointsSettings",
    jsii_struct_bases=[],
    name_mapping={"authorization": "authorization", "token": "token"},
)
class GoogleAnalytics4OAuthEndpointsSettings:
    def __init__(
        self,
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__16b79d1c2d135eaf234bf503c016c9a1248eac523d767a115dc42924cdb8d5ab)
    ...
    def __repr__(self) -> str:
        return "GoogleAnalytics4OAuthEndpointsSettings(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class GoogleAnalytics4OAuthSettings:
    def __init__(
        ...
        *,
        ...
        endpoints: typing.Optional[typing.Union[GoogleAnalytics4OAuthEndpointsSettings, typing.Dict[builtins.str, typing.Any]]] = None,
        flow: typing.Optional[typing.Union[GoogleAnalytics4OAuthFlow, typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''
        :param access_token: (experimental) The access token to be used when interacting with Google Analytics 4. Note that if only the access token is provided AppFlow is not able to retrieve a fresh access token when the current one is expired
        :param endpoints: 
        :param flow: 
        ...
        if isinstance(endpoints, dict):
            endpoints = GoogleAnalytics4OAuthEndpointsSettings(**endpoints)
    ...
    @builtins.property
    def endpoints(self) -> typing.Optional[GoogleAnalytics4OAuthEndpointsSettings]:
        '''
        :stability: experimental
        '''
        result = self._values.get("endpoints")
        return typing.cast(typing.Optional[GoogleAnalytics4OAuthEndpointsSettings], result)
...
class MicrosoftSharepointOnlineOAuthSettings:
    def __init__(
        self,
        *,
        endpoints: typing.Union[MicrosoftSharepointOnlineOAuthEndpointsSettings, typing.Dict[builtins.str, typing.Any]],
        access_token: typing.Optional[builtins.str] = None,
    ...
    @builtins.property
    def endpoints(self) -> MicrosoftSharepointOnlineOAuthEndpointsSettings:
        '''
        :stability: experimental
        '''
        result = self._values.get("endpoints")
        assert result is not None, "Required property 'endpoints' is missing"
        return typing.cast(MicrosoftSharepointOnlineOAuthEndpointsSettings, result)
...
class MicrosoftSharepointOnlineTokenUrlBuilder(
    ...
    @jsii.member(jsii_name="buildFromTenant")
    @builtins.classmethod
    def build_from_tenant(cls, tenant_id: builtins.str) -> builtins.str:
        '''
        :param tenant_id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b4babbdfbe50229e4fe41d03eabb3e8e9f9ea29982fb256607cca52c0995feda)
            check_type(argname="argument tenant_id", value=tenant_id, expected_type=type_hints["tenant_id"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "buildFromTenant", [tenant_id]))
...
class RedshiftDestinationProps:
    def __init__(
        ...
        *,
        ...
        :param profile: (experimental) An instance of the @type RedshiftConnectorProfile.
    ...
    def profile(self) -> "RedshiftConnectorProfile":
        '''(experimental) An instance of the @type RedshiftConnectorProfile.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"database": "database", "table_prefix": "tablePrefix"},
)
class S3Catalog:
    def __init__(
        self,
        *,
        database: _aws_cdk_aws_glue_alpha_ce674d29.Database,
    ...
    @builtins.property
    def database(self) -> _aws_cdk_aws_glue_alpha_ce674d29.Database:
        '''
        :stability: experimental
        '''
...
class S3OutputFormatting:
    def __init__(
        ...
        *,
        ...
        :param file_prefix: 
        :param file_type: 
        :param preserve_source_data_types: 
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"refres_token_grant": "refresTokenGrant"},
)
class SalesforceOAuthFlow:
    def __init__(
        self,
        *,
        refres_token_grant: typing.Union["SalesforceOAuthRefreshTokenGrantFlow", typing.Dict[builtins.str, typing.Any]],
    ) -> None:
        '''
        :param refres_token_grant: 

        :stability: experimental
        '''
        if isinstance(refres_token_grant, dict):
            refres_token_grant = SalesforceOAuthRefreshTokenGrantFlow(**refres_token_grant)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7bb20287992df1bb2824bccc50aa824c16613f769993cb06ee2d3bd7bd25daee)
            check_type(argname="argument refres_token_grant", value=refres_token_grant, expected_type=type_hints["refres_token_grant"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "refres_token_grant": refres_token_grant,
        }

    @builtins.property
    def refres_token_grant(self) -> "SalesforceOAuthRefreshTokenGrantFlow":
        '''
        :stability: experimental
        '''
        result = self._values.get("refres_token_grant")
        assert result is not None, "Required property 'refres_token_grant' is missing"
        return typing.cast("SalesforceOAuthRefreshTokenGrantFlow", result)
...
class Task(metaclass=jsii.JSIIMeta, jsii_type="@cdklabs/cdk-appflow.Task"):
    ...
    def __init__(
        ...
        properties: typing.Union["TaskProperties", typing.Dict[builtins.str, typing.Any]],
    ...
    def _connector_operator(self, value: "TaskConnectorOperator") -> None:
        ...
        jsii.set(self, "connectorOperator", value)

    @builtins.property
    @jsii.member(jsii_name="properties")
    def _properties(self) -> "TaskProperties":
        '''
        :stability: experimental
        '''
        return typing.cast("TaskProperties", jsii.get(self, "properties"))
    ...
    @_properties.setter
    def _properties(self, value: "TaskProperties") -> None:
        if __debug__:
...
@jsii.data_type(
    jsii_type="@cdklabs/cdk-appflow.TaskProperties",
    jsii_struct_bases=[],
    name_mapping={},
)
class TaskProperties:
    def __init__(self) -> None:
        '''(experimental) A generic bucket for the task properties.
...
class TriggeredFlowBase(
    ...
    def __init__(
        ...
        scope: _constructs_77d1e7e8.Construct,
        id: builtins.str,
        props: typing.Union[FlowBaseProps, typing.Dict[builtins.str, typing.Any]],
        auto_activate: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''
        :param scope: -
        ...
        if __debug__:
            ...
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument auto_activate", value=auto_activate, expected_type=type_hints["auto_activate"])
        jsii.create(self.__class__, self, [scope, id, props, auto_activate])
...
__all__ = [
    ...
    "GoogleAnalytics4OAuthEndpointsSettings",
...
def _typecheckingstub__16b79d1c2d135eaf234bf503c016c9a1248eac523d767a115dc42924cdb8d5ab(
    *,
    authorization: typing.Optional[builtins.str] = None,
    token: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__b4babbdfbe50229e4fe41d03eabb3e8e9f9ea29982fb256607cca52c0995feda(
