...
class SLEAPImporterSLP(ConfigReader, PoseImporterMixin):
    ...
    #
            ...
            write_df(df=self.data_df, file_type=self.file_type, save_path=self.save_path, multi_idx_header=True)
        ...
        stdout_success(msg='All SLEAP SLP data files imported', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)
...
# test = SLEAPImporterSLP(project_path="/Users/simon/Desktop/envs/troubleshooting/sleap_dropped_frms_2/project_folder/project_config.ini",
#                    data_folder=r'/Users/simon/Desktop/envs/troubleshooting/sleap_dropped_frms_2/data_slp',
#                    id_lst=['Simon'],
