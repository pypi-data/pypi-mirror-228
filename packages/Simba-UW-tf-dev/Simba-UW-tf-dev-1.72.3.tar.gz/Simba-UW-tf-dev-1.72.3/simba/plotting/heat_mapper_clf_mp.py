    ...
    def run(self):
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            if self.video_setting or self.frame_setting:
                ...
                print('Creating heatmaps, multiprocessing (chunksize: {}, cores: {})...'.format(str(self.multiprocess_chunksize), str(self.core_cnt)))
        ...
        stdout_success(msg='heatmap visualizations for {} videos created in project_folder/frames/output/heatmap_classifier locations directory', elapsed_time=self.timer.elapsed_time_str, source=self.__class__.__name__)
