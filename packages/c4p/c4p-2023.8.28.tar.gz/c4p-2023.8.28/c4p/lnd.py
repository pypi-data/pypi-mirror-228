...
class LND:
    ...
    def clean(self):
        utils.run_shell(f'rm -rf *paleo_mkraw* Makefile pathnames.sed mksrf_org.nc mksrf_soi.nc core *.ncl *.sh mapping_lnd2atm* gen_surfdata* mksrfdata_map* *.zsh *.log *.Log *.txt')
