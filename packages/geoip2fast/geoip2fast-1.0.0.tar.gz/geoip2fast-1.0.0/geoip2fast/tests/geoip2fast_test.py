...
if __name__ == "__main__":
    ...
    for IP in ['0.0.0.1','266.266.266.266','192,0x0/32','1.2.3.4/32','1.2.3.4','2.2.2.2','127.0.0.10','8.4.4.2','13.107.195.95',
               '8.8.8.8','10.20.30.40','52.96.91.34', '88.221.89.159', '54.233.138.252','100.64.15.20','130.228.130.204',
               '196.197.114.1','57.242.128.144','200.25.31.45','192.168.10.10','255.255.255.240']:
        geoip = GEOIP.lookup(IP)
        print("IP: "+IP.ljust(18)+" "+str(geoip.country_code).ljust(5)+str(geoip.country_name).ljust(35)+ \
    ...
    print("Hostname: "+result.hostname+"\t\t\t << must be empty")
    result.get_hostname()
