    ...
    def run_task(self, current_task):
        ...
        try:           
            ...
            if task.documentation is not None:    
                hb.write_to_file(task.documentation, os.path.join(task.task_dir, 'task_documentation.txt'))
        except:
            pass
...
class DataRef(str):
    ...
    def __init__(self, input_path, p, graft_dir=None, verbose=False):
        ...
        if verbose:
            self.p.L.info('Path object created and found the following attributes: \n'
