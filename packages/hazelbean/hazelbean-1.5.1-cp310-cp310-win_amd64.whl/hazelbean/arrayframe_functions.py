...
def raster_calculator_flex(input_, op, output_path, **kwargs): #KWARGS: datatype=None, ndv=None, gtiff_creation_options=None, compress=False, add_overviews=False
    """AF Wrapper sending to raster_calculator_hb"""
