...
class RabbitMQ:
    def __init__(self, **kwargs):
        ...
        self.max_channel_size = kwargs.get('max_channel_size') or 50 + 5
    ...
    async def init(self, max_channel_size=None):
        if max_channel_size and isinstance(max_channel_size, int):
            self.max_channel_size = max_channel_size + 5  # reserve
        self.connection_pool = Pool(self._get_connection, max_size=self.max_connection_size)
        self.channel_pool = Pool(self._get_channel, max_size=self.max_channel_size)
