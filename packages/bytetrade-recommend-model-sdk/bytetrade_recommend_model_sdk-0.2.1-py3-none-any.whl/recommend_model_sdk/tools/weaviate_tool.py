...
class WeaviateTool:
    ...
    def insert_package_data_list(self,package_info_list,target_model_name,target_model_version,metadata=True,capacity=10000,overload_delete=True):
        ...
        for current_package_info in package_info_list:
            url_to_success_info,overload_delete_uuid_to_cloud_id = self.insert_package_data(current_package_info,target_model_name,target_model_version,metadata=metadata,capacity=capacity,overload_delete=False)
    ...
    def insert_package_data(self,package_info,target_model_name,target_model_version,metadata=True,capacity=10000,overload_delete=True):
        """_summary_
    ...
    def search_nearest(self,model_name,model_version,limit,major_language,embedding=None,
                       ...
                       category_list=None,url_list=None,filtered_condition=False,cloud_id_list=None,feed_id_list=None):
        """_summary_
