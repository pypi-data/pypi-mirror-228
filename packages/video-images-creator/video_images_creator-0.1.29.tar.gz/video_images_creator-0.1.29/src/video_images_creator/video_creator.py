...
def create_left_to_right_movement(left_image_file_path, right_image_file_path, current_index_, directory_name, left_screen_name, right_screen_name):
    ...
    right_image = build_screen(right_image_file_name, f'{directory_name}/combined_right_image_{current_index_}.jpg', 1375, "", False) 
    ...
    right_image_with_name = build_screen(right_image_file_name, f'{directory_name}/combined_right_image_with_name_{current_index_}.jpg', 1375, right_screen_name, True) 
...
def run_ffmpeg(directory_name, uniq_code):
    os.system(f"ffmpeg -y -framerate 60 -i {directory_name}/frame_%d.jpg -c:v libx264 -crf 18 -pix_fmt yuv420p -r 60 outputs/output_{uniq_code}.mp4")  
