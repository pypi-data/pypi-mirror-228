...
from reva.lib.graphql_queries.roles_and_permissions import (
    update_roles_query, update_permissions_query
)
...
class RolesAndPermissionUpdate(RevaUpdate):
    ...
    def get_json_paths_to_update(self, prefixes = ["ROL_", "PRM_"]):
        ...
        return self.get_file_paths_ui(namespaces_to_update, prefixes)
    ...
    def start(self):
        ...
        self.__update(roles_json_data, update_roles_query)
        self.__update(permissions_json_data, update_permissions_query)
