...
VERSION = "0.4.3a1693528549"
PLUGIN_VERSION = "0.4.3-alpha.1693528549+b4ea9d38"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the slack resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource slack {PLUGIN_VERSION}`
                """)
            else:
                raise
