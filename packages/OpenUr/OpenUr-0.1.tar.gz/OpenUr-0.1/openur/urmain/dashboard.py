...
"""
# Author: "Beck Isakov"
# Copyright: "(c) 2023 Toyota Yuki Inc.,"
...
class DashboardClient:
    ...
    """
    def __init__(self, host, port, max_retries=10): # max_retiries is the number of times __init__ tries to connect if connection fails
        self.host = host
        self.port = port
        self.conn = None
...
class Dashboard(DashboardClient):
    ...
    def __init__(self, host, port, max_retries=10): # max_retiries is the number of times __init__ tries to connect if connection fails
        ...
        self.speed_slider_mask_lock = threading.Lock()
...
if __name__ == '__main__':
    ...
    with Dashboard('10.2.4.109', 29999) as dc: # replace with the IP of your robot
        dc.close_popup()
