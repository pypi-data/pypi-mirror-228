...
def get_default_rpc_list():
    ...
    file_path = os.path.join(dir_path, "data", "rpcListNew.json")
    return load_from_file('data/rpc_list.json')
def get_rpc_list(file_path:str=None)->(list or dict):
    """
    ...
    """
    if file_path == None:
        return get_default_rpc_list(file_path)
    else:
