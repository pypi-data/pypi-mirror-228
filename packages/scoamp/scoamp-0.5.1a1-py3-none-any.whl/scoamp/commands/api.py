...
def stub(
    ...
    from scoamp.toolkit import model_file_download, snapshot_download, create_and_upload_model
    model_id = 'test-0830-1'
    local_dir = 'data/upload-model'
    is_public = False
    ...
    ms = 'a520a4e0-b4a3-4746-8117-ee81925ab272'
    r= create_and_upload_model(model_id, local_dir, model_space_name=ms, allow_exist=False)
    print(r)
