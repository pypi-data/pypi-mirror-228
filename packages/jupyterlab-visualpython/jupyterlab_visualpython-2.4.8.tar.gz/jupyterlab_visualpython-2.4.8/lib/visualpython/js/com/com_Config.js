...
define([
    ...
    './com_util', 
    './com_interface',
    '!!text-loader!vp_base/python/userCommand.py', // INTEGRATION: unified version of text loader
    '!!text-loader!vp_base/python/printCommand.py', // INTEGRATION: unified version of text loader
    '!!text-loader!vp_base/python/fileNaviCommand.py', // INTEGRATION: unified version of text loader
    '!!text-loader!vp_base/python/pandasCommand.py', // INTEGRATION: unified version of text loader
    '!!text-loader!vp_base/python/variableCommand.py', // INTEGRATION: unified version of text loader
    '!!text-loader!vp_base/python/visualizationCommand.py' // INTEGRATION: unified version of text loader
