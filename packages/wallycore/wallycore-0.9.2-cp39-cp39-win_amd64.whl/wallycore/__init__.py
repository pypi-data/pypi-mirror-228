...
def bip32_path_from_str(path_str, child_num, multi_index, flags, child_path_out, child_path_out_len):
    return _wallycore.bip32_path_from_str(path_str, child_num, multi_index, flags, child_path_out, child_path_out_len)
bip32_path_from_str = _wallycore.bip32_path_from_str

def bip32_path_from_str_n(path_str, path_str_len, child_num, multi_index, flags, child_path_out, child_path_out_len):
    return _wallycore.bip32_path_from_str_n(path_str, path_str_len, child_num, multi_index, flags, child_path_out, child_path_out_len)
