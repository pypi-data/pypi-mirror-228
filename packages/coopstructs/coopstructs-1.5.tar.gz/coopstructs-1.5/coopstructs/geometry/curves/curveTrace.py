...
from coopstructs.geometry.curves.curve_factory import curve_from_json, curves_from_json
...
if __name__ == "__main__":
    ...
    traces = trace_from_files(
        r'C:\Users\tburns\PycharmProjects\coopstructs\tests\testData\traceable_poly_data.json',
        r'C:\Users\tburns\PycharmProjects\coopstructs\tests\testData\curves.json'
    )
