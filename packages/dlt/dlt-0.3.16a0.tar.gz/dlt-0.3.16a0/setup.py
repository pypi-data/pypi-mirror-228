...
extras_require = \
{':platform_python_implementation != "PyPy"': ['orjson>=3.6.7'],
 'athena': ['pyarrow>=8.0.0',
            's3fs>=2022.4.0',
            'boto3>=1.25',
            'pyathena>=2.9.6'],
 'az': ['adlfs>=2022.4.0'],
 ...
 'filesystem': ['s3fs>=2022.4.0', 'boto3>=1.25'],
