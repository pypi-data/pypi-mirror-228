...
InstanceResponse.__str__ = instance_monkey_str
VerifyResponse.__str__ = verify_monkey_str
...
class HttpInstanceSession:
    ...
    def instance(self, src, **args):
        instance_request_src = imandra_http_api_client.InstanceRequestSrc(src=src, **args)
