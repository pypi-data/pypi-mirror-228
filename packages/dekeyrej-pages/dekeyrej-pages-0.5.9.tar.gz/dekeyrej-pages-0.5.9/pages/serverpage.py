...
class ServerPage:
    ...
    # def read_encrypted_secrets(self):
    #     dd = DecryptDicts()
    #     if self.prod:
    ...
    # def read_kube_secret(self, namespace, secret, datapath, inkube=True):
    #     if inkube:
    ...
    def read_secrets(self):
        if self.prod:
            return self.ks.read_secret(namespace='default', secret_name='matrix-secrets',
                                  data_name='secrets.json', data_is_json=True)
            # return self.read_kube_secret("default", "matrix-secrets", "secrets.json", inkube=True)
        else:
            return self.read_json_from_file(self.path)
