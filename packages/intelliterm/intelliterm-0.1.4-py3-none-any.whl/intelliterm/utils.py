...
if setup_cfg_path.exists():
    ...
    print(f"Configuration file {setup_cfg_path} does not exist.")
    # Handle the case when the file does not exist, e.g., by setting default values
    app_config = {}

AutoCopy = Literal["off", "all", "code"]

APP_AUTHOR = app_config['metadata']['author']
