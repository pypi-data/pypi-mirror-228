    ...
    def execute(self, input_message):
        ...
        try:
            ...
            for file_name in file_names:
                current_status = df[df['FILE_NAME'] == file_name]['PIPELINE_STATUS']
                if current_status == 'SUCCESS_RESAMPLE_AND_WRITE_TO_ZARR_STORE':
            ...
            if (len(completed_files) + len(failed_files)) == total_number_of_files:
                email_message = {
