...
def get_instance_provisioning_payload(class_version,zone_id,instance_name,site_id,instance_type,instance_type_code,layout_id,plan_id,template_parameters,tags:list):
    """
    ...
    try:
        ...
        f = pkgutil.get_data(__name__, f"../template_files/{class_version}/instance_provisioning_payload.json")
        f = json.loads(f)
    except Exception as e:
...
def get_morpheus_terraform_inputs(morpheus_custom_options):
    ...
    if "administration" in morpheus_custom_options["class_name"]:
        ...
        f = pkgutil.get_data('molab', f"template_files/{class_version}/admin_class_config.json")
        f = json.loads(f)
        ...
        f = pkgutil.get_data('molab', f"template_files/{class_version}/install_class_config.json")
        f = json.loads(f)
        ...
        f = pkgutil.get_data('molab', f"template_files/{class_version}/automation_class_config.json")
        f = json.loads(f)
        ...
        f = pkgutil.get_data('molab', f"template_files/{class_version}/troubleshooting_class_config.json")
        f = json.loads(f)
    terraform_inputs = {}
