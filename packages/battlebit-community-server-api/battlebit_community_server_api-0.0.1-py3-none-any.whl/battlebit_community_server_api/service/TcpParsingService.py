...
class TcpParsingService:
    ...
    def parse_hail_message(cls, message: bytes) -> ServerInfo:
        ...
        # Room Settings
        cls._parse_room_settings(message[:room_settings_length])
    ...
    @staticmethod
    def _parse_room_settings(room_settings_bytes: bytes) -> RoomSettings:
        damage_multiplier, room_settings_bytes = read_float32(room_settings_bytes)
        friendly_fire_enabled, room_settings_bytes = read_bool(room_settings_bytes)
        hide_map_votes, room_settings_bytes = read_bool(room_settings_bytes)
        only_winner_team_can_vote, room_settings_bytes = read_bool(room_settings_bytes)
        player_collision, room_settings_bytes = read_bool(room_settings_bytes)

        medic_limit_per_squad, room_settings_bytes = read_uint8(room_settings_bytes)
        engineer_limit_per_squad, room_settings_bytes = read_uint8(room_settings_bytes)
        support_limit_per_squad, room_settings_bytes = read_uint8(room_settings_bytes)
        recon_limit_per_squad, room_settings_bytes = read_uint8(room_settings_bytes)

        return RoomSettings(damage_multiplier=damage_multiplier,
                            friendly_fire_enabled=friendly_fire_enabled,
                            hide_map_votes=hide_map_votes,
                            only_winner_team_can_vote=only_winner_team_can_vote,
                            medic_limit_per_squad=medic_limit_per_squad,
                            engineer_limit_per_squad=engineer_limit_per_squad,
                            support_limit_per_squad=support_limit_per_squad,
                            recon_limit_per_squad=recon_limit_per_squad)
