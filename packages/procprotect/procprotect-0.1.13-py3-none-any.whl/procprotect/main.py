...
def checks(self):
    ...
    while True:
        ...
        if self.anti_debug == True:
            ...
            if debugChecks_main(self, default_windowNames_list, default_processNames_list):
                # debugger detected
                detection(self)
        ...
        if self.anti_vm == True:
            ...
            if vmChecks_main(self, default_knownIps_list, default_vmpaths, default_vmProcesses):
                # vm detected
                detection(self)
