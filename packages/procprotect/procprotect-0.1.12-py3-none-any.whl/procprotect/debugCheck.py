def debugChecks_main(self, default_windowNames_list, default_processNames_list):
    try:
        ...
        if "WindowNames" in self.anti_debug_checks:
            ...
            if WindowNamesCheck(self, default_windowNames_list):return True

        # check if "ProcessNames" is enabled
        if "ProcessNames" in self.anti_debug_checks:
            # ProcessNames is enabled run check
            if ProcessNamesCheck(self, default_processNames_list):return True
...
def WindowNamesCheck(self, default_windowNames_list):
...
def ProcessNamesCheck(self, default_processNames_list):
    process_names = []
