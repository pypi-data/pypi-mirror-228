...
#             interactions_df = GOPa_interactions[(GOPa_interactions['B'].isin(list(set(list(interactions_df['A']) + list(interactions_df['B']) + list_of_terms)))) & GOPa_interactions['A'].isin(list(set(list(interactions_df['A']) + list(interactions_df['B']) + list_of_terms )))]
...
#             interactions_df = GOPa_interactions[(GOPa_interactions['A'].isin(list_a + list_b)) & (GOPa_interactions['B'].isin(list_b + list_a))]
