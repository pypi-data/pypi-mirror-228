...
class PyGridHandler:
    ...
    def __init__(self,
                 ...
                 vec_transformer_getter: vec.VecTransformerGetter = None,
                 inv_vec_transformer_getter: vec.VecTransformerGetter = None
                 ):
        super().__init__()
        ...
        self._vec_transformer_getter = vec_transformer_getter
        self._inv_vec_transformer_getter = inv_vec_transformer_getter
    ...
    def _get_grid_surface(self):
        ...
        utils.draw_to_surface(
            ...
            vec_transformer=self._vec_transformer_getter
        )
        return surf
    ...
    def mouse_grid_pos(self) -> Vector2:
        ...
        mouse_gpo = Vector2.from_tuple(utils.get_mouse_grid_pos(mouse_pos=mse,
                                                                ...
                                                                vec_transformer=self._vec_transformer_getter,
                                                                inv_vec_transformer=self._vec_transformer_getter,
                                                                grid=self.grid_provider()))
        return mouse_gpo
