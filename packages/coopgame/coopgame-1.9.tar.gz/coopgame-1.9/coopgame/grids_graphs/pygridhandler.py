...
class PyGridHandler:
    ...
    def _get_grid_surface(self):
        ...
        utils.draw_to_surface(
            ...
            vec_transformer=self._vec_transformer_getter() if callable(self._vec_transformer_getter) else self._vec_transformer_getter
        )
        return surf
    ...
    def mouse_grid_pos(self) -> Vector2:
        ...
        mouse_gpo = Vector2.from_tuple(utils.get_mouse_grid_pos(mouse_pos=mse,
                                                                ...
                                                                vec_transformer=None,
                                                                inv_vec_transformer=None,
                                                                grid=self.grid_provider()))
        return mouse_gpo
