...
class Session(PyFiber):
    ...
    def __init__(self,
        ...
        if type(behavior) == Behavior:
            ...
            self.behavior = Behavior(behavior,kwargs.get('filetype',None),verbosity=self._verbosity)
...
#TODO CHANGE DEBUG
    def __init__(self, folder, debug=0.800, **kwargs):
        ...
        if debug  and self.filetype is None:
            ...
            for r in rats:
                ...
                for file in os.listdir(os.path.join(folder, r)):
                    ...
                    if ('.csv' in path) or ('.doric' in path):
                        ...
                        b = path
                sessions[r] = Session(behavior=b, fiber=f, filetype=self.filetype, verbosity=self._verbosity)
