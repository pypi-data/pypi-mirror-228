...
VERSION = "3.1.0a1693463220"
PLUGIN_VERSION = "3.1.0-alpha.1693463220+4ae5d27c"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the ns1 resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource ns1 {PLUGIN_VERSION}`
                """)
            else:
                raise
