...
# region cpodcast
l_cpodcast_text = {
    'ru': "🎥 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> трансляцию подкастов в каналы/группы, где пользователь администратор\n\n👩🏽‍💻 <b>Настройки</b> авто-подкаста\n[посты]/[каналы|группы]: [<b>{0}</b>]/[{1}]",
...
l_cpodcast_ids = {
    'ru': "🎥 <b>Перечисли</b> id-каналов/групп где у аккаунта есть права [Администратор] и режим [✅ Управление трансляциями]\n\n👩🏽‍💻 <b>Доступные</b> посты: {0}",
    'en': "👋🏽 You have to ⚙️Configure at least one trigger",
    'es': "👋🏽 Tienes que ⚙️ Configurar al menos una palabra de inicio",
    'fr': "👋🏽 Vous devez ⚙️ Configurer au moins un mot de départ",
    'zh': "👋🏽 你必須 ⚙️ 配置至少一個起始詞",
