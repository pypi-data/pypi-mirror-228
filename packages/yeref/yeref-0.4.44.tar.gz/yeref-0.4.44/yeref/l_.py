...
l_try_again = {
    'ru': "👩🏽‍💻 <b>Ошибка</b> или попробуй позже",
...
# region post
l_post_media = {
    'ru': "✏️ 1. <b>Прикрепи медиа</b> контент для поста: <i>фото/гиф/видео/аудио/документ/стикер</i> или запиши <i>голосовое/видео-заметку</i> в кружке\n\n(<i>или нажми «➡️️/Next», чтобы пропустить этот шаг</i>)",
...
l_media_isvideonote = {
    'ru': "👩🏽‍💻 <b>Использовать</b> это квадратное видео как <b>телескоп</b> <i>(круглая видео-заметка)</i>?",
    'en': "👩🏽‍💻 The file is larger than 20 MB, please upload a smaller size",
    'es': "👩🏽‍💻 El archivo tiene más de 20 MB, cargue un tamaño más pequeño",
    'fr': "👩🏽‍💻 Le fichier fait plus de 20 Mo, veuillez télécharger une taille plus petite",
    'zh': "👩🏽‍💻文件大于20MB，请上传较小的文件",
...
l_post_timer = {
    'ru': "✏️ <b>Выбери дату</b> на календаре для <b>авто-удаления</b> поста\n\n(<i>или нажми «➡️️/Next», чтобы пропустить этот шаг</i>)",
    'en': "✏️ 4. <b>Select a date</b> on the calendar\n\n( <i>or press &quot;➡️️/Next&quot; to skip this step</i> )",
    'es': "✏️ 4. <b>Selecciona una fecha</b> en el calendario\n\n( <i>o presiona &quot;➡️️/Siguiente&quot; para omitir este paso</i> )",
    'fr': "✏️ 4. <b>Sélectionnez une date</b> sur le calendrier\n\n( <i>ou appuyez sur &quot;➡️️/Suivant&quot; pour ignorer cette étape</i> )",
    'zh': "✏️ 4. 在日历上<b>选择一个日期</b>\n\n（<i>或按“➡️️/Next”跳过此步骤</i>）",
...
l_preview_text = {
    'ru': "👩🏽‍💻 Режим [✅ превью] используется с jpg|png|gif|mp4-файлами до 5Mb",
...
l_spoiler_text = {
    'ru': "👩🏽‍💻 Режим [✅ спойлер] доступен для photo/gif/video контента",
...
l_podcast_call = {
    'ru': "👩🏽‍💻 Режим [✅ подкаст] доступен для audio/voice/video контента",
    'en': "👩🏽‍💻 [spoiler] mode available for photo/gif/video",
    'es': "👩🏽‍💻 Modo [spoiler] disponible para foto/gif/video",
    'fr': "👩🏽‍💻 Mode [spoiler] disponible pour photo/gif/vidéo",
    'zh': "👩🏽‍💻 [剧透] 模式可用于照片/gif/视频",
...
l_post_del_timer = {
    'ru': "👩🏽‍💻 <b>Пост</b> #{0} удален по таймеру в {1}",
    'en': "🏁 <b>Newsletter</b> completed\n\n📧 <b>Number</b> of users who received the message: <u>{0}</u>",
    'es': "🏁 <b>Boletín</b> completado\n\n📧 <b>Número</b> de usuarios que recibieron el mensaje: <u>{0}</u>",
    'fr': "🏁 <b>Newsletter</b> terminée\n\n📧 <b>Nombre</b> d&#x27;utilisateurs ayant reçu le message : <u>{0}</u>",
    'zh': "🏁<b>通讯</b>已完成\n\n📧 收到消息的用户<b>数</b>： <u>{0}</u>",
...
l_time_timer = {
    'ru': "🕒 <b>Отправь время</b> <i>авто-удаления</i> поста на {0} в формате {1}. Текущее время: <u>{2}</u> ({3} по Гринвичу)\n\n📍 Пришли <b>геопозицию</b>, чтобы <i>автоматически</i> определить часовой пояс",
    'en': "🕒 <b>Send the time</b> of the post to {0} in the format {1} . Current time: <u>{2}</u> ({3} GMT)\n\n🔗 Send <b>geolocation</b> to <i>automatically</i> determine the time zone",
    'es': "🕒 <b>Envía la hora</b> de la publicación a {0} en el formato {1} . Hora actual: <u>{2}</u> ({3} GMT)\n\n🔗 Enviar <b>geolocalización</b> para determinar <i>automáticamente</i> la zona horaria",
    'fr': "🕒 <b>Envoyez l&#x27;heure</b> de la publication à {0} au format {1} . Heure actuelle : <u>{2}</u> ({3} GMT)\n\n🔗 Envoyez <b>la géolocalisation</b> pour déterminer <i>automatiquement</i> le fuseau horaire",
    'zh': "🕒 以{1}格式将帖子<b>时间发送到</b>{0}。当前时间： <u>{2}</u> ({3} GMT)\n\n🔗 发送<b>地理定位</b>以<i>自动</i>确定时区",
...
l_pstmedia = {
    'ru': "👩🏽‍💻 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> режим просмотра поста: <i>превью-предпросмотр</i>/<i>спойлер-скрытый</i>/<i>галерея</i>/<i>формат</i>/<i>подкаст</i>\n\n[✅ превью]-режим помещает медиа-контент <i>(jpg/gif/mp4 до 5 Мб)</i> под текстом\n[✅ формат]-режим применяет случайные стили к посту",
    'en': "👋🏽 <b>Press</b> ✅/☑️ to <b>turn on/off</b> auto-reply to text messages using neural network",
    'es': "👋🏽 <b>Presione</b> ✅/☑️ para <b>activar/desactivar</b> la respuesta automática a los mensajes de texto usando la red neuronal",
    'fr': "👋🏽 <b>Appuyez sur</b> ✅/☑️ pour <b>activer/désactiver</b> la réponse automatique aux messages texte à l'aide du réseau neuronal",
    'zh': "👋🏽<b>按</b>✅/☑️ 使用神经网络<b>打开/关闭</b>自动回复短信",
...
# region canswer_
l_canswer_text = {
    'ru': "💭 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> режим авто-ответа на сообщения пользователя в @{0} с помощью нейросети (на основе контента всех блоков)",
    'en': "💭 <b>Press</b> ✅/☑️ to <b>turn on/off</b> auto-reply to text messages using neural network",
    'es': "💭 <b>Presione</b> ✅/☑️ para <b>activar/desactivar</b> la respuesta automática a los mensajes de texto usando la red neuronal",
    'fr': "💭 <b>Appuyez sur</b> ✅/☑️ pour <b>activer/désactiver</b> la réponse automatique aux messages texte à l'aide du réseau neuronal",
    'zh': "💭<b>按</b>✅/☑️ 使用神经网络<b>打开/关闭</b>自动回复短信",
...
# region cneuro_
l_cneuro_text = {
    'ru': "🦾 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> нейро-постинг: генерация фото/текста на основе постов/описания/контента в <b>{0}</b>",
    'en': "文<b>Click</b> on ✅/☑️ to <b>enable/disable</b> auto-translate for <i>outgoing</i> bot messages into the user's language when /start-starting the bot",
    'es': "文<b>Haga clic</b> en ✅/☑️ para <b>habilitar/deshabilitar</b> la traducción automática de los mensajes <i>salientes</i> del bot al idioma del usuario cuando/inicie el bot",
    'fr': "文<b>Cliquez</b> sur ✅/☑️ pour <b>activer/désactiver</b> la traduction automatique des messages <i>sortants</i> du bot dans la langue de l'utilisateur lors du/démarrage du bot",
    'zh': "文<b>单击</b>✅/☑️<b>启用/禁用</b>在/启动机器人时将<i>传出的</i>机器人消息自动翻译成用户的语言",
...
l_cneuro_media = {
    'ru': "🦾 1. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию <u>фото</u> на основе постов/описания/контента в <b>{0}</b>\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
l_cneuro_error = {
    'ru': "🦾 <b>Ошибка</b> генерации: попробуй еще раз или повтори позже",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
l_cneuro_caption = {
    'ru': "🦾 2. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию <u>текста</u> на основе описания и контента в <b>{0}</b>\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
l_cintegration_text = {
    'ru': "🗝️ <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> crm-интеграцию базы пользователей с <i><b>google</b>/<b>airtable</b></i>\n\n👩🏽‍💻 Например, опция [<b>{0}</b>] означает возможность интеграции базы пользователей с <i>google-crm</i>",
...
l_telegraph_blog = {
    'ru': "<figure><img src='{0}'/><figcaption>Фото профиля: @{1}</figcaption></figure><blockquote><i>Telegram</i> Landing blog</blockquote>👩🏽‍💻 <b>Бот:</b> {2}<br>[<b>id</b>={3}]<br><b>Био:</b> {4}<br><aside>Канал</aside><a href='https://t.me/{5}'>@{5}</a>",
...
l_chn_welcome = {
    'ru': "🌱 {0}, добро пожаловать в <i>лендинг-бот</i> администрирования <b>Telegram</b>-каналов:\n\n▪️<b>защита</b> канала от шпионов\n▪️<b>организация</b> бана/антифлуда\n▪️<b>аналитика/сбор</b> подписчиков\n▪️кнопочный <b>счетчик</b>\n▪️<b>авто-декор/эмоджи</b> поста\n▪️<b>веб-апп/нейро</b>-постинг\n\n❗️Регулярно-обновляемый /content",
...
l_subscribe_channel = {
    'ru': "👩🏽‍💻 <b>Оформи</b> ежемесячную <i>подписку</i>:\n\n¹ [<b>Все боты</b> и проекты (-<u>5</u>%)]\n² [@{0}-бот]:\n▪️<b>добавление</b> нескольких каналов\n▪️до 75 <b>emoji</b> на пост\n▪️<b>нейро</b>-постинг\n▪️аудио/видео-<b>подкасты</b> более 1мин\n▪️<b>/parse</b> подписчиков/кликов\n\n👩🏽‍💻 /balance",
    'en': "👩🏽‍💻 <b>Sign up for</b> a monthly\n\n¹ <i>subscription</i> to @{0}-bot [{1} ₽]\n▪️ no ads\n▪️ creative tasks\n² Subscribe to <u>all</u> bots [{2} ₽]",
    'es': "👩🏽‍💻 <b>Regístrese para obtener</b> una\n\n¹ <i>suscripción</i> mensual a @{0}-bot [{1} ₽]\n▪️ sin anuncios\n▪️ tareas creativas\n² Suscríbase a <u>todos</u> los bots [{2} ₽]",
    'fr': "👩🏽‍💻 <b>Inscrivez-vous pour</b> un <i>abonnement</i>\n\n¹ mensuel à @{0}-bot [{1} ₽]\n▪️ pas de publicité\n▪️ tâches créatives\n² Abonnez-vous à <u>tous</u> les bots [{2} ₽]",
    'zh': "👩🏽‍💻<b>注册</b>每月\n\n¹<i>订阅</i>@{0}-bot [{1} ₽]\n▪️ 无广告\n▪️ 创意任务\n² 订阅<u>所有</u>机器人 [{2} ₽]",
...
l_add_chn_text = {
    'ru': "👮🏽‍♀️ <b>Добавь</b> @{0}-бота как  <b>Administrator</b> через настройки своего канала: ‹👤Add Admin›\n\n👮🏽‍♀️ <b>Опция</b> [✅ Назначение администраторов] позволит сделать парсинг старых подписчиков, даже если в канале более 200 подписчиков",
...
l_podcast_handler = {
    'ru': "🎥 Авто-анонс <b>видео-подкаста</b> [/podcast d h] каждый <u>d</u>-день (1-31) на <u>h</u>-часов (1-168). Текущее значение: /podcast {0}\n\n👩🏽‍💻 Например,\n/podcast 1 1 (ежедневный видео-анонс длительностью 1 час)\n/podcast 0 (отключение опции)\n\n⚙️ <b>Команды</b> /cmd",
    'en': "🎥 Automatic announcement <b>of the video broadcast</b> [/podcast dh] every <u>d</u> -day (1-31) for <u>h</u> -hours (1-168). Current value: /podcast {0}\n\n👩🏽‍💻 For example\n/podcast 1 1 (daily 1 hour video announcement)\n/podcast 0 (disable option)\n\n⚙️ <b>Commands</b> /cmd",
    'es': "🎥 Anuncio automático <b>de la transmisión de video</b> [/podcast dh] cada <u>d</u> -día (1-31) durante <u>h</u> -horas (1-168). Valor actual: /podcast {0}\n\n👩🏽‍💻 Por ejemplo\n/podcast 1 1 (anuncio de video diario de 1 hora)\n/podcast 0 (opción deshabilitada)\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "🎥 Annonce automatique <b>de la diffusion vidéo</b> [/podcast dh] tous <u>les j</u> -jours (1-31) pendant <u>h</u> -heures (1-168). Valeur actuelle : /podcast {0}\n\n👩🏽‍💻 Par exemple\n/podcast 1 1 (annonce vidéo quotidienne d&#x27;une heure)\n/podcast 0 (option de désactivation)\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "🎥 每<u>d</u>天（1-31）自动播报<b>视频广播</b>[/podcast dh] ，持续<u>h</u>小时（1-168）。当前值：/podcast {0}\n\n👩🏽‍💻 例如\n/podcast 1 1 （每日 1 小时视频公告）\n/podcast 0 （禁用选项）\n\n⚙️<b>命令</b>/cmd",
    'ar': "🎥 الإعلان التلقائي <b>عن بث الفيديو</b> [/podcast dh] كل يوم <u>يوم</u> (1-31) لمدة <u>ساعة</u> (1-168). القيمة الحالية: / podcast {0}\n\n👩🏽‍💻 على سبيل المثال\n/podcast 1 1 (إعلان فيديو لمدة ساعة يوميًا)\n/podcast 0 (خيار تعطيل)\n\n⚙️ <b>أوامر</b> / cmd",
}
l_podcast_on = {
    'ru': "🎥 Авто-анонс <b>видео-подкаста</b>: каждый <u>{0}</u> день на <u>{1}</u> часов\n\n⚙️ <b>Команды</b> /cmd",
...
l_podcast_off = {
    'ru': "🎥 Авто-анонс <b>видео-подкаста</b> отключен\n\n⚙️ <b>Команды</b> /cmd",
...
# region creact_
l_creact_text = {
    'ru': "👍🏽 <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> креативные авто-эмоджи на последний пост канала\n\n👩🏽‍💻 Используй команду <code>/emoji {0}</code>, чтобы задать количество авто-emoji на пост (без подписки: <u>{1}</u>)\n\n👍🏽 <b>Tекущее</b> количество: <u>{0}</u>",
...
# region cdecor_
l_cdecor_text = {
    'ru': "🪄 <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> авто-декор публикуемого поста: <i><b>пагинация</b> (порядковый номер поста)/креативный <b>формат</b> (<b>жирный</b>/<i>курсив</i>/<u>подчеркнутый</u>/<code>моно</code>/<tg-spoiler>спойлер</tg-spoiler>/#хэштег/$кэштег/<a href='{0}'>ссылка</a>)/<b>футер</b> (текстовое окончание поста)</i>\n\n👩🏽‍💻 Жми <b>[✅☑Вкл формат]</b>, чтобы включить креативное изменение поста с использованием 8 стилей",
...
l_update_handler00 = {
    'ru': "🛡 Для дальнейшего <b>администрирования</b> данной группы запусти @{0}-бота и добавьте его в группу как <b>Administrator</b>",
...
l_update_handler100 = {
    'ru': "🛡 Группа обновлена, но не подключена @{0}-боту! Для дальнейшего <b>администрирования</b> данной группы зайди в @{0}-бота и нажми /start",
...
l_transfer_reply = {
    'ru': "⚠️ <b>Используй</b> команду /transfer в <b>ответном</b> сообщении пользователя, которому вы хоти передать права",
...
l_add_userbot_text = {
    ...
    'en': "👇🏽 Push the ‹➕ Add account› to add extra account-account (for automatization): @{0}\n\n👮🏽‍♀️ To connect account use <b>code</b> virification sending from official <i>Telegram</i>-account",
    ...
    'fr': "👇🏽 Appuyez sur ‹➕ Ajouter un accounte› pour ajouter à votre accounte (avec les paramètres par défaut): @{0}\n\n👮🏽‍♀️ Ou ajoutez le bot en tant qu'<b>administrateur</b> via les paramètres de votre accounte : ‹👤Ajouter un administrateur›\n\n👮🏽‍♀️ Si vous ne pouvez pas ajouter de accounte, essayez de modifier le <b>Titre personnalisé</b> (regardez la capture d'écran)",
...
l_rent_userbot_handler = {
    ...
    'en': "👩🏽‍💻 <b>Account rent</b> include all opportunities\n\n👉🏼 Push the [💳 Account rent], чтобы получить уже прогретый аккаунт",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_new_userbot_start = {
    'ru': "👩🏽‍💻 <b>1/5. Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>34663072680</code>\n\n<i>P.S. Будет очень трудно пройти все шаги до конца, но стоит того</i>",
    'en': "👩🏽‍💻 <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_new_userbot_api = {
    'ru': "👩🏽‍💻 <b>2/5. Зарегистрируй</b> свой <u>дополнительный</u> аккаунт на официальном сайта <b>Telegram-приложений</b> (выключи VPN): https://my.telegram.org/auth. <i>Придумай</i> [App title] и [Short name (из 5 цифр)] и <u>пришли</u>: <code>App api_id и App api_hash</code>\n\n👩🏽‍💻 <b>Например:</b>\n<code>1225257 2bb552cc55d5cc2eccd22dab2d</code>",
    'en': "👩🏽‍💻 <b>Create</b>/<code>user extra</code> <i>Telegram</i>-account via <b>mobile</b> app, and then send its phone <u>number</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
...
l_fsm_new_userbot = {
    'ru': "👩🏽‍💻 <b>Пришли</b> корректный номер телефона℡\n\n👉🏼 Например, <code>34663072680</code>",
    'en': "👩🏽‍💻 Send correct phone number℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth = {
    ...
    'en': "👩🏽‍💻 Enter <b>Authorization code</b>, sending to <u>extra</u> account from <i>verified</i> <b>Telegram</b>-account\n\n👉🏼 For example, on the photo <code>YVTdd9r7brb</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth_fail = {
    ...
    'en': "👩🏽‍💻 Trying to authorize on https://my.telegram.org/auth is fail! Try again later!",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth_cloud = {
    ...
    'en': "👩🏽‍💻 Create <i>cloud password</i> for account protection or send <b>current</b> one to <u>start</u> account\n\n👉🏼 For example, <code>ferey2</code>\n(push to copy)",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_selenium_time = {
    ...
    'en': "👩🏽‍💻 Waiting time is over! Try again later!",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth_code = {
    ...
    'en': "👩🏽‍💻 Now enter <b>Verification code</b> for <u>start</u> this account, also getting from <b>Telegram</b>\n\n👉🏼 For example, on th photo <code>20777</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_cloud_current = {
    ...
    'en': "👩🏽‍💻 Specify current cloud password",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth_error = {
    'ru': "👩🏽‍💻 <b>Ошибка</b> Telegram, попробуй еще раз! <b>Создай</b>/<code>используй дополнительный</code> <i>Telegram</i>-аккаунт через <b>мобильное</b> приложение, а затем пришли его <u>номер</u> телефона℡\n\n👉🏼 Например, <code>34663072680</code>",
    'en': "👩🏽‍💻 Telegram error, try again later! <b>Create</b>/<code>use extra</code> <i>Telegram</i>-account via <b>mobile</b> app and then send its <u>phone</u>℡\n\n👉🏼 For example, <code>79331114545</code>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_code_error = {
    'ru': "👩🏽‍💻 <b>Пришли</b> корректный числовой код",
    'en': "👩🏽‍💻 Enter correct number code",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_code_ban = {
    ...
    'en': "👩🏽‍💻 Telegram bans account for code sending\n\n#duration {0}",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_fsm_auth_done = {
    'ru': "👩🏽‍💻 <b>Готово!</b> <u>Аккаунт</u> <b>{0}</b> \n[<b>id</b>=<code>{1}</code>, <code>+{2}</code>] успешно <i>прикреплен</i> к @{3}\n\n📇 Добавь <b>{4}</b> (@{5}) в свои контакты и отправь любое сообщение",
    'en': "👩🏽‍💻 Ready! <u>Account</u> <b>{0}<b> \n[<b>id</b>=<code>{1}</code>, <code>+{2}</code>] successfully <i>attached</i> to @{3}\n\n📇 Add <b>{4}</b> (@{5}) into your contacts and send any message",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_repair = {
    ...
    'en': "👩🏽‍💻 <b>Account:</b> {0}\n[<b>id</b>=<code>{1}</code>, +{2}]\n\n ✅ Cleaning drafts..\n ✅ Unpin messages..\n ✅ See @mentions..\n ✅ Reset notifies..\n ✅ Reading history..\n ✅ Remove timer deletion..\n ✅ Deleting schedule sending..\n ✅ Updating folders..\n\n⚙️ <b>Commands</b> /cmd",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_reset = {
    ...
    'en': "👩🏽‍💻 <b>Account:</b> {0}\n[<b>id</b>=<code>{1}</code>, +{2}]\n\n ✅ Reset settings..\n ✅ Deleting contacts..\n ✅ Deleting Telegram-bots..\n ✅ Deleting dialogs..\n ✅ Exit from groups & channels..\n ✅ Deleting payment information..\n ✅ Deleting call-history..\n ✅ Deleting stickers/emoji..\n ✅ Reset notify settings..\n ✅ Cleanging wallpapers gallery..\n\n⚙️ <b>Commands</b> /cmd",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_post = {
    'ru': "👩🏽‍💻 <i>Публикация сообщения успешно запущена</i>\n\n⚙️ <b>Команды</b> /cmd",
    'en': "👩🏽‍💻 <i>Messages publication successfully started</i>\n\n⚙️ <b>Commands</b> /cmd",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_parse_csend_correct = {
    ...
    'en': "📨 Enter <b>correct</b> link on a group for parsing @username",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_parse_csend_done = {
    ...
    'en': "🔥 Ready! Parsing-result <b>{0}</b> of real @username: <u>{1}</u>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_geo_csend_empty = {
    ...
    'en': "📨 There are no @usernames in this <b>geo-location</b>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_geo_csend_done = {
    ...
    'en': "🔥 Ready! Geo-parsing-result <b>{0} {1}</b> of real @username: <u>{2}</u>",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_init = {
    ...
    'en': "👩🏽‍💻 Creating of <b>service</b> Telegram bot & channel:\n\n@{0}, @{1}\n\n👩🏽‍💻 Do not change their @username for correct work",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_is_mutual = {
    'ru': "📇 Добавь <b>{0}</b> (@{1}) в свои контакты",
    'en': "📇 Add <b>{0}</b> (@{1}) into your contact list",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_userbot_res_scheduler_client = {
    ...
    'en': "👩🏽‍💻 There is no session! Repeat to re-add account",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_usr_config = {
    ...
    ("cban", "🕵🏽", "☑"): {  # возможность не банить premium
        'ru': "Авто-бан",
        'en': "Auto-ban",
        'es': "Prohibición automática",
        'fr': "Interdiction automatique",
...
l_to_delete = {
    ...
    'en': "🚫Put away account",
    'es': "🚫Guardar grupo",
    'fr': "🚫accounte de rangement",
    'zh': "🚫收起組",
    'ar': "🚫 أبعد المجموعة",
}
l_show_userbots = {
    'ru': "👩🏽‍💻 <b>Добавленные пользователи</b>\n\n[команды /cmd]",
    'en': "🐋 <b>Added accounts</b>\n\n[commands /cmd]",
    'es': "🐋 <b>Grupos añadidos</b>\n\n[comandos /cmd]",
    'fr': "🐋 <b>accountes ajoutés</b>\n\n[commands /cmd]",
    'zh': "🐋 <b>添加組</b>\n\n[命令 /cmd]",
    'ar': "🐋 <b> المجموعات المضافة </b> \n\n [أوامر /cmd]",
}
...
l_update_fun = {
    ...
    'en': "👩🏽‍💻 <b>Account:</b> {0}\n[<b>id</b>=<code>{1}</code>, +{2}]\n<b>Bio:</b> {3}\n\n✅ <i>Profile have been updated</i>\n\n⚙️ <b>Cpmmands</b> /cmd",
    'es': "Cambiar información del grupo",
    'fr': "Modifier les informations du accounte",
    'zh': "更改組信息",
...
l_off_handler = {
    ...
    'en': "👩🏽‍💻 Finishing account-session {0}..\n\n#duration 1min",
    'es': "🎉 Enviar este comando como respuesta al mensaje",
    'fr': "🎉 Envoyez cette commande en réponse au message",
    'zh': "🎉 將此命令作為對消息的回復發送",
    'ar': "🎉 أرسل هذا الأمر كرد على الرسالة",
...
l_restart_handler = {
    ...
    'en': "👩🏽‍💻 Restart of account-session {0}..\n\n#duration 1min",
    'es': "🎉 Enviar este comando como respuesta al mensaje",
    'fr': "🎉 Envoyez cette commande en réponse au message",
    'zh': "🎉 將此命令作為對消息的回復發送",
    'ar': "🎉 أرسل هذا الأمر كرد على الرسالة",
...
l_leaveall_handler = {
    'ru': "👩🏽‍💻 Выход из групп/каналов выполнен",
    'en': "👩🏽‍💻 Exit from groups/channels has done successfully",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_deleteall_handler = {
    'ru': "👩🏽‍💻 Удаление диалогов выполнено",
    'en': "👩🏽‍💻 Dialogs deleting has done successfully",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_poll_handler = {
    'ru': "👩🏽‍💻 Авто-голосование в <b>{0}</b> [{1}, <code>{2}</code>] за <u>{3}</u>-вариант успешно проведено",
    'en': "👩🏽‍💻 Auto-voting in <b>{0}</b> [{1}, <code>{2}</code>] for <u>{3}</u>-option has done successfully",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_add_new_acc = {
    'ru': "👩🏽‍💻 <b>Аккаунт:</b> {0}\n[<b>id</b>=<code>{1}</code>, +{2}]\n\n👩🏽‍💻 Добавьте <i>новый</i> аккаунт на устройстве\n\n👩🏽‍💻 Потребуется ввести <i>номер телефона</i>. <b>Код</b> подтверждения будет выслан в @{3}",
    'en': "👩🏽‍💻 <b>Account:</b> {0}\n[<b>id</b>=<code>{1}</code>, +{2}]\n\n👩🏽‍💻 Add <i>new</i> account on the device\n\n👩🏽‍💻 You have to enter <i>phone number</i>. <b>Code authorization</b> will sent you into @{3}",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_autodel_text = {
    ...
    'en': "👩🏽‍💻 Enter day number for <b>auto-deletion</b> of <u>private</u>-messages (current day count: <code>/autodel {0}</code>):\n\nfrom <u>1</u> to <u>365</u> (one year)\n<u>0</u> (disable auto-deletion)",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_autodel_on = {
    ...
    'en': "👩🏽‍💻 <b>Auto-deleting</b> of <u>private</u>-messages for new users: <u>{0}</u> days",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_autodel_off = {
    ...
    'en': "👩🏽‍💻 <b>Auto-deleting</b> of <u>private</u>-messages is disabled",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_delay_text2 = {
    ...
    'en': "👩🏽‍💻 Enter seconds number of <b>delay</b> before auto-answer (current delay: <code>/delay {0}</code>):\n\nfrom <u>1</u> to <u>{1}</u> (one days)\n<u>0</u> (disable delay)",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_delay2_on = {
    ...
    'en': "👩🏽‍💻 <b>Delay</b> before auto-answer: <u>{0}</u> sec",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_spoiler2_text = {
    'ru': "👩🏽‍💻 Введи <b>символ</b>, который будет <tg-spoiler>скрываться</tg-spoiler>{0}\n\n<b>/spoiler w</b> (сокрытие <code>w</code>-символа, если активирована опция [{0}])\n<b>/spoiler 0</b> (сокрытие конкретного символа отключено)",
    'en': "👩🏽‍💻 Enter <b>symbol</b>, which will be <tg-spoiler>hidden</tg-spoiler>{0}\n\n<b>/spoiler w</b> (hide <code>w</code>-symbol, if option [{1}]) is activated\n<b>/spoiler 0</b> (hideden of special symbol is disable)",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_spoiler_on = {
    'ru': "👩🏽‍💻 Установлен <tg-spoiler>{0}</tg-spoiler>-символ, который будет скрываться, если активирована опция [{0}]",
    'en': "👩🏽‍💻 <tg-spoiler>{0}</tg-spoiler>-symbol is enabled for hidden if option [{0}] is activated",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_spoiler_off = {
    'ru': "👩🏽‍💻 Использование <b>символа</b> для сокрытия отключено (включение: <code>/spoiler w</code>)",
    'en': "👩🏽‍💻 Using the <b>symbol</b> for text hidden is disabled (to enable: <code>/spoiler w</code>)",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_vote_text = {
    ...
    'en': "👩🏽‍💻 <b>Enter</b> chat-id и answer-id for auto-voting (current settings: <code>/vote {0}</code>)\n\n<b>/vote -1001894710086 0</b> (auto-voting for upper option in the -1001894710086 dialog)\n<b>/vote 0</b> (auto-voting is disabled)",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_vote_on = {
    ...
    'en': "👩🏽‍💻 <b>Auto-voting</b> in <code>{0}</code>-chat for <u>{1}</u>-option is enabled",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
l_vote_off = {
    ...
    'en': "👩🏽‍💻 <b>Auto-voting</b> is disabled",
    'es': "💳 Agregar grupo",
    'fr': "💳 Ajouter un accounte",
    'zh': "💳 添加組",
    'ar': "💳 إضافة مجموعة",
...
# region cformat_
l_cformat_text = {
    'ru': "🪄 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-генерацию <i><b>кнопок</b> для ссылок в тексте/стильных @tager-<b>упоминаний</b>/<b>бот-ссылку</b> над именем/<b>защиту</b> текста от стоп-слов и копирования контента/<b>сокрытие</b> <tg-spoiler>/spoiler w</tg-spoiler> текста/символа</i> для <code>гарантированного</code> просмотра сообщения",
    'en': "🪄 Push the ✅/☑️ to <b>On/Off</b> auto-generation of <i><b>buttons</b> for links in text/stylish @tager-mentions/<b>bot-link</b> under the name/text <b>protection</b> from от stop-words and content-saving/text/symbol <b>hidden</b> <tg-spoiler>/spoiler w</tg-spoiler>/</i> for <code>garanting</code> message view\n\n👉🏼 For example, [{1}] means using link of {1} inline bot <b>near name</b> after message sending",
    ...
    'fr': "🪄 Appuyez sur le ✅/☑️ sur <b>On/Off</b> <i>externak <b>links</b>/telegram-<b>links</b>/forward</i>-<b>liens</b>\n\n👉🏼 Par exemple, [✅☑On forward-links] signifie l'autorisation de <b>transférer</b> les messages provenant d'<u>autres</u> chaînes Telegram-<i> /accountes/comptes</i> dans <u>notre</u> accounte",
    'zh': "🪄 將 ✅/☑️ 推到 <b>On/Off</b> <i>externak <b>links</b>/telegram-<b>links</b>/forward</i>-<b>links</b>\n\n👉🏼 例如，[✅☑On forward-links] 表示允許 <b>forward</b> 來自 <u>other</u> Telegram-<i> 頻道的消息 /accounts/accounts</i> 進入 <u>我們的</u> 組",
    'ar': "🪄 ادفع ✅ / ☑️ إلى تشغيل / إيقاف روابط خارجية telegram- روابط/ إعادة توجيه الروابط \n\n👉🏼 على سبيل المثال ، [على روابط إعادة التوجيه] تعني إذنًا بشأن <b> إعادة توجيه </b> الرسائل من أخرى Telegram قنوات/accounts/accounts في مجموعتنا",
}
...
# region cservice_
l_cservice_text = {
    'ru': "💬 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> <i>сервисные <b>статусы</b>/<b>пересылку</b> входящих себе (в том числе оригинальных/<u>удаленных</u> сообщений)</i>\n\n👩🏽‍💻 [✅☑Вкл сервисные статусы] означает показ у пользователей <b>статусов</b>: <i>печатает..ищет стикер..</i>",
...
# region ctranslate_
l_ctranslate2_text = {
    'ru': "文 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-перевод для <i><b>входящих</b>/<b>исходящих</b> сообщений</i>",
...
# region ctranscribe_
l_ctranscribe_text = {
    'ru': "🗣 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-транскрибацию (перевод голосовых/телескопов в текст) для <i><b>входящих</b>/<b>исходящих</b> сообщений</i>",
...
# region cpodcast_
l_cpodcast_text = {
    'ru': "🎥 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> трансляцию подкастов в каналы|группы, где аккаунт [Администратор] c [✅ Управление трансляциями]\n\n👩🏽‍💻 <b>Настройки</b> авто-подкаста\n[<i>посты</i>]/[<i>каналы|группы</i>]:\n[<b>{0}</b>]/[<code>{1}</code>]",
    'en': "🎥 Push the ✅/☑️ to <b>On/Off</b> <i>service <b>statuses</b>/<b>forward</b> income for yourself (including original/<u>deleted</u> messages)/tag about income-<b>reading</b></i>\n\n👉🏼 For example, [{0}] means <code>show</code> service <b>statuses</b>: <i>typing..search sticker..</i>",
    'es': "🎥 Presiona ✅/☑️ para <b>Encender/Apagar</b> <i>sistema</i> mensajes\n\n👉🏼 Por ejemplo, <i>Usuario se unió al grupo</i>",
    'fr': "🎥 Appuyez sur ✅/☑️ pour <b>Activer/Désactiver</b> les messages <i>système</i>\n\n👉🏼 Par exemple, <i>L'utilisateur a rejoint le accounte</i>",
    'zh': "🎥 將 ✅/☑️ 推送到 <b>On/Off</b> <i>system</i> 消息\n\n👉🏼 例如，<i>用戶加入群組</i>",
...
l_cpodcast_posts = {
    'ru': "🎥 <b>Перечисли</b> номера из [🔔 Авто-постинга] с <i>аудио/видео</i> контентом для подкаста",
    'en': "👋🏽 You have to ⚙️Configure at least one trigger",
    'es': "👋🏽 Tienes que ⚙️ Configurar al menos una palabra de inicio",
    'fr': "👋🏽 Vous devez ⚙️ Configurer au moins un mot de départ",
    'zh': "👋🏽 你必須 ⚙️ 配置至少一個起始詞",
...
l_cpodcast_ids = {
    'ru': "🎥 <b>Перечисли</b> id-каналов/групп, где аккаунт [Администратор] c [✅ Управление трансляциями]\n\n👩🏽‍💻 <b>Доступные</b> посты: {0}",
    'en': "👋🏽 You have to ⚙️Configure at least one trigger",
    'es': "👋🏽 Tienes que ⚙️ Configurar al menos una palabra de inicio",
    'fr': "👋🏽 Vous devez ⚙️ Configurer au moins un mot de départ",
    'zh': "👋🏽 你必須 ⚙️ 配置至少一個起始詞",
...
# region cgeo_
l_cgeo_text = {
    'ru': "📍 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> гео-мониторинг ближайших гео-контактов/встреч\n\n👩🏽‍💻 <b>Начни</b> [Трансляция геопозиции] в любом приватном диалоге с пользователем [выбери 15мин/1ч/8ч]: в @{0}-боте - будут появляться отфильтрованные пользователи в текущей геопозиции",
    'en': "🎥 Push the ✅/☑️ to <b>On/Off</b> <i>service <b>statuses</b>/<b>forward</b> income for yourself (including original/<u>deleted</u> messages)/tag about income-<b>reading</b></i>\n\n👉🏼 For example, [{0}] means <code>show</code> service <b>statuses</b>: <i>typing..search sticker..</i>",
    'es': "🎥 Presiona ✅/☑️ para <b>Encender/Apagar</b> <i>sistema</i> mensajes\n\n👉🏼 Por ejemplo, <i>Usuario se unió al grupo</i>",
    'fr': "🎥 Appuyez sur ✅/☑️ pour <b>Activer/Désactiver</b> les messages <i>système</i>\n\n👉🏼 Par exemple, <i>L'utilisateur a rejoint le accounte</i>",
    'zh': "🎥 將 ✅/☑️ 推送到 <b>On/Off</b> <i>system</i> 消息\n\n👉🏼 例如，<i>用戶加入群組</i>",
...
l_cgeo_config = {
    'ru': "📍 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> фильтр гео-мониторинга пользователей по <i>наличию @username/аватара/биографии/<b>премиум</b>-аккаунта</i>",
    'en': "🎥 Push the ✅/☑️ to <b>On/Off</b> <i>service <b>statuses</b>/<b>forward</b> income for yourself (including original/<u>deleted</u> messages)/tag about income-<b>reading</b></i>\n\n👉🏼 For example, [{0}] means <code>show</code> service <b>statuses</b>: <i>typing..search sticker..</i>",
    'es': "🎥 Presiona ✅/☑️ para <b>Encender/Apagar</b> <i>sistema</i> mensajes\n\n👉🏼 Por ejemplo, <i>Usuario se unió al grupo</i>",
    'fr': "🎥 Appuyez sur ✅/☑️ pour <b>Activer/Désactiver</b> les messages <i>système</i>\n\n👉🏼 Par exemple, <i>L'utilisateur a rejoint le accounte</i>",
    'zh': "🎥 將 ✅/☑️ 推送到 <b>On/Off</b> <i>system</i> 消息\n\n👉🏼 例如，<i>用戶加入群組</i>",
...
l_csend_text = {
    ...
    'fr': "📨️ Appuyez sur ✅/☑️ pour <b>Activer/Désactiver</b> l'invitation automatique d'utilisateurs dans votre accounte\n\n👉🏼 Inviter <u>{0}</u> utilisateurs par jour à partir du accounte {1}",
...
l_csend_cnt = {
    ...
    'fr': "Envoyez <b>lien</b> au accounte comme source pour les nouveaux membres\n\n👉🏼 Par exemple, <code>https://t.me/likeconcentrat</code> - appuyez sur le lien pour le copier",
...
l_csend_choose_src = {
    ...
    'en': "📨️ Choose <b>source</b> from which @usernames will taken auto-sending",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csend_choose_cnt = {
    'ru': "📨️ Введи <b>количество</b> сообщений для авто-рассылки, которое будет отправляться ежедневно (без подписки: 1 сообщ)",
    'en': "📨️ Enter <b>count</b> of messages for auto-sending, which will be sent everyday (without subscribtion: 1 message)",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csend_choose_post = {
    ...
    'en': "📨️ Choose <b>post</b>, which бwill be used for auto-sending and push the [{0}] under chosen post",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csendsrc_group = {
    ...
    'en': "📨️ Send <b>link</b> on group to config auto-sending by its @usernames",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csendsrc_file = {
    ...
    'en': "📨️ Attach text-<b>file</b> with @username-list for auto-sending",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csendsrc_geo = {
    ...
    'en': "📨️ Send <b>geo-location</b> to get @usernames by location for auto-sending",
    'es': "🚶🏽 Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "🚶🏽 Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "🚶🏽 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csend_fsm_cnt = {
    ...
    'en': "📨️ Enter correct number of users for auto-sending",
    'es': "📨️ Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "📨️ Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "📨️ 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
}
l_csend_fsm_geo = {
    'ru': "📨 Начинаем гео-парсинг @username по координатам <b>{0} {1}</b>\n\n#длительность 1min",
    'en': "📨 Starting @username-geo-parsing by coordinates <b>{0} {1}</b>\n\n#duration 1min",
    'es': "📨️ Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "📨️ Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "📨️ 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_csend_fsm_parse_start = {
    ...
    'en': "📨 Starting @username-parsing from <b>{0}</b>\n\n#duration 1min",
    'es': "📨️ Listo! Invitación <b>automática</b> a <u>{0}</u> usuarios por día del grupo {1}",
    'fr': "📨️ Prêt ! <b>Auto</b>-inviter <u>{0}</u> utilisateurs par jour du groupe {1}",
    'zh': "📨️ 準備好了！ <b>自動</b>-每天從組 {1} 中邀請 <u>{0}</u> 個用戶",
    'ar': "🚶🏽 جاهز! <b> دعوة تلقائية </b> <u>{0}</u> للمستخدمين يوميًا من المجموعة {1}",
...
l_set_ban = {
    'ru': "👩🏽‍💻 Пользователь @{0} [id=<code>{1}</code>] был заблокирован по причине: {2}",
    'en': "👩🏽‍💻 User @{0} [id=<code>{1}</code>] have been blocked by reason: {2}",
    'es': "",
    'fr': "",
    'zh': "",
    'ar': "",
...
l_direct_message = {
    'ru': "👩🏽‍💻 <a href='{0}'>Пересылка</a> от {1}:",
    'en': "👩🏽‍💻 <a href='{0}'>Forward</a> from {1}:",
    'es': "",
    'fr': "",
    'zh': "",
    'ar': "",
...
l_userbot_cmd_life_time = {
    ...
    'en': "\n\n<b>Lifetime of account:</b> ~{0} days",
    'es': "",
    'fr': "",
    'zh': "",
    'ar': "",
...
l_extra_bot_block = {
    'ru': "👩🏽‍💻 Пользователь <b>{0}</b> заблокировал @{1}-бота",
...
l_extra_bot_unblock = {
    'ru': "👩🏽‍💻 Пользователь <b>{0}</b> разблокировал @{1}-бота",
...
l_extra_bot_answer = {
    'ru': "👩🏽‍💻 Пользователь <b>{0}</b> (<code>{1}</code>) ответил в @{2}-боте:",
...
l_extra_bot_gift_choose = {
    'ru': "👩🏽‍💻 Пользователь {0} (<code>{1}</code>) выбрал [{2}] в @{3}-боте",
...
l_extra_bot_notify = {
    'ru': "👩🏽‍💻 Пользователь ({0}) {1} (<code>{2}</code>) запустил @{3}-бота <b>{4}</b>",
...
l_handler_3127_admin = {
    'ru': "👩🏽‍💻 Пользователь {0} (<code>{1}</code>) активировал <b>промокод</b> на 5% в @{2}-боте",
    'en': "👩🏽‍💻 User <b>{0}</b> (<code>{1}</code>) activate <b>promo-code</b> on 5% in @{2}-bot",
    'es': "🔙 Volver..",
    'fr': "🔙 Retour..",
    'zh': "🔙 回來..",
    'ar': "🔙 رجوع ..",
...
l_generate_subcribe2 = {
    'ru': "👩🏽‍💻 <b>Подожди</b> <i>{0}сек или <a href='{1}'>оформи подписку</a></i>",
    'en': "👩🏽‍💻 Wait {0}sec or subscribe",
    'es': "👩🏽‍💻 Espera {0}segundos o suscríbete",
    'fr': "👩🏽‍💻 Attendez {0}sec ou abonnez-vous",
    'zh': "👩🏽‍💻 等待 {0} 秒或订阅",
...
l_post_welcome = {
    'ru': "🌱 {0}, добро пожаловать в <i>лендинг-бот</i> для создания креативных постов\n▪️<b>кнопочный</b> счетчик\n▪️инлайн-<b>телескопы</b>\n▪️<b>уведомления</b> о кликах\n▪️<b>шёпот</b>-сообщения\n\n❗️Регулярно-обновляемый /content",
...
l_subscribe_post = {
    'ru': "👩🏽‍💻 <b>Оформи</b> ежемесячную <i>подписку</i>:\n\n¹ [<b>Все боты</b> и проекты (-<u>5</u>%)]\n² [@{0}-бот]:\n▪️<b>нотис</b>-уведомления о кликах\n(<i>ссылка на пользователя</i>)\n\n👩🏽‍💻 /balance",
    'en': "👩🏽‍💻 <b>Sign up for</b> a monthly\n\n¹ <i>subscription</i> to @{0}-bot [{1} ₽]\n▪️ no ads\n▪️ creative tasks\n² Subscribe to <u>all</u> bots [{2} ₽]",
    'es': "👩🏽‍💻 <b>Regístrese para obtener</b> una\n\n¹ <i>suscripción</i> mensual a @{0}-bot [{1} ₽]\n▪️ sin anuncios\n▪️ tareas creativas\n² Suscríbase a <u>todos</u> los bots [{2} ₽]",
    'fr': "👩🏽‍💻 <b>Inscrivez-vous pour</b> un <i>abonnement</i>\n\n¹ mensuel à @{0}-bot [{1} ₽]\n▪️ pas de publicité\n▪️ tâches créatives\n² Abonnez-vous à <u>tous</u> les bots [{2} ₽]",
    'zh': "👩🏽‍💻<b>注册</b>每月\n\n¹<i>订阅</i>@{0}-bot [{1} ₽]\n▪️ 无广告\n▪️ 创意任务\n² 订阅<u>所有</u>机器人 [{2} ₽]",
...
l_post_parse = {
    'ru': "👩🏽‍💻 <b>Список</b> взаимодействий с постом #{0}: <u>{1}</u> пользователей",
    'en': "👩🏽‍💻 <b>Пользователь</b>: {name} нажал на: [{button}] (пост #<u>{post_id}</u>)",
    'es': "👩🏽‍💻 <b>Regístrese para obtener</b> una\n\n¹ <i>suscripción</i> mensual a @{0}-bot [{1} ₽]\n▪️ sin anuncios\n▪️ tareas creativas\n² Suscríbase a <u>todos</u> los bots [{2} ₽]",
    'fr': "👩🏽‍💻 <b>Inscrivez-vous pour</b> un <i>abonnement</i>\n\n¹ mensuel à @{0}-bot [{1} ₽]\n▪️ pas de publicité\n▪️ tâches créatives\n² Abonnez-vous à <u>tous</u> les bots [{2} ₽]",
    'zh': "👩🏽‍💻<b>注册</b>每月\n\n¹<i>订阅</i>@{0}-bot [{1} ₽]\n▪️ 无广告\n▪️ 创意任务\n² 订阅<u>所有</u>机器人 [{2} ₽]",
...
l_post_whisper_skip = {
    'ru': "👩🏽‍💻 Вы не види этот шёпот, потому что он был отправлен не вам",
    'en': "👩🏽‍💻 <b>Пользователь</b>: {name} нажал на: [{button}] (пост #<u>{post_id}</u>)",
    'es': "👩🏽‍💻 <b>Regístrese para obtener</b> una\n\n¹ <i>suscripción</i> mensual a @{0}-bot [{1} ₽]\n▪️ sin anuncios\n▪️ tareas creativas\n² Suscríbase a <u>todos</u> los bots [{2} ₽]",
    'fr': "👩🏽‍💻 <b>Inscrivez-vous pour</b> un <i>abonnement</i>\n\n¹ mensuel à @{0}-bot [{1} ₽]\n▪️ pas de publicité\n▪️ tâches créatives\n² Abonnez-vous à <u>tous</u> les bots [{2} ₽]",
    'zh': "👩🏽‍💻<b>注册</b>每月\n\n¹<i>订阅</i>@{0}-bot [{1} ₽]\n▪️ 无广告\n▪️ 创意任务\n² 订阅<u>所有</u>机器人 [{2} ₽]",
...
l_image_ico_attach = {
    'ru': "👩🏽‍💻 <b>Прикрепи</b> фото для преобразования в ico-иконку (160x160)",
...
l_vacancy_4 = {
    'ru': "👩🏽‍💻 <b>Telegram Ads - partner/investor</b>\n\nInvestment: <a href='https://promote.telegram.org/account/budget/add_funds'>€2,000,000</a>\nPay: share of the company",
    'en': "👩🏽‍💻 <b>Aio/pyro-gram developer</b>\n\nTasks: dev and support all projects\nGender: girl\nAge: less than 30\nPay: share of the company",
    'es': "👩🏽‍💻 <b>Desarrollador Aio/pyro-gram</b>\n\nTareas: desarrollar y apoyar todos los proyectos\nGénero: niña\nEdad: menos de 30\nPago: parte de la empresa",
    'fr': "👩🏽‍💻 <b>Développeur Aio/pyro-gram</b>\n\nTâches : développement et support de tous les projets\nSexe : fille\nÂge : moins de 30 ans\nRémunération : part de l'entreprise",
    'zh': "👩🏽‍💻 <b>Aio/pyro-gram 开发者</b>\n\n任务：开发和支持所有项目\n性别：女孩\n年龄：30岁以下\n薪酬：公司股份",
...
l_vacancy_5 = {
    'ru': "👩🏽‍💻 <b>Philanthropist</b>\n\nRequirements: any simple game for @gamee-project as Ferey-company\nPay: 10 TON",
    'en': "👩🏽‍💻 <b>Aio/pyro-gram developer</b>\n\nTasks: dev and support all projects\nGender: girl\nAge: less than 30\nPay: share of the company",
    'es': "👩🏽‍💻 <b>Desarrollador Aio/pyro-gram</b>\n\nTareas: desarrollar y apoyar todos los proyectos\nGénero: niña\nEdad: menos de 30\nPago: parte de la empresa",
    'fr': "👩🏽‍💻 <b>Développeur Aio/pyro-gram</b>\n\nTâches : développement et support de tous les projets\nSexe : fille\nÂge : moins de 30 ans\nRémunération : part de l'entreprise",
    'zh': "👩🏽‍💻 <b>Aio/pyro-gram 开发者</b>\n\n任务：开发和支持所有项目\n性别：女孩\n年龄：30岁以下\n薪酬：公司股份",
...
l_vacancy_6 = {
    'ru': "👩🏽‍💻 <b>Bot Premium</b>\n\nRequirements: <a href='https://fragment.com/my/assets'>5000 TON</a>\nPay: share of the company",
    'en': "👩🏽‍💻 <b>Aio/pyro-gram developer</b>\n\nTasks: dev and support all projects\nGender: girl\nAge: less than 30\nPay: share of the company",
    'es': "👩🏽‍💻 <b>Desarrollador Aio/pyro-gram</b>\n\nTareas: desarrollar y apoyar todos los proyectos\nGénero: niña\nEdad: menos de 30\nPago: parte de la empresa",
    'fr': "👩🏽‍💻 <b>Développeur Aio/pyro-gram</b>\n\nTâches : développement et support de tous les projets\nSexe : fille\nÂge : moins de 30 ans\nRémunération : part de l'entreprise",
    'zh': "👩🏽‍💻 <b>Aio/pyro-gram 开发者</b>\n\n任务：开发和支持所有项目\n性别：女孩\n年龄：30岁以下\n薪酬：公司股份",
