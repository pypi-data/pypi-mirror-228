...
async def generate_tgph_page(bot, USER_ID, ENT_TID, ENT_USERNAME, ENT_FN, MEDIA_D, BASE_D, entity_type='bot'):
    ...
    try:
        ...
        ENT_TOKENTGPH, ENT_PAGETGPH, ENT_JSONTGPH = await create_tgph_page(tgph_ph, ENT_TID, ENT_USERNAME, ENT_FN)
    except Exception as e:
        logger.info(log_ % str(e))
        await asyncio.sleep(round(random.uniform(0, 1), 2))
    finally:
