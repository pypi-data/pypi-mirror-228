...
async def create_tgph_json_and_token(title_hash):
    ...
    try:
        telegraph_ = Telegraph()
        account_ = telegraph_.create_account(short_name='me',
                                             author_name='blog',
                                             author_url="https://t.me")

        page_1 = telegraph_.create_page(title=f"TGPH-JSON-USERS-blog", html_content="<a href='https://t.me'>@blog</a>",
                                        author_name='blog', author_url="https://t.me")
        page_2 = telegraph_.create_page(title=f"TGPH-JSON-USERS-{title_hash}", html_content='{}')
