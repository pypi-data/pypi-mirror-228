...
if TYPE_CHECKING:
    from tsdoc0.python.question_shape import QuestionShape  # noqa: F401

import attr


@attr.s(auto_attribs=True, kw_only=True)
class AnswerShape(Segment):
    ...
    parent: Optional["QuestionShape"] = attr.ib(eq=False, repr=repr_parent)
