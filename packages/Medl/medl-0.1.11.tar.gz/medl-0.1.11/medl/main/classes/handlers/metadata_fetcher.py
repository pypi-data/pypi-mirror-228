...
from medl.common import SongData, PlaylistData, BaseOptionsManager
...
class MetadataFetcher:
    ...
    def fetch(self, query: str) -> Union[SongData, PlaylistData, None]:
        ...
        if isinstance(metadata, SongMetadata):  # song
            ...
            track_list = PlaylistData.from_mumee(metadata)

            self._logger.fetched_playlist(track_list.name, len(track_list.tracks))
            return track_list
