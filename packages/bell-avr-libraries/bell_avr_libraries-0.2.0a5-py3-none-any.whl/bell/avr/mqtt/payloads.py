...
class AVRFCMMissionUpload(BaseModel):
    ...
    """
    Either `n`, `e`, and `d` must be provided, or `lat`, `lon`, and `abs_alt` must be provided. Only the first waypoint may be a "TAKEOFF" waypoint, and that waypoint may omit an X and Y coordinate.
    """
