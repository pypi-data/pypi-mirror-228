...
class Config():
    ...
    def eval(self, featureSymbol: FeatureSymbol, frames: StringA = [], scale: arr = array(0.), target: arr = array(0.0078125), order: int = -1) -> tuple: 
        """
        evaluate a feature
        """
...
class ImpType():
    ...
    openGripper: ry.ImpType # value = <ImpType.openGripper: 1>
