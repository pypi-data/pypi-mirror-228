...
set_target_properties(ngcore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libngcore.so"
  IMPORTED_SONAME_RELEASE "libngcore.so"
  )

list(APPEND _cmake_import_check_targets ngcore )
list(APPEND _cmake_import_check_files_for_ngcore "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libngcore.so" )
...
set_target_properties(nggui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libnggui.so"
  IMPORTED_SONAME_RELEASE "libnggui.so"
  )

list(APPEND _cmake_import_check_targets nggui )
list(APPEND _cmake_import_check_files_for_nggui "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libnggui.so" )
...
set_target_properties(togl PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libtogl.a"
  )

list(APPEND _cmake_import_check_targets togl )
list(APPEND _cmake_import_check_files_for_togl "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libtogl.a" )
...
set_target_properties(nglib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libnglib.so"
  IMPORTED_SONAME_RELEASE "libnglib.so"
  )

list(APPEND _cmake_import_check_targets nglib )
list(APPEND _cmake_import_check_files_for_nglib "${_IMPORT_PREFIX}/lib/python3.10/site-packages/netgen_mesher.libs/libnglib.so" )
