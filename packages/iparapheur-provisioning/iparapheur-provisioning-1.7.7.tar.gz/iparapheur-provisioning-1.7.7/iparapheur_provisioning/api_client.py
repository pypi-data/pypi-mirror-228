...
from iparapheur_provisioning import rest
from iparapheur_provisioning.configuration import Configuration
from iparapheur_provisioning.exceptions import ApiTypeError, ApiValueError
from iparapheur_provisioning.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.7.7/python'
