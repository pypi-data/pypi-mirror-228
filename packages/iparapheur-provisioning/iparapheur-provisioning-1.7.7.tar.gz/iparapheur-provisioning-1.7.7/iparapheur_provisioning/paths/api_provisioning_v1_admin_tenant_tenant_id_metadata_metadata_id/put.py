...
MetadataIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tenantId': typing.Union[TenantIdSchema, str, ],
        'metadataId': typing.Union[MetadataIdSchema, str, ],
    }
)
...
request_path_metadata_id = api_client.PathParameter(
    name="metadataId",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = MetadataDto


request_body_metadata_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_metadata_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_metadata_dto.serialize(body, content_type)
