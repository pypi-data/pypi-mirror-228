...
# body param
SchemaForRequestBodyApplicationJson = TenantDto


request_body_tenant_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_tenant_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tenant_dto.serialize(body, content_type)
