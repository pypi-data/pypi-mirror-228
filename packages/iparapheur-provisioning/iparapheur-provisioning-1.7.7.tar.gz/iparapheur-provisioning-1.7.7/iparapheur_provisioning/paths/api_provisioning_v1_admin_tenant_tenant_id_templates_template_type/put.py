...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'templateType': typing.Union[TemplateTypeSchema, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_custom_template_oapg(
        self,
...
class UpdateCustomTemplate(BaseApi):
    ...
    def update_custom_template(
        ...
        return self._update_custom_template_oapg(
            body=body,
