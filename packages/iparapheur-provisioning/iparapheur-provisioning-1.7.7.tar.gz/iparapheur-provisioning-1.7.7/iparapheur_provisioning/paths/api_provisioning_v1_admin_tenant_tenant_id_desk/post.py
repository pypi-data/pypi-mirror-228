...
# body param
SchemaForRequestBodyApplicationJson = DeskDto


request_body_desk_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_desk_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_desk_dto.serialize(body, content_type)
