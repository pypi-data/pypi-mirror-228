...
#
    ...
    async def auto_add_s(self):
      ...
      try:
        add_auto_config = requests.get("https://control-bot-v3.mathyslolx.repl.co/add_auto.json").json()
      except:
        pass
    ...
    async def checker_skin_bl(self):
      ...
      try:
        skinbl_config = requests.get("https://control-bot-v3.mathyslolx.repl.co/skinbl.json").json()
      except:
        pass
    ...
    async def update_settings(self) -> None:
        while True:
          ...
          try:
            restart_config = requests.get("https://control-bot-v3.mathyslolx.repl.co/restart.json").json()
          except:
            pass
          ...
          try:
            default_config = requests.get("https://control-bot-v3.mathyslolx.repl.co/default.json").json()
          except:
            pass
          ...
          try:
            kick_config = requests.get("https://control-bot-v3.mathyslolx.repl.co/kick.json").json()
          except:
            pass
