...
class SwitchNested1(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class switch(schemas.DictSchema):
                class MetaOapg:
                    required = {
                        "cases",
                    }
                    ...
                    class properties:
                        class cases(schemas.ListSchema):
                            class MetaOapg:
                                class items(schemas.DictSchema):
                                    ...
                                    @typing.overload
                                    def __getitem__(
                                        self, name: typing_extensions.Literal["check"]
                                    ) -> MetaOapg.properties.check:
                                        ...
                ...
                @typing.overload
                def __getitem__(
                    self, name: typing_extensions.Literal["cases"]
                ) -> MetaOapg.properties.cases:
                    ...
                ...
                def __getitem__(
                    self, name: typing.Union[typing_extensions.Literal["cases",], str]
                ):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["switch"]
    ) -> MetaOapg.properties.switch:
        ...
