...
class CarrierStream(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["options"]
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["options"]
    ) -> typing.Union["CarrierStreamOptions", schemas.Unset]:
        ...

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["details"]
    ) -> typing.Union["CarrierStreamDetails", schemas.Unset]:
        ...
