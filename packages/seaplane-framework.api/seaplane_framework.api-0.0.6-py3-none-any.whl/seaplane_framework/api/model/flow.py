...
class Flow(schemas.DictSchema):
    ...
    def __getitem__(
        self,
        name: typing.Union[
            typing_extensions.Literal["input"],
            typing_extensions.Literal["processor"],
            typing_extensions.Literal["output"],
            typing_extensions.Literal["replicas"],
        ],
    ):
    ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["input"]
    ) -> typing.Union["Input", schemas.Unset]:
        ...

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["processor"]
    ) -> typing.Union["Processor", schemas.Unset]:
        ...

    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["output"]
    ) -> typing.Union["Output", schemas.Unset]:
        ...
