...
from trajectopy.settings.matching_settings import MatchingMethod, MatchingSettings
...
def kd_matcher(ref: np.ndarray, test: np.ndarray, max_distance: float = 0.0) -> Tuple[np.ndarray, np.ndarray]:
    ...
    return closest_indices[distance_filter][unique_indices], distance_index_matrix[distance_filter, 1][unique_indices]
