...
class TranslationExportStart(ModelView):
    ...
    override_format = fields.Boolean('Override format',
        help='Create the export file as override po file.')
...
class TranslationExport(Wizard):
    ...
    def transition_export(self):
        ...
        self.result.file = Translation.translation_export(
            ...
            override=self.start.override_format)
        return 'result'
