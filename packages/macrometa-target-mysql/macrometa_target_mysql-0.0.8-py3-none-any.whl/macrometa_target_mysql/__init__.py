    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty(
                ...
                False,
                False,
                description="Replace null values with default values.",
                default_value="false",
            ),
            ConfigProperty(
                "batch_flush_size",
            ...
            ConfigProperty(
                ...
                False,
                False,
                description="Use lowercase for table names or not. This will update target table "
                "name to lower case.",
                default_value="false",
            ),
            ConfigProperty(
                ...
                False,
                False,
                description="Allow column alterations if target table's column type doesn't match "
