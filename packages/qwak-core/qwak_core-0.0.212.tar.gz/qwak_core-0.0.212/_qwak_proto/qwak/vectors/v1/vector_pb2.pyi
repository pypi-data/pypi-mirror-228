...
class Property(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bool_val", b"bool_val", "double_val", b"double_val", "int_val", b"int_val", "name", b"name", "string_val", b"string_val", "timestamp_val", b"timestamp_val", "value_type", b"value_type"]) -> None: ...
