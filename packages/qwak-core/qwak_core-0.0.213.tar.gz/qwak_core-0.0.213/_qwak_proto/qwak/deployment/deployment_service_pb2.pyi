...
class GetDeploymentResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployments_details", b"deployments_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deployments_details", b"deployments_details"]) -> None: ...
...
class CancelDeploymentRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___CancelDeploymentRequest = CancelDeploymentRequest

class CancelDeploymentResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___CancelDeploymentResponse = CancelDeploymentResponse
