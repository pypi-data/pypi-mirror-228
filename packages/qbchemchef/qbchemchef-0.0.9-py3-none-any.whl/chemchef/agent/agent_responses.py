...
KNOWLEDGE_HEADER = "Current knowledge/experience: "
...
AI_MESSAGE_FOR_TOOL = "Original question: {}\n"\
                      "Current knowledge/experience: {}\n"\
                      "Plan going forward: {}\n"\
                      "Next tool: {}\n"\
                      "Input to next tool: {}"

AI_MESSAGE_FOR_FINAL_ANS = "Original question: {}\n"\
                           "Current knowledge/experience: {}\n"\
                           "Plan going forward: {}\n"\
                           "Final answer: {}"
...
STANDARD_EXAMPLES: list[ParsedAssistantMessage] = [
    ...
    ParsedAssistantMessageForTool(
        ...
        knowledge="The ECB website should list the current Test squad. "
                  "Cricinfo should have information about each player's scores in individual matches",
        plan='Find the page on the ECB website that lists the current Test squad, and extract the list of names. '
             'For each squad member, look up the runs scored by that player in Test innings in 2023 on Cricinfo.',
        tool_name=GoogleSearchTool.NAME,
    ...
    ParsedAssistantMessageForFinalAnswer(
        ...
        knowledge='Madrid is the capital of Spain. (common knowledge - no tools required)',
        plan='No further steps',
        answer='Madrid'
    ),
]
