...
from chemchef.agent.agent_responses import ParsedAssistantMessage, construct_assistant_message, FORMATTING_INSTRUCTION, \
    parse_assistant_message, ParsedAssistantMessageForTool, ParsedAssistantMessageForFinalAnswer, STANDARD_ASSISTANT_MESSAGE_EXAMPLES
from chemchef.agent.tools import AbstractTool, ToolUsageError, STANDARD_TOOLS
...
class Agent:
    ...
    @classmethod
    def create_with_standard_tools(cls) -> "Agent":
        return cls(tools=STANDARD_TOOLS, assistant_message_examples=STANDARD_ASSISTANT_MESSAGE_EXAMPLES)
