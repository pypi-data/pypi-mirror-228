...
def model(R,L,scour_depth,soil_layers,prj_dir):
    layering = []
    ...
    #basic model
    command1 = f'''zone import '{prj_dir}\zone_{int(R)}.inp' format abaqus
    ...
    print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++")
    os.remove(f"{prj_dir}\zone_{int(radius)}.inp")
