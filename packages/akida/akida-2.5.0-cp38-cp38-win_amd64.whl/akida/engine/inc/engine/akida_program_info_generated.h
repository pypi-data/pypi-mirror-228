...
struct LearningLayerSpans;
struct LearningLayerSpansBuilder;
...
struct LearningLayerSpans FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef LearningLayerSpansBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_LEARNING_REGISTERS_SPAN = 4,
    VT_INFERENCE_REGISTERS_SPAN = 6,
    VT_RAM_SPAN = 8,
    VT_NP = 10
  };
  const akida::fb::TrackSpan *learning_registers_span() const {
    return GetStruct<const akida::fb::TrackSpan *>(VT_LEARNING_REGISTERS_SPAN);
  }
  const akida::fb::TrackSpan *inference_registers_span() const {
    return GetStruct<const akida::fb::TrackSpan *>(VT_INFERENCE_REGISTERS_SPAN);
  }
  const akida::fb::RecordSpans *ram_span() const {
    return GetPointer<const akida::fb::RecordSpans *>(VT_RAM_SPAN);
  }
  const akida::fb::NPIdent *np() const {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<akida::fb::TrackSpan>(verifier, VT_LEARNING_REGISTERS_SPAN, 4) &&
           VerifyField<akida::fb::TrackSpan>(verifier, VT_INFERENCE_REGISTERS_SPAN, 4) &&
           VerifyOffset(verifier, VT_RAM_SPAN) &&
           verifier.VerifyTable(ram_span()) &&
...
struct LearningLayerSpansBuilder {
  typedef LearningLayerSpans Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_learning_registers_span(const akida::fb::TrackSpan *learning_registers_span) {
    fbb_.AddStruct(LearningLayerSpans::VT_LEARNING_REGISTERS_SPAN, learning_registers_span);
  }
  void add_inference_registers_span(const akida::fb::TrackSpan *inference_registers_span) {
    fbb_.AddStruct(LearningLayerSpans::VT_INFERENCE_REGISTERS_SPAN, inference_registers_span);
  }
  void add_ram_span(flatbuffers::Offset<akida::fb::RecordSpans> ram_span) {
    fbb_.AddOffset(LearningLayerSpans::VT_RAM_SPAN, ram_span);
  }
  void add_np(const akida::fb::NPIdent *np) {
    fbb_.AddStruct(LearningLayerSpans::VT_NP, np);
  }
  explicit LearningLayerSpansBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<LearningLayerSpans> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<LearningLayerSpans>(end);
    return o;
  }
};

inline flatbuffers::Offset<LearningLayerSpans> CreateLearningLayerSpans(
    flatbuffers::FlatBufferBuilder &_fbb,
    const akida::fb::TrackSpan *learning_registers_span = nullptr,
    const akida::fb::TrackSpan *inference_registers_span = nullptr,
    flatbuffers::Offset<akida::fb::RecordSpans> ram_span = 0,
    const akida::fb::NPIdent *np = nullptr) {
  LearningLayerSpansBuilder builder_(_fbb);
  builder_.add_np(np);
  builder_.add_ram_span(ram_span);
  builder_.add_inference_registers_span(inference_registers_span);
  builder_.add_learning_registers_span(learning_registers_span);
  return builder_.Finish();
}
...
struct ProgramInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<akida::fb::PassSpans>> *pass_spans() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<akida::fb::PassSpans>> *>(VT_PASS_SPANS);
  }
  const akida::fb::LearningLayerSpans *learning_layer_span() const {
    return GetPointer<const akida::fb::LearningLayerSpans *>(VT_LEARNING_LAYER_SPAN);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_PASS_SPANS) &&
           verifier.VerifyVector(pass_spans()) &&
           verifier.VerifyVectorOfTables(pass_spans()) &&
           VerifyOffset(verifier, VT_LEARNING_LAYER_SPAN) &&
           verifier.VerifyTable(learning_layer_span()) &&
           verifier.EndTable();
  }
};
...
struct ProgramInfoBuilder {
  ...
  void add_pass_spans(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<akida::fb::PassSpans>>> pass_spans) {
    fbb_.AddOffset(ProgramInfo::VT_PASS_SPANS, pass_spans);
  }
  void add_learning_layer_span(flatbuffers::Offset<akida::fb::LearningLayerSpans> learning_layer_span) {
    fbb_.AddOffset(ProgramInfo::VT_LEARNING_LAYER_SPAN, learning_layer_span);
  }
...
inline flatbuffers::Offset<ProgramInfo> CreateProgramInfo(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<akida::fb::PassSpans>>> pass_spans = 0,
    flatbuffers::Offset<akida::fb::LearningLayerSpans> learning_layer_span = 0) {
  ProgramInfoBuilder builder_(_fbb);
  builder_.add_learning_layer_span(learning_layer_span);
  builder_.add_pass_spans(pass_spans);
...
inline flatbuffers::Offset<ProgramInfo> CreateProgramInfoDirect(
    ...
    const std::vector<flatbuffers::Offset<akida::fb::PassSpans>> *pass_spans = nullptr,
    flatbuffers::Offset<akida::fb::LearningLayerSpans> learning_layer_span = 0) {
  ...
  auto pass_spans__ = pass_spans ? _fbb.CreateVector<flatbuffers::Offset<akida::fb::PassSpans>>(*pass_spans) : 0;
