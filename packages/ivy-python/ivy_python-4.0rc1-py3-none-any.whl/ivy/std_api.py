...
Bindings:
  ...
  :py:func:`IvyBindMsg`, :py:func:`IvyUnbindMsg`, :py:func:`IvyBindDirectMsg`
...
Interacting with other Ivy clients:
  ...
  :py:func:`IvySendMsg`, :py:func:`IvySendDieMsg`, :py:func:`IvySendDirectMsg`
...
@public_api
def IvyTimerModify(timer_id: int, delay: int) -> None:
    """
