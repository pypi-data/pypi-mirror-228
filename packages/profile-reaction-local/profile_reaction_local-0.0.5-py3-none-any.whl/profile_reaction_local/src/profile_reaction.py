...
from profile_reaction_dto import ProfileReactionDto  # noqa: E402

load_dotenv()
from logger_local.Logger import Logger  # noqa: E402
from circles_local_database_python.generic_crud.src.generic_crud import GenericCRUD  # noqa: E402
...
class ProfileReactions(GenericCRUD):
    ...
    def insert(reaction_id: int, profile_id: int) -> int:
        ...
        json_data = {'reaction_id': reaction_id, 'profile_id': profile_id}
        insert_result = None
        try:
            ...
            insert_result = GenericCRUD.insert(PROFILE_REACTION_DATABASE_NAME, PROFILE_REACTION_TABLE_NAME, json_data)
        ...
        profile_reaction_id = insert_result['contacts ids'][0]
    ...
    def insert_with_dto(profile_reaction_dto: ProfileReactionDto) -> int:
        ...
        json_data = profile_reaction_dto.get_arguments()
    ...
    def read_by_profile_reaction_id(profile_reaction_id: int) -> (int, int):
        ...
        try:
            if profile_reaction_id <= 0:
                ...
                raise Exception(message)
            read_result = GenericCRUD.get_records_by_id(
                PROFILE_REACTION_DATABASE_NAME, PROFILE_REACTION_VIEW_NAME, PROFILE_REACTION_ID_COLUMN_NAME,
                profile_reaction_id)
        ...
        try:
            if profile_reaction_id < 0:
                ...
                logger.end(READ_PROFILE_REACTION_METHOD_NAME, object={
                           'profile_reaction_id': profile_reaction_id, 'message': message})
                raise Exception(message)
            read_results = GenericCRUD.get_records_by_id(
                PROFILE_REACTION_DATABASE_NAME, PROFILE_REACTION_VIEW_NAME, PROFILE_REACTION_ID_COLUMN_NAME,
                profile_reaction_id)
    ...
    def read_all_by_profile_id(profile_id: int) -> list((int, int)):
        ...
        try:
            if profile_id < 0:
                ...
                raise Exception(message)
            read_result = GenericCRUD.get_records_by_id(
                PROFILE_REACTION_DATABASE_NAME, PROFILE_REACTION_VIEW_NAME, PROFILE_ID_COLUMN_NAME, profile_id)
        except Exception as e:
            logger.exception(ERROR_MESSAGE_FAILED_READ, object=e)
    ...
    def read_all_by_reaction_id(reaction_id: int) -> list((int, int)):
        ...
        try:
            if reaction_id < 0:
                ...
                raise Exception(message)
            read_result = GenericCRUD.get_records_by_id(
                PROFILE_REACTION_DATABASE_NAME, PROFILE_REACTION_VIEW_NAME, REACTION_ID_COLUMN_NAME, reaction_id)
        except Exception as e:
            logger.exception(ERROR_MESSAGE_FAILED_READ, object=e)
