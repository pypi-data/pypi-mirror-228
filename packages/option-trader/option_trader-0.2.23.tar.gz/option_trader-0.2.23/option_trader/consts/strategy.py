...
SPREAD_LIST =      [CREDIT_PUT_SPREAD, DEBIT_PUT_SPREAD, CREDIT_CALL_SPREAD, DEBIT_PUT_SPREAD]
...
NEUTRAL_LIST =     [CREDIT_IRON_CONDOR, DEBIT_IRON_CONDOR, IRON_BUTTERFLY]
...
BIGMOVE_LIST =     [REVERSE_IRON_BUTTERFLY] #long straddle 
