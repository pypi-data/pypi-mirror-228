...
from pywallex.schemas import FiatPayModel, CryptoPayModel
...
class Payout:
    ...
    def __init__(self, merchant_id, secret_key, wallex_client=None):
        self.merchant_id = merchant_id
        self.secret_key = secret_key
        self.client = wallex_client or WallexClient()
