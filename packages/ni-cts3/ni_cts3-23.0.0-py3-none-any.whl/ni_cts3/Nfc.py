...
_callback_dict: Dict[
    str, Optional[Callable[[c_uint32, c_uint32, c_char_p, c_size_t], c_int32]]
] = {}
...
class Header(C_Union):
    ...
    _fields_ = [("events", EventHeader), ("analog", AnalogHeader)]
...
def _unit_autoselect(unit: NfcUnit, values: List[float]) -> Tuple[NfcUnit, List[int]]:
    """
...
def MPC_SelectType(card_type: TechnologyType) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SelectType(c_uint8(0), c_uint8(card_type)))
...
def MPC_SelectModulationASK(ask: float) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SelectModulationASKpt(c_uint8(0), c_uint16(ask_pm)))
...
def MPC_SelectFieldStrength(
    unit: FieldUnit, value: float, max_duration: Optional[float] = None
) -> None:
    """
    ...
    if unit == FieldUnit.APPLY_DEFAULT_VALUE:
        CTS3Exception._check_error(
            _MPuLib.MPC_SelectFieldStrengthEx(
                c_uint8(0), c_uint8(unit), c_int16(0), c_uint32(max_duration_ms)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_SelectFieldStrengthEx(
                c_uint8(0), c_uint8(unit), c_int16(value_pm), c_uint32(max_duration_ms)
            )
        )
    else:  # mV
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_SelectFieldStrengthEx(
                c_uint8(0), c_uint8(unit), c_int16(value_mV), c_uint32(max_duration_ms)
            )
        )


def MPC_SetupFindFieldStrength(expected_voltage: float) -> Dict[str, Union[float, int]]:
    """
    ...
    field = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_SetupFindFieldStrength(
            c_uint8(0), c_uint32(0), c_uint32(expected_voltage_mV), byref(field), byref(voltage)
        )
    )
    return {"voltage_reached": voltage.value / 1e3, "field_per_mille": field.value}
...
def MPC_SelectCarrierExt(frequency: float) -> None:
    ...
    Args:
        frequency: Carrier frequency in Hz
    """
    CTS3Exception._check_error(_MPuLib.MPC_SelectCarrierExt(c_uint8(0), c_double(frequency)))
...
def MPC_SelectFallAndRiseTime(falling_time: float, rising_time: float) -> None:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectFallAndRiseTime(
            c_uint8(0), c_uint16(falling_time_ns), c_uint16(rising_time_ns)
        )
    )
...
def MPC_ForceModulationASK(activate: bool) -> None:
    ...
    """
    CTS3Exception._check_error(_MPuLib.MPC_ForceModulationASK(c_uint8(0), c_bool(activate)))
...
def MPC_SetFWTETU(fwt_etu: int) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SetFWTETU(c_uint8(0), c_uint32(fwt_etu)))
...
def MPC_SetFWTus(fwt: float) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SetFWTus(c_uint8(0), c_uint32(fwt_us)))
...
def MPC_SelectDataRate(pcd_data_rate: DataRate, picc_data_rate: DataRate) -> None:
    """
    Selects data rate
    ...
    if not isinstance(pcd_data_rate, DataRate):
        raise TypeError("pcd_data_rate must be an instance of DataRate IntEnum")
    if not isinstance(picc_data_rate, DataRate):
        raise TypeError("picc_data_rate must be an instance of DataRate IntEnum")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectDataRate(c_uint8(0), c_uint16(pcd_data_rate), c_uint16(picc_data_rate))
    )


def MPC_ExchangeCmd(
    tx_frame: bytes, tx_bits_number: Optional[int] = None
    ...
    if tx_frame:
        ...
        _check_limits(c_uint32, tx_bits_number, "tx_bits_number")
        CTS3Exception._check_error(
            _MPuLib.MPC_ExchangeCmd(
                c_uint8(0), tx_frame, c_uint32(tx_bits_number), data, byref(rx_bits)
            )
        )
    else:
        CTS3Exception._check_error(
            _MPuLib.MPC_ExchangeCmd(c_uint8(0), None, c_uint32(0), data, byref(rx_bits))
        )
    bytes_number = int(rx_bits.value / 8)
    if rx_bits.value % 8 > 0:
        bytes_number += 1
...
def MPC_SendFrameProtocol(tx_frame: bytes) -> bytes:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_SendFrameProtocol(
            c_uint8(0), tx_frame, c_uint32(len(tx_frame)), data, byref(length)
        )
    )
...
def MPC_SendAPDU(
    header: Union[bytes, int], lc_field: Optional[bytes] = None, le: Optional[int] = 0
) -> Dict[str, Union[bytes, int]]:
    """
...
def MPC_SendSBlockParameters(tx_frame: bytes) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_SendSBlockParameters(
            c_uint8(0), tx_frame, c_uint16(len(tx_frame)), data, byref(length)
        )
    )
    return data[: length.value]
...
def MPC_SelectPauseWidth(pause: float) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SelectPauseWidth(c_uint8(0), c_uint16(pause_ns)))
...
def MPC_AnticollA() -> Dict[str, bytes]:
    ...
    sak = c_uint8()
    length = c_uint16()
    CTS3Exception._check_error(_MPuLib.MPC_AnticollA(c_uint8(0), uid, byref(length), byref(sak)))
...
def MPC_SelectCardA(uid: bytes) -> bytes:
    ...
    sak = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectCardA(c_uint8(0), uid, c_uint16(len(uid)), byref(sak))
    )
...
def MPC_GetPosColl() -> int:
    ...
    """
    position = c_uint32()
    CTS3Exception._check_error(_MPuLib.MPC_GetPosColl(c_uint8(0), byref(position)))
...
def MPC_SendRATS(rats: Optional[bytes] = None) -> bytes:
    ...
    if rats:
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_SendRATSFree(c_uint8(0), rats, c_uint16(len(rats)), data, byref(length))
        )
    else:
        CTS3Exception._check_error(_MPuLib.MPC_SendRATS(c_uint8(0), data, byref(length)))
    return data[: length.value]


def MPC_SendPPS(cid: Union[int, bytes], dri: Union[int, bytes], dsi: Union[int, bytes]) -> None:
    """
    Sends a PPS command
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_SendPPS(c_uint8(0), c_uint8(cid_value), c_uint8(dri_value), c_uint8(dsi_value))
    )


def MPC_ExchangeCmdRawA(
    tx_frame: Optional[bytes], tx_bits_number: Optional[int] = None
) -> Dict[str, Union[bytes, int]]:
    """
...
def MPC_PowerOnGetFrameFromSpecialTagA(
    unit: FieldUnit, value: int, timeout: float, nb_id_to_get: int
) -> Dict[str, Union[bytes, int]]:
    """
...
def MPC_RequestB(slots_number: int) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_RequestB(c_uint8(0), c_uint8(slots_number), data, byref(length))
    )
    return data[: length.value]
...
def MPC_RequestBFree(reqb: bytes) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_RequestBFree(c_uint8(0), reqb, c_uint16(len(reqb)), data, byref(length))
    )
    return data[: length.value]
...
def MPC_WakeUpB(slots_number: int) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_WakeUpB(c_uint8(0), c_uint8(slots_number), data, byref(length))
    )
    return data[: length.value]
...
def MPC_SlotMarkerCmd(slot_number: int) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_SlotMarkerCmd(c_uint8(0), c_uint8(slot_number), data, byref(length))
    )
    return data[: length.value]
...
def MPC_SendATTRIB(attrib: bytes) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_SendATTRIB(c_uint8(0), attrib, c_uint16(len(attrib)), data, byref(length))
    )
    return data[: length.value]
...
def MPC_SelectETUWidthTX(etu_logic_0: int, etu_logic_1: int) -> None:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectETUWidthTX(c_uint8(0), c_uint16(etu_logic_0), c_uint16(etu_logic_1))
    )
...
def MPC_FelicaPolling(
    system_code: Union[bytes, int], request_code: Union[bytes, int], time_slot: Union[bytes, int]
) -> bytes:
    """
...
@overload
def MPC_FelicaCheck(
    idm: bytes, service_codes: List[FelicaService], blocks: List[FelicaBlock]
...
def MPC_FelicaCheck(idm, service_codes, blocks):  # type: ignore[no-untyped-def]
    """
    ...
    if not isinstance(service_codes, list):
        raise TypeError("service_codes must be an instance of FelicaService list or int list")
    _check_limits(c_uint8, len(service_codes), "service_codes")
    if not isinstance(blocks, list):
        raise TypeError("blocks must be an instance of FelicaBlock list or int list")
    ...
    return {"idm2": idm2, "status1": status1.value, "status2": status2.value, "data": data_list}
...
def MPC_FELICA_Read_Without_Encryption(
    ...
    Returns:
        ...
        - "data": Read 16-byte blocks (list(bytes))
    """
    warn("MPC_FELICA_Read_Without_Encryption renamed as MPC_FelicaCheck", FutureWarning, 2)
    return MPC_FelicaCheck(idm, service_codes, blocks)


@overload
def MPC_FelicaUpdate(
    idm: bytes, service_codes: List[FelicaService], blocks: List[FelicaBlock], data: List[bytes]
) -> Dict[str, Union[bytes, int]]:
    ...
...
@overload
def MPC_FelicaUpdate(
    idm: bytes, service_codes: List[int], blocks: List[int], data: List[bytes]
) -> Dict[str, Union[bytes, int]]:
    ...


def MPC_FelicaUpdate(idm, service_codes, blocks, data):  # type: ignore[no-untyped-def]
    """
    ...
    if not isinstance(blocks, list):
        raise TypeError("blocks must be an instance of FelicaBlock list or int list")
    _check_limits(c_uint8, len(blocks), "blocks")
    if not isinstance(data, list) or any(not isinstance(i, bytes) or len(i) != 16 for i in data):
...
def MPC_FELICA_Write_Without_Encryption(
    ...
    Returns:
        ...
        - "status2": Status flag 2 (int)
    """
    warn("MPC_FELICA_Write_Without_Encryption renamed as MPC_FelicaUpdate", FutureWarning, 2)
...
def MPC_MFULReadPage(page_number: int) -> bytes:
    ...
    data = bytes(16)
    CTS3Exception._check_error(_MPuLib.MPC_MFULReadPage(c_uint8(0), c_uint32(page_number), data))
    return data
...
def MPC_MFULWritePage(page_number: int, page_content: bytes) -> None:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_MFULWritePage(c_uint8(0), c_uint32(page_number), page_content)
    )
...
def MPC_MFULCAuthenticate(key1: bytes, key2: bytes) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_MFULCAuthenticate(c_uint8(0), key1, key2, c_uint32(0)))
...
def MPC_MFULCWriteKey(key1: bytes, key2: bytes) -> None:
    ...
    if not isinstance(key2, bytes) or len(key2) != 8:
        raise TypeError("key2 must be an instance of 8 bytes")
    CTS3Exception._check_error(_MPuLib.MPC_MFULCWriteKey(c_uint8(0), key1, key2))
...
def CLP_Authentication_2(key_mode: MifareKey, sector: int, key_address: int) -> None:
    """
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_Authentication_2(
            c_uint8(0), c_uint8(key_mode), c_uint8(sector), c_uint8(key_address)
        )
    )
...
def CLP_Read(block_number: int) -> bytes:
    ...
    CTS3MifareException._check_error(_MPuLib.CLP_Read(c_uint8(0), c_uint8(block_number), data))
    return data
...
def CLP_Write(block_number: int, data: bytes) -> None:
    ...
    CTS3MifareException._check_error(_MPuLib.CLP_Write(c_uint8(0), c_uint8(block_number), data))
...
def CLP_Increment(block_number: int, value: int) -> None:
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_Increment(c_uint8(0), c_uint8(block_number), c_uint32(value))
    )
...
def CLP_Decrement(block_number: int, value: int) -> None:
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_Decrement(c_uint8(0), c_uint8(block_number), c_uint32(value))
    )
...
def CLP_Decrement_Transfer(block_number: int, value: int) -> None:
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_Decrement_Transfer(c_uint8(0), c_uint8(block_number), c_uint32(value))
    )
...
def CLP_Restore(block_number: int) -> None:
    ...
    CTS3MifareException._check_error(_MPuLib.CLP_Restore(c_uint8(0), c_uint8(block_number)))
...
def CLP_Transfer(block_number: int) -> None:
    ...
    CTS3MifareException._check_error(_MPuLib.CLP_Transfer(c_uint8(0), c_uint8(block_number)))
...
def CLP_LoadKey(key_mode: MifareKey, sector: int, key: bytes) -> None:
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_LoadKey(c_uint8(0), c_uint8(key_mode), c_uint8(sector), str_key.encode("ascii"))
    )


def CLP_Authentication_3(key_mode: MifareKey, sector: int, key_address: int, snr: bytes) -> None:
    """
    ...
    CTS3MifareException._check_error(
        _MPuLib.CLP_Authentication_3(
            c_uint8(0), c_uint8(key_mode), c_uint8(sector), c_uint8(key_address), snr32
        )
    )
...
def CLP_PersonalizeUIDUsage(option: MifareUidOption) -> None:
    ...
    if not isinstance(option, MifareUidOption):
        raise TypeError("option must be an instance of MifareUidOption IntEnum")
    _MPuLib.CLP_PersonalizeUIDUsage.restype = c_int32
    CTS3MifareException._check_error(_MPuLib.CLP_PersonalizeUIDUsage(c_uint8(0), c_uint8(option)))
...
def MPC_SelectVCCommunication(
    mode: VicinityCodingMode, data_rate: VicinityDataRate, sub_carrier: VicinitySubCarrier
) -> None:
    """
    ...
    if not isinstance(mode, VicinityCodingMode):
        raise TypeError("mode must be an instance of VicinityCodingMode IntEnum")
    if not isinstance(data_rate, VicinityDataRate):
        raise TypeError("data_rate must be an instance of VicinityDataRate IntEnum")
    if not isinstance(sub_carrier, VicinitySubCarrier):
        raise TypeError("sub_carrier must be an instance of VicinitySubCarrier IntEnum")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectVCCommunication(
            c_uint8(0), c_uint8(mode), c_uint8(data_rate), c_uint8(sub_carrier)
        )
    )
...
def MPC_SelectPauseWidthVicinity(pause: float) -> None:
    ...
    pause_ns = round(pause * 1e9)
    _check_limits(c_uint16, pause_ns, "pause")
    CTS3Exception._check_error(_MPuLib.MPC_SelectPauseWidthVicinity(c_uint8(0), c_uint16(pause_ns)))
...
def MPC_ExchangeCmdVicinity(tx_frame: bytes) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_ExchangeCmdVicinity(
            c_uint8(0), tx_frame, c_uint16(len(tx_frame)), data, byref(length)
        )
    )
    return data[: length.value]
...
def MPC_VcInventory(
    slot: int, afi: Optional[Union[bytes, int]], mask: bytes
) -> Dict[str, Union[bytes, int]]:
    """
...
def MPC_VcSelect() -> int:
    ...
    """
    response_flag = c_uint8()
    CTS3Exception._check_error(_MPuLib.MPC_VcSelect(c_uint8(0), byref(response_flag)))
...
def MPC_VcReadSingleBlock(flag: VicinityFlag, block_number: int) -> Dict[str, Union[bytes, int]]:
    """
...
def MPC_VcExtendedReadSingleBlock(
    flag: VicinityFlag, block_number: int
) -> Dict[str, Union[bytes, int]]:
    """
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcExtendedReadSingleBlock(
            c_uint8(0),
            c_uint8(flag),
...
def MPC_VcReadMultipleBlock(
    flag: VicinityFlag, first_block_number: int, blocks_number: int
    ...
    block_size = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcReadMultipleBlock(
            c_uint8(0),
            c_uint8(flag),
            c_uint8(first_block_number),
            c_uint8(blocks_number),
            security,
            data,
            byref(block_num),
            byref(block_size),
...
def MPC_VcExtendedReadMultipleBlock(
    ...
    block_size = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcExtendedReadMultipleBlock(
            c_uint8(0),
            c_uint8(flag),
...
def MPC_VcWriteSingleBlock(flag: VicinityFlag, block_number: int, data: bytes) -> int:
    """
    ...
    response_flag = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcWriteSingleBlock(
            c_uint8(0),
            c_uint8(flag),
            c_uint16(len(data)),
            c_uint8(block_number),
...
def MPC_VcWriteExtendedSingleBlock(flag: VicinityFlag, block_number: int, data: bytes) -> int:
    """
    ...
    response_flag = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcWriteExtendedSingleBlock(
            c_uint8(0),
            c_uint8(flag),
            c_uint16(len(data)),
            c_uint16(block_number),
...
def MPC_VcLockSingleBlock(flag: VicinityFlag, block_number: int) -> int:
    ...
    response_flag = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcLockSingleBlock(
            c_uint8(0), c_uint8(flag), c_uint8(block_number), byref(response_flag)
        )
    )
    return response_flag.value


def MPC_VcExtendedLockSingleBlock(flag: VicinityFlag, block_number: int) -> int:
    """
    ...
    response_flag = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcExtendedLockSingleBlock(
            c_uint8(0), c_uint8(flag), c_uint16(block_number), byref(response_flag)
        )
    )
    return response_flag.value
...
def MPC_VcResetToReady(flag: VicinityFlag) -> int:
    ...
    response_flag = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_VcResetToReady(c_uint8(0), c_uint8(flag), byref(response_flag))
    )
    return response_flag.value
...
def MPC_VcGetLastErrorCode() -> int:
    ...
    """
    err_code = c_uint8()
    CTS3Exception._check_error(_MPuLib.MPC_VcGetLastErrorCode(c_uint8(0), byref(err_code)))
...
def MPC_VcGetLastAnswer() -> bytes:
    ...
    data = bytes(10000)
    length = c_uint16()
    CTS3Exception._check_error(_MPuLib.MPC_VcGetLastAnswer(c_uint8(0), data, byref(length)))
    return data[: length.value]
...
def MPC_SetModulationShape(
    pattern_index: int, falling_edge_per_mille: List[int], rising_edge_per_mille: List[int]
) -> None:
    """
    ...
    if not isinstance(falling_edge_per_mille, list) or any(
        ...
        raise TypeError("falling_edge_per_mille must be an instance of integers list")
    if not isinstance(rising_edge_per_mille, list) or any(
        not isinstance(i, int) for i in rising_edge_per_mille
    ):
        raise TypeError("rising_edge_per_mille must be an instance of integers list")
    falling = (c_uint16 * len(falling_edge_per_mille))()
    for i in range(len(falling_edge_per_mille)):
        _check_limits(c_uint16, falling_edge_per_mille[i], "falling_edge_per_mille")
    ...
    for i in range(len(rising_edge_per_mille)):
        _check_limits(c_uint16, rising_edge_per_mille[i], "rising_edge_per_mille")
        rising[i] = c_uint16(rising_edge_per_mille[i])
    CTS3Exception._check_error(
        _MPuLib.MPC_SetModulationShape(
...
def MPC_SelectModulationGeneration(pattern_index: int, mode: ModulationShapeMode) -> None:
    """
    ...
    if not isinstance(mode, ModulationShapeMode):
        raise TypeError("mode must be an instance of ModulationShapeMode IntEnum")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectModulationGeneration(c_uint8(pattern_index), c_uint8(mode))
    )
...
def MPC_SelectModulationPattern(
    item_type: ModulationItem, pattern_index: int, start: int, duration: int
) -> None:
    """
    ...
    if not isinstance(item_type, ModulationItem):
        raise TypeError("item_type must be an instance of ModulationItem IntEnum")
    _check_limits(c_uint8, pattern_index, "pattern_index")
    _check_limits(c_uint32, start, "start")
    _check_limits(c_uint32, duration, "duration")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectModulationPattern(
            c_uint8(item_type), c_uint8(pattern_index), c_uint32(start), c_uint32(duration)
        )
    )
...
def MPC_FastFallingEdge(delay_fc: float, duration_fc: float) -> None:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_FastFallingEdge(c_uint8(0), c_uint32(delay_10fc), c_uint32(duration_10fc))
    )
...
def MPC_SetDeafTime(deaf_time: float) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SetDeafTime(c_uint8(0), c_uint32(deaf_time_us)))
...
def MPS_AntiTearing(clock_count: int) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPS_AntiTearing(c_uint8(0), c_uint32(clock_count)))


def MPS_AntiTearing2() -> None:
    """Deactivates RF field during communication upon rising edge on SYNC connector"""
    CTS3Exception._check_error(_MPuLib.MPS_AntiTearing2(c_uint8(0), c_uint32(2), c_uint32(0)))
...
def MPC_ChangeProtocolParameters(
    ...
    param_value: Union[int, float, bool, ConnectorState, List[int], List[float]],
) -> None:
    """
    ...
    if not isinstance(param_type, ProtocolParameters):
        raise TypeError("param_type must be an instance of ProtocolParameters IntEnum")
    if (
        param_type == ProtocolParameters.CPP_CURRENT_CID
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), byref(int_val), c_uint32(1)
            )
        )

    # List parameter
    elif (
        param_type == ProtocolParameters.CPP_FRAME_TYPE_B
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(4)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(2)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(14)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(8)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u32_val, c_uint32(3)
            )
        )

    # Boolean parameter
    elif (
        param_type == ProtocolParameters.CPP_CID
        ...
        or param_type == (ProtocolParameters.CPP_RF_FIELD_STRENGTH_COMPATIBILITY)
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), byref(int_val), c_uint32(4)
            )
        )

    # ms/mdB/mV parameter
    elif (
        param_type == ProtocolParameters.CPP_PROTOCOL_STOP_TIMEOUT
    ...
    # ConnectorState parameter
        ...
        param_type == ProtocolParameters.CPP_LMA_OUTPUT
        or param_type == ProtocolParameters.CPP_VDC_INPUT
    ):
        if not isinstance(param_value, ConnectorState):
            raise TypeError("param_value must be an instance of ConnectorState IntEnum")
        int_val = c_uint32(param_value)
        CTS3Exception._check_error(
            _MPuLib.MPC_ChangeProtocolParameters(
                c_uint8(0), c_uint32(param_type), byref(int_val), c_uint32(4)
...
def MPC_GetProtocolParameters(
    ...
    if (
        ...
        int8_val = c_uint8()
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), byref(int8_val), c_uint32(1), byref(param_size)
            )
        )
    ...
    # List parameter
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(8), byref(param_size)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(4), byref(param_size)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(28), byref(param_size)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u16_val, c_uint32(16), byref(param_size)
            )
        )
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), list_u32_val, c_uint32(12), byref(param_size)
            )
        )
    ...
    # Boolean parameter
        ...
        CTS3Exception._check_error(
            _MPuLib.MPC_GetProtocolParameters(
                c_uint8(0), c_uint32(param_type), byref(int_val), c_uint32(1), byref(param_size)
            )
        )
...
def MPC_SelectRxChannel(channel: RxChannel) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_SelectRxChannel(c_uint8(0), c_uint16(channel)))
...
def MPC_SelectRxGainExt(gain_type: RxGainType, value: int) -> None:
    ...
    _check_limits(c_uint32, value, "value")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectRxGainExt(c_uint8(0), c_uint32(gain_type), c_uint32(value))
    )
...
def MPC_GetRxGainExternalRx() -> int:
    ...
    """
    gain = c_uint32()
    CTS3Exception._check_error(_MPuLib.MPC_GetRxGainExternalRx(c_uint8(0), byref(gain)))
    return gain.value
...
def MPC_GetDemodThreshold() -> Dict[str, int]:
    ...
    average = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_GetDemodThreshold(c_uint8(0), byref(threshold), byref(average))
    )
...
def MPC_ForceGainExtRx(gain: int) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_ForceGainExtRx(c_uint8(0), c_uint32(gain)))
...
@overload
def MPC_Test(test_type: TestType, reset_time: float, time_1: float, time_2: float) -> bytes:
...
@overload
def MPC_Test(
    test_type: TestType, param: Union[int, float], delay: float, tx_bits: int, tx_frame: bytes
) -> Dict[str, Union[int, bytes]]:
...
def MPC_Test(test_type, *args):  # type: ignore[no-untyped-def]
    ...
    if (
        test_type == TestType.TEST_REQA_REQB
        ...
        if len(args) != 1:
            raise TypeError(
                f"MPC_Test({test_type.name}) takes exactly two arguments ({len(args) + 1} given)"
            )
        ...
        test_type == TestType.TEST_REQB_REQA
        ...
        test_type == TestType.TEST_FDT_PICCPCD_A
        ...
        if len(args) != 3:
            raise TypeError(
                f"MPC_Test({test_type.name}) takes exactly four arguments ({len(args) + 1} given)"
            )
        if not isinstance(args[0], float) and not isinstance(args[0], int):
        ...
        if len(args) != 4:
            raise TypeError(
                f"MPC_Test({test_type.name}) takes exactly five arguments ({len(args) + 1} given)"
            )
        if not isinstance(args[0], float) and not isinstance(args[0], int):
        ...
        if len(args) != 10:
            raise TypeError(
                f"MPC_Test({test_type.name}) takes exactly eleven arguments ({len(args) + 1} given)"
            )
        if not isinstance(args[0], float) and not isinstance(args[0], int):
            raise TypeError("reset_time must be an instance of float")
        ...
        if not isinstance(args[3], TechnologyType):
            raise TypeError("type_odd must be an instance of TechnologyType IntEnum")
        if not isinstance(args[4], int):
        ...
        if not isinstance(args[6], TechnologyType):
            raise TypeError("type_even must be an instance of TechnologyType IntEnum")
...
def MPC_PiccResponseTime2(param: ResponseTimeAction, unit: NfcUnit) -> List[int]:
    """
    ...
    if not isinstance(param, ResponseTimeAction):
        raise TypeError("param must be an instance of ResponseTimeAction IntEnum")
    if not isinstance(unit, NfcUnit):
        raise TypeError("unit must be an instance of NfcUnit IntEnum")
    measurement = (c_uint32 * 10)()
    nb_meas = c_uint32()
    CTS3Exception._check_error(
        _MPuLib.MPC_PiccResponseTime2(
            c_uint8(0), c_uint32(param), c_uint32(unit), measurement, byref(nb_meas)
        )
    )
    if nb_meas.value:
...
def MPC_GetTrigger(trigger: InputTriggerNum) -> bool:
    ...
    if not isinstance(trigger, InputTriggerNum):
        raise TypeError("trigger must be an instance of InputTriggerNum IntEnum")
    status = c_uint32()
    CTS3Exception._check_error(_MPuLib.MPC_GetTrigger(c_uint8(0), c_uint8(trigger), byref(status)))
...
def MPC_TriggerConfig(
    ...
    if not isinstance(trigger_id, NfcTriggerId):
        raise TypeError("trigger_id must be an instance of NfcTriggerId IntFlag")
    ...
    if config == NfcTrigger.TRIG_FORCE:
        ...
        if not isinstance(value, CTS3ErrorCode):
            raise TypeError("value must be an instance of CTS3ErrorCode IntEnum")
        val = value.value
    elif config == NfcTrigger.TRIG_RX_FRAME or config == NfcTrigger.TRIG_TX_FRAME:
        if not isinstance(value, TechnologyType):
            raise TypeError("value must be an instance of TechnologyType IntEnum")
        val = value.value
    else:
        val = 0
...
def MPC_GenerateDisturbance(
    ...
    offset: float,
    duration: float,
    param: Union[None, bool, int] = None,
) -> None:
    """
    ...
    if not isinstance(operation, DisturbanceOperation):
        raise TypeError("operation must be an instance of DisturbanceOperation IntEnum")
    if not isinstance(disturbance_type, DisturbanceType):
        raise TypeError("disturbance_type must be an instance of DisturbanceType IntEnum")
    ...
    if disturbance_type == DisturbanceType.DISTURBANCE_RAMP:
        ...
        disturbance_type == DisturbanceType.DISTURBANCE_SQUARE
...
def MPC_LoadDisturbanceWaveshape(
    operation: DisturbanceOperation, timebase: int, data: List[float]
) -> None:
    """
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_LoadDisturbanceWaveshape(
            c_uint8(0), c_uint8(operation), c_uint32(timebase), c_uint32(len(data)), data_array
        )
    )


def MPC_SetDisturbanceTrigger(
    operation: DisturbanceOperation, trigger: NfcTrigger, delay: float = 0, count: int = 1
) -> None:
    """
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_SetDisturbanceTrigger(
            c_uint8(0), c_uint8(operation), c_uint32(trigger), c_uint32(delay_ns), c_uint16(count)
        )
    )
...
def MPC_ResetDisturbance() -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPC_ResetDisturbance(c_uint8(0), c_uint8(0)))
...
def MPS_CPLAutoTest(test_id: CplAutotestId = CplAutotestId.TEST_CPL_ALL) -> List[List[str]]:
    """
    ...
    result = c_char_p()
    ret = CTS3ErrorCode(
        _MPuLib.MPS_CPLAutoTest(
            c_uint8(0), c_uint32(test_id), c_bool(True), c_uint32(0), c_uint32(0), byref(result)
        )
    )
    if (
...
def MPC_ComputeCrc(card_type: TechnologyType, frame: bytes) -> bytes:
    ...
    crc2 = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_ComputeCrc(
            c_uint8(0), c_int32(card_type), frame, c_uint32(len(frame)), byref(crc1), byref(crc2)
        )
    )
...
def MPC_CheckCRCFrame(card_type: TechnologyType, frame: bytes) -> bool:
    ...
    _check_limits(c_uint32, len(frame), "frame")
    ret = CTS3ErrorCode(
        _MPuLib.MPC_CheckCRCFrame(c_uint8(0), c_int32(card_type), frame, c_uint32(len(frame)))
    )
    if (
        ret == CTS3ErrorCode.ERR_RX_FRAME_CRCA
...
def MPC_SelectInputImpedanceAnalogIn(impedance: InputImpedance) -> None:
    ...
    if not isinstance(impedance, InputImpedance):
        raise TypeError("impedance must be an instance of InputImpedance IntEnum")
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectInputImpedanceAnalogIn(c_uint8(0), c_uint32(impedance))
    )
...
def MPS_Counter(command: CounterCommand) -> int:
    ...
    if not isinstance(command, CounterCommand):
        raise TypeError("command must be an instance of CounterCommand IntEnum")
    counter = c_uint32()
    CTS3Exception._check_error(_MPuLib.MPS_Counter(c_uint8(0), c_uint32(command), byref(counter)))
...
def MPC_NfcConfiguration(mode: NfcMode, initiator: bool, data_rate: NfcDataRate) -> None:
    """
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_NfcConfiguration(
            c_uint8(0), c_uint8(mode), c_uint8(1) if initiator else c_uint8(2), c_uint16(data_rate)
        )
    )
...
def MPC_SensReq() -> bytes:
    ...
    """
    sens_res = c_uint16()
    CTS3Exception._check_error(_MPuLib.MPC_SensReq(c_uint8(0), byref(sens_res)))
...
def MPC_Sdd() -> Dict[str, bytes]:
    ...
    length = c_uint16()
    sel_res = c_uint8()
    CTS3Exception._check_error(_MPuLib.MPC_Sdd(c_uint8(0), data, byref(length), byref(sel_res)))
...
def MPC_SelReq(nfc_id1: bytes) -> bytes:
    ...
    sel_res = c_uint8()
    CTS3Exception._check_error(
        _MPuLib.MPC_SelReq(c_uint8(0), nfc_id1, c_uint16(len(nfc_id1)), byref(sel_res))
    )
...
def MPC_PollReq(
    system_code: Union[bytes, int], rc: Union[bytes, int], tsn: Union[bytes, int]
) -> Dict[str, bytes]:
    """
    ...
    return {"nfc_id2": nfc_id2, "pad": pad, "rd": bytes([rd.value >> 8, rd.value & 0xFF])}
...
def MPC_AtrReq(atr_req: bytes) -> bytes:
    ...
    length = c_uint16()
    CTS3Exception._check_error(
        _MPuLib.MPC_AtrReq(c_uint8(0), atr_req, c_uint16(len(atr_req)), data, byref(length))
    )
    return data[: length.value]
...
def MPC_ExchangeNFCData(command: bytes) -> bytes:
    ...
    if command:
        CTS3Exception._check_error(
            _MPuLib.MPC_ExchangeNFCData(
                c_uint8(0), command, c_uint16(len(command)), data, byref(length)
            )
        )
    else:
        CTS3Exception._check_error(
            _MPuLib.MPC_ExchangeNFCData(c_uint8(0), None, c_uint16(0), data, byref(length))
        )
    return data[: length.value]
...
def MPC_DepReq(command: bytes) -> bytes:
    ...
    length = c_uint32()
    CTS3Exception._check_error(
        _MPuLib.MPC_DepReq(c_uint8(0), command, c_uint32(len(command)), data, byref(length))
    )
    return data[: length.value]
...
def MPC_NfcWaitAndGetFrameAsTarget(timeout: float) -> bytes:
    ...
    length = c_uint32()
    CTS3Exception._check_error(
        _MPuLib.MPC_NfcWaitAndGetFrameAsTarget(
            c_uint8(0), c_uint32(timeout_ms), data, c_uint32(0), byref(length)
        )
    )
    return data[: length.value]
...
def MPC_NfcRFCollisionAvoidance(unit: FieldUnit, value: float) -> None:
    ...
    if unit == FieldUnit.APPLY_DEFAULT_VALUE:
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcRFCollisionAvoidance(c_uint8(0), c_uint8(unit), c_int16(0))
        )
    elif unit == FieldUnit.UNIT_PER_CENT:
        value_pm = round(value * 1e1)
        _check_limits(c_int16, value_pm, "value")
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcRFCollisionAvoidance(
                c_uint8(0), c_uint8(FieldUnit.UNIT_PER_MILLE), c_int16(value_pm)
            )
        )
    elif (
        unit == FieldUnit.UNIT_PER_MILLE
        ...
        _check_limits(c_int16, value_pm, "value")
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcRFCollisionAvoidance(c_uint8(0), c_uint8(unit), c_int16(value_pm))
        )
    else:  # mV
        value_mV = round(value)
        _check_limits(c_int16, value_mV, "value")
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcRFCollisionAvoidance(c_uint8(0), c_uint8(unit), c_int16(value_mV))
        )
...
def MPC_NfcSendFrameAsTarget(tx_frame: bytes, timeout: float = 0) -> None:
    ...
    if tx_frame:
        ...
        _check_limits(c_uint32, len(tx_frame), "tx_frame")
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcSendFrameAsTarget(
                c_uint8(0), c_uint32(timeout_us), tx_frame, c_uint32(len(tx_frame))
            )
        )
    else:
        CTS3Exception._check_error(
            _MPuLib.MPC_NfcSendFrameAsTarget(c_uint8(0), c_uint32(timeout_us), None, c_uint32(0))
        )
...
def MPS_OpenLog() -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPS_OpenLog(c_uint8(0), c_uint32(0), c_uint32(0)))
...
def MPS_SpyChangeParameters(param: SpyParameter, value: int) -> None:
    ...
    _check_limits(c_uint32, value, "value")
    CTS3Exception._check_error(
        _MPuLib.MPS_SpyChangeParameters(c_uint8(0), c_uint32(param), c_uint32(value))
    )
...
def MPS_SpyGetParameters(param: SpyParameter) -> int:
    ...
    value = c_uint32()
    CTS3Exception._check_error(
        _MPuLib.MPS_SpyGetParameters(c_uint8(0), c_uint32(param), byref(value))
    )
    return value.value
...
def MPS_SetUserEvent(user_event_number: int) -> None:
    ...
    CTS3Exception._check_error(_MPuLib.MPS_SetUserEvent(c_uint8(0), c_uint8(user_event_number)))
...
def BeginDownload(call_back: Callable[[int, int, bytes, int], int]) -> None:
    ...
    if len(host) > 0:
        cmp_func = CFUNCTYPE(c_int32, c_uint32, c_uint32, POINTER(c_uint8), c_size_t)
        _callback_dict[host] = cmp_func(call_back)
        ret = _MPuLib.BeginDownload(c_uint8(0), _callback_dict[host], c_uint32(0), c_int(0))
        if ret == CTS3ErrorCode.RET_UNKNOWN_COMMAND.value:
            # For compatibility with MP500
            ret = _MPuLib.StartDownload(c_uint8(0), _callback_dict[host], c_uint32(0), c_int(0))
        CTS3Exception._check_error(ret)
    else:
...
def MPC_SetDefaultParameters(
    card_type: TechnologyType, param_id: DefaultParameterType, param_value: int
) -> None:
    """
    ...
    if not isinstance(param_id, DefaultParameterType):
        raise TypeError("param_id must be an instance of DefaultParameterType IntEnum")
    _check_limits(c_uint32, param_value, "param_value")
    CTS3Exception._check_error(
        _MPuLib.MPC_SetDefaultParameters(
            c_uint8(0),
            c_uint8(card_type),
            c_uint32(param_id),
...
def MPC_GetDefaultParameters(card_type: TechnologyType, param_id: DefaultParameterType) -> int:
    """
    ...
    size = c_uint32(4)
    CTS3Exception._check_error(
        _MPuLib.MPC_GetDefaultParameters(
            c_uint8(0), c_uint8(card_type), c_uint32(param_id), byref(param_value), byref(size)
        )
    )
...
def MPS_GetInternalParameter(param_type: InternalParameterType) -> int:
    ...
    if not isinstance(param_type, InternalParameterType):
        raise TypeError("param_type must be an instance of InternalParameterType IntEnum")
    param_value = c_uint32()
    CTS3Exception._check_error(
        _MPuLib.MPS_GetInternalParameter(
            c_uint8(0), c_uint32(param_type), c_uint32(0), byref(param_value)
        )
    )
    return param_value.value
...
def MPC_SelectPhaseDriftLimits(
    ...
    """
    CTS3Exception._check_error(
        _MPuLib.MPC_SelectPhaseDriftLimits(
            c_uint8(0), c_double(intra_modulation), c_double(inter_modulations), c_double(frame)
        )
    )
...
def MPC_GetPhaseDrifts() -> Dict[str, List[float]]:
    ...
    frame = (c_double * 10)()
    CTS3Exception._check_error(
        _MPuLib.MPC_GetPhaseDrifts(c_uint8(0), byref(nb_meas), intra, inter, frame)
    )
    if nb_meas.value:
        return {
