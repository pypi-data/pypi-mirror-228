...
from utils.log.conf import OutputConfig

from utils.log.mp_handler import MultiProcessingHandler
from utils.log.noun import LogLevel, _DefaultFileName, LevelToLoggingLevel
from utils.log.writer import BaseWriter, ConsoleWriter, FileWriter
...
class LoggingLogger(BaseLogger):
    def __init__(self, writers: List[BaseWriter]):
        ...
        for writer in writers:
            ...
            # self.logger.addHandler(writer.handler)
