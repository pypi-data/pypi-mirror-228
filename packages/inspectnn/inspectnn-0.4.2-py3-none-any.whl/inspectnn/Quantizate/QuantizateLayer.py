...
class QuantizateLayer(BaseLayer):
    ...
    def forward_pass_input(self, inputv):
        ...
        #print(self.name,"input",A_global_mem.copy_to_host()[0][0])
        ...
        #print(self.name,"out",self.results.copy_to_host()[7])
    ...
    def load_weights(self, **kwargs):
        ...
        if self.enable_gpu:
            ...
            self.results = cuda.device_array(self.output_shape, dtype=np.int32)#int16 o 8
