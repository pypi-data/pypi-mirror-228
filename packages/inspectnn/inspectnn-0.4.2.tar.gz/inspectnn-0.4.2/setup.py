...
setup(
    ...
    python_requires='>=3.9.16',#3.11 o 3.12
    #numba 0.57.0rc1 va con python 3.11 e numpy 1.24
    install_requires=["tensorflow==2.12", "protobuf","numpy==1.23.5","numba==0.57.1","scipy==1.10.1","scikit-learn"],#fare -U pymoo
    project_urls={
