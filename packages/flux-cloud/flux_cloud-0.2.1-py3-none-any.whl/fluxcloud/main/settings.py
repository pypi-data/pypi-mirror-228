...
class UserSettings:
    ...
    def validate(self):
        ...
        """
        jsonschema.validate(
            instance=self._settings, schema=fluxcloud.main.schemas.settings
        )
    ...
    def add(self, key, value):
        ...
        if value not in current:
            ...
            logger.warning(
                "Warning: Check with fluxcloud config edit - ordering of list can change."
            )
