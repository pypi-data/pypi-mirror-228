...
def get_args():
    ...
    parser.add_argument("--destination-filename", dest="destination_filename", required=True)
...
def main():  # sourcery skip: extract-method
    ...
    try:
        ...
        export_id = client.export_list(export_name=args.export_name,
                                       list_id=args.list_id,
                                       object_properties=object_properties).get("id")
        ...
        download_export(export_details.get("result"), f"{args.destination_filename}.csv")
