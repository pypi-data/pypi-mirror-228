...
class Serializer(base.Serializer):
    ...
    can be executed.  Use :cmd:`pm dump2py` instead.
...
class DpyDeserializer(LoaderBase):
    ...
    not, as `documented
    <https://docs.djangoproject.com/en/4.1/howto/initial-data/#where-django-finds-fixture-files>`__,
...
def Deserializer(fp, **options):
    ...
    <https://docs.djangoproject.com/en/4.1/ref/settings/#serialization-modules>`__.
