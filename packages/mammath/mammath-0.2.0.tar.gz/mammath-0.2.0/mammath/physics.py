...
def apparent_magnitude_binary(m1, m2):
    """
    Calculates the apparent magnitude of a binary star system using m_1-m_0 = -2.5log(F1/F0) with a reference star
    """
    flux_1 = 10**(m1/-2.5)
    flux_2 = 10**(m2/-2.5)
    f_total = flux_1+flux_2
    return -2.5*log(f_total, 10)
