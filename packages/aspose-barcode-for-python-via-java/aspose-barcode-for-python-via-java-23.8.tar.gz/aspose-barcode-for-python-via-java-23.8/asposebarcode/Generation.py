...
class BarcodeGenerator(Assist.BaseJavaClass):
     ...
     2D:<br>
      ...
      def __init__(self, encodeType, codeText):
            """!
            BarcodeGenerator constructor.<br>
...
class Code128Emulation:
      """!
          Function codewords for Code 128 emulation. Applied for MicroPDF417 only. Ignored for PDF417 and MacroPDF417 barcodes.
            ...
            CODE_903 = 903 - UCC/EAN-128 emulation. Text compactionmode implied.
            CODE_904 = 904 - UCC/EAN-128 emulation. Numeric compactionmode implied.
            CODE_905 = 905 - UCC/EAN-128 emulation. Implied '01' AI and 14-digit codetext.
            """
...
class TwoDComponentType(Enum):
      ...
      \code
      codetext = "(01)03212345678906/(21)A1B2C3D4E5F6G7H8";
      BarcodeGenerator generator = BarcodeGenerator(EncodeTypes.GS_1_COMPOSITE_BAR, codetext);
