...
from azureml.metrics import _rag_evaluation
...
def get_metric_class(metric_name):
    ...
    qa_classes = {
        ...
        constants.Metric.GPTGroundedness: _seq2seq_qa.GPTGroundedness,
    ...
    rag_evaluation_classes = {
        constants.Metric.GroundingScore: _rag_evaluation.GroundingScore,
        constants.Metric.GenerationScore: _rag_evaluation.GenerationScore,
        constants.Metric.RetrievalScore: _rag_evaluation.RetrievalScore,
    }
