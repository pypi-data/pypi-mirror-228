...
from arthurai.common.constants import ValueType, Stage, InputType, OutputType, ImageResponseType, ImageContentType, \
    ModelStatus, ONBOARDING_SPINNER_MESSAGE, ONBOARDING_UPDATE_MESSAGE
from arthurai.common.exceptions import UserValueError, MethodNotApplicableError, ArthurUnexpectedError, UserTypeError
from arthurai.core.attributes import AttributeCategory, AttributeBin, ArthurAttribute
from arthurai.core.dataset_validation_utils import validate_series_data_type, ensure_obj_matches_attr_value_type, \
    validate_attr_names
from arthurai.core.models import ArthurModel, ArthurModelGroup
from http import HTTPStatus
from mock import patch, mock_open, MagicMock
from tests.helpers import assert_attributes_equal, mock_post, mock_get, mock_patch
from tests.fixtures.models import regression as reg, multiclass as mclass, nlp
...
from tests.fixtures.models.multiclass import initial_biclass_model, SAMPLE_DATAFRAME_NO_NEG_PRED, \
...
def test_save_model_with_refset(reg_unsaved_batch_model):
    ...
    with patch('arthurai.core.model_status_waiter.ModelStatusWaiter.wait_for_valid_model_status',
...
def test_save_model_provisioning_failed(reg_unsaved_batch_model):
    ...
    with pytest.raises(ArthurUnexpectedError), \
            patch('arthurai.core.model_status_waiter.ModelStatusWaiter.wait_for_valid_model_status',
...
@pytest.mark.parametrize('obj,attr,expected', [
    ...
    ([["str"]], token_likelihoods_attr, False), ([], tokens_attr, "warning"),  # warning test cases
    ([None, None], tokens_attr, "warning"), ([{}], token_likelihoods_attr, "warning"),
    ([{None: 0.8}], token_likelihoods_attr, "warning"), ([{"str": None}], token_likelihoods_attr, "warning"),
    ([[None, None, None, None, None, None]], bounding_box_attr, "warning"), ([[]], bounding_box_attr, "warning"),
    ([], bounding_box_attr, "warning"), ([None, None], bounding_box_attr, "warning"),
    ([[None, None]], bounding_box_attr, False), ([{None: None}], token_likelihoods_attr, "warning"),
...
@pytest.mark.parametrize('series,attr,expected',
                         [([1, 0.1], float_attr, True), ([1, 2], int_attr, True),
                          ...
                          ([str(datetime.now())], str_attr, False), ([None, 12, None], float_attr, False),
                          ([None, 0.4, None], float_attr, True), ([None, 12, None], int_attr, True)])
...
@pytest.mark.parametrize('df,error_expected,attr_changes,data_changes',
     [
         ...
         (datetime_valid_df, True, [("DATETIME_VALID", ValueType.String)], {"DATETIME_VALID": str}),  # tests valid tz aware datetime obj passed as strings errors
         (datetime_invalid_df, True, [("DATETIME_INVALID", ValueType.Timestamp)], None),  # tests Datetime obj not timezone aware errors
         (datetime_invalid_df, True, [("DATETIME_INVALID", ValueType.String)], None),  # tests col of Datetime objects not tz aware and expected as str attr errors
         (datetime_invalid_df, True, [("DATETIME_INVALID", ValueType.Timestamp)], {"DATETIME_INVALID": str}),  # tests col of not tz aware datetime obj passed as strings expected as timestamp attr  errors
         (datetime_invalid_df, True, [("DATETIME_INVALID", ValueType.String)], {"DATETIME_INVALID": str}),  # tests col of not tz aware datetime obj passed as strings expected as str attr errors
         (non_dt_timestamps_df, True, [("TIMESTAMPS_INVALID", ValueType.String)], None),  # tests col of non-datetime timestamp strings errors
         (numpy_floats_df, False, [("FLOATS", ValueType.Float)], None),  # tests valid numpy types pass
         (weird_indices_df, False, None, None),
         (bounding_df, False, [("image", ValueType.Image), ("pred_bounding_box_column", ValueType.BoundingBox), ('gt_bounding_box_column', ValueType.BoundingBox)], None),  # tests models with boundingbox cols
         (bounding_df, True, [("image", ValueType.BoundingBox), ("pred_bounding_box_column", ValueType.BoundingBox), ('gt_bounding_box_column', ValueType.BoundingBox)], None),
         (bounding_df, True, [("image", ValueType.Image), ("pred_bounding_box_column", ValueType.String), ('gt_bounding_box_column', ValueType.BoundingBox)], None),
         ...
         (nlp_df_3, True, [("input_text", ValueType.Unstructured_Text), ('output_probs', ValueType.TokenLikelihoods)], {'output_probs': str}),
