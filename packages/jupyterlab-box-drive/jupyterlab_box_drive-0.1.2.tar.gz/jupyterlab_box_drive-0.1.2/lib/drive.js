...
export class BoxDrive {
    ...
    async get_file_id(path) {
        var _a, _b;
        let id = (_a = this._boxPathMap.get(path)) === null || _a === void 0 ? void 0 : _a.id;
        if (id) {
            return id;
        }
        let dirname = PathExt.dirname(path);
        ...
        id = (_b = this._boxPathMap.get(path)) === null || _b === void 0 ? void 0 : _b.id;
        if (id) {
            return id;
        }
        throw new Error('ID not found for path');
    }
    build_and_set_to_map(dirpath, name, id, isdir) {
