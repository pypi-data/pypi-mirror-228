...
#     sql="select avg(osmid) from osm_nod2e where osmid between 80080000 and 90080000;",
#     worker_limit=10,
#     split_size=256
# )
# print(job_id)
...
# get job status
job_status = citybrain_platform.Computing.get_job_status(job_id="32042c77-d926-4b8a-bf8a-7563533445f8")
print(job_status)
