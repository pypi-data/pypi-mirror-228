        ...
        if path.exists(date_folder_path):
            ...
            if not path.exists(day_file_save_path):
                ...
                if hours_with_target_file != 0:
                    ...
                    df_participant["EVENT_TIMESTAMP"] = [convert_readable_time_list_to_timestamp(x) for x in
                                                         df_participant["EVENT_TIME"]]

                    # step 3:  write out day file for participant
                    df_participant = df_participant[
                        ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", "LOG_TIME", "EVENT_TIME", "EVENT_TIMESTAMP",
