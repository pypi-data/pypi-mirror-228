            ...
            if not path.exists(day_file_save_path):
                ...
                if hours_with_target_file != 0:
                    ...
                    df_participant = df_participant[
                        ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", "LOG_TIME", "LOG_TIMESTAMP", 'Percentage', 'isCharging', 'isUSBCharging', 'isACCharging', 'isWirelessCharging']]
                    ...
                    if not os.path.exists(day_file_name_battery_minute):
                        ...
                        df_battery_minute = df_battery_minute[
                            ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", "YEAR", "MONTH","DAY", "HOUR", "MINUTE", "BATTERY_LEVEL", "CHARGING_STATUS"]]
                        ...
                        df_battery_hour = df_battery_hour[
                            ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", "YEAR", "MONTH","DAY", "HOUR", "AVERAGE_BATTERY_LEVEL", "CHARGING_MINUTES", "CHARGING_STATES_MISSING_MINUTES"]]
                        ...
                        df_battery_day = df_battery_day[
                            ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", "YEAR", "MONTH","DAY", "AVERAGE_BATTERY_LEVEL", "CHARGING_MINUTES", "CHARGING_STATES_MISSING_MINUTES"]]
