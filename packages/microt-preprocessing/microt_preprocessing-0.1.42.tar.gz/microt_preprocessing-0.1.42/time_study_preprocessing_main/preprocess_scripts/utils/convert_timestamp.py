...
def convert_readable_time_list_to_timestamp(readable_time):
    time_zone = readable_time.split(" ")[2]
    time_delta, sign = get_time_offset(time_zone)
    if time_zone == "unknownTZ" or sign == 0:
        timestamp_str = ["unknown time zone"] * len(readable_time)
    else:
...
if __name__ == "__main__":
    ...
    print(convert_readable_time_list_to_timestamp(readable_time))
