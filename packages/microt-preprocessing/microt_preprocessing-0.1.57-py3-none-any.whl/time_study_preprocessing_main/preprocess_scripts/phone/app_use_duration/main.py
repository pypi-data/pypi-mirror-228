            ...
            if not path.exists(day_file_save_path):
                ...
                if hours_with_target_file != 0:
                    ...
                    df_participant = df_participant[
                        ["PARTICIPANT_ID_TEXT", "PARTICIPANT_ID_NUMERIC", 'LOG_TIME', 'START_TIMESTAMP', 'START_TIME',
                         'STOP_TIMESTAMP', 'STOP_TIME',
                         'APP_PACKAGE_NAME', 'USAGE_DURATION_MIN']]
