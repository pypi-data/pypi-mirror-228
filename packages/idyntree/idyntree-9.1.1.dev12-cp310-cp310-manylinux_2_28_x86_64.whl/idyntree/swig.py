...
SHARED_PTR_DISOWN = _iDynTree.SHARED_PTR_DISOWN
...
NoJointDynamics = _iDynTree.NoJointDynamics
URDFJointDynamics = _iDynTree.URDFJointDynamics
class IJoint(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    def getJointDynamicsType(self):
        return _iDynTree.IJoint_getJointDynamicsType(self)

    def setJointDynamicsType(self, enable):
        return _iDynTree.IJoint_setJointDynamicsType(self, enable)

    def setDamping(self, _index, damping):
        return _iDynTree.IJoint_setDamping(self, _index, damping)

    def setStaticFriction(self, _index, staticFriction):
        return _iDynTree.IJoint_setStaticFriction(self, _index, staticFriction)

    def getDamping(self, _index):
        return _iDynTree.IJoint_getDamping(self, _index)

    def getStaticFriction(self, _index):
        return _iDynTree.IJoint_getStaticFriction(self, _index)
...
class FixedJoint(IJoint):
    ...
    def getJointDynamicsType(self):
        return _iDynTree.FixedJoint_getJointDynamicsType(self)

    def setJointDynamicsType(self, enable):
        return _iDynTree.FixedJoint_setJointDynamicsType(self, enable)

    def getDamping(self, _index):
        return _iDynTree.FixedJoint_getDamping(self, _index)

    def getStaticFriction(self, _index):
        return _iDynTree.FixedJoint_getStaticFriction(self, _index)

    def setDamping(self, _index, damping):
        return _iDynTree.FixedJoint_setDamping(self, _index, damping)

    def setStaticFriction(self, _index, staticFriction):
        return _iDynTree.FixedJoint_setStaticFriction(self, _index, staticFriction)
...
class RevoluteJoint(MovableJointImpl1):
    ...
    def getJointDynamicsType(self):
        return _iDynTree.RevoluteJoint_getJointDynamicsType(self)

    def setJointDynamicsType(self, enable):
        return _iDynTree.RevoluteJoint_setJointDynamicsType(self, enable)

    def getDamping(self, _index):
        return _iDynTree.RevoluteJoint_getDamping(self, _index)

    def getStaticFriction(self, _index):
        return _iDynTree.RevoluteJoint_getStaticFriction(self, _index)

    def setDamping(self, _index, damping):
        return _iDynTree.RevoluteJoint_setDamping(self, _index, damping)

    def setStaticFriction(self, _index, staticFriction):
        return _iDynTree.RevoluteJoint_setStaticFriction(self, _index, staticFriction)
...
class PrismaticJoint(MovableJointImpl1):
    ...
    def getJointDynamicsType(self):
        return _iDynTree.PrismaticJoint_getJointDynamicsType(self)

    def setJointDynamicsType(self, enable):
        return _iDynTree.PrismaticJoint_setJointDynamicsType(self, enable)

    def getDamping(self, _index):
        return _iDynTree.PrismaticJoint_getDamping(self, _index)

    def getStaticFriction(self, _index):
        return _iDynTree.PrismaticJoint_getStaticFriction(self, _index)

    def setDamping(self, _index, damping):
        return _iDynTree.PrismaticJoint_setDamping(self, _index, damping)

    def setStaticFriction(self, _index, staticFriction):
        return _iDynTree.PrismaticJoint_setStaticFriction(self, _index, staticFriction)
...
class ExternalMesh(SolidShape):
    ...
    def getPackageDirs(self):
        return _iDynTree.ExternalMesh_getPackageDirs(self)
    ...
    def setPackageDirs(self, packageDirs):
        return _iDynTree.ExternalMesh_setPackageDirs(self, packageDirs)
...
class Model(object):
    ...
    def getPackageDirs(self):
        return _iDynTree.Model_getPackageDirs(self)

    def setPackageDirs(self, packageDirs):
        return _iDynTree.Model_setPackageDirs(self, packageDirs)
...
def addRandomLinkToModel(model, parentLink, newLinkName, onlyRevoluteJoints=False):
    return _iDynTree.addRandomLinkToModel(model, parentLink, newLinkName, onlyRevoluteJoints)
...
def getRandomChain(nrOfJoints, nrOfAdditionalFrames=10, onlyRevoluteJoints=False):
    return _iDynTree.getRandomChain(nrOfJoints, nrOfAdditionalFrames, onlyRevoluteJoints)
...
def removeFakeLinks(modelWithFakeLinks, modelWithoutFakeLinks):
    return _iDynTree.removeFakeLinks(modelWithFakeLinks, modelWithoutFakeLinks)

def createReducedModel(fullModel, jointsInReducedModel, reducedModel):
    return _iDynTree.createReducedModel(fullModel, jointsInReducedModel, reducedModel)

def createModelWithNormalizedJointNumbering(model, baseForNormalizedJointNumbering, reducedModel):
    return _iDynTree.createModelWithNormalizedJointNumbering(model, baseForNormalizedJointNumbering, reducedModel)

def extractSubModel(fullModel, subModelTraversal, outputSubModel):
    return _iDynTree.extractSubModel(fullModel, subModelTraversal, outputSubModel)
class SubModelDecomposition(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _iDynTree.SubModelDecomposition_swiginit(self, _iDynTree.new_SubModelDecomposition())
    __swig_destroy__ = _iDynTree.delete_SubModelDecomposition

    def splitModelAlongJoints(self, model, traversal, splitJoints):
        return _iDynTree.SubModelDecomposition_splitModelAlongJoints(self, model, traversal, splitJoints)

    def setNrOfSubModels(self, nrOfSubModels):
        return _iDynTree.SubModelDecomposition_setNrOfSubModels(self, nrOfSubModels)

    def getNrOfSubModels(self):
        return _iDynTree.SubModelDecomposition_getNrOfSubModels(self)

    def getNrOfLinks(self):
        return _iDynTree.SubModelDecomposition_getNrOfLinks(self)

    def getTraversal(self, *args):
        return _iDynTree.SubModelDecomposition_getTraversal(self, *args)

    def getSubModelOfLink(self, link):
        return _iDynTree.SubModelDecomposition_getSubModelOfLink(self, link)

    def getSubModelOfFrame(self, model, frame):
        return _iDynTree.SubModelDecomposition_getSubModelOfFrame(self, model, frame)

# Register SubModelDecomposition in _iDynTree:
_iDynTree.SubModelDecomposition_swigregister(SubModelDecomposition)

def computeTransformToTraversalBase(fullModel, traversal, jointPos, traversalBase_H_link):
    return _iDynTree.computeTransformToTraversalBase(fullModel, traversal, jointPos, traversalBase_H_link)

def computeTransformToSubModelBase(fullModel, subModelDecomposition, jointPos, subModelBase_H_link):
    return _iDynTree.computeTransformToSubModelBase(fullModel, subModelDecomposition, jointPos, subModelBase_H_link)
...
class DHLink(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    A = property(_iDynTree.DHLink_A_get, _iDynTree.DHLink_A_set)
    D = property(_iDynTree.DHLink_D_get, _iDynTree.DHLink_D_set)
    Alpha = property(_iDynTree.DHLink_Alpha_get, _iDynTree.DHLink_Alpha_set)
    Offset = property(_iDynTree.DHLink_Offset_get, _iDynTree.DHLink_Offset_set)
    Min = property(_iDynTree.DHLink_Min_get, _iDynTree.DHLink_Min_set)
    Max = property(_iDynTree.DHLink_Max_get, _iDynTree.DHLink_Max_set)

    def __init__(self):
        _iDynTree.DHLink_swiginit(self, _iDynTree.new_DHLink())
    __swig_destroy__ = _iDynTree.delete_DHLink

# Register DHLink in _iDynTree:
_iDynTree.DHLink_swigregister(DHLink)
class DHChain(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def setNrOfDOFs(self, nDofs):
        return _iDynTree.DHChain_setNrOfDOFs(self, nDofs)

    def getNrOfDOFs(self):
        return _iDynTree.DHChain_getNrOfDOFs(self)

    def setH0(self, _H0):
        return _iDynTree.DHChain_setH0(self, _H0)

    def getH0(self):
        return _iDynTree.DHChain_getH0(self)

    def setHN(self, _HN):
        return _iDynTree.DHChain_setHN(self, _HN)

    def getHN(self):
        return _iDynTree.DHChain_getHN(self)

    def __call__(self, *args):
        return _iDynTree.DHChain___call__(self, *args)

    def getDOFName(self, dofIdx):
        return _iDynTree.DHChain_getDOFName(self, dofIdx)

    def setDOFName(self, dofIdx, dofName):
        return _iDynTree.DHChain_setDOFName(self, dofIdx, dofName)

    def toModel(self, outputModel):
        return _iDynTree.DHChain_toModel(self, outputModel)

    def fromModel(self, model, baseFrame, eeFrame):
        return _iDynTree.DHChain_fromModel(self, model, baseFrame, eeFrame)

    def __init__(self):
        _iDynTree.DHChain_swiginit(self, _iDynTree.new_DHChain())
    __swig_destroy__ = _iDynTree.delete_DHChain

# Register DHChain in _iDynTree:
_iDynTree.DHChain_swigregister(DHChain)

def TransformFromDHCraig1989(a, alpha, d, theta):
    return _iDynTree.TransformFromDHCraig1989(a, alpha, d, theta)

def TransformFromDH(a, alpha, d, theta):
    return _iDynTree.TransformFromDH(a, alpha, d, theta)

def ExtractDHChainFromModel(model, baseFrame, eeFrame, outputChain, tolerance=1e-5):
    return _iDynTree.ExtractDHChainFromModel(model, baseFrame, eeFrame, outputChain, tolerance)

def CreateModelFromDHChain(inputChain, outputModel):
    return _iDynTree.CreateModelFromDHChain(inputChain, outputModel)
...
class ModelExporterOptions(object):
    ...
    xmlBlobs = property(_iDynTree.ModelExporterOptions_xmlBlobs_get, _iDynTree.ModelExporterOptions_xmlBlobs_set)
...
class ExtWrenchesAndJointTorquesEstimator(object):
    ...
    def computeSubModelMatrixRelatingFTSensorsMeasuresAndKinematics(self, unknowns, A, b, subModelID, baseLinkIndeces):
        return _iDynTree.ExtWrenchesAndJointTorquesEstimator_computeSubModelMatrixRelatingFTSensorsMeasuresAndKinematics(self, unknowns, A, b, subModelID, baseLinkIndeces)
...
BERDY_FLOATING_BASE_NON_COLLOCATED_EXT_WRENCHES = _iDynTree.BERDY_FLOATING_BASE_NON_COLLOCATED_EXT_WRENCHES
...
RCM_SENSOR = _iDynTree.RCM_SENSOR
...
class BerdyHelper(object):
    ...
    def getRangeRCMSensorVariable(self, sensorType):
        return _iDynTree.BerdyHelper_getRangeRCMSensorVariable(self, sensorType)
    ...
    def serializeSensorVariables(self, sensMeas, netExtWrenches, jointTorques, jointAccs, linkJointWrenches, rcm, y):
        return _iDynTree.BerdyHelper_serializeSensorVariables(self, sensMeas, netExtWrenches, jointTorques, jointAccs, linkJointWrenches, rcm, y)
