...
polite_prompt = Prompt(
    """\
The following was taken from a conversation between a salesperson and a customer.
Classify if the agent was polite to the customer.
Label 1 if so, and 0 otherwise.
---
{dialog}
---
...
question_prompt = Prompt(
    """\
The following was taken from a conversation between a salesperson and a customer.
Classify if the agent asked a question to the customer.
Label 1 if so, and 0 otherwise.
---
{dialog}
---
...
disinterested_thanks_and_bye_prompt = Prompt(
    """\
The following was taken from a conversation between a salesperson and a customer.
