...
class LKNN(SeqRecBase):    
    def __init__(self, config):
        ...
        super(LKNN, self).__init__(config)
...
class Layer(nn.Module):
    def __init__(self, conv_size, padding_mode, hidden_dropout_prob, hidden_size, inner_size, hidden_act, layer_norm_eps, init_ratio):
        ...
        self.filterlayer = LKNNLayer(conv_size, padding_mode, hidden_dropout_prob, hidden_size, layer_norm_eps, init_ratio)
