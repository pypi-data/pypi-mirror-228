...
def parse_cmd_arguments():
    ...
    parser.add_argument("--item_price_filename", type=str)
    parser.add_argument("--item_category_filename", type=str)
    ...
    parser.add_argument("--morec_objective_controller", type=str, help="Objective Controller.") 
    parser.add_argument("--morec_ngroup", type=int, help="Number of groups for data sampling. The data would be split into N groups \
                        according to price/popularity.")
    ...
    parser.add_argument("--morec_objective_weights", type=str, help="Objective static weights.")  # [0.3,0.4,0.3]
