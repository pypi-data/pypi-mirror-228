...
import copy
from .lknn import LKNN, Intermediate
...
class Layer(nn.Module):
    def __init__(self, conv_size, padding_mode, hidden_dropout_prob, hidden_size, inner_size, hidden_act, layer_norm_eps, max_seq_len):
        ...
        self.filterlayer = FASTLKNNLayer(conv_size, padding_mode, hidden_dropout_prob, hidden_size, layer_norm_eps, max_seq_len)
...
class FASTLKNNLayer(nn.Module):
    def __init__(self, conv_size, padding_mode, hidden_dropout_prob, hidden_size, layer_norm_eps, max_seq_len):
        ...
        # which makes the result theoretically consistent to the LKNN approach with the hidden states zeroly padded.
