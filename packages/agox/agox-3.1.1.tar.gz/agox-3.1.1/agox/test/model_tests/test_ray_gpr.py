...
import numpy as np
from agox.test.test_utils import test_data_dicts, get_test_environment, get_test_data
...
def test_ray_global_gpr(test_data_dict, ray_fix, cmd_options):
    ...
    print(energies)
    print(results_actor_0['E'])
    np.testing.assert_allclose(energies, results_actor_0['E'])
