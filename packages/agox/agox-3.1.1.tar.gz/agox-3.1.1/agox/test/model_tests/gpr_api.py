...
from agox.utils.filters import EnergyFilter, Filter
...
# if more than 50 structure are left, remove them using CUR
filter = EnergyFilter() + Filter(descriptor=descriptor, sparsifier=CUR(m_points=50))
