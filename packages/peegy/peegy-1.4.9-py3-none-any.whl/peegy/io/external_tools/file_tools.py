...
def get_files_and_meta_files(measurement_path: str = '',
                             ...
                             split_trigger_codes: [float] = None,
                             ) -> pd.DataFrame:
    """
    ...
    :param split_trigger_codes: list of trigger codes. Ff provided, bdf file will be marked in chunks starting at each
    of these trigger events.
