...
class DManV3(MarketMakingControllerBase):
    ...
    def __init__(self, config: DManV3Config, mode: ControllerMode = ControllerMode.LIVE):
    ...
    def get_processed_data(self):
        ...
        std = candles_df["close"].rolling(self.config.std_span).std()

        price_multiplier = (0.5 * macd_signal + 0.5 * macdh_signal) * max_price_shift

        candles_df["spread_multiplier"] = std
