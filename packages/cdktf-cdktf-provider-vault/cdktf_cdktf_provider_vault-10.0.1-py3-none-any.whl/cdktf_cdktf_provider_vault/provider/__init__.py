...
class VaultProvider(
    ...
    def __init__(
        ...
        *,
        ...
        auth_login: typing.Optional[typing.Union["VaultProviderAuthLogin", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_aws: typing.Optional[typing.Union["VaultProviderAuthLoginAws", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_azure: typing.Optional[typing.Union["VaultProviderAuthLoginAzure", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_cert: typing.Optional[typing.Union["VaultProviderAuthLoginCert", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_gcp: typing.Optional[typing.Union["VaultProviderAuthLoginGcp", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_jwt: typing.Optional[typing.Union["VaultProviderAuthLoginJwt", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_kerberos: typing.Optional[typing.Union["VaultProviderAuthLoginKerberos", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_oci: typing.Optional[typing.Union["VaultProviderAuthLoginOci", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_oidc: typing.Optional[typing.Union["VaultProviderAuthLoginOidc", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_radius: typing.Optional[typing.Union["VaultProviderAuthLoginRadius", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_token_file: typing.Optional[typing.Union["VaultProviderAuthLoginTokenFile", typing.Dict[builtins.str, typing.Any]]] = None,
        auth_login_userpass: typing.Optional[typing.Union["VaultProviderAuthLoginUserpass", typing.Dict[builtins.str, typing.Any]]] = None,
        ca_cert_dir: typing.Optional[builtins.str] = None,
        ca_cert_file: typing.Optional[builtins.str] = None,
        client_auth: typing.Optional[typing.Union["VaultProviderClientAuth", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs vault} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param address: URL of the root of the target Vault server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#address VaultProvider#address}
        :param add_address_to_env: If true, adds the value of the ``address`` argument to the Terraform process environment. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#add_address_to_env VaultProvider#add_address_to_env}
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#alias VaultProvider#alias}
        :param auth_login: auth_login block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login VaultProvider#auth_login}
        :param auth_login_aws: auth_login_aws block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_aws VaultProvider#auth_login_aws}
        :param auth_login_azure: auth_login_azure block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_azure VaultProvider#auth_login_azure}
        :param auth_login_cert: auth_login_cert block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_cert VaultProvider#auth_login_cert}
        :param auth_login_gcp: auth_login_gcp block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_gcp VaultProvider#auth_login_gcp}
        :param auth_login_jwt: auth_login_jwt block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_jwt VaultProvider#auth_login_jwt}
        :param auth_login_kerberos: auth_login_kerberos block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_kerberos VaultProvider#auth_login_kerberos}
        :param auth_login_oci: auth_login_oci block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_oci VaultProvider#auth_login_oci}
        :param auth_login_oidc: auth_login_oidc block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_oidc VaultProvider#auth_login_oidc}
        :param auth_login_radius: auth_login_radius block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_radius VaultProvider#auth_login_radius}
        :param auth_login_token_file: auth_login_token_file block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_token_file VaultProvider#auth_login_token_file}
        :param auth_login_userpass: auth_login_userpass block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_login_userpass VaultProvider#auth_login_userpass}
        :param ca_cert_dir: Path to directory containing CA certificate files to validate the server's certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#ca_cert_dir VaultProvider#ca_cert_dir}
        :param ca_cert_file: Path to a CA certificate file to validate the server's certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#ca_cert_file VaultProvider#ca_cert_file}
        :param client_auth: client_auth block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#client_auth VaultProvider#client_auth}
        :param headers: headers block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#headers VaultProvider#headers}
        :param max_lease_ttl_seconds: Maximum TTL for secret leases requested by this provider. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#max_lease_ttl_seconds VaultProvider#max_lease_ttl_seconds}
        :param max_retries: Maximum number of retries when a 5xx error code is encountered. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#max_retries VaultProvider#max_retries}
        :param max_retries_ccc: Maximum number of retries for Client Controlled Consistency related operations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#max_retries_ccc VaultProvider#max_retries_ccc}
        :param namespace: The namespace to use. Available only for Vault Enterprise. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        :param skip_child_token: Set this to true to prevent the creation of ephemeral child token used by this provider. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#skip_child_token VaultProvider#skip_child_token}
        :param skip_get_vault_version: Skip the dynamic fetching of the Vault server version. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#skip_get_vault_version VaultProvider#skip_get_vault_version}
        :param skip_tls_verify: Set this to true only if the target Vault server is an insecure development instance. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#skip_tls_verify VaultProvider#skip_tls_verify}
        :param tls_server_name: Name to use as the SNI host when connecting via TLS. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#tls_server_name VaultProvider#tls_server_name}
        :param token: Token to use to authenticate to Vault. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#token VaultProvider#token}
        :param token_name: Token name to use for creating the Vault child token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#token_name VaultProvider#token_name}
        :param vault_version_override: Override the Vault server version, which is normally determined dynamically from the target Vault server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#vault_version_override VaultProvider#vault_version_override}
        '''
        if __debug__:
    ...
    def auth_login_aws_input(self) -> typing.Optional["VaultProviderAuthLoginAws"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginAws"], jsii.get(self, "authLoginAwsInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginAzureInput")
    def auth_login_azure_input(self) -> typing.Optional["VaultProviderAuthLoginAzure"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginAzure"], jsii.get(self, "authLoginAzureInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginCertInput")
    def auth_login_cert_input(self) -> typing.Optional["VaultProviderAuthLoginCert"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginCert"], jsii.get(self, "authLoginCertInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginGcpInput")
    def auth_login_gcp_input(self) -> typing.Optional["VaultProviderAuthLoginGcp"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginGcp"], jsii.get(self, "authLoginGcpInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginInput")
    def auth_login_input(self) -> typing.Optional["VaultProviderAuthLogin"]:
        return typing.cast(typing.Optional["VaultProviderAuthLogin"], jsii.get(self, "authLoginInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginJwtInput")
    def auth_login_jwt_input(self) -> typing.Optional["VaultProviderAuthLoginJwt"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginJwt"], jsii.get(self, "authLoginJwtInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginKerberosInput")
    def auth_login_kerberos_input(
        self,
    ) -> typing.Optional["VaultProviderAuthLoginKerberos"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginKerberos"], jsii.get(self, "authLoginKerberosInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginOciInput")
    def auth_login_oci_input(self) -> typing.Optional["VaultProviderAuthLoginOci"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginOci"], jsii.get(self, "authLoginOciInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginOidcInput")
    def auth_login_oidc_input(self) -> typing.Optional["VaultProviderAuthLoginOidc"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginOidc"], jsii.get(self, "authLoginOidcInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginRadiusInput")
    def auth_login_radius_input(
        self,
    ) -> typing.Optional["VaultProviderAuthLoginRadius"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginRadius"], jsii.get(self, "authLoginRadiusInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginTokenFileInput")
    def auth_login_token_file_input(
        self,
    ) -> typing.Optional["VaultProviderAuthLoginTokenFile"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginTokenFile"], jsii.get(self, "authLoginTokenFileInput"))

    @builtins.property
    @jsii.member(jsii_name="authLoginUserpassInput")
    def auth_login_userpass_input(
        self,
    ) -> typing.Optional["VaultProviderAuthLoginUserpass"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginUserpass"], jsii.get(self, "authLoginUserpassInput"))
    ...
    def client_auth_input(self) -> typing.Optional["VaultProviderClientAuth"]:
        return typing.cast(typing.Optional["VaultProviderClientAuth"], jsii.get(self, "clientAuthInput"))
    ...
    def auth_login(self) -> typing.Optional["VaultProviderAuthLogin"]:
        return typing.cast(typing.Optional["VaultProviderAuthLogin"], jsii.get(self, "authLogin"))

    @auth_login.setter
    def auth_login(self, value: typing.Optional["VaultProviderAuthLogin"]) -> None:
        if __debug__:
    ...
    def auth_login_aws(self) -> typing.Optional["VaultProviderAuthLoginAws"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginAws"], jsii.get(self, "authLoginAws"))

    @auth_login_aws.setter
    def auth_login_aws(
        self,
        value: typing.Optional["VaultProviderAuthLoginAws"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e01b7937c68afbbebdc5e4845d39215b1aa84d4e2c813c59965b3a2475a30b1f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginAws", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginAzure")
    def auth_login_azure(self) -> typing.Optional["VaultProviderAuthLoginAzure"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginAzure"], jsii.get(self, "authLoginAzure"))

    @auth_login_azure.setter
    def auth_login_azure(
        self,
        value: typing.Optional["VaultProviderAuthLoginAzure"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__18ef03027fb974ac6f55af2c7641e0e261c4673c77a213d2bcc93e505e858e74)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginAzure", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginCert")
    def auth_login_cert(self) -> typing.Optional["VaultProviderAuthLoginCert"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginCert"], jsii.get(self, "authLoginCert"))

    @auth_login_cert.setter
    def auth_login_cert(
        self,
        value: typing.Optional["VaultProviderAuthLoginCert"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4be5c26ab33f5e79b2e51cf8e61b794beca04649e5c1597d6d2855f487895dbe)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginCert", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginGcp")
    def auth_login_gcp(self) -> typing.Optional["VaultProviderAuthLoginGcp"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginGcp"], jsii.get(self, "authLoginGcp"))

    @auth_login_gcp.setter
    def auth_login_gcp(
        self,
        value: typing.Optional["VaultProviderAuthLoginGcp"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c94fb99f53120eb6da4e1e0ecd0173ee6bdd1ff9e2a74ba3a363175db27b4f89)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginGcp", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginJwt")
    def auth_login_jwt(self) -> typing.Optional["VaultProviderAuthLoginJwt"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginJwt"], jsii.get(self, "authLoginJwt"))

    @auth_login_jwt.setter
    def auth_login_jwt(
        self,
        value: typing.Optional["VaultProviderAuthLoginJwt"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__997fabe98b5ffbb86d64e7573c8ee796e165db66b7dee91d83391857ca80a054)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginJwt", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginKerberos")
    def auth_login_kerberos(self) -> typing.Optional["VaultProviderAuthLoginKerberos"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginKerberos"], jsii.get(self, "authLoginKerberos"))

    @auth_login_kerberos.setter
    def auth_login_kerberos(
        self,
        value: typing.Optional["VaultProviderAuthLoginKerberos"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a45afc5ac62a1484b28a72948aa0fcd52e9cbacf3c5630052bb46666e9d61306)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginKerberos", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginOci")
    def auth_login_oci(self) -> typing.Optional["VaultProviderAuthLoginOci"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginOci"], jsii.get(self, "authLoginOci"))

    @auth_login_oci.setter
    def auth_login_oci(
        self,
        value: typing.Optional["VaultProviderAuthLoginOci"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__886110d602f20627d559e66441cd42afb7b59a3ee4c56928234ffe6e206f9701)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginOci", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginOidc")
    def auth_login_oidc(self) -> typing.Optional["VaultProviderAuthLoginOidc"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginOidc"], jsii.get(self, "authLoginOidc"))

    @auth_login_oidc.setter
    def auth_login_oidc(
        self,
        value: typing.Optional["VaultProviderAuthLoginOidc"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7872bc318f6ab77f55cc3681f9813a0b70597c43fa614d3330d2c80e3ccf045a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginOidc", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginRadius")
    def auth_login_radius(self) -> typing.Optional["VaultProviderAuthLoginRadius"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginRadius"], jsii.get(self, "authLoginRadius"))

    @auth_login_radius.setter
    def auth_login_radius(
        self,
        value: typing.Optional["VaultProviderAuthLoginRadius"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ae5550453911cabc56f1684a61b1f21144dddbb85cf1e312da541d0174eb3f16)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginRadius", value)
    ...
    def auth_login_token_file(
        ...
        return typing.cast(typing.Optional["VaultProviderAuthLoginTokenFile"], jsii.get(self, "authLoginTokenFile"))

    @auth_login_token_file.setter
    def auth_login_token_file(
        self,
        value: typing.Optional["VaultProviderAuthLoginTokenFile"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__699e969dbd9a15f496067c7fe2d4c08390454817e20b35aeccb9629ae2da9e51)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginTokenFile", value)

    @builtins.property
    @jsii.member(jsii_name="authLoginUserpass")
    def auth_login_userpass(self) -> typing.Optional["VaultProviderAuthLoginUserpass"]:
        return typing.cast(typing.Optional["VaultProviderAuthLoginUserpass"], jsii.get(self, "authLoginUserpass"))

    @auth_login_userpass.setter
    def auth_login_userpass(
        self,
        value: typing.Optional["VaultProviderAuthLoginUserpass"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f2f5510c57a792b65d8dc32646efc325e4079f8a492c9f445ab300d57469ff89)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "authLoginUserpass", value)
    ...
    def client_auth(self) -> typing.Optional["VaultProviderClientAuth"]:
        return typing.cast(typing.Optional["VaultProviderClientAuth"], jsii.get(self, "clientAuth"))

    @client_auth.setter
    def client_auth(self, value: typing.Optional["VaultProviderClientAuth"]) -> None:
        if __debug__:
    ...
    def skip_get_vault_version(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "skipGetVaultVersion", value)
    ...
    def vault_version_override(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vaultVersionOverride", value)
...
class VaultProviderAuthLogin:
    def __init__(
        ...
        *,
        ...
        '''
        :param path: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#path VaultProvider#path}.
        :param method: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#method VaultProvider#method}.
        :param namespace: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}.
        :param parameters: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#parameters VaultProvider#parameters}.
        '''
        if __debug__:
...
class VaultProviderAuthLoginAws:
    def __init__(
        ...
        *,
        ...
        '''
        :param role: The Vault role to use when logging into Vault. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#role VaultProvider#role}
        :param aws_access_key_id: The AWS access key ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_access_key_id VaultProvider#aws_access_key_id}
        :param aws_iam_endpoint: The IAM endpoint URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_iam_endpoint VaultProvider#aws_iam_endpoint}
        :param aws_profile: The name of the AWS profile. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_profile VaultProvider#aws_profile}
        :param aws_region: The AWS region. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_region VaultProvider#aws_region}
        :param aws_role_arn: The ARN of the AWS Role to assume.Used during STS AssumeRole. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_role_arn VaultProvider#aws_role_arn}
        :param aws_role_session_name: Specifies the name to attach to the AWS role session. Used during STS AssumeRole. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_role_session_name VaultProvider#aws_role_session_name}
        :param aws_secret_access_key: The AWS secret access key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_secret_access_key VaultProvider#aws_secret_access_key}
        :param aws_session_token: The AWS session token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_session_token VaultProvider#aws_session_token}
        :param aws_shared_credentials_file: Path to the AWS shared credentials file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_shared_credentials_file VaultProvider#aws_shared_credentials_file}
        :param aws_sts_endpoint: The STS endpoint URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_sts_endpoint VaultProvider#aws_sts_endpoint}
        :param aws_web_identity_token_file: Path to the file containing an OAuth 2.0 access token or OpenID Connect ID token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#aws_web_identity_token_file VaultProvider#aws_web_identity_token_file}
        :param header_value: The Vault header value to include in the STS signing request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#header_value VaultProvider#header_value}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
        if __debug__:
...
class VaultProviderAuthLoginAzure:
    def __init__(
        ...
        *,
        ...
        '''
        :param resource_group_name: The resource group for the machine that generated the MSI token. This information can be obtained through instance metadata. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#resource_group_name VaultProvider#resource_group_name}
        :param role: Name of the login role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#role VaultProvider#role}
        :param subscription_id: The subscription ID for the machine that generated the MSI token. This information can be obtained through instance metadata. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#subscription_id VaultProvider#subscription_id}
        :param client_id: The identity's client ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#client_id VaultProvider#client_id}
        :param jwt: A signed JSON Web Token. If not specified on will be created automatically. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#jwt VaultProvider#jwt}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        :param scope: The scopes to include in the token request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#scope VaultProvider#scope}
        :param tenant_id: Provides the tenant ID to use in a multi-tenant authentication scenario. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#tenant_id VaultProvider#tenant_id}
        :param vm_name: The virtual machine name for the machine that generated the MSI token. This information can be obtained through instance metadata. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#vm_name VaultProvider#vm_name}
        :param vmss_name: The virtual machine scale set name for the machine that generated the MSI token. This information can be obtained through instance metadata. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#vmss_name VaultProvider#vmss_name}
        '''
        if __debug__:
...
class VaultProviderAuthLoginCert:
    def __init__(
        ...
        *,
        ...
        '''
        :param cert_file: Path to a file containing the client certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#cert_file VaultProvider#cert_file}
        :param key_file: Path to a file containing the private key that the certificate was issued for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#key_file VaultProvider#key_file}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param name: Name of the certificate's role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#name VaultProvider#name}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
        if __debug__:
...
class VaultProviderAuthLoginGcp:
    def __init__(
        ...
        *,
        ...
        '''
        :param role: Name of the login role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#role VaultProvider#role}
        :param credentials: Path to the Google Cloud credentials file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#credentials VaultProvider#credentials}
        :param jwt: A signed JSON Web Token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#jwt VaultProvider#jwt}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        :param service_account: IAM service account. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#service_account VaultProvider#service_account}
        '''
        if __debug__:
...
class VaultProviderAuthLoginKerberos:
    def __init__(
        ...
        *,
        ...
        '''
        :param disable_fast_negotiation: Disable the Kerberos FAST negotiation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#disable_fast_negotiation VaultProvider#disable_fast_negotiation}
        :param keytab_path: The Kerberos keytab file containing the entry of the login entity. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#keytab_path VaultProvider#keytab_path}
        :param krb5_conf_path: A valid Kerberos configuration file e.g. /etc/krb5.conf. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#krb5conf_path VaultProvider#krb5conf_path}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        :param realm: The Kerberos server's authoritative authentication domain. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#realm VaultProvider#realm}
        :param remove_instance_name: Strip the host from the username found in the keytab. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#remove_instance_name VaultProvider#remove_instance_name}
        :param service: The service principle name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#service VaultProvider#service}
        :param token: Simple and Protected GSSAPI Negotiation Mechanism (SPNEGO) token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#token VaultProvider#token}
        :param username: The username to login into Kerberos with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#username VaultProvider#username}
        '''
        if __debug__:
...
class VaultProviderAuthLoginOci:
    def __init__(
        ...
        *,
        ...
        '''
        :param auth_type: Authentication type to use when getting OCI credentials. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#auth_type VaultProvider#auth_type}
        :param role: Name of the login role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#role VaultProvider#role}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
...
class VaultProviderAuthLoginOidc:
    def __init__(
        ...
        *,
        ...
        '''
        :param role: Name of the login role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#role VaultProvider#role}
        :param callback_address: The callback address. Must be a valid URI without the path. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#callback_address VaultProvider#callback_address}
        :param callback_listener_address: The callback listener's address. Must be a valid URI without the path. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#callback_listener_address VaultProvider#callback_listener_address}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
        if __debug__:
...
class VaultProviderAuthLoginRadius:
    def __init__(
        ...
        *,
        ...
        '''
        :param password: The Radius password for username. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#password VaultProvider#password}
        :param username: The Radius username. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#username VaultProvider#username}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
        if __debug__:
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"filename": "filename", "namespace": "namespace"},
)
class VaultProviderAuthLoginTokenFile:
    def __init__(
        ...
        *,
        ...
        '''
        :param filename: The name of a file containing a single line that is a valid Vault token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#filename VaultProvider#filename}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        '''
        if __debug__:
...
class VaultProviderAuthLoginUserpass:
    def __init__(
        ...
        *,
        ...
        '''
        :param username: Login with username. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#username VaultProvider#username}
        :param mount: The path where the authentication engine is mounted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#mount VaultProvider#mount}
        :param namespace: The authentication engine's namespace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#namespace VaultProvider#namespace}
        :param password: Login with password. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#password VaultProvider#password}
        :param password_file: Login with password from a file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#password_file VaultProvider#password_file}
        '''
        if __debug__:
...
class VaultProviderConfig:
    def __init__(
        ...
        *,
        ...
        if isinstance(auth_login, dict):
            auth_login = VaultProviderAuthLogin(**auth_login)
        if isinstance(auth_login_aws, dict):
            auth_login_aws = VaultProviderAuthLoginAws(**auth_login_aws)
        if isinstance(auth_login_azure, dict):
            auth_login_azure = VaultProviderAuthLoginAzure(**auth_login_azure)
        if isinstance(auth_login_cert, dict):
            auth_login_cert = VaultProviderAuthLoginCert(**auth_login_cert)
        if isinstance(auth_login_gcp, dict):
            auth_login_gcp = VaultProviderAuthLoginGcp(**auth_login_gcp)
        if isinstance(auth_login_jwt, dict):
            auth_login_jwt = VaultProviderAuthLoginJwt(**auth_login_jwt)
        if isinstance(auth_login_kerberos, dict):
            auth_login_kerberos = VaultProviderAuthLoginKerberos(**auth_login_kerberos)
        if isinstance(auth_login_oci, dict):
            auth_login_oci = VaultProviderAuthLoginOci(**auth_login_oci)
        if isinstance(auth_login_oidc, dict):
            auth_login_oidc = VaultProviderAuthLoginOidc(**auth_login_oidc)
        if isinstance(auth_login_radius, dict):
            auth_login_radius = VaultProviderAuthLoginRadius(**auth_login_radius)
        if isinstance(auth_login_token_file, dict):
            auth_login_token_file = VaultProviderAuthLoginTokenFile(**auth_login_token_file)
        if isinstance(auth_login_userpass, dict):
            auth_login_userpass = VaultProviderAuthLoginUserpass(**auth_login_userpass)
        if isinstance(client_auth, dict):
            client_auth = VaultProviderClientAuth(**client_auth)
        if __debug__:
    ...
    def auth_login(self) -> typing.Optional[VaultProviderAuthLogin]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLogin], result)
    ...
    def auth_login_aws(self) -> typing.Optional[VaultProviderAuthLoginAws]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginAws], result)
    ...
    def auth_login_azure(self) -> typing.Optional[VaultProviderAuthLoginAzure]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginAzure], result)
    ...
    def auth_login_cert(self) -> typing.Optional[VaultProviderAuthLoginCert]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginCert], result)
    ...
    def auth_login_gcp(self) -> typing.Optional[VaultProviderAuthLoginGcp]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginGcp], result)
    ...
    def auth_login_jwt(self) -> typing.Optional[VaultProviderAuthLoginJwt]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginJwt], result)
    ...
    def auth_login_kerberos(self) -> typing.Optional[VaultProviderAuthLoginKerberos]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginKerberos], result)
    ...
    def auth_login_oci(self) -> typing.Optional[VaultProviderAuthLoginOci]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginOci], result)
    ...
    def auth_login_oidc(self) -> typing.Optional[VaultProviderAuthLoginOidc]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginOidc], result)
    ...
    def auth_login_radius(self) -> typing.Optional[VaultProviderAuthLoginRadius]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginRadius], result)

    @builtins.property
    def auth_login_token_file(self) -> typing.Optional[VaultProviderAuthLoginTokenFile]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginTokenFile], result)
    ...
    def auth_login_userpass(self) -> typing.Optional[VaultProviderAuthLoginUserpass]:
        ...
        return typing.cast(typing.Optional[VaultProviderAuthLoginUserpass], result)
    ...
    def client_auth(self) -> typing.Optional[VaultProviderClientAuth]:
        ...
        return typing.cast(typing.Optional[VaultProviderClientAuth], result)
...
class VaultProviderHeaders:
    def __init__(self, *, name: builtins.str, value: builtins.str) -> None:
        '''
        :param name: The header name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#name VaultProvider#name}
        :param value: The header value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs#value VaultProvider#value}
        '''
        if __debug__:
...
def _typecheckingstub__aa3b4bef01072b48310ed5081591961b76db438cd005fb22a6e5bd301da63f68(
    value: typing.Optional[VaultProviderAuthLogin],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3153e1a79f3137c81a654219243493834f4e56a925bc2b5c59f3bf37fa7b8c2a(
    value: typing.Optional[VaultProviderClientAuth],
) -> None:
    """Type checking stubs"""
    pass
