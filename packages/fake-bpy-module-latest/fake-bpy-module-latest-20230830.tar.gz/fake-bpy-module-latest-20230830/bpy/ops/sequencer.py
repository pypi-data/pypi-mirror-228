...
def retiming_handle_add(
    ...
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param timeline_frame: Timeline Frame, Frame where handle will be added
...
def retiming_handle_move(
        override_context: typing.Optional[
            typing.Union[typing.Dict, 'bpy.types.Context']] = None,
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None,
        *,
        handle_index: typing.Optional[typing.Any] = 0):
    ''' Move retiming handle

    :type override_context: typing.Optional[typing.Union[typing.Dict, 'bpy.types.Context']]
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param handle_index: Handle Index, Index of handle to be moved
    :type handle_index: typing.Optional[typing.Any]
    '''

    pass


def retiming_handle_remove(
        override_context: typing.Optional[
            typing.Union[typing.Dict, 'bpy.types.Context']] = None,
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None,
        *,
        handle_index: typing.Optional[typing.Any] = 0):
    ''' Remove retiming handle

    :type override_context: typing.Optional[typing.Union[typing.Dict, 'bpy.types.Context']]
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param handle_index: Handle Index, Index of handle to be removed
    :type handle_index: typing.Optional[typing.Any]
    '''
