...
def interface_item_duplicate(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a copy of the active item to the interface :File: `startup/bl_operators/node.py\:337 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L337>`__
...
def interface_item_new(
    ...
    ''' Add a new item to the interface :File: `startup/bl_operators/node.py\:292 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L292>`__
...
def interface_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove active item from the interface :File: `startup/bl_operators/node.py\:356 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L356>`__
...
def new_geometry_node_group_tool(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group for an tool :File: `startup/bl_operators/geometry_nodes.py\:272 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L272>`__
...
def repeat_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a repeat item to the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:413 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L413>`__
...
def repeat_zone_item_move(
    ...
    ''' Move a repeat item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:463 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L463>`__
...
def repeat_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a repeat item from the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:440 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L440>`__
...
def simulation_zone_item_add(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a state item to the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:314 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L314>`__
...
def simulation_zone_item_move(
        ...
        *,
        direction: typing.Optional[typing.Any] = 'UP'):
    ''' Move a simulation state item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:364 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L364>`__
...
def simulation_zone_item_remove(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a state item from the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:341 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L341>`__
