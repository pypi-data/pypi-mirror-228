...
import icon from '@datalayer/icons-react/data2/EjectIconLabIcon';
...
namespace CommandIDs {
  export const create = 'create-jupyter-functions-widget';
}
...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: (
    ...
    connect('ws://localhost:8888/api/jupyter/jupyter_functions/echo', true);
