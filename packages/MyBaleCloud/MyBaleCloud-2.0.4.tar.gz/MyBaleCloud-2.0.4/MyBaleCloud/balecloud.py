...
class BaleCloud:
    ...
    def sendItToMyPVs(self, adminChatIDs : str | list = None):
        try:
    ...
    def responeText(self, targetText : str = "/"):
        ...
        try:
            ...
            if text.startswith(targetText):
                ...
                #self.sendMessage(text=sendWhat, chatID=UP.get('chat').get('id'), messageID=UP.get('message_id') if UP.get('message_id') else '')
