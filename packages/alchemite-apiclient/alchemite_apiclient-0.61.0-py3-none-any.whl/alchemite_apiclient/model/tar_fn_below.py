...
def lazy_import():
    ...
    globals()['TarFnBelowAllOf'] = TarFnBelowAllOf


class TarFnBelow(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TarFnBelow - a model defined in OpenAPI

        Keyword Args:
            maximum (float):
            target (str): The target column name.
            type (str): Find a solution below `\"maximum\"`.. defaults to "below", must be one of ["below", ]  # noqa: E501
