...
def lazy_import():
    ...
    globals()['TarFnIncludeCategoriesAllOf'] = TarFnIncludeCategoriesAllOf


class TarFnIncludeCategories(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TarFnIncludeCategories - a model defined in OpenAPI

        Keyword Args:
            values (bool, date, datetime, dict, float, int, list, str, none_type): The values to include or exclude.
            target (str): The target column name.
            type (str): Find a solution where the category of the given column is one of the values.. defaults to "include categories", must be one of ["include categories", ]  # noqa: E501
        ...
        type = kwargs.get('type', "include categories")
