...
def lazy_import():
    ...
    globals()['TarFnAboveAllOf'] = TarFnAboveAllOf


class TarFnAbove(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TarFnAbove - a model defined in OpenAPI

        Keyword Args:
            minimum (float):
            target (str): The target column name.
            type (str): Find a solution above `\"minimum\"`.. defaults to "above", must be one of ["above", ]  # noqa: E501
