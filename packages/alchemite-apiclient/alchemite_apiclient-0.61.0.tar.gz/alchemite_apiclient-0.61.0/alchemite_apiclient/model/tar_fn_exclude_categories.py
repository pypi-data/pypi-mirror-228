...
def lazy_import():
    ...
    globals()['IntCatArr'] = IntCatArr
    globals()['PartTarFnCategoricals'] = PartTarFnCategoricals
    globals()['PartTarFnSingleTar'] = PartTarFnSingleTar
    globals()['StringCatArr'] = StringCatArr
    globals()['TarFnExcludeCategoriesAllOf'] = TarFnExcludeCategoriesAllOf


class TarFnExcludeCategories(ModelComposed):
    ...
    def openapi_types():  # noqa
        ...
        lazy_import()
        return {
            'values': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'target': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'importance': (float,),  # noqa: E501
            'vector_element': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'vector_element': 'vectorElement',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TarFnExcludeCategories - a model defined in OpenAPI

        Keyword Args:
            values (bool, date, datetime, dict, float, int, list, str, none_type): The values to include or exclude.
            target (str): The target column name.
            type (str): Find a solution where the category of the given column is not one of the values.. defaults to "exclude categories", must be one of ["exclude categories", ]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              PartTarFnCategoricals,
              PartTarFnSingleTar,
              TarFnExcludeCategoriesAllOf,
          ],
          'oneOf': [
          ],
        }
