...
def lazy_import():
    ...
    globals()['TarFnBetweenAllOf'] = TarFnBetweenAllOf


class TarFnBetween(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TarFnBetween - a model defined in OpenAPI

        Keyword Args:
            maximum (float):
            minimum (float):
            target (str): The target column name.
            type (str): Find a solution between `\"minimum\"` and `\"maximum\"`.. defaults to "between", must be one of ["between", ]  # noqa: E501
