...
PROFILE_LOCAL_PYTHON_PACKAGE_COMPONENT_NAME = 'profile_local/src/profile.py'
...
class ProfileLocalClass(GenericCRUD):
    ...
    profile_id: int
    '''
    def insert_profile(self, person_id: int, data: Dict[str, any]) -> int:
        ...
        number_generator = NumberGenerator("profile", "profile_table", "profile_id", "`number`")
        number = number_generator.get_random_number()
        self.cursor.execute(
