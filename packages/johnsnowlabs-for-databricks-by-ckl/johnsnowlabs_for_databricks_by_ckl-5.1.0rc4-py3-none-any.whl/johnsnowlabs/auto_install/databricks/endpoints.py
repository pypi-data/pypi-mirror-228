...
def log_nlu_model(nlu_model_name, registerd_model_name):
    ...
    # TODO WTF WHY LOG INTO WR ONG OFLDER???
    ...
    # 2. Log the model # FUCK TODO SOMETING SHITTYY HAPENING HEHRUCKCKFASLKJHFSDNPAJSDPNHJk;qwerd[jo
...
def query_and_deploy_if_missing(
    ...
    if not db_host:
        raise Exception("db_host must be specified")
...
def deploy_nlu_model_as_endpoint(
    ...
    print(
        f"""Creating:\n
REGISTERD_MODEL_NAME: {REGISTERD_MODEL_NAME}\n
