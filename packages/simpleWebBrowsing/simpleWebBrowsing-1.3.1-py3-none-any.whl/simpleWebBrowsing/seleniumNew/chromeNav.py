...
class NavChrome:
    def waitObject(driver, object):
        a = 0
        while len(driver.find_elements(By.ID, object)) == 0 and len(driver.find_elements(By.NAME, object)) == 0 and len(driver.find_elements(By.XPATH, object)) == 0 and a < 20:
            sleep(1)
            a = a + 1
    ...
    def waitObjectClose(driver, object):
        while len(driver.find_elements(By.ID, object)) == 0 and len(driver.find_elements(By.NAME, object)) == 0 and len(driver.find_elements(By.XPATH, object)) > 0:
            sleep(1)
        sleep(1)
