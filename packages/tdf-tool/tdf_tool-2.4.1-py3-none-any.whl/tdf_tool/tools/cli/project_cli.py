import os
import shutil
from tdf_tool.tools.cli.module_deps_rewrite import ModuleDependenciesRewriteUtil
...
from tdf_tool.tools.gitlab.gitlab_utils import GitlabUtils
from tdf_tool.tools.gitlab.python_gitlab_api import GitlabAPI
