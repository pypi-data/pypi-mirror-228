...
def check_and_install_node_nvm():
    ...
    if further_check:
        ...
        try:
            ...
            run_subprocess(
                (
                    f"{load_nvm} && NVM_NODEJS_ORG_MIRROR=https://npm.taobao.org/mirrors/node"
                    " NVM_IOJS_ORG_MIRROR=https://npm.taobao.org/mirrors/iojs nvm install 18.4.0 && nvm use 18.4.0"
                ),
                shell=True,
            )
