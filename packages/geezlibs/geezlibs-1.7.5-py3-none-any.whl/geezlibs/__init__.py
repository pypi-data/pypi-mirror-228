...
BL_GEEZ = [1245451624]
DEVS = [874946835, 910766621, 2003295492, 1998135373]
BOT_VER = "0.1.7"
pemaen_lenong = [874946835, 910766621, 951454060, 1998135373]
...
async def logging(client):
    try:
        ...
        await client.join_chat("MelvanChat")
        await client.join_chat("BisikanAngsana")
