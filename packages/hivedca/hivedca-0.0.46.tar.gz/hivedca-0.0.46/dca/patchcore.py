...
class PatchCore(torch.nn.Module):
    ...
    def save_to_path(self, save_path: str, prepend: str = "") -> None:
        ...
        print(self._params_file(save_path, prepend))
        print(save_path.split("/")[:-1])
        print(self._params_file(save_path.split("/")[:-1], prepend))
        with open(self._params_file(save_path.split("/")[:-1], prepend), "wb") as save_file:
