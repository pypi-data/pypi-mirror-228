...
setuptools.setup(
     ...
     version='0.0.4', # https://pypi.org/project/profile-user-local/
     author="Circles",
     author_email="info@circles.life",
     description="PyPI Package for Circles profile-user Local Python",   
     long_description="This is a package for sharing common profile-user functions used in different repositories",
