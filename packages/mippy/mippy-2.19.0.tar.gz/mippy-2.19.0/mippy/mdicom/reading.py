...
def get_dataset(info,tempdir=None):
        ...
        cprint(f"ERROR: Cannot find image file - {uid}\n\tPlease reload the image directory.")
        return None
        ...
        if ds and not ds is None:
                ...
                if enhanced:
                        ...
                        try:
                                ...
                                cprint(f"ERROR: InstanceNumber tag doesn't exist\n\t{path}")
                                raise
                ...
                for i in instance:
                        ...
                        if compressed:
                                ...
                                # function.
                                cprint(f"WARNING: Compressed DICOM - {path}")
                                ...
                                if os.path.exists(temppath):
                                        ...
                                        if dcmdjpeg is None:
                                                if 'darwin' in sys.platform:
                                                        ...
                                                        cprint(f"ERROR: UNSUPPORTED OPERATING SYSTEM - {sys.platform}")
                                        # Uncompress the file
