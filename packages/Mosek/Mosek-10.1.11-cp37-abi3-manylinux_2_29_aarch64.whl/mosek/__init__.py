...
## ---- BEGIN /home/mosekdaemon/jenkins/langeland/workspace/10.1/Distro-pipeline/linuxaarch64/bld/langeland/final/default/src/py3n/mosek/__init__.py
...
miovarseltype = Enum("miovarseltype", ["free","pseudocost","strong"], [0,1,2])
...
startpointtype = Enum("startpointtype", ["constant","free","guess"], [2,0,1])
...
class Env:
    ...
    def linkfiletoenvstream(self,*args,**kwds):
      """
      Directs all output from a stream to a file.
    
      linkfiletoenvstream(whichstream,filename,append)
...
class Task:
    ...
    def appendacc(self,*args,**kwds):
      ...
      appendacc(domidx,afeidxlist,b)
        ...
        [b : array(float64)]  The vector of constant terms added to affine expressions. Optional.  
...
class LinAlg:
  ...
  syevd = __env.syevd
  potrf = __env.potrf
## ---- END   /home/mosekdaemon/jenkins/langeland/workspace/10.1/Distro-pipeline/linuxaarch64/bld/langeland/final/default/src/py3n/mosek/__init__.py
