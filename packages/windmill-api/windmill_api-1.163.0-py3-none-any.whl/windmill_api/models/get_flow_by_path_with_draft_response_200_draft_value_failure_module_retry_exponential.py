...
T = TypeVar("T", bound="GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetryExponential")


@attr.s(auto_attribs=True)
class GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_with_draft_response_200_draft_value_failure_module_retry_exponential = cls(
            attempts=attempts,
            multiplier=multiplier,
            seconds=seconds,
        )

        get_flow_by_path_with_draft_response_200_draft_value_failure_module_retry_exponential.additional_properties = d
