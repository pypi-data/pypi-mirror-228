...
T = TypeVar("T", bound="ForloopFlowModulesItemMock")


@attr.s(auto_attribs=True)
class ForloopFlowModulesItemMock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        forloop_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        forloop_flow_modules_item_mock.additional_properties = d
