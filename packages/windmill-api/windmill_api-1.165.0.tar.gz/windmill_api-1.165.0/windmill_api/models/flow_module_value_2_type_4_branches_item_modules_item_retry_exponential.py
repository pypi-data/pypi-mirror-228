...
T = TypeVar("T", bound="FlowModuleValue2Type4BranchesItemModulesItemRetryExponential")


@attr.s(auto_attribs=True)
class FlowModuleValue2Type4BranchesItemModulesItemRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_4_branches_item_modules_item_retry_exponential = cls(
            attempts=attempts,
            multiplier=multiplier,
            seconds=seconds,
        )

        flow_module_value_2_type_4_branches_item_modules_item_retry_exponential.additional_properties = d
