...
T = TypeVar("T", bound="EditWorkspaceUser")


@attr.s(auto_attribs=True)
class EditWorkspaceUser:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_workspace_user = cls(
            is_admin=is_admin,
            operator=operator,
            disabled=disabled,
        )

        edit_workspace_user.additional_properties = d
        return edit_workspace_user
