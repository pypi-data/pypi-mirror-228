...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/w/{workspace}/inputs/history".format(client.base_url, workspace=workspace)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[GetInputHistoryResponse200Item]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[GetInputHistoryResponse200Item]]:
    return Response(
