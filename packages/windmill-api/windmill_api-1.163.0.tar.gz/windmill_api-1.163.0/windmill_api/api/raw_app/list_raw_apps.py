...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/w/{workspace}/raw_apps/list".format(client.base_url, workspace=workspace)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ListRawAppsResponse200Item]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[ListRawAppsResponse200Item]]:
    return Response(
