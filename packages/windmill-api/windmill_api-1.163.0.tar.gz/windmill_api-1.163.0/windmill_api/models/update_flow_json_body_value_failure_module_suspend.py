...
from ..models.update_flow_json_body_value_failure_module_suspend_resume_form import (
    UpdateFlowJsonBodyValueFailureModuleSuspendResumeForm,
)
...
class UpdateFlowJsonBodyValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, UpdateFlowJsonBodyValueFailureModuleSuspendResumeForm]):
    """

    required_events: Union[Unset, int] = UNSET
    timeout: Union[Unset, int] = UNSET
    resume_form: Union[Unset, UpdateFlowJsonBodyValueFailureModuleSuspendResumeForm] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = UpdateFlowJsonBodyValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
