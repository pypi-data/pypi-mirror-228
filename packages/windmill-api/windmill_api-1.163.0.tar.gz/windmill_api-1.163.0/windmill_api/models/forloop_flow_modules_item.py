...
class ForloopFlowModulesItem:
    ...
    Attributes:
        ...
        suspend (Union[Unset, ForloopFlowModulesItemSuspend]):
        retry (Union[Unset, ForloopFlowModulesItemRetry]):
    """
    ...
    suspend: Union[Unset, ForloopFlowModulesItemSuspend] = UNSET
    retry: Union[Unset, ForloopFlowModulesItemRetry] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ForloopFlowModulesItemSleepType0):
            sleep = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ForloopFlowModulesItemSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ForloopFlowModulesItemSleepType0.from_dict(_sleep_type_0)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, ForloopFlowModulesItemSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = ForloopFlowModulesItemSleepType1.from_dict(_sleep_type_1)
        ...
        if isinstance(_mock, Unset):
            ...
            mock = ForloopFlowModulesItemMock.from_dict(_mock)
        ...
        if isinstance(_suspend, Unset):
            ...
            suspend = ForloopFlowModulesItemSuspend.from_dict(_suspend)
        ...
        if isinstance(_retry, Unset):
            ...
            retry = ForloopFlowModulesItemRetry.from_dict(_retry)

        forloop_flow_modules_item = cls(
            id=id,
            value=value,
        ...
        forloop_flow_modules_item.additional_properties = d
