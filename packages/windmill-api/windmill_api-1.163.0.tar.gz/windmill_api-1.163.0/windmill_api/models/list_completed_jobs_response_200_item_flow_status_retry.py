...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemFlowStatusRetry")


@attr.s(auto_attribs=True)
class ListCompletedJobsResponse200ItemFlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        list_completed_jobs_response_200_item_flow_status_retry.additional_properties = d
        return list_completed_jobs_response_200_item_flow_status_retry
