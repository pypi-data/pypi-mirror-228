...
T = TypeVar("T", bound="DeleteCompletedJobResponse200FlowStatusRetry")


@attr.s(auto_attribs=True)
class DeleteCompletedJobResponse200FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        delete_completed_job_response_200_flow_status_retry.additional_properties = d
        return delete_completed_job_response_200_flow_status_retry
