...
class FlowPreviewValueFailureModule:
    ...
    Attributes:
        ...
        mock (Union[Unset, FlowPreviewValueFailureModuleMock]):
    ...
    mock: Union[Unset, FlowPreviewValueFailureModuleMock] = UNSET
    suspend: Union[Unset, FlowPreviewValueFailureModuleSuspend] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_mock, Unset):
            ...
            mock = FlowPreviewValueFailureModuleMock.from_dict(_mock)
        ...
        if isinstance(_suspend, Unset):
            ...
            suspend = FlowPreviewValueFailureModuleSuspend.from_dict(_suspend)
