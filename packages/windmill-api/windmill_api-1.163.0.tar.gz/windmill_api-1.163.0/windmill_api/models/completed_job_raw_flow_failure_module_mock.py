...
T = TypeVar("T", bound="CompletedJobRawFlowFailureModuleMock")


@attr.s(auto_attribs=True)
class CompletedJobRawFlowFailureModuleMock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        completed_job_raw_flow_failure_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        completed_job_raw_flow_failure_module_mock.additional_properties = d
