...
from ..models.delete_completed_job_response_200_flow_status_modules_item_approvers_item import (
    DeleteCompletedJobResponse200FlowStatusModulesItemApproversItem,
)
from ..models.delete_completed_job_response_200_flow_status_modules_item_branch_chosen import (
...
from ..models.delete_completed_job_response_200_flow_status_modules_item_type import (
...
class DeleteCompletedJobResponse200FlowStatusModulesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for approvers_item_data in _approvers or []:
            approvers_item = DeleteCompletedJobResponse200FlowStatusModulesItemApproversItem.from_dict(
                approvers_item_data
            )
