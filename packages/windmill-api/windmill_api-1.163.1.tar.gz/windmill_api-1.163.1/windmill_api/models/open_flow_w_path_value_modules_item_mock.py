...
T = TypeVar("T", bound="OpenFlowWPathValueModulesItemMock")


@attr.s(auto_attribs=True)
class OpenFlowWPathValueModulesItemMock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_w_path_value_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        open_flow_w_path_value_modules_item_mock.additional_properties = d
