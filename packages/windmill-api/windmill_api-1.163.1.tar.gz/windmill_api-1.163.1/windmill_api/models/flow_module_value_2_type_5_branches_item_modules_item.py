...
from ..models.flow_module_value_2_type_5_branches_item_modules_item_mock import (
    FlowModuleValue2Type5BranchesItemModulesItemMock,
)
...
class FlowModuleValue2Type5BranchesItemModulesItem:
    ...
    Attributes:
        ...
        mock (Union[Unset, FlowModuleValue2Type5BranchesItemModulesItemMock]):
    ...
    mock: Union[Unset, FlowModuleValue2Type5BranchesItemModulesItemMock] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_mock, Unset):
            ...
            mock = FlowModuleValue2Type5BranchesItemModulesItemMock.from_dict(_mock)
