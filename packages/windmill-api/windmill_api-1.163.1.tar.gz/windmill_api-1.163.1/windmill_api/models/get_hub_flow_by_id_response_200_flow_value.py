...
from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module import (
    GetHubFlowByIdResponse200FlowValueFailureModule,
)
from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item import (
    GetHubFlowByIdResponse200FlowValueModulesItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValue")


@attr.s(auto_attribs=True)
class GetHubFlowByIdResponse200FlowValue:
    """
    Attributes:
        modules (List[GetHubFlowByIdResponse200FlowValueModulesItem]):
        failure_module (Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModule]):
    ...
    modules: List[GetHubFlowByIdResponse200FlowValueModulesItem]
    failure_module: Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModule] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = GetHubFlowByIdResponse200FlowValueModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = GetHubFlowByIdResponse200FlowValueFailureModule.from_dict(_failure_module)
        ...
        return get_hub_flow_by_id_response_200_flow_value
