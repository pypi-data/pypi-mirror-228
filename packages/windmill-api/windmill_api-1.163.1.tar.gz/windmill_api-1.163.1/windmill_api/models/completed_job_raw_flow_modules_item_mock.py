...
T = TypeVar("T", bound="CompletedJobRawFlowModulesItemMock")


@attr.s(auto_attribs=True)
class CompletedJobRawFlowModulesItemMock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        completed_job_raw_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        completed_job_raw_flow_modules_item_mock.additional_properties = d
