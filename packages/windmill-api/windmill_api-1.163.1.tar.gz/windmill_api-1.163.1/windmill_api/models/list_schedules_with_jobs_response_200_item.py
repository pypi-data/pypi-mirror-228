...
from ..models.list_schedules_with_jobs_response_200_item_on_failure_extra_args import (
    ListSchedulesWithJobsResponse200ItemOnFailureExtraArgs,
)
...
class ListSchedulesWithJobsResponse200Item:
    ...
    on_failure_extra_args: Union[Unset, ListSchedulesWithJobsResponse200ItemOnFailureExtraArgs] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_on_failure_extra_args, Unset):
            ...
            on_failure_extra_args = ListSchedulesWithJobsResponse200ItemOnFailureExtraArgs.from_dict(
                _on_failure_extra_args
            )
        ...
        if isinstance(_on_recovery_extra_args, Unset):
            ...
            on_recovery_extra_args = ListSchedulesWithJobsResponse200ItemOnRecoveryExtraArgs.from_dict(
