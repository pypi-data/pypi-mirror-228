...
from ..models.get_completed_job_response_200_raw_flow_modules_item_mock import (
    GetCompletedJobResponse200RawFlowModulesItemMock,
)
...
class GetCompletedJobResponse200RawFlowModulesItem:
    ...
    Attributes:
        ...
        suspend (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspend]):
        retry (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemRetry]):
    """
    ...
    suspend: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspend] = UNSET
    retry: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemRetry] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, GetCompletedJobResponse200RawFlowModulesItemSleepType0):
            sleep = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = GetCompletedJobResponse200RawFlowModulesItemSleepType0.from_dict(_sleep_type_0)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = GetCompletedJobResponse200RawFlowModulesItemSleepType1.from_dict(_sleep_type_1)
        ...
        if isinstance(_mock, Unset):
            ...
            mock = GetCompletedJobResponse200RawFlowModulesItemMock.from_dict(_mock)
        ...
        if isinstance(_suspend, Unset):
            ...
            suspend = GetCompletedJobResponse200RawFlowModulesItemSuspend.from_dict(_suspend)
        ...
        if isinstance(_retry, Unset):
            ...
            retry = GetCompletedJobResponse200RawFlowModulesItemRetry.from_dict(_retry)
