...
def _get_kwargs(
    *,
    ...
    url = "{}/groups/list".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ListInstanceGroupsResponse200Item]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[ListInstanceGroupsResponse200Item]]:
    return Response(
