...
from ..models.app_with_last_version_w_draft_policy_triggerables_additional_property import (
    AppWithLastVersionWDraftPolicyTriggerablesAdditionalProperty,
)
...
class AppWithLastVersionWDraftPolicyTriggerables:
    ...
    additional_properties: Dict[str, AppWithLastVersionWDraftPolicyTriggerablesAdditionalProperty] = attr.ib(
