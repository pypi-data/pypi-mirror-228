...
T = TypeVar("T", bound="GetCompletedJobResponse200FlowStatusRetry")


@attr.s(auto_attribs=True)
class GetCompletedJobResponse200FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        get_completed_job_response_200_flow_status_retry.additional_properties = d
        return get_completed_job_response_200_flow_status_retry
