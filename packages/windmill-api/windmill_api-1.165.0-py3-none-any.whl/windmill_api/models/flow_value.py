...
from ..models.flow_value_failure_module import FlowValueFailureModule
from ..models.flow_value_modules_item import FlowValueModulesItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="FlowValue")
...
class FlowValue:
    """
    Attributes:
        modules (List[FlowValueModulesItem]):
        failure_module (Union[Unset, FlowValueFailureModule]):
    ...
    modules: List[FlowValueModulesItem]
    failure_module: Union[Unset, FlowValueFailureModule] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = FlowValueModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = FlowValueFailureModule.from_dict(_failure_module)
        ...
        flow_value.additional_properties = d
        return flow_value
