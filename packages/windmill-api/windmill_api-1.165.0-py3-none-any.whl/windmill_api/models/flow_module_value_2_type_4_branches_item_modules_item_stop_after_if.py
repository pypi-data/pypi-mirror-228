...
T = TypeVar("T", bound="FlowModuleValue2Type4BranchesItemModulesItemStopAfterIf")


@attr.s(auto_attribs=True)
class FlowModuleValue2Type4BranchesItemModulesItemStopAfterIf:
    """
    Attributes:
        expr (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_4_branches_item_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
        )

        flow_module_value_2_type_4_branches_item_modules_item_stop_after_if.additional_properties = d
