...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/w/{workspace}/schedules/list_with_jobs".format(client.base_url, workspace=workspace)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ListSchedulesWithJobsResponse200Item]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[ListSchedulesWithJobsResponse200Item]]:
    return Response(
