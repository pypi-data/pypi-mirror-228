...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/w/{workspace}/apps/get/draft/{path}".format(client.base_url, workspace=workspace, path=path)
...
def _parse_response(*, response: httpx.Response) -> Optional[GetAppByPathWithDraftResponse200]:
...
def _build_response(*, response: httpx.Response) -> Response[GetAppByPathWithDraftResponse200]:
    return Response(
