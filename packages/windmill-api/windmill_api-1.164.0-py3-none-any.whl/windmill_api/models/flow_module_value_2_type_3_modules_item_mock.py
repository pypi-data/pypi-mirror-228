...
T = TypeVar("T", bound="FlowModuleValue2Type3ModulesItemMock")


@attr.s(auto_attribs=True)
class FlowModuleValue2Type3ModulesItemMock:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_3_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        flow_module_value_2_type_3_modules_item_mock.additional_properties = d
