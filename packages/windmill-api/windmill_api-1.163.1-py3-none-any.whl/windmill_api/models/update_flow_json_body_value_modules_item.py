...
from ..models.update_flow_json_body_value_modules_item_mock import UpdateFlowJsonBodyValueModulesItemMock
...
class UpdateFlowJsonBodyValueModulesItem:
    ...
    Attributes:
        ...
        mock (Union[Unset, UpdateFlowJsonBodyValueModulesItemMock]):
    ...
    mock: Union[Unset, UpdateFlowJsonBodyValueModulesItemMock] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_mock, Unset):
            ...
            mock = UpdateFlowJsonBodyValueModulesItemMock.from_dict(_mock)
