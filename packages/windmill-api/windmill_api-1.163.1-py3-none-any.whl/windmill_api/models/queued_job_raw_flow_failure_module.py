...
class QueuedJobRawFlowFailureModule:
    ...
    Attributes:
        ...
        mock (Union[Unset, QueuedJobRawFlowFailureModuleMock]):
        suspend (Union[Unset, QueuedJobRawFlowFailureModuleSuspend]):
        retry (Union[Unset, QueuedJobRawFlowFailureModuleRetry]):
    """
    ...
    mock: Union[Unset, QueuedJobRawFlowFailureModuleMock] = UNSET
    suspend: Union[Unset, QueuedJobRawFlowFailureModuleSuspend] = UNSET
    retry: Union[Unset, QueuedJobRawFlowFailureModuleRetry] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, QueuedJobRawFlowFailureModuleSleepType0):
            sleep = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, QueuedJobRawFlowFailureModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = QueuedJobRawFlowFailureModuleSleepType0.from_dict(_sleep_type_0)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, QueuedJobRawFlowFailureModuleSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = QueuedJobRawFlowFailureModuleSleepType1.from_dict(_sleep_type_1)
        ...
        if isinstance(_mock, Unset):
            ...
            mock = QueuedJobRawFlowFailureModuleMock.from_dict(_mock)
        ...
        if isinstance(_suspend, Unset):
            ...
            suspend = QueuedJobRawFlowFailureModuleSuspend.from_dict(_suspend)
        ...
        if isinstance(_retry, Unset):
            ...
            retry = QueuedJobRawFlowFailureModuleRetry.from_dict(_retry)
