...
T = TypeVar("T", bound="FlowModuleValue2Type3ModulesItemRetryConstant")
...
class FlowModuleValue2Type3ModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_3_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        flow_module_value_2_type_3_modules_item_retry_constant.additional_properties = d
        return flow_module_value_2_type_3_modules_item_retry_constant
