...
from ..models.get_app_by_version_response_200_policy_execution_mode import GetAppByVersionResponse200PolicyExecutionMode
from ..models.get_app_by_version_response_200_policy_triggerables import GetAppByVersionResponse200PolicyTriggerables
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAppByVersionResponse200Policy")


@attr.s(auto_attribs=True)
class GetAppByVersionResponse200Policy:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_triggerables, Unset):
            ...
            triggerables = GetAppByVersionResponse200PolicyTriggerables.from_dict(_triggerables)
        ...
        if isinstance(_execution_mode, Unset):
            ...
            execution_mode = GetAppByVersionResponse200PolicyExecutionMode(_execution_mode)
