...
from fuzzaprox.fuzzaprox.transformation.Transform import Transform
from fuzzaprox.fuzzaprox.transformation.FuzzySet import FuzzySet
from fuzzaprox.fuzzaprox.services.DataService import DataService
...
class Fuzzaprox:
    ...
    def get_denormalised_y_vals(self, data_to_denormalise):
        """ Returns denormalised-Y values """
        return DataService.denormalise(
            orig_values=self.norm_data_y,
            data_to_denormalise=data_to_denormalise
        )
