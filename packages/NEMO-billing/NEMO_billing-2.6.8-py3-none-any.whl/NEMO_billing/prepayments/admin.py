...
class FundAdmin(admin.ModelAdmin):
    ...
    list_filter = [("fund_type", admin.RelatedOnlyFieldListFilter), ("project_prepayment__project", admin.RelatedOnlyFieldListFilter), ("project_prepayment__project__account", admin.RelatedOnlyFieldListFilter)]
