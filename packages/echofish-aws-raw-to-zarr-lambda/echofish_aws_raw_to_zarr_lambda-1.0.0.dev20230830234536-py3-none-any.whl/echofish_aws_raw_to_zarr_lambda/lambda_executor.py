...
class LambdaExecutor:
    ...
    def execute(self, input_message):
        ...
        try:
            ...
            if len(s3_objects) > 0 and self.__overwrite_existing_zarr_store is False:
                ...
                return
            if len(s3_objects) > 0 and self.__overwrite_existing_zarr_store is True:
                print('Zarr store already exists in s3, deleting existing and continuing.')
