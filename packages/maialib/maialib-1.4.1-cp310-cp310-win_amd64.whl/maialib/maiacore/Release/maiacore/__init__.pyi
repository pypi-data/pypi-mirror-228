...
import maialib.maiacore.Release.maiacore
import typing
...
class Chord():
    ...
    def getHarmonicSpectrum(self, numPartials: int = 6, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None) -> typing.Tuple[typing.List[float], typing.List[float]]: ...
    def getIntervals(self, firstNoteAsReference: bool = False) -> typing.List[Interval]: ...
    def getIntervalsFromOriginalSortedNotes(self) -> typing.List[Interval]: ...
    ...
    def getSetharesDissonanceValue(self, numPartials: int = 6, useMinModel: bool = True, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None) -> float: ...
...
class ClefSign():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    C: maialib.maiacore.Release.maiacore.ClefSign # value = <ClefSign.C: 2>
    F: maialib.maiacore.Release.maiacore.ClefSign # value = <ClefSign.F: 1>
    G: maialib.maiacore.Release.maiacore.ClefSign # value = <ClefSign.G: 0>
    P: maialib.maiacore.Release.maiacore.ClefSign # value = <ClefSign.P: 3>
    __members__: dict # value = {'G': <ClefSign.G: 0>, 'F': <ClefSign.F: 1>, 'C': <ClefSign.C: 2>, 'P': <ClefSign.P: 3>}
    pass
class Duration():
    """
    Members:
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BREVE: maialib.maiacore.Release.maiacore.Duration # value = <Duration.BREVE: 34>
    BREVE_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.BREVE_DOT: 35>
    BREVE_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.BREVE_DOT_DOT: 36>
    EIGHTH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.EIGHTH: 22>
    EIGHTH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.EIGHTH_DOT: 23>
    EIGHTH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.EIGHTH_DOT_DOT: 24>
    HALF: maialib.maiacore.Release.maiacore.Duration # value = <Duration.HALF: 28>
    HALF_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.HALF_DOT: 29>
    HALF_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.HALF_DOT_DOT: 30>
    LONG: maialib.maiacore.Release.maiacore.Duration # value = <Duration.LONG: 37>
    LONG_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.LONG_DOT: 38>
    LONG_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.LONG_DOT_DOT: 39>
    MAXIMA: maialib.maiacore.Release.maiacore.Duration # value = <Duration.MAXIMA: 40>
    MAXIMA_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.MAXIMA_DOT: 41>
    MAXIMA_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.MAXIMA_DOT_DOT: 42>
    N1024TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N1024TH: 1>
    N1024TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N1024TH_DOT: 2>
    N1024TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N1024TH_DOT_DOT: 3>
    N128TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N128TH: 10>
    N128TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N128TH_DOT: 11>
    N128TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N128TH_DOT_DOT: 12>
    N16TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N16TH: 19>
    N16TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N16TH_DOT: 20>
    N16TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N16TH_DOT_DOT: 21>
    N256TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N256TH: 7>
    N256TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N256TH_DOT: 8>
    N256TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N256TH_DOT_DOT: 9>
    N32ND: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N32ND: 16>
    N32ND_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N32ND_DOT: 17>
    N32ND_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N32ND_DOT_DOT: 18>
    N512TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N512TH: 4>
    N512TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N512TH_DOT: 5>
    N512TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N512TH_DOT_DOT: 6>
    N64TH: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N64TH: 13>
    N64TH_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N64TH_DOT: 14>
    N64TH_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.N64TH_DOT_DOT: 15>
    QUARTER: maialib.maiacore.Release.maiacore.Duration # value = <Duration.QUARTER: 25>
    QUARTER_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.QUARTER_DOT: 26>
    QUARTER_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.QUARTER_DOT_DOT: 27>
    WHOLE: maialib.maiacore.Release.maiacore.Duration # value = <Duration.WHOLE: 31>
    WHOLE_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.WHOLE_DOT: 32>
    WHOLE_DOT_DOT: maialib.maiacore.Release.maiacore.Duration # value = <Duration.WHOLE_DOT_DOT: 33>
...
class Score():
    ...
    def getChords(self, config: json = None) -> typing.List[typing.Tuple[int, float, Key, Chord]]: ...
    def getChordsDataFrame(self, config: json = None) -> object: ...
    ...
    def getPartsNames(self) -> typing.List[str]: ...
