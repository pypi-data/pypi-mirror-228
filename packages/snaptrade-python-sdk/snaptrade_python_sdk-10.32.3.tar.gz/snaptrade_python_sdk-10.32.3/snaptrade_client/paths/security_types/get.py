...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['SecurityType'], typing.List['SecurityType']],
    ...
    def __getitem__(self, i: int) -> 'SecurityType':
        return super().__getitem__(i)


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: typing.List[SecurityType]
...
class BaseApi(api_client.Api):
    ...
    def _get_security_types_mapped_args(
        self,
...
class GetSecurityTypes(BaseApi):
