...
class ApiResponseFor200(api_client.ApiResponse):
    body: typing.List[BrokerageAuthorization]
...
class BaseApi(api_client.Api):
    ...
    def _list_brokerage_authorizations_mapped_args(
        self,
    ...
    async def _alist_brokerage_authorizations_oapg(
        self,
        query_params: typing.Optional[dict] = {},
    ...
    def _list_brokerage_authorizations_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class ListBrokerageAuthorizations(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_brokerage_authorizations(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        query_params: typing.Optional[dict] = {},
        ...
        args = self._list_brokerage_authorizations_mapped_args(
    ...
    def list_brokerage_authorizations(
        ...
        return self._list_brokerage_authorizations_oapg(
            query_params=args.query,
        )
