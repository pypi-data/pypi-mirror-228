...
class BaseApi(api_client.Api):
    ...
    def _list_user_accounts_mapped_args(
        self,
    ...
    async def _alist_user_accounts_oapg(
        self,
        query_params: typing.Optional[dict] = {},
...
class ListUserAccounts(BaseApi):
    ...
    async def alist_user_accounts(
        ...
        return await self._alist_user_accounts_oapg(
    ...
    def list_user_accounts(
        ...
        return self._list_user_accounts_oapg(
            query_params=args.query,
        )
