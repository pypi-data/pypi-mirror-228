...
from snaptrade_client.exceptions_base import ApiValueError
from snaptrade_client.exceptions import ClientConfigurationError
from snaptrade_client.exceptions import InvalidHostConfigurationError
...
conf = snaptrade_client.Configuration(
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'PartnerClientId' in self.api_key:
            auth['PartnerClientId'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'clientId',
        ...
        if 'PartnerSignature' in self.api_key:
            auth['PartnerSignature'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Signature',
                'value': self.get_api_key_with_prefix(
        ...
        if 'PartnerTimestamp' in self.api_key:
            auth['PartnerTimestamp'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'timestamp',
                'value': self.get_api_key_with_prefix(
