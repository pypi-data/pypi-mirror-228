...
VS Code is the preferred IDE for this repository.

Use the Test extension that is automatically configured in VSCode to run tests using the UI.
...
This project has been created from a template for creating Python projects that follows the Python Standards declared in PEP 621.