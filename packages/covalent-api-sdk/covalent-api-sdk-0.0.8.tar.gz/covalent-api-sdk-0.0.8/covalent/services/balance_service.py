...
class BalanceService:
    ...
    async def get_erc20_transfers_for_wallet_address(self, chain_name: chains, wallet_address: str, quote_currency: Optional[quotes] = None, contract_address: Optional[str] = None, starting_block: Optional[int] = None, ending_block: Optional[int] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[BlockTransactionWithContractTransfers]:
        """
        Parameters:
        ...
        while not success:
            try:
                ...
                async for response in paginate_endpoint(f"https://api.covalenthq.com/v1/{chain_name}/address/{wallet_address}/transfers_v2/", self.__api_key, url_params, BlockTransactionWithContractTransfers):
                    yield response
    ...
    async def get_token_holders_v2_for_token_address(self, chain_name: chains, token_address: str, block_height: Optional[int] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[TokenHolder]:
        """
        Parameters:
        ...
        while not success:
            try:
                ...
                async for response in paginate_endpoint(f"https://api.covalenthq.com/v1/{chain_name}/tokens/{token_address}/token_holders_v2/", self.__api_key, url_params, TokenHolder):
                    yield response
