...
class NftService:
    ...
    async def get_chain_collections(self, chain_name: chains, page_size: Optional[int] = None, page_number: Optional[int] = None, no_spam: Optional[bool] = None) -> AsyncIterable[ChainCollectionItem]:
        """
        Parameters:
        ...
        while not success:
            try:
                ...
                async for response in paginate_endpoint(f"https://api.covalenthq.com/v1/{chain_name}/nft/collections/", self.__api_key, url_params, ChainCollectionItem):
                    yield response
    ...
    async def get_token_ids_for_contract_with_metadata(self, chain_name: chains, contract_address: str, no_metadata: Optional[bool] = None, page_size: Optional[int] = None, page_number: Optional[int] = None, traits_filter: Optional[str] = None, values_filter: Optional[str] = None, with_uncached: Optional[bool] = None) -> AsyncIterable[NftTokenContract]:
        """
        Parameters:
        ...
        while not success:
            try:
                ...
                async for response in paginate_endpoint(f"https://api.covalenthq.com/v1/{chain_name}/nft/{contract_address}/metadata/", self.__api_key, url_params, NftTokenContract):
                    yield response
