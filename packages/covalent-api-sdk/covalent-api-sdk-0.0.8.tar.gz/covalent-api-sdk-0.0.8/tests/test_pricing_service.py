...
class TestPricingService:
    ...
    def test_success(self, client: Client):
        res = client.pricing_service.get_token_prices("eth-mainnet", "CAD", "0x39ee2c7b3cb80254225884ca001f57118c8f21b6")
    ...
    def test_different_quote_currencies(self, client: Client):
        res = client.pricing_service.get_token_prices("eth-mainnet", "EUR", "0xb8c77482e45f1f44de1745f52c74426c631bdd52")
    ...
    def test_incorrect_contract_address(self, client: Client):
