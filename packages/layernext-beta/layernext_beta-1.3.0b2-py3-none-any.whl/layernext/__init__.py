...
class LayerNextClient:
    ...
    def get_file_details(
        ...
        return _datalake_client.get_item_details(unique_file_name, filter)
    ...
    def get_collection_details(
        ...
        return _datalake_client.get_collection_details(collection_id, filter)
    ...
    def download_annotations(self, collection_id: str, operation_id, custom_download_path: str = None):
        ...
        _dataset_client.download_annotations(
            collection_id, annotation_type, operation_id_list)
    ...
    def download_project_annotations(self, project_id, task_status_list: list = [], is_annotated_only: bool = False, custom_download_path: str = None):
        ...
        _dataset_client.download_annotations_for_project_v2(
            project_id_list, task_status_list, is_annotated_only)
