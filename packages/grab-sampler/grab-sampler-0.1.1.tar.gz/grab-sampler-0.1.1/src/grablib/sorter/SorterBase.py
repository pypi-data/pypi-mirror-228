...
from grablib.utils import EventTimer
        ...
        with self.timer("init_random_projection"):
            ...
            match random_projection:
                ...
                case RandomProjectionType.JL_GAUSSIAN:
                    from grablib.utils.random_projection import JLGaussianRP as RP
                case RandomProjectionType.JL_VERY_SPARSE:
                    from grablib.utils.random_projection import JLVerySparseRP as RP
                case RandomProjectionType.KRONECKER:
                    from grablib.utils.random_projection import KroneckerRP as RP
                case _:
                    raise ValueError(
