...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngstd "${_IMPORT_PREFIX}/netgen/libngstd.dylib" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngbla "${_IMPORT_PREFIX}/netgen/libngbla.dylib" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngla "${_IMPORT_PREFIX}/netgen/libngla.dylib" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngfem "${_IMPORT_PREFIX}/netgen/libngfem.dylib" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngcomp "${_IMPORT_PREFIX}/netgen/libngcomp.dylib" )
...
set_target_properties(solve PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/netgen/libsolve.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libsolve.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS solve )
list(APPEND _IMPORT_CHECK_FILES_FOR_solve "${_IMPORT_PREFIX}/netgen/libsolve.dylib" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ngsolve "${_IMPORT_PREFIX}/netgen/libngsolve.dylib" )
