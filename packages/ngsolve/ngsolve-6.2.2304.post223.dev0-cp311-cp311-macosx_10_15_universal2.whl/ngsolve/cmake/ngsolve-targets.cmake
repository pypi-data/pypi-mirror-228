...
set_target_properties(netgen_python PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/Library/Frameworks/Python.framework/Versions/3.11/include/python3.11"
)
...
set_target_properties(ngstd PROPERTIES
  ...
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-std=c++17>;\$<\$<COMPILE_LANGUAGE:CXX>:-Wno-undefined-var-template>;-DMAX_SYS_DIM=3"
  INTERFACE_LINK_LIBRARIES "ngcore;nglib"
)
...
add_library(solve SHARED IMPORTED)

set_target_properties(solve PROPERTIES
  INTERFACE_LINK_LIBRARIES "ngcomp;ngstd;ngfem;ngla;ngbla;nglib"
)
...
file(GLOB CONFIG_FILES "${_DIR}/ngsolve-targets-*.cmake")
