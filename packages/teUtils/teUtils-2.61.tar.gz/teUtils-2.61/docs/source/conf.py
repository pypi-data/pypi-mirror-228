...
# -*- coding: utf-8 -*-
#
# teUtils documentation build configuration file, created by
# sphinx-quickstart 
#
...
#latex_documents = [
#  (master_doc, 'teUtils.tex', u'teUtils Documentation',
#   u'Herbert Sauro', 'manual'),
#]
...
man_pages = [
    (master_doc, 'teUtils', u'teUtils Documentation',
     [author], 1)
]
