...
def agent(
    ...
    deployment_name: str,
    skill_one: AgentSkillConfiguration = None,
    skill_two: AgentSkillConfiguration  = None,
    skill_three: AgentSkillConfiguration = None,
    skill_four: AgentSkillConfiguration = None,
    skill_five: AgentSkillConfiguration = None
):
  ...
  agent_skills = []
  skill_configs = [skill_one, skill_two, skill_three, skill_four, skill_five]
  for config in skill_configs:
    if config:
      agent_skills.append(AgentSkill(config, pf, subscription_id, resource_group_name, workspace_name))
