...
--- | --- | --- | --- | ---
👔  Return caller role in `get_instance_by_id` | [251](https://github.com/laminlabs/lnhub-rest/pull/251) | [bpenteado](https://github.com/bpenteado) | 2023-08-30 | 0.10.18
✨ Create `get_instance_by_id` router | [250](https://github.com/laminlabs/lnhub-rest/pull/250) | [bpenteado](https://github.com/bpenteado) | 2023-08-30 | 0.10.17
♻️ Refactor noxfile, only prettification, no changes | [249](https://github.com/laminlabs/lnhub-rest/pull/249) | [falexwolf](https://github.com/falexwolf) | 2023-08-19 |
