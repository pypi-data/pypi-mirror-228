...
from lnhub_rest._ci import start_local_supabase, supabase
...
def main():
    ...
    if LAMIN_ENV == "local":
        logger.info("Ensuring local Supabase instance is up for LAMIN_ENV=local")
        start_local_supabase()
