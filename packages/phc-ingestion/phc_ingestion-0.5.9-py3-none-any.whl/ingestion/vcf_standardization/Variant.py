...
def check_formatting(var: str) -> str:
...
# I think this is wholly unnecessary to drop this much information from the VCFs.
# Leaving commented out, and will remove if all is good after testing.
