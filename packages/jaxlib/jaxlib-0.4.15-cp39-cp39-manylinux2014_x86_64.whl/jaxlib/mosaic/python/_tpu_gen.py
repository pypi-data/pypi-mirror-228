...
class EnqueueDMAOp(_ods_ir.OpView):
  ...
  def __init__(self, source, source_semaphore, target, target_semaphore, *, device_id=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(source))
    operands.append(_get_op_result_or_value(source_semaphore))
