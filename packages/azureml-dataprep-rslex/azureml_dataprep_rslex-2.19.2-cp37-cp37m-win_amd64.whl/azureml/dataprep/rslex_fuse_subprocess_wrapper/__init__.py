...
import sys
sys.path={sys.path}
from azureml.dataprep.rslex import PyVolumeMountOptions, RslexDirectURIMountContext, init_environment
...
options = PyVolumeMountOptions(None, None, None, None, read_only, 0o777, False)
