...
__all__ = ["list_portfolios", "get_portfolio", "rename_portfolio", "delete_portfolio", "save_index_as_portfolio"]
...
def get_portfolio(portfolio, startdate: str = None, enddate: str = None, shownid: list = None):
    ...
    --------
        ...
        >>> prism.get_portfolio(portfolio="S&P 500")
        {
...
def save_index_as_portfolio(
    ...
    Examples
    --------
        >>> prism.index.portfolio_dataitems("S&P 500")
        ...
        >>> prism.save_index_as_portfolio(dataitemid=4006682)
        {'status': 'Success',
...
def rename_portfolio(old: Union[str, int], new: str):
    ...
    --------
        ...
        >>> prism.rename_portfolio(old='S&P 500', new='newname_snp')
        {'status': 'Success',
...
def delete_portfolio(portfolio: Union[str, int]):
    ...
    --------
        ...
        >>> prism.delete_portfolio(portfolio='S&P 500')
        {'status': 'Success',
