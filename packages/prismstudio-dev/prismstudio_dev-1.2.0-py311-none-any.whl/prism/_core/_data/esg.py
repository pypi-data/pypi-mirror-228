...
class environmental(_PrismESGComponent):
    ...
    def dataitems(cls, search: str = None, package: str = None):
        ...
        Examples
        --------
            >>> env_dataitems = prism.esg.environmental.dataitems()
            >>> print(env_dataitems)
...
class social(_PrismESGComponent):
    ...
    def dataitems(cls, search: str = None, package: str = None):
        ...
        Examples
        --------
            >>> soc_dataitems = prism.esg.social.dataitems()
            >>> print(soc_dataitems)
                dataitemid                                       dataitemname  datamodule                package  dataitemdescription
...
class summary(_PrismESGComponent):
    """
    ...
    def dataitems(cls, search: str = None, package: str = None):
        ...
        Examples
        --------
            >>> sum_dataitems = prism.esg.summary.dataitems()
            >>> print(sum_dataitems)
            dataitemid              dataitemname  datamodule                package                                dataitemdescription
