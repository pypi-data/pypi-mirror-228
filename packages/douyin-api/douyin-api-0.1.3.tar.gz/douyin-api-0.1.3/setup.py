...
"""
pip install -U douyin-api
pip --no-cache-dir install -U douyin-api
...
setup(
    ...
    # 官网地址
    url="https://github.com/ldsxp/douyin-api",
    # 程序的下载地址
    download_url="https://pypi.org/project/douyin-api",
    # 作者
    author="lds",
    # 作者的邮箱地址
