    ...
    def connect(self) -> AnyscaleClientContext:
        ...
        if not feature_flag_on:
            ...
            self._log.warning(
                ...
                "https://docs.anyscale.com/user-guide/develop-and-debug/workspaces or Ray Jobs "
                "https://docs.anyscale.com/user-guide/develop-and-debug/ray-jobs-support instead."
            )
