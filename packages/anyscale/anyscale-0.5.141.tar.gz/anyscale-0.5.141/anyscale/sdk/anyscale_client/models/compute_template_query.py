...
class ComputeTemplateQuery(object):
    ...
    def __init__(self, orgwide=False, project_id=None, creator_id=None, name=None, include_anonymous=False, archive_status=None, cloud_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def cloud_id(self):
        ...
        Filters Compute Templates by cloud. This is only supported when `orgwide` is True.  # noqa: E501
