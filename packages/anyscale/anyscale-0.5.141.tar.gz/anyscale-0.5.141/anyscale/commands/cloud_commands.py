...
def register_cloud(  # noqa: PLR0913
    ...
    if provider == "aws":
        ...
        # Only memorystore_instance_name is optional for GCP clouds
        for resource in [
...
def cloud_edit(  # noqa: PLR0913
    ...
    if any(
        ...
        raise click.ClickException(
            "Please provide at least one of the following arguments: --aws-s3-id, --aws-efs-id, --aws-efs-mount-target-ip, --gcp-filestore-instance-id, --gcp-filestore-location, --gcp-cloud-storage-bucket-name."
        )
