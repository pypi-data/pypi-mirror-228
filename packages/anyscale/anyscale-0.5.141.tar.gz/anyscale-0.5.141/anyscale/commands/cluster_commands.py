...
@click.option(
    ...
    help=(
        ...
        "An example can be found at {website}. ".format(
            website="https://docs.anyscale.com/user-guide/configure/cluster-computes",
        )
    ),
)
@click.option(
...
@click.option(
    ...
    required=False,
    default=None,
    help="DEPRECATED: Please specify the idle_termination_minutes field in the cluster compute. "
