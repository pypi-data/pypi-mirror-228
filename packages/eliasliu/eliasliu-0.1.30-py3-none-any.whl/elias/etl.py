...
def excel_to_mysql(m_id,mission_name,name,comment,file,sheet,skiprows,hosts_write,hosts_record,robot_key,index_columns_list=[],wtype='r',excel_type = 'excel',encoding='utf-8'):
