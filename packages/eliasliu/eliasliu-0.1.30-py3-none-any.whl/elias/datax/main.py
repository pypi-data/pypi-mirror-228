...
def run(data):
    ...
    try:
        ...
        file_path = job.datax_json_config(origin_table_name,origin_hosts,target_table_name,target_hosts,channel,record,percentage)
        return file_path
...
def main(args):
    ...
    try:
        act.auto_create(origin_table_name,origin_hosts,target_table_name,target_hosts)
        job.datax_json_config(origin_table_name,origin_hosts,target_table_name,target_hosts,channel,record,percentage)
