...
from .utils import version as __version__, init, reset_limit, minus_limit, get_limit, has_group, has_user, set_user, get_groups, get_users, format_msg
...
async def divine(matcher: Matcher, event: Event):
    global DEBUG
