...
import cv2
import numpy as np
from YODE_Segmentation.Image_Processing import binary_img
from YODE_Segmentation.Image_Processing import get_threshold_keys
...
def get_molecular(init_path,mask_path,value):
    for file_name in os.listdir(mask_path):
        ...
        for key in list_keys:
            ...
            temp = temp+1
    print("Processing done:The extracted chemical molecular structure diagrams are stored in the result_img folder")
