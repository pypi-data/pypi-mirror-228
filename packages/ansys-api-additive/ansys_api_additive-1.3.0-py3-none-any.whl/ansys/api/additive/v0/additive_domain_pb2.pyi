...
class MachineSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["beam_diameter",b"beam_diameter","hatch_spacing",b"hatch_spacing","heater_temperature",b"heater_temperature","laser_power",b"laser_power","layer_rotation_angle",b"layer_rotation_angle","layer_thickness",b"layer_thickness","scan_speed",b"scan_speed","slicing_stripe_width",b"slicing_stripe_width","starting_layer_angle",b"starting_layer_angle"]) -> None: ...
...
class MeltPool(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["time_steps",b"time_steps"]) -> None: ...
...
class SingleBeadInput(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bead_length",b"bead_length","machine",b"machine","material",b"material"]) -> None: ...
...
class MaterialTuningResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["characteristic_width_lookup",b"characteristic_width_lookup","log",b"log","optimized_parameters",b"optimized_parameters"]) -> None: ...
