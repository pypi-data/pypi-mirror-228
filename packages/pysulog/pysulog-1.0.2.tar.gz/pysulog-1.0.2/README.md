...
Example output:
```
ubuntu@ubuntu:~/github/pysulog/test$ ulog_messages sample.ulg
...
```
ubuntu@ubuntu:~/github/pysulog/test$ ulog_params sample.ulg
ATT_ACC_COMP,1
...
Example output (to console):
```
ubuntu@ubuntu:~/github/pysulog$ ulog_migratedb
Using migration files in /home/ubuntu/github/pysulog/pysulog/sql.
Database file pysulog.sqlite3 not found, creating it from scratch.
Current schema version: 0 (database) and 1 (code).
Executing /home/ubuntu/github/pysulog/pysulog/sql/pysulog.1.sql.
Migration done.
```
