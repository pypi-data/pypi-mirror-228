...
__all__ = (
    ...
    "TestingDataPaginatorTypeDef",
    "TestingDataTypeDef",
    "TrainingDataPaginatorTypeDef",
    "TrainingDataTypeDef",
    ...
    "TestingDataResultPaginatorTypeDef",
    "TestingDataResultTypeDef",
    "TrainingDataResultPaginatorTypeDef",
    ...
    "ProjectVersionDescriptionPaginatorTypeDef",
    "ProjectVersionDescriptionTypeDef",
    "DescribeProjectVersionsResponsePaginatorTypeDef",
...
TestingDataPaginatorTypeDef = TypedDict(
    "TestingDataPaginatorTypeDef",
    {
...
TrainingDataPaginatorTypeDef = TypedDict(
    "TrainingDataPaginatorTypeDef",
    {
        "Assets": NotRequired[List[AssetTypeDef]],
    },
...
TestingDataResultPaginatorTypeDef = TypedDict(
    "TestingDataResultPaginatorTypeDef",
    {
        "Input": NotRequired[TestingDataPaginatorTypeDef],
        "Output": NotRequired[TestingDataPaginatorTypeDef],
...
TrainingDataResultPaginatorTypeDef = TypedDict(
    "TrainingDataResultPaginatorTypeDef",
    {
        "Input": NotRequired[TrainingDataPaginatorTypeDef],
        "Output": NotRequired[TrainingDataPaginatorTypeDef],
        "Validation": NotRequired[ValidationDataTypeDef],
    },
)
...
ProjectVersionDescriptionPaginatorTypeDef = TypedDict(
    "ProjectVersionDescriptionPaginatorTypeDef",
    {
        ...
        "TrainingDataResult": NotRequired[TrainingDataResultPaginatorTypeDef],
        "TestingDataResult": NotRequired[TestingDataResultPaginatorTypeDef],
...
DescribeProjectVersionsResponsePaginatorTypeDef = TypedDict(
    "DescribeProjectVersionsResponsePaginatorTypeDef",
    {
        "ProjectVersionDescriptions": List[ProjectVersionDescriptionPaginatorTypeDef],
        "NextToken": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
