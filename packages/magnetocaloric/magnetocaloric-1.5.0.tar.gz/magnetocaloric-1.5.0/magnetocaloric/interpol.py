...
def interpol(path, int_val, final_val, interval, interpol_type, interpolation, deg):
    ...
    for i in range(n_cols):
        prov_T.append(sheet.cell_value(0, i))
    ...
    if (interpol_type == 'poly'):
        ...
        for i in range (0, len(prov_data)):
            ...
            plt.scatter(prov_H, prov_data[i], marker = '.')
            plt.plot(H, M_fitted_con[i], linestyle='solid', linewidth= 0.5)
        plt.xlabel("H_unit", fontname = "monospace")
        plt.ylabel("M_unit", fontname = "monospace")
        plt.title(f"M-H interpolation", fontname = "monospace")
        #plt.show()
        ...
        for i in range (0, len(prov_data)):
            ...
            plt.scatter(prov_H, prov_data[i], marker = '.')
            plt.plot(H, total_interp_M_con[i], linestyle='solid', linewidth= 0.5)
        plt.xlabel("H_unit", fontname = "monospace")
        plt.ylabel("M_unit", fontname = "monospace")
        plt.title(f"M-H interpolation", fontname = "monospace")
        #plt.show()
