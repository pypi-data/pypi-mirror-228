...
# install with python setup.py sdist

setup(
    name='invoice-excel-pdf',  # * Your package will have this name
                               # Official name on PyPi
                               # not found on PyPi
    packages=['invoicing'],    # * Name the package again
    version='1.0.0',          # * To be increased every time your change your
    # library
    license='MIT',  # Type of license. More here:
    # https://help.github.com/articles/licensing-a-repository
    description='This package can be used to convert Excel invoices to '
                'PDF invoices.',  # Short description of your library
    author='Mike Gitchell',       # Your name
    author_email='mgaggie@aol.com',  # Your email
