...
class QuadraticDiscriminantAnalysis(BaseTransformer):
    ...
    def __init__(  # type: ignore
        ...
        *,
        ...
        self._sklearn_object = sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis(
    ...
    def fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "QuadraticDiscriminantAnalysis":
