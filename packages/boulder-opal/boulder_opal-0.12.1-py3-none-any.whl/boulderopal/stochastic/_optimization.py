...
def run_stochastic_optimization(
    ...
    dict
        ...
        ``metadata``
            Metadata associated with the optimization. No guarantees are made about the contents
            of this metadata dictionary; the contained information is intended purely to help
            interpret the results of the optimization on a one-off basis.
    ...
    .. [1] `R. Wu, H. Ding, D. Dong, and X. Wang, Physical Review A 99, 042327 (2019).
            <https://link.aps.org/doi/10.1103/PhysRevA.99.042327>`_
    ...
    return run_stochastic_optimization_workflow(
        ...
        iteration_count=ScalarDType.INT(iteration_count, "iteration_count", min_=0),
        target_cost=nullable(ScalarDType.REAL, target_cost, "target_cost"),
        cost_history_scope=validate_enum(HistoryScope, cost_history_scope),
        seed=nullable(ScalarDType.INT, seed, "seed", min_=0, min_inclusive=True),
    )
