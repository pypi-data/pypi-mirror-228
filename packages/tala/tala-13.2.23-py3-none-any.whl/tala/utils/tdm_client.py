...
class TDMClient(Observable):
    ...
    def request_speech_input(
        self, hypotheses: Sequence[InputHypothesis], session: Mapping = None
    ) -> Mapping:
    ...
    def request_semantic_input(
        self, interpretations: Sequence[Interpretation], session: Mapping = None
    ) -> Mapping:
    ...
    def request_event_notification(
        self, notification: EventNotification, session: Mapping = None
    ) -> Mapping:
