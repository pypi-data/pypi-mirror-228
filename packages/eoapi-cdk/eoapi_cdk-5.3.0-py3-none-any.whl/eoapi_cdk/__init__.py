...
@jsii.data_type(
    jsii_type="eoapi-cdk.ApiEntrypoint",
    jsii_struct_bases=[],
...
class BootstrapPgStac(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="eoapi-cdk.BootstrapPgStac",
):
...
@jsii.data_type(
    jsii_type="eoapi-cdk.BootstrapPgStacProps",
    jsii_struct_bases=[],
    name_mapping={
        "database": "database",
        "db_secret": "dbSecret",
...
class PgStacApiLambda(
    ...
    def __init__(
        ...
        *,
        ...
        stac_api_domain_name: typing.Optional[aws_cdk.aws_apigatewayv2_alpha.IDomainName] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class PgStacApiLambdaProps:
    ...
    def stac_api_domain_name(
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_apigatewayv2_alpha.IDomainName], result)
...
class StacBrowser(
    ...
    def __init__(
        ...
        *,
        ...
        :param stac_catalog_url: (experimental) STAC catalog URL.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StacBrowser.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def bucket(self, value: aws_cdk.aws_s3.IBucket) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(StacBrowser, "bucket").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def bucket_deployment(
        self,
        value: aws_cdk.aws_s3_deployment.BucketDeployment,
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(StacBrowser, "bucket_deployment").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class StacBrowserProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StacBrowserProps.__init__)
...
class StacIngestor(
    ...
    def __init__(
        ...
        *,
        ...
        ingestor_domain_name_options: typing.Optional[typing.Union[aws_cdk.aws_apigateway.DomainNameOptions, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class StacIngestorProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(ingestor_domain_name_options, dict):
            ingestor_domain_name_options = aws_cdk.aws_apigateway.DomainNameOptions(**ingestor_domain_name_options)
        if __debug__:
    ...
    def ingestor_domain_name_options(
        self,
    ) -> typing.Optional[aws_cdk.aws_apigateway.DomainNameOptions]:
...
@jsii.data_type(
    jsii_type="eoapi-cdk.TiPgApiEntrypoint",
    jsii_struct_bases=[],
    name_mapping={"entry": "entry", "handler": "handler", "index": "index"},
)
class TiPgApiEntrypoint:
    def __init__(
        self,
        *,
        entry: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TiPgApiEntrypoint.__init__)
            check_type(argname="argument entry", value=entry, expected_type=type_hints["entry"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
            check_type(argname="argument index", value=index, expected_type=type_hints["index"])
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def __repr__(self) -> str:
        return "TiPgApiEntrypoint(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class TiPgApiLambda(
    ...
    def __init__(
        ...
        *,
        ...
        subnet_selection: typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]],
        vpc: aws_cdk.aws_ec2.IVpc,
        api_code: typing.Optional[typing.Union[TiPgApiEntrypoint, typing.Dict[str, typing.Any]]] = None,
        api_env: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        tipg_api_domain_name: typing.Optional[aws_cdk.aws_apigatewayv2_alpha.IDomainName] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TiPgApiLambda.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def ti_pg_lambda_function(self) -> aws_cdk.aws_lambda_python_alpha.PythonFunction:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_lambda_python_alpha.PythonFunction, jsii.get(self, "tiPgLambdaFunction"))
    ...
    def ti_pg_lambda_function(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(TiPgApiLambda, "ti_pg_lambda_function").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class TiPgApiLambdaProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(subnet_selection, dict):
            subnet_selection = aws_cdk.aws_ec2.SubnetSelection(**subnet_selection)
        if isinstance(api_code, dict):
            api_code = TiPgApiEntrypoint(**api_code)
        if __debug__:
            type_hints = typing.get_type_hints(TiPgApiLambdaProps.__init__)
            check_type(argname="argument db", value=db, expected_type=type_hints["db"])
            check_type(argname="argument db_secret", value=db_secret, expected_type=type_hints["db_secret"])
            check_type(argname="argument subnet_selection", value=subnet_selection, expected_type=type_hints["subnet_selection"])
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
    ...
    @builtins.property
    def api_code(self) -> typing.Optional[TiPgApiEntrypoint]:
        '''(experimental) Custom code to run for fastapi-pgstac.
        ...
        '''
        result = self._values.get("api_code")
        return typing.cast(typing.Optional[TiPgApiEntrypoint], result)
...
class TitilerPgStacApiLambdaProps:
    def __init__(
        ...
        *,
        ...
        titiler_pgstac_api_domain_name: typing.Optional[aws_cdk.aws_apigatewayv2_alpha.IDomainName] = None,
    ) -> None:
        '''
        :param db: (experimental) RDS Instance with installed pgSTAC.
        :param db_secret: (experimental) Secret containing connection information for pgSTAC database.
        ...
        :param titiler_pgstac_api_domain_name: (experimental) Custom Domain Name Options for Titiler Pgstac API,.
