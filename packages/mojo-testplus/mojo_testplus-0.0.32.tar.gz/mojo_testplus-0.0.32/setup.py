...
['click>=8.1.3,<9.0.0',
 'debugpy>=1.6.5,<2.0.0',
 'mojo-collections>=0.0.11,<0.1.0',
 'mojo-config>=0.0.20,<0.1.0',
 'mojo-errors>=0.0.1,<0.1.0',
 'mojo-runtime>=0.0.71,<0.1.0',
 'mojo-xmodules>=0.0.87,<0.1.0',
 'requests<=2.29.0']

extras_require = \
{'couchdb': ['couchdb>=1.2,<2.0'],
 'interop': ['mojo-interop>=0.0.29,<0.1.0'],
