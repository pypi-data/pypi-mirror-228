...
class TestBatchUploadEggsMain(MainTestingMixin, unittest.TestCase):
    ...
    def test_batch_upload_non_existing_file(self):
        ...
        # Different versions of click evidently prefer ' vs. " quotes, so
        # normalize before comparing.
        self.assertRegexpMatches(result.output.replace("'", '"'),
                                 re.escape(r_error.replace("'",'"')))
    ...
    def test_batch_upload_directory_fails(self):
        ...
        self.assertRegexpMatches(
            ...
            re.escape(r_error_template.format(tempdir).replace("'",'"')))
