...
class BroodResponses(object):
    ...
    def dummy_runtime_metadata(self, body):
        return {
            "build": 1,
            "file_format": "zip",
            "filename": "python_runtime_2.7.3_2.0.0.dev1-c9fa3fa_rh5-64_1.zip",
    ...
    def test_runtime_metadata(self, python_tag, full_version, expected):
        responses.add(
            responses.GET,
            self.response(
                path=self.urls.metadata.artefacts.runtimes.format(
