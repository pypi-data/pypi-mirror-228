...
class Model:
    ...
    def find_by(cls, where: str, *args, **kwargs):
        ...
        DeprecationWarning: please use where replace, like this:  Person.fields('id', 'name', 'age').where('where name=?').find('李四')
        """
        log_support.orm_by_log(sys._getframe().f_code.co_name, cls.__name__, where, *args, **kwargs)
    ...
    def query_by(cls, where: str, *args, **kwargs):
        ...
        DeprecationWarning: please use where replace, like this:  Person.fields('id', 'name', 'age').where('where name=?').query('李四')
        """
        log_support.orm_by_log(sys._getframe().f_code.co_name, cls.__name__, where, *args, **kwargs)
    ...
    def select_by(cls, where: str, *args, **kwargs):
        ...
        DeprecationWarning: please use where replace, like this:  Person.fields('id', 'name', 'age').where('where name=?').select('李四')
        """
        log_support.orm_by_log(sys._getframe().f_code.co_name, cls.__name__, where, *args, **kwargs)
        sql = cls._where_sql(where)
        sql, args = simple_sql(sql, *args, **kwargs)
    ...
    def find_page_by(cls, page_num: int, page_size: int, where: str, *args, **kwargs):
        ...
        DeprecationWarning: replace like: Person.fields('id', 'name', 'age').where('where name=?').page(1, 10).find('李四')
        """
    ...
    def query_page_by(cls, page_num: int, page_size: int, where: str, *args, **kwargs):
        ...
        DeprecationWarning: replace like: Person.fields('id', 'name', 'age').where('where name=?').page(1, 10).query('李四')
        """
    ...
    def select_page_by(cls, page_num: int, page_size: int, where: str, *args, **kwargs):
        ...
        DeprecationWarning: replace like: Person.fields('id', 'name', 'age').where('where name=?').page(1, 10).select('李四')
        """
        log_support.orm_by_page_log(sys._getframe().f_code.co_name, page_num, page_size, cls.__name__, where, *args, **kwargs)
        sql = cls._where_sql(where)
        sql, args = simple_sql(sql, *args, **kwargs)
    ...
    @classmethod
    def where(cls, where: str):
        return orm_support.WhereExec(cls, where)

    @classmethod
    def page(cls, page_num=1, page_size=10):
        return cls.where(None).page(page_num, page_size)
