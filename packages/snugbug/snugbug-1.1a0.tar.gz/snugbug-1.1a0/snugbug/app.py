...
def leave_chat(username, room):
    ...
    sio.disconnect()
    print("[bold green]Leaving the chat and exiting...[/bold green]")
    raise SystemExit
        ...
        if message.strip()=="/help":
            ...
            if message.strip() == "/send":
                if paste_buffer:
                    ...
                    print(
                        "[blod green]Code sent. Reverting to message mode.[/bold green]"
                    )
                    paste_mode = False
                    paste_buffer = []
                else:
            ...
            if message.strip() == "/send":
                if stick_file_path:
                    if os.path.exists(stick_file_path):
                        ...
                        print(
                            "[bold green]File link sent. Reverting to message mode.[/bold green]"
                        )
                    else:
                        print(
