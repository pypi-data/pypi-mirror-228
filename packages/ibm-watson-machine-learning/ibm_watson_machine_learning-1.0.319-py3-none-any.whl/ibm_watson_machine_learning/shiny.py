...
class Shiny(WMLResource):
    ...
    def _create_asset(self, shiny_meta, file_path):
        ...
        if self._client.ICP_46 or self._client.ICP_47 or self._client.ICP_48:
        ...
        if not self._client.CLOUD_PLATFORM_SPACES and not self._client.ICP_PLATFORM_SPACES:
            ...
            if (self._client.ICP_46 or self._client.ICP_47 or self._client.ICP_48) and shiny_sw_spec_id:
