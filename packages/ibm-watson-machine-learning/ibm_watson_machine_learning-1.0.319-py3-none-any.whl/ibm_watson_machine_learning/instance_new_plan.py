...
class ServiceInstanceNewPlan:
    ...
    def _get_cpd_token_from_request(self):
        ...
        :rtype: str
        """
        if (self._client.ICP_40 or self._client.ICP_45 or self._client.ICP_46 or self._client.ICP_47 or self._client.ICP_48) and 'bedrock_url' in self._client.wml_credentials and 'password' in self._client.wml_credentials:
            try:
