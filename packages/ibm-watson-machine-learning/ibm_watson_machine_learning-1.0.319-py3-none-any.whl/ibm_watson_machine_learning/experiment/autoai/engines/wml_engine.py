...
class WMLEngine(BaseEngine):
    ...
    def _initialize_wml_pipeline_metadata(self, **kwargs) -> None:
        ...
        if self._wml_client.CLOUD_PLATFORM_SPACES or self._wml_client.ICP_45 or self._wml_client.ICP_46 or self._wml_client.ICP_47 or self._wml_client.ICP_48:
        ...
        if self._auto_pipelines_parameters['data_join_graph']:
            ...
            if not self._wml_client.ICP:
                ...
                if self._wml_client.ICP_45 or self._wml_client.ICP_46 or self._wml_client.ICP_47 or self._wml_client.ICP_48:
