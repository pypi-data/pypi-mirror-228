    ...
    def optimizer(self,
        ...
        **Examples**
        ...
        if data_join_graph is not None:
            if self._workspace.wml_client.ICP_46 or self._workspace.wml_client.ICP_47 or self._workspace.wml_client.ICP_48:
        ...
        if train_sample_rows_test_size and (self._workspace.wml_client.ICP_46 or self._workspace.wml_client.ICP_47 or self._workspace.wml_client.ICP_48):
