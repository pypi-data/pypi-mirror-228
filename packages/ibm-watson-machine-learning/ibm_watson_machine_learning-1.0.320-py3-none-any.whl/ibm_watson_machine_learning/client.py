...
import logging
import ibm_watson_machine_learning.utils
...
class APIClient:
    ...
    def __init__(self, wml_credentials, project_id=None, verify=None):
        ...
        self.ICP_48 = False  # Use it for any 4.8 specific functionalities
        ...
        self.__wml_local_supported_version_list = ['1.0', '1.1',
                                                   ...
                                                   '3.0.0', '3.0.1', '3.5', '4.0', '4.5', '4.6', '4.7', '4.8']
            ...
            if 'icp' == self.wml_credentials[u'instance_id'].lower() or 'openshift' == self.wml_credentials[
                ...
                if response_get_wml_services.status_code ==200:
                    ...
                    if wml_version:
                        ...
                        if self.wml_credentials['version'] not in self.__wml_local_supported_version_list:
                            raise WMLClientError(
                                Messages.get_message(self.wml_credentials['version'], package_release_version,
                ...
                if 'version' in self.wml_credentials.keys() and (self.wml_credentials[u'version'].lower() in ['3.5', '4.0', '4.5', '4.6', '4.7', '4.8', '1.1', '2.0']):
                    self.CAMS = True
                    ...
                    if self.wml_credentials[u'version'].lower() in ['4.0', '4.5', '4.6', '4.7', '4.8']:
                        self.ICP_PLATFORM_SPACES = True
                        ...
                        self.ICP_48 = self.wml_credentials[u'version'].lower() == '4.8'
    ...
    @staticmethod
    def _get_api_version_param():
        try:
            file_name = 'API_VERSION_PARAM'
            path = os.path.dirname(ibm_watson_machine_learning.utils.__file__)
