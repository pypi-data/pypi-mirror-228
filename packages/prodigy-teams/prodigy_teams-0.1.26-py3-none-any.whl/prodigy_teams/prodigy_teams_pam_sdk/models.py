...
class Resources(BaseModel):
    ...
    Devices: Optional[Dict[str, Any]] = Field(None, title="Devices")
...
class WorkerClassResources(BaseModel):
    cores: int = Field(..., title="Cores")
    memory_mb: int = Field(..., title="Memory Mb")
    gpus: Optional[int] = Field(0, title="Gpus")
    gpu_memory_mb: Optional[int] = Field(None, title="Gpu Memory Mb")


class WorkerClassSpec(BaseModel):
    name: str = Field(..., title="Name")
    resources: WorkerClassResources
    description: str = Field(..., title="Description")
    instance_type: str = Field(..., title="Instance Type")
    cloud_provider: Optional[str] = Field("aws", title="Cloud Provider")
...
class BrokerDetail(BaseModel):
    ...
    client_id: UUID = Field(..., title="Client Id")
    client_secret: str = Field(..., title="Client Secret")
    worker_classes: List[WorkerClassSpec] = Field(..., title="Worker Classes")
