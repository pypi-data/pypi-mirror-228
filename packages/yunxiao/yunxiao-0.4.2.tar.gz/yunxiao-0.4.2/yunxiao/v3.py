...
from .yunxiao import YunXiao, Time
import requests
...
class V3(YunXiao):
        ...
        def wrapper_func(func):
            def wrapper(*args, **kwargs):
                ...
                while page <= page_count:  # 列表中数据行的数量不等于 1 时
                    ...
                    print(f"size: {size}, page: {page}/{page_count}, {page * size}/{row_count}")  # 汇报数量
                    page += 1  # 翻页
                return data_list
    ...
    # 查询机构指定日期范围业绩。
    def company_query_performance(self, startdate: str = Time.this_month_start,
                                  enddate: str = Time.this_month_end) -> list:
        """
        查询机构指定日期范围业绩。
    ...
    # 查询指定日期范围业绩（APP接口）
    def campus_query_performance(self, start: str = Time.this_month_start, end: str = Time.this_month_end) -> list:
        """
        分校区列出指定日期的费用数据。
        :param start:
        :param end:
    ...
    def teachers_query(self, page, size, name: str = "", status: tuple = (1,)):
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-crm/teacher/pageList",
            json={
                "_t_": Time.stamp_ms,
    ...
    def students_query(self, page, size, curriculumids: tuple = (), classids: tuple = (), student_ids: tuple = (),
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-crm/student/extendList",
            json={
                "_t_": Time.stamp_ms,
                "campusIds": self.campus,
    ...
    def student_query_info(self, student_id: int):
        ...
        return self.request(
            method="get",
            url="https://yunxiao.xiaogj.com/api/cs-pc-crm/student/detail",
            params={
                "_t_": Time.stamp_ms,
                "id": student_id,
                "queryMember": True,
    ...
    def student_query_cards(self, studentid: int) -> list:
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/studentCard/list",
            json={
                "_t_": Time.stamp_ms,
                "studentId": studentid
            }
    ...
    def student_query_course(self, studentid: int) -> list:
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/courseStudent/findStudentAttendCourse",
            json={
                "_t_": Time.stamp_ms,
                "studentId": studentid,
    ...
    def student_operation_become_history(self, studentlist: tuple):
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/student/becomeHistory",
            json={"_t_": Time.stamp_ms, "studentIds": list(studentlist)}
        )
    ...
    def student_operation_become_study(self, studentlist: tuple):
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/student/becomeStudy",
            json={"_t_": Time.stamp_ms, "studentIds": list(studentlist)}
        )
    ...
    def curriculums_query(self, page: int, size: int, searchname: str = None):
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/curriculum/page",
            json={
                "_t_": Time.stamp_ms,
                "page": {"pageNum": page, "pageSize": size},
    ...
    # 查排课
    @loop_pages()
    def arranges_query(self, page, size, starttime: str = Time.last_week_monday, classid: int = "",
                       endtime: str = Time.next_week_sunday, teacherids: tuple = (), studentids: tuple = (),
                       display_completed_class: bool = False, courseStatusList: tuple = (0, 1)):
        """
        查询某日到某日的排课。
        :param classid: 班级
        :param size: 分页查询，每页数量
    ...
    def classes_query(self, page, size, teacherids: tuple = (), class_ids: tuple = (), class_status: tuple = ()):
        ...
        return self.request(
            method="post",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/classInfo/page",
            json={
                "_t_": Time.stamp_ms,
                "queryClassTime": 1,
                "campusIds": self.campus,
    ...
    def class_query_info(self, classid: int = None) -> dict:
        ...
        return self.request(
            method="get",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/classInfo/getClassInfoVo",
            params={
                "_t_": Time.stamp_ms,
                "classId": classid
            }
    ...
    def class_query_student(self, classid: int, inout: int = 1) -> list:
        ...
        return self.request(
            method="get",
            url="https://yunxiao.xiaogj.com/api/cs-pc-edu/classStudent/queryClassStudentList",
    ...
    def charges_query_record(self, page, size, startdate: str = Time.this_month_start,
                             enddate: str = Time.this_month_end, class_id: int = None, student_id: int = None,
                             curriculum_ids: tuple = (), teacher_ids: tuple = ()):
        """
        列出指定上课日期范围的所有课消记录
        :param teacher_ids:
    ...
    def comefroms_query(self):
        return self.request(
            ...
            params={"_t_": Time.stamp_ms, "customFieldId": "26118419"}
        )["data"]["selectItemList"]
