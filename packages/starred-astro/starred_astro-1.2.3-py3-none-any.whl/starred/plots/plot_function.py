...
def single_PSF_plot(model, data, sigma_2, kwargs, n_psf=0, figsize=(15, 8), units=None, upsampling=None, masks=None):
    """
    ...
    fig.colorbar(axs[0, 2].imshow(rr, origin='lower', alpha = alphas[n_psf,:,:]), ax=axs[0, 2], fraction=fraction, pad=pad)
...
def multiple_PSF_plot(model, data, sigma_2, kwargs, masks=None, figsize=None, units=None, vmin=None, vmax=None):
    """
