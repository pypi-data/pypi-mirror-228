...
class ParametersDeconv(Parameters):
    ...
    def __init__(self, kwargs_init, kwargs_fixed, kwargs_up=None, kwargs_down=None):
        ...
        self.epochs = len(kwargs_init['kwargs_analytic']['dx']) + 1  # + 1 here because we assign a 0-shift to epoch 0.
        ...
        for name in param_names:
            if not name in kwargs_fixed_k:
                if name == 'a':
                    ...
                    num_param = self.background_param_number ** 2
                elif name == 'mean':
                    num_param = self.epochs
                elif name == 'dx' or name == 'dy':
                    num_param = self.epochs - 1
