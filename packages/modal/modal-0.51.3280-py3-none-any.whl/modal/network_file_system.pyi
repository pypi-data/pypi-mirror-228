...
async def load_network_file_systems(network_file_systems: typing.Dict[typing.Union[str, os.PathLike], _NetworkFileSystem], allow_cross_region_volumes: bool, resolver: modal._resolver.Resolver) -> typing.List[modal_proto.api_pb2.SharedVolumeMount]:
    ...
