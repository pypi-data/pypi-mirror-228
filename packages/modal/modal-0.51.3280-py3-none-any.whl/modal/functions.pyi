...
class _Function(modal.object._Object):
    ...
    def from_parametrized(self, args: typing.Iterable[typing.Any], kwargs: typing.Dict[str, typing.Any]) -> _Function:
        ...
...
class Function(modal.object.Object):
    ...
    def from_parametrized(self, args: typing.Iterable[typing.Any], kwargs: typing.Dict[str, typing.Any]) -> Function:
        ...
...
class _PartialFunction:
    @staticmethod
    def initialize_cls(user_cls: type, functions: typing.Dict[str, _Function]):
        ...

    @staticmethod
    def initialize_obj(user_obj, functions: typing.Dict[str, _Function]):
        ...
...
class PartialFunction:
    ...
    @staticmethod
    def initialize_cls(user_cls: type, functions: typing.Dict[str, Function]):
        ...

    @staticmethod
    def initialize_obj(user_obj, functions: typing.Dict[str, Function]):
        ...
...
def _web_endpoint(method: str = 'GET', label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], _PartialFunction]:
    ...


def _asgi_app(label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], _PartialFunction]:
    ...


def _wsgi_app(label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], _PartialFunction]:
    ...
...
def web_endpoint(method: str = 'GET', label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], PartialFunction]:
    ...


def asgi_app(label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], PartialFunction]:
    ...


def wsgi_app(label: typing.Union[str, None] = None, wait_for_response: bool = True, custom_domains: typing.Union[typing.Iterable[str], None] = None) -> typing.Callable[[typing.Callable[..., typing.Any]], PartialFunction]:
    ...
