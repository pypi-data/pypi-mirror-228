...
REQUIRES = ["aspose-3d==23.8.0",
            "aspose-barcode-for-python-via-net==23.8",
            "aspose-cad==23.6",
            "aspose-cells-python==23.8.0",
            "aspose-diagram-python==23.8.0",
            "Aspose.Email-for-Python-via-NET==23.7",
            "aspose-imaging-python-net==23.8.0",
            "aspose-ocr-python-net==23.8.0",
            "aspose-pdf==23.8.0",
