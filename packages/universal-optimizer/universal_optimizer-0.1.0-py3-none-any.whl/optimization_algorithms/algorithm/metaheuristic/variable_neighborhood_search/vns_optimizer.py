...
class VnsOptimizer(Metaheuristic, Generic[S_co]):
    """
    Instance of the class VnsOptimizer encapsulate VNS optimization algorithm.
    ...
    def __copy__(self):
        ...
        :rtype: :class:`optimization_algorithms.algorithm.metaheuristic.variable_neighborhood_search.VnsOptimizer`        
        """
