...
setup(
    name="edu-yh",
    # todo 直接设置pypi版本，只能升不能降
    version='4.1.4',
    description="Python IDE for beginners",
    long_description="use thonny program, is a simple Python IDE with features useful for learning programming."
                     " See https://thonny.org for more info.",
