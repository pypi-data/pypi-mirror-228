...
class homeworkAndExamDialog(CommonDialog):
    def __init__(self, master):
        ...
        for i, label in enumerate(header_labels):
            ...
            header_label.grid(row=0, column=i, padx=10, pady=5, ipady=30, sticky="nsew")
    ...
    def show_data(self, data_type):
        data = self.get_data_from_database(data_type)
        # self.show_tree_window(data)

    def get_data_from_database(self, data_type):
