...
class MultiPeriodEnv(Environment, ABC):
    def __init__(self,
        ...
        self.overage_cost = self.convert_to_numpy_array(overage_cost)
        self.underage_cost = self.convert_to_numpy_array(underage_cost)

        self.fixed_ordering_cost = self.convert_to_numpy_array(fixed_ordering_cost)
        self.variable_ordering_cost = self.convert_to_numpy_array(variable_ordering_cost)

        self.max_demand_backlog = self.convert_to_numpy_array(max_demand_backlog)
        ...
        self.start_inventory = self.convert_to_numpy_array(start_inventory)
        ...
        self.order_limit_low = order_limit_low
        self.order_limit_high = order_limit_high

        self.horizon = horizon
        self.gamma = gamma

        # Set action space
        self.action_space = Box(order_limit_low, order_limit_high, shape=(self.num_products,))
    ...
    def set_observation_space(self,
        ...
        order_pipeline_space = np.sum(self.num_products * self.lead_time) if order_pipeline else 0
