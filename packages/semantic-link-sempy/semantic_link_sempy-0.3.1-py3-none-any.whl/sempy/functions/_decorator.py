...
from sempy._utils._log import _sempy_log, _sempy_extract_message
import pandas as pd
...
def _semantic_decorator(
    ...
    def semantic_function_wrapper(func):
        ...
        # inject telemetry
        def extract_message_fn(result, arg_dict) -> Dict:
        ...
        logged_pip_guard = _sempy_log(extract_message_fn)(pip_guard)
