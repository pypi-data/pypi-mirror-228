...
from PySide2.QtCore import Qt, Signal, QTime, QRectF, QPoint, QRect, Property, QRegularExpression
from PySide2.QtGui import QIntValidator, QPainter, QPen, QPainterPath, QFont, QRegularExpressionValidator
from PySide2.QtWidgets import (QWidget, QLineEdit, QApplication, QLabel, QHBoxLayout, QVBoxLayout,
                               QPushButton, QFrame)
