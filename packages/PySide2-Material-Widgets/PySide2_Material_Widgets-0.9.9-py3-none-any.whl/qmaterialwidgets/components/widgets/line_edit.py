...
from PySide2.QtCore import (QSize, Qt, QRectF, Signal, QPoint, QTimer, QEvent,
...
from PySide2.QtWidgets import (QApplication, QHBoxLayout, QLineEdit, QAction, QTextEdit,
