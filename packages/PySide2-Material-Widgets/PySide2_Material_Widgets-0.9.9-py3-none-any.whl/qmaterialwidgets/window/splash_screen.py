...
from PySide2.QtWidgets import QWidget, QVBoxLayout, QGraphicsDropShadowEffect
...
class SplashScreen(QWidget):
    ...
    def __init__(self, icon: Union[str, QIcon, MaterialIconBase], parent=None, enableShadow=True):
        ...
        MaterialStyleSheet.MATERIAL_WINDOW.apply(self.titleBar)
