...
from PySide2.QtCore import Qt, Signal, QRectF, QRect, QPropertyAnimation, QSize, QEasingCurve, QEvent
from PySide2.QtGui import QPainter, QColor, QIcon, QPainterPath
