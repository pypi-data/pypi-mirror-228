...
from PySide2.QtCore import (Qt, QPropertyAnimation, QPoint, QParallelAnimationGroup, QEasingCurve, QMargins,
                          QRectF, QObject, QSize, Signal)
from PySide2.QtGui import QPixmap, QPainter, QColor, QCursor, QIcon, QImage, QPainterPath, QBrush, QMovie, QImageReader
from PySide2.QtWidgets import QWidget, QGraphicsDropShadowEffect, QLabel, QHBoxLayout, QVBoxLayout, QApplication
...
class FlyoutView(FlyoutViewBase):
    ...
    def __initWidgets(self):
        ...
        MaterialStyleSheet.TEACHING_TIP.apply(self)
...
class Flyout(QWidget):
    ...
    @classmethod
    def create(cls, title: str, content: str, icon: Union[MaterialIconBase, QIcon, str] = None,
