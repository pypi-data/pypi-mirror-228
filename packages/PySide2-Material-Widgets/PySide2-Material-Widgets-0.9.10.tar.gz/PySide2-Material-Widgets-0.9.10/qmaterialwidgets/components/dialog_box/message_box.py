...
from PySide2.QtCore import Qt, Signal, QObject, QEvent, QSize
from PySide2.QtGui import QColor, QIcon
from PySide2.QtWidgets import QLabel, QFrame, QVBoxLayout, QHBoxLayout, QPushButton, QDialogButtonBox
