...
_AbstractNodeWrapperImpl = TypeVar('_AbstractNodeWrapperImpl', bound='AbstractNodeWrapperImpl')
...
class AbstractNodeWrapperImpl(AbstractNodeWrapper[_Node], Generic[_Node, _Markup]):
    ...
    @classmethod
    def wrap(cls: Type[_AbstractNodeWrapperImpl], node: _Node) -> _AbstractNodeWrapperImpl:
