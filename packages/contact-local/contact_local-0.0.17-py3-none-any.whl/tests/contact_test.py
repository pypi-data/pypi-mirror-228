...
def test_insert_select():
    ...
    logger.start()
    id=ContactsLocal.insert("ai","bye","0539229102","","sami@gmail.com","haifa","sniper","wha")
...
def test_update():
    ...
    ContactsLocal.update(person_id, name_prefix, first_name, additional_name, job_title, id)
    contactRes = ContactsLocal.get_contact_by_contact_id(id)
    print(contactRes[3])
