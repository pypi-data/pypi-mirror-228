...
Refer to the Terraform Registory for docs: [`aws_codepipeline_webhook`](https://registry.terraform.io/providers/hashicorp/aws/5.15.0/docs/resources/codepipeline_webhook).
'''
import abc
import builtins
import datetime
