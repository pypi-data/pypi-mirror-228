...
Refer to the Terraform Registory for docs: [`data_aws_route53_traffic_policy_document`](https://registry.terraform.io/providers/hashicorp/aws/5.15.0/docs/data-sources/route53_traffic_policy_document).
'''
import abc
import builtins
import datetime
